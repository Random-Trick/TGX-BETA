...
public class C9817l implements AbstractC10311w1 {
    ...
    public static boolean m6800h() {
        ...
        return f32083c.contains(Build.MODEL.toUpperCase(Locale.US));
    }
    ...
    public final List<C10226f2> m6804d(int i) {
        ...
        if (i == 0) {
            arrayList.add(f32081a);
            arrayList.add(f32082b);
        }
        return arrayList;
    }
