...
public class C0202a {
    ...
    @RecentlyNonNull
    public static C0202a m42090a() {
        C0202a aVar = new C0202a();
        aVar.m42089b(aVar, RunnableC0226q.f714a);
        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public final void run() {
                ...
                while (!set2.isEmpty()) {
                    try {
                        ((C0228s) referenceQueue2.remove()).mo42057a();
    ...
    @RecentlyNonNull
    public AbstractC0203a m42089b(@RecentlyNonNull Object obj, @RecentlyNonNull Runnable runnable) {
