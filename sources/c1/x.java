...
public final class x {
    public static Method f4313a;

    static {
        if (Build.VERSION.SDK_INT == 25) {
            try {
                f4313a = ViewConfiguration.class.getDeclaredMethod("getScaledScrollFactor", new Class[0]);
    ...
    public static float a(ViewConfiguration viewConfiguration, Context context) {
        Method method;
        if (Build.VERSION.SDK_INT >= 25 && (method = f4313a) != null) {
            try {
