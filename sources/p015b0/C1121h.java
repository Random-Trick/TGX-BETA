...
public class C1121h<V> implements AbstractFutureC1291a<List<V>> {
    ...
    public final AbstractFutureC1291a<List<V>> f4320N = C6287c.m20719a(new C1122a());
    ...
    public class C1122a implements C6287c.AbstractC6290c<List<V>> {
        ...
        public Object mo5520a(C6287c.C6288a<List<V>> aVar) {
            C1132h.m38319h(C1121h.this.f4321O == null, "The result can only set once!");
    ...
    public void mo13372a(Runnable runnable, Executor executor) {
        this.f4320N.mo13372a(runnable, executor);
    }

    public final void m38340b() {
    ...
    public final void m38337e(Executor executor) {
        mo13372a(new RunnableC1123b(), C0003a.m42611a());
        if (this.f4322a.isEmpty()) {
            this.f4321O.m20716c(new ArrayList(this.f4323b));
            return;
        }
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            ...
            aVar.mo13372a(new RunnableC1124c(i2, aVar), executor);
        }
    }

    public void m38336f(int i, Future<? extends V> future) {
        C6287c.C6288a<List<V>> aVar;
        ArrayList arrayList;
        int decrementAndGet;
        List<V> list = this.f4323b;
        if (isDone() || list == 0) {
            C1132h.m38319h(this.f4324c, "Future was done before all dependencies completed");
            return;
        }
        boolean z = true;
        try {
            try {
                try {
                    try {
                        C1132h.m38319h(future.isDone(), "Tried to set value from future which is not done");
                        list.set(i, C1111f.m38354e(future));
                        decrementAndGet = this.f4319M.decrementAndGet();
                        if (decrementAndGet < 0) {
                            z = false;
                        }
                        C1132h.m38319h(z, "Less than 0 remaining futures");
                    } catch (ExecutionException e) {
                        if (this.f4324c) {
                            this.f4321O.m20713f(e.getCause());
                        }
            ...
            if (decrementAndGet == 0) {
                ...
                if (list6 != null) {
                    ...
                    aVar.m20716c(arrayList);
                    return;
                }
                C1132h.m38320g(isDone());
            }
        } catch (Throwable th) {
            ...
            if (decrementAndGet6 == 0) {
                ...
                if (list7 != null) {
                    this.f4321O.m20716c(new ArrayList(list7));
                } else {
                    C1132h.m38320g(isDone());
                }
            }
