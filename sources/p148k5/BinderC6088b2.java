...
public final class BinderC6088b2 extends BinderC6199d implements AbstractC5867f.AbstractC5869b, AbstractC5867f.AbstractC5870c {
    ...
    public BinderC6088b2(Context context, Handler handler, C6336e eVar) {
        ...
        this.f19318e = (C6336e) C6378r.m20506l(eVar, "ClientSettings must not be null");
        this.f19317d = eVar.m20605e();
        this.f19316c = aVar;
    }

    public static void m21383K1(BinderC6088b2 b2Var, C6207l lVar) {
        ...
        if (b.m23612f()) {
            ...
            if (!b.m23612f()) {
                ...
                b2Var.f19320g.mo21282c(q0Var.m20521b(), b2Var.f19317d);
                b2Var.f19319f.mo905j();
            }
        }
        b2Var.f19320g.mo21283a(b);
        b2Var.f19319f.mo905j();
    }

    public final void m21386H1(AbstractC6083a2 a2Var) {
        AbstractC5891f fVar = this.f19319f;
        if (fVar != null) {
            fVar.mo905j();
        }
        this.f19318e.m20600j(Integer.valueOf(System.identityHashCode(this)));
        ...
        this.f19319f = aVar.mo21894c(context, looper, eVar, eVar.m20602h(), this, this);
        this.f19320g = a2Var;
        Set<Scope> set = this.f19317d;
        if (set == null || set.isEmpty()) {
            this.f19315b.post(new RunnableC6190y1(this));
        } else {
            this.f19319f.mo21079c();
        }
    }

    public final void m21385I1() {
        AbstractC5891f fVar = this.f19319f;
        if (fVar != null) {
            fVar.mo905j();
        }
    ...
    public final void mo11483s(C5217a aVar) {
        this.f19320g.mo21283a(aVar);
    }

    @Override
    public final void mo21080t(Bundle bundle) {
        this.f19319f.mo21078f(this);
    }
}
