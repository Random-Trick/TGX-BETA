...
public final class C6137l2<A extends AbstractC3487a<? extends AbstractC5876k, C5850a.AbstractC5852b>> extends AbstractC6154p2 {
    ...
    public C6137l2(int i, A a) {
        super(i);
        this.f19463b = (A) C6378r.m20505l(a, "Null methods are not runnable.");
    }

    @Override
    public final void mo21184a(Status status) {
        try {
            this.f19463b.m30370w(status);
    ...
    public final void mo21183b(Exception exc) {
        ...
        try {
            this.f19463b.m30370w(new Status(10, sb2.toString()));
        } catch (IllegalStateException e) {
            Log.w("ApiCallRunner", "Exception reporting failure", e);
        }
    }
    ...
    public final void mo21182c(C6172u uVar, boolean z) {
        uVar.m21127a(this.f19463b, z);
    }

    @Override
    public final void mo21181d(C6093c1<?> c1Var) {
        try {
            this.f19463b.m30372u(c1Var.m21340v());
