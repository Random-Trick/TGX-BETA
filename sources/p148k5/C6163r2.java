...
public final class C6163r2 extends AbstractDialogInterface$OnCancelListenerC6183w2 {
    ...
    public C6163r2(AbstractC6116h hVar) {
        super(hVar, C5220d.m23605p());
        this.f11598a.m21275a("AutoManageHelper", this);
    }

    public static C6163r2 m21141k(C6111g gVar) {
        AbstractC6116h b = LifecycleCallback.m30378b(gVar);
        C6163r2 r2Var = (C6163r2) b.m21274b("AutoManageHelper", C6163r2.class);
        return r2Var != null ? r2Var : new C6163r2(b);
    }

    @Override
    public final void mo21095f(C5217a aVar, int i) {
    ...
    public final void m21140l(int i, AbstractC5867f fVar, AbstractC5867f.AbstractC5870c cVar) {
        C6378r.m20506l(fVar, "GoogleApiClient instance cannot be null");
        boolean z = this.f19537O.indexOfKey(i) < 0;
        StringBuilder sb2 = new StringBuilder(54);
        sb2.append("Already managing a GoogleApiClient with id ");
        sb2.append(i);
        C6378r.m20504n(z, sb2.toString());
    ...
    public final void m21139m(int i) {
        C6158q2 q2Var = this.f19537O.get(i);
        this.f19537O.remove(i);
        if (q2Var != null) {
            q2Var.f19524b.mo21087l(q2Var);
            q2Var.f19524b.mo21089e();
        }
    }

    public final C6158q2 m21138n(int i) {
