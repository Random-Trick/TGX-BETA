...
public final class RunnableC6788v implements Runnable {
    ...
    public final void run() {
        ...
        try {
            ...
            AbstractC6775l lVar = (AbstractC6775l) cVar.mo10598a(this.f21268a);
            if (lVar == null) {
                this.f21269b.mo4157c(new NullPointerException("Continuation returned null"));
                return;
            }
            Executor executor = C6779n.f21257b;
            lVar.mo19075f(executor, this.f21269b);
            lVar.mo19077d(executor, this.f21269b);
            lVar.mo19080a(executor, this.f21269b);
        } catch (C6771j e) {
