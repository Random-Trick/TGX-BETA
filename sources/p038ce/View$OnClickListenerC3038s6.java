...
public class View$OnClickListenerC3038s6 extends AbstractC2420g6<C3041c> implements View.OnClickListener, C2546iq.AbstractC2551e {
    ...
    public static final String[] f10200J0 = {"1", "10", "50", "100", C4403w.m27871i1(R.string.Infinity)};
    ...
    public class C3039a implements AbstractC5117h0 {
        ...
        public void m31958b(AbstractC5920l lVar, long j) {
            lVar.mo3050a(j - View$OnClickListenerC3038s6.this.f30170b.m2898D4());
        }
        ...
        public boolean mo493A3(View view, int i) {
            ...
            String i1 = C4403w.m27871i1(R.string.InviteLinkExpireTitle);
            ...
            s6Var.m9309Xd(i1, R.string.InviteLinkExpireToday, R.string.InviteLinkExpireTomorrow, R.string.InviteLinkExpireFuture, new AbstractC5920l() {
                ...
                public final void mo3050a(long j2) {
                    View$OnClickListenerC3038s6.C3039a.this.m31958b(lVar, j2);
                }
            }, null);
            return true;
        }
    ...
    public class C3040b extends C2546iq {
        ...
        public void mo31469J1(C2964ra raVar, C6942k3 k3Var, int i, int i2) {
            int i3 = 0;
            if (raVar.m32838j() == R.id.btn_inviteLinkDateSlider) {
                View$OnClickListenerC3038s6 s6Var = View$OnClickListenerC3038s6.this;
                if (i != s6Var.f10212x0.length - 1) {
                    i3 = View$OnClickListenerC3038s6.this.f10213y0[i];
                }
                s6Var.f10204C0 = i3;
                View$OnClickListenerC3038s6.this.f10203B0.m34133s3(R.id.btn_inviteLinkDateLimit);
            } else if (raVar.m32838j() == R.id.btn_inviteLinkUserSlider) {
                ...
                s6Var2.f10205D0 = i3;
                View$OnClickListenerC3038s6.this.f10203B0.m34133s3(R.id.btn_inviteLinkUserLimit);
            }
            View$OnClickListenerC3038s6.this.m31989Ff();
        }

        @Override
        public void mo31467O2(C2964ra raVar, C6942k3 k3Var) {
            k3Var.setPadding(k3Var.getPaddingLeft(), k3Var.getPaddingTop(), C1357a0.m37544i(16.0f), k3Var.getPaddingBottom());
        ...
        public void mo394V2(C2964ra raVar, C9137c cVar, boolean z) {
            if (raVar.m32838j() == R.id.btn_inviteLinkDateLimit) {
                cVar.setData(View$OnClickListenerC3038s6.this.f10204C0 > 0 ? C4403w.m28003C1(View$OnClickListenerC3038s6.this.f10202A0 + View$OnClickListenerC3038s6.this.f10204C0, TimeUnit.SECONDS) : C4403w.m27871i1(R.string.InviteLinkNoLimitSet));
            } else if (raVar.m32838j() == R.id.btn_inviteLinkUserLimit) {
                ...
                cVar.setData(View$OnClickListenerC3038s6.this.f10205D0 == 0 ? C4403w.m27871i1(R.string.InviteLinkNoLimitSet) : C4403w.m27846o2(R.string.InviteLinkRemains, i));
            } else if (raVar.m32838j() == R.id.btn_inviteLinkAdminApproval) {
                cVar.getToggler().m10185r(View$OnClickListenerC3038s6.this.f10207F0, false);
            }
        }
    ...
    static {
        ...
        f10199I0 = iArr;
        f10201K0 = new String[]{C4403w.m27820v0(iArr[0]), C4403w.m27820v0(iArr[1]), C4403w.m27820v0(iArr[2]), C4403w.m27871i1(R.string.Infinity)};
    }
    ...
    public void m31983Lf(long j) {
        this.f10204C0 = (int) TimeUnit.MILLISECONDS.toSeconds(j);
        m31977Rf();
        this.f10203B0.m34133s3(R.id.btn_inviteLinkDateLimit);
        this.f10203B0.m34174g3(R.id.btn_inviteLinkDateSlider);
        m31989Ff();
    }

    public boolean m31982Mf(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
        ...
        m31976Sf();
        this.f10203B0.m34174g3(R.id.btn_inviteLinkUserSlider);
        this.f10203B0.m34133s3(R.id.btn_inviteLinkUserLimit);
        m31989Ff();
        return true;
    }

    public void m31981Nf(TdApi.Object object) {
        if (object.getConstructor() == -205812476) {
            m9131x9().f10220c.m33143zh((TdApi.ChatInviteLink) object, m9131x9().f10218a);
            m9298Zb();
    ...
    public void m31980Of(final TdApi.Object object) {
        m9135wd(new Runnable() {
            @Override
            public final void run() {
                View$OnClickListenerC3038s6.this.m31981Nf(object);
            }
        });
    }

    public final void m31990Ef() {
        int N0 = this.f10203B0.m34227N0(R.id.btn_inviteLinkDateLimit);
        if (N0 != -1) {
            this.f10203B0.m34191b1(N0 + 3, m31988Gf());
        }
    }

    public final void m31989Ff() {
        if (!this.f10206E0) {
            mo31399hf(m31987Hf());
        }
    }

    public final C2964ra[] m31988Gf() {
    ...
    public final boolean m31986If(int i) {
        TdApi.ChatInviteLink chatInviteLink = this.f10209H0;
        return chatInviteLink != null && i - chatInviteLink.memberCount < 0;
    }

    public final boolean m31985Jf() {
        int i = this.f10204C0;
        if (i != 0) {
            int[] iArr = f10199I0;
    ...
    public final boolean m31984Kf() {
        int i = this.f10205D0;
        return i == 0 || i == 1 || i == 10 || i == 50 || i == 100;
    }

    public final void m31979Pf() {
        int N0 = this.f10203B0.m34227N0(R.id.btn_inviteLinkDateLimit);
        if (N0 != -1) {
            this.f10203B0.m34207V1(N0 + 3, 7);
        }
    }

    public void m31978Qf(C3041c cVar) {
        super.m9476Ad(cVar);
        ...
        if (chatInviteLink != null) {
            ...
            this.f10204C0 = Math.max(0, (int) (chatInviteLink.expirationDate - this.f30170b.m2914C4(TimeUnit.SECONDS)));
        ...
        this.f10202A0 = (int) this.f30170b.m2914C4(TimeUnit.SECONDS);
    }
    ...
    public final void m31977Rf() {
        int[] iArr = m31985Jf() ? new int[]{3600, 86400, 604800, Integer.MAX_VALUE} : new int[]{3600, 86400, 604800, Integer.MAX_VALUE, this.f10204C0};
        Arrays.sort(iArr);
        C5146u0 u0Var = new C5146u0(iArr.length);
        for (int i = 0; i < iArr.length; i++) {
            int i2 = iArr[i];
            u0Var.m23816b(i2 == Integer.MAX_VALUE ? C4403w.m27871i1(R.string.Infinity) : C4403w.m27820v0(i2));
            if (this.f10204C0 == i2) {
                this.f10214z0 = i;
            }
        }
        ...
        this.f10212x0 = u0Var.m23814d();
        this.f10213y0 = iArr;
        this.f10202A0 = (int) this.f30170b.m2914C4(TimeUnit.SECONDS);
    }

    public final void m31976Sf() {
        int[] iArr = m31984Kf() ? new int[]{1, 10, 50, 100, Integer.MAX_VALUE} : new int[]{1, 10, 50, 100, Integer.MAX_VALUE, this.f10205D0};
        Arrays.sort(iArr);
        C5146u0 u0Var = new C5146u0(iArr.length);
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (chatInviteLink == null || i2 >= chatInviteLink.memberCount) {
                u0Var.m23816b(i2 == Integer.MAX_VALUE ? C4403w.m27871i1(R.string.Infinity) : String.valueOf(i2));
            }
        }
        int e = u0Var.m23813e(String.valueOf(this.f10205D0));
        this.f10211w0 = e;
        if (e == -1) {
            this.f10211w0 = u0Var.m23814d().length - 1;
        }
        this.f10210v0 = u0Var.m23814d();
    }

    @Override
    public CharSequence mo9313X9() {
        return C4403w.m27871i1(this.f10206E0 ? R.string.CreateLink : R.string.InviteLinkEdit);
    }
    ...
    public void mo30699Ze(Context context, FrameLayoutFix frameLayoutFix, RecyclerView recyclerView) {
        ...
        if (chatInviteLink == null || !chatInviteLink.createsJoinRequest) {
            arrayList.addAll(Arrays.asList(m31988Gf()));
        }
        this.f10203B0.m34119x2(arrayList, false);
    ...
    public boolean mo30698af() {
        ...
        r4.m14783o(function, new Client.AbstractC7865g() {
            ...
            public final void mo255t2(TdApi.Object object) {
                View$OnClickListenerC3038s6.this.m31980Of(object);
            }
        });
        return true;
    }
        ...
        if (view.getId() == R.id.btn_inviteLinkDateLimit) {
            ...
            AbstractC5920l o6Var = new AbstractC5920l() {
                ...
                public final void mo3050a(long j) {
                    View$OnClickListenerC3038s6.this.m31983Lf(j);
                }
            };
            cVar.m23285a(R.id.btn_expireIn12h);
            u0Var.m23816b(C4403w.m27846o2(R.string.InviteLinkExpireInHours, 12L));
            cVar2.m23285a(R.drawable.baseline_schedule_24);
            cVar.m23285a(R.id.btn_expireIn2d);
            u0Var.m23816b(C4403w.m27846o2(R.string.InviteLinkExpireInDays, 2L));
            cVar2.m23285a(R.drawable.baseline_schedule_24);
            cVar.m23285a(R.id.btn_expireIn1w);
            u0Var.m23816b(C4403w.m27846o2(R.string.InviteLinkExpireInWeeks, 1L));
            cVar2.m23285a(R.drawable.baseline_schedule_24);
            cVar.m23285a(R.id.btn_expireIn2w);
            u0Var.m23816b(C4403w.m27846o2(R.string.InviteLinkExpireInWeeks, 2L));
            cVar2.m23285a(R.drawable.baseline_schedule_24);
            cVar.m23285a(R.id.btn_sendScheduledCustom);
            u0Var.m23816b(C4403w.m27871i1(R.string.InviteLinkExpireInCustomDate));
            cVar2.m23285a(R.drawable.baseline_date_range_24);
            m9261ee(null, cVar.m23281e(), u0Var.m23814d(), null, cVar2.m23281e(), new C3039a(o6Var));
        } else if (view.getId() == R.id.btn_inviteLinkUserLimit) {
            m9364Pc(C4403w.m27871i1(R.string.InviteLinkLimitedByUsersItem), C4403w.m27871i1(R.string.InviteLinkLimitedByUsersAlertHint), R.string.Done, R.string.Cancel, String.valueOf(this.f10205D0), new AbstractC9323v4.AbstractC9336m() {
                @Override
                public final boolean mo4197a(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
                    boolean Mf;
                    Mf = View$OnClickListenerC3038s6.this.m31982Mf(y1Var, str);
                    return Mf;
                }
            }, true).getEditText().setInputType(2);
        } else if (view.getId() == R.id.btn_inviteLinkAdminApproval) {
            boolean W2 = this.f10203B0.m34204W2(view);
            this.f10207F0 = W2;
            if (W2) {
                m31979Pf();
            } else {
