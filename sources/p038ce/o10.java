...
public class o10 extends i10<AbstractC4718o<?>> implements C9773p0.AbstractC9777d, C9773p0.AbstractC9776c {
    ...
    public static void m33510Rg() {
    }

    public boolean m33509Sg(AbstractC4718o oVar, View view, View view2, int i) {
        if (i == R.id.btn_delete) {
            ...
            x00Var.m30996Vi(new x00.C3281m(oVar.getMessage()).m30890A(true));
            x00Var.m30962ej();
        } else if (i == R.id.btn_showInChat) {
            this.f8587r0.mo9314X8(false);
            this.f30170b.m2485dd().m3459s7(this, oVar.getMessage(), new HandlerC10770jj.C10788q().m3312s(mo4347s().m14584H3().m8985g(view)));
        }
        return true;
    }

    public static void m33507Ug(ArrayList<AbstractC4718o<?>> arrayList, TdApi.Message message) {
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            while (it2.hasNext()) {
                ...
                if (next2 instanceof C4756s) {
                    ((C4756s) next2).m26257k0(C9773p0.m7114D(next2.getMessage(), message));
                }
            }
        }
    }
    ...
    public AbstractC4718o<?> mo33047rg(TdApi.Object object) {
        AbstractC4718o<?> oVar;
        ...
        if (searchMessagesFilter == null || searchMessagesFilter.getConstructor() != -1828724341) {
            oVar = AbstractC4718o.m26344X(this.f30168a, this.f30170b, message);
        } else {
            oVar = new C4836y(this.f30168a, this.f30170b, message);
        }
        if (oVar != null) {
            oVar.m26348T(message.f25409id);
            oVar.m26351O(message.date);
            if ((oVar instanceof C4756s) && message.content.getConstructor() == 276722716) {
                ((C4756s) oVar).m26258j0(false);
            }
        }
        return oVar;
    }

    public o10 m33506Vg(TdApi.SearchMessagesFilter searchMessagesFilter) {
    ...
    public CharSequence mo9313X9() {
        switch (this.f9444G0.getConstructor()) {
            case TdApi.SearchMessagesFilterUrl.CONSTRUCTOR:
                return C4403w.m27871i1(R.string.TabLinks);
            case TdApi.SearchMessagesFilterAudio.CONSTRUCTOR:
                return C4403w.m27871i1(R.string.TabAudio);
            case TdApi.SearchMessagesFilterDocument.CONSTRUCTOR:
                return C4403w.m27871i1(R.string.TabDocs);
            case TdApi.SearchMessagesFilterVoiceNote.CONSTRUCTOR:
                return C4403w.m27871i1(R.string.TabVoiceMessages);
            default:
                return "";
        }
    }
    ...
    public void mo6983Y1(C10930q6 q6Var, TdApi.Message message, int i, int i2, float f, boolean z) {
        m33507Ug(this.f8577A0, message);
        if (m34384Rf()) {
            m33507Ug(this.f8578B0, message);
        }
    }
    ...
    public void mo417Z8() {
        ...
        if (searchMessagesFilter != null && searchMessagesFilter.getConstructor() == 867505275) {
            this.f30170b.m2930B4().m4636w2().m7087Q0(this);
        }
    }

    @Override
    public CharSequence mo33054if(ArrayList<AbstractC4718o<?>> arrayList) {
        switch (this.f9444G0.getConstructor()) {
            case TdApi.SearchMessagesFilterUrl.CONSTRUCTOR:
                return C4403w.m27838q2(R.string.xLinks, arrayList.size());
            case TdApi.SearchMessagesFilterAudio.CONSTRUCTOR:
                return C4403w.m27838q2(R.string.xAudios, arrayList.size());
            case TdApi.SearchMessagesFilterDocument.CONSTRUCTOR:
                return C4403w.m27838q2(R.string.xFiles, arrayList.size());
            case TdApi.SearchMessagesFilterVoiceNote.CONSTRUCTOR:
                return C4403w.m27838q2(R.string.xVoiceMessages, arrayList.size());
            default:
                return null;
        }
    }
    ...
    public void mo33048ng(Context context, MediaRecyclerView mediaRecyclerView, C2546iq iqVar) {
        ...
        TdApi.SearchMessagesFilter searchMessagesFilter = this.f9444G0;
        if (searchMessagesFilter != null && searchMessagesFilter.getConstructor() == 867505275) {
            this.f30170b.m2930B4().m4636w2().m7030p(this);
        }
    }
    ...
    public void onClick(View view) {
        ...
        if (raVar != null && raVar.m32879A() == 41) {
            ...
            int v = oVar.m26331v();
            if (v == 0) {
                this.f30170b.m2485dd().m3469r7(this, this.f8583n0, new C7319d(this.f8583n0, oVar.m26335r()), new HandlerC10770jj.C10788q().m3312s(mo4347s().m14584H3().m8985g(view)));
            } else if (v == 7 || v == 8) {
                this.f30170b.m2930B4().m4636w2().m7105H0(this.f30170b, oVar.getMessage(), this);
            } else if (v == 9) {
                ((C4756s) oVar).m26260h0(view);
            }
        }
    }
    ...
    @Override
    public boolean mo33504qg(final View view, C2964ra raVar) {
        final AbstractC4718o oVar = (AbstractC4718o) raVar.m32847d();
        this.f8587r0.m9261ee(null, new int[]{R.id.btn_showInChat, R.id.btn_share, R.id.btn_delete}, new String[]{C4403w.m27871i1(R.string.ShowInChat), C4403w.m27871i1(R.string.Share), C4403w.m27871i1(R.string.Delete)}, new int[]{1, 1, 2}, new int[]{R.drawable.baseline_visibility_24, R.drawable.baseline_forward_24, R.drawable.baseline_delete_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view2, int i) {
                boolean Sg;
                Sg = o10.this.m33509Sg(oVar, view, view2, i);
                return Sg;
            }
    ...
    public C9773p0.C9775b mo6986s5(TdApi.Message message) {
        ...
        for (int size = arrayList.size() - 1; size >= 0; size--) {
            ...
            if (oVar.m26331v() == i && (oVar instanceof C4756s)) {
