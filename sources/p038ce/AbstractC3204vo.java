...
public abstract class AbstractC3204vo<T> extends AbstractC9299t2<T> implements AbstractC9388z1, AbstractC9376x4.AbstractC9378b, AbstractC9201h1 {
    ...
    public class C3206b extends LinearLayoutManager {
        ...
        @Override
        public int mo31289y1(int i, RecyclerView.C0913v vVar, RecyclerView.C0880a0 a0Var) {
            if (!AbstractC3204vo.this.f10700u0 || AbstractC3204vo.this.f10699t0.getScrollState() != 2 || AbstractC3204vo.this.f10702w0 == 1) {
                return super.mo31289y1(i, vVar, a0Var);
            }
            return 0;
        }
    }
    ...
    public void m31301mg(View view) {
        if (this.f10698C0.getIsVisible()) {
            mo31297sg();
        }
    }

    public void m31300ng() {
        if (!m9347Sa()) {
    ...
    public AbstractC3204vo<T> m31316Ag() {
        this.f10697B0 |= 2;
        return this;
    }
    ...
    public void mo8829I() {
        if (this.f10699t0.getAdapter() != null) {
            try {
                ...
                if (X1 != -1) {
                    int r = ((C2546iq) this.f10699t0.getAdapter()).mo11422r(X1);
                    View C = linearLayoutManager.mo39262C(X1);
                    if (C != null) {
                        r -= C.getTop();
                    }
                    m31303kg().mo8024v1(0, -r);
                }
            } catch (Throwable th) {
    ...
    public void mo8867Ia() {
        super.mo8867Ia();
        C1399s0.m37171l0(this.f10699t0);
    }
    ...
    public void mo417Z8() {
        super.mo417Z8();
        C1399s0.m37162q(this.f10699t0);
    }

    public void m31307gg() {
        if (this.f10703x0 != -1) {
            LinearLayoutManager linearLayoutManager = (LinearLayoutManager) m31303kg().getLayoutManager();
            if (linearLayoutManager != null) {
                linearLayoutManager.m39522z2(this.f10703x0, this.f10704y0);
            }
            this.f10703x0 = -1;
            this.f10704y0 = 0;
        }
    ...
    public int m31306hg() {
        return ((LinearLayoutManager) this.f10699t0.getLayoutManager()).m39549X1();
    }

    public final C6982o0 m31305ig() {
        if (this.f10698C0 == null) {
            this.f10698C0 = new C6982o0(this.f30165a);
            ...
            t1.leftMargin = i3;
            t1.rightMargin = i3;
            C6982o0 o0Var = new C6982o0(this.f30165a);
            this.f10698C0 = o0Var;
            ...
            this.f10698C0.setOnClickListener(new View.OnClickListener() {
                ...
                public final void onClick(View view) {
                    AbstractC3204vo.this.m31301mg(view);
                }
            });
    ...
    public CustomRecyclerView m31303kg() {
        return this.f10699t0;
    }

    @Override
    public int mo415la() {
        return m31298qg() ? R.id.menu_clear : super.mo415la();
    }

    public int m31302lg(int i) {
        View C = this.f10699t0.getLayoutManager().mo39262C(i);
        if (C != null) {
            return C.getTop();
        }
        return 0;
    ...
    public View mo403oc(Context context) {
        ...
        if (m31299og()) {
            C10192g.m5782i(frameLayoutFix, m31304jg(), this);
        }
        frameLayoutFix.setLayoutParams(FrameLayoutFix.m18008s1(-1, -1));
        CustomRecyclerView customRecyclerView = (CustomRecyclerView) C1399s0.m37146y(mo4347s(), R.layout.recycler_custom, null);
    ...
    public void mo414p0(int i, View$OnClickListenerC9170d1 d1Var, LinearLayout linearLayout) {
        switch (i) {
            case R.id.menu_clear:
                ...
                return;
            case R.id.menu_help:
                d1Var.m10104N1(linearLayout, R.id.menu_btn_help, R.drawable.baseline_help_outline_24, mo9375O9(), this, C1357a0.m37541i(49.0f));
                return;
            case R.id.menu_more:
    ...
    public final boolean m31298qg() {
        return (this.f10697B0 & 1) != 0;
    }

    public abstract void mo30633rg(Context context, CustomRecyclerView customRecyclerView);
    ...
    public final void m31294vg() {
        ...
        if (this.f10705z0 >= 0 && (customRecyclerView = this.f10699t0) != null) {
            ...
            if (linearLayoutManager != null && adapter != null && (i = this.f10705z0) >= 0 && i < adapter.mo6153D()) {
                linearLayoutManager.m39522z2(this.f10705z0, this.f10696A0);
                this.f10705z0 = -1;
                this.f10696A0 = 0;
            }
        }
    ...
    public void m31292xg(boolean z) {
        this.f10700u0 = z;
    }
    ...
    public final void m31291yg(boolean z, boolean z2) {
        m31305ig().m18184p(z, z2);
    }
    ...
    public AbstractC3204vo<T> m31290zg() {
        this.f10697B0 |= 1;
        return this;
    }
}
