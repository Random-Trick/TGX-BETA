...
public class C2760nb extends AbstractC9376x4<Void> implements View$OnClickListenerC9347w1.AbstractC9349b, AbstractC11041ub, C5120j.AbstractC5121a, AbstractC10903p0 {
    ...
    public class C2761a implements View$OnClickListenerC9156b5.AbstractC9160d {
        ...
        @Override
        public void mo10138a(View view, MotionEvent motionEvent, int i, boolean z) {
            if (!z || C2760nb.this.f9347A0 == -1) {
                C2760nb.this.m33584Ph(-1, motionEvent, view.getMeasuredHeight(), false);
            } else {
                C2760nb nbVar = C2760nb.this;
                nbVar.m33590Mh(nbVar.f9347A0);
                C2760nb.this.m33584Ph(-1, motionEvent, view.getMeasuredHeight(), true);
            }
            C2760nb.this.m33588Nh(view, false);
        }

        @Override
        public void mo10137b(View view, MotionEvent motionEvent, int i) {
            int i2;
            ...
            if (measuredWidth >= 0.0f && measuredWidth < C2760nb.this.f9349C0.getMeasuredWidth()) {
                ...
                C2760nb.this.m33584Ph(i2, motionEvent, view.getMeasuredHeight(), false);
            }
            i2 = -1;
            C2760nb.this.m33584Ph(i2, motionEvent, view.getMeasuredHeight(), false);
        }
        ...
        @Override
        public void mo10136c(View view, MotionEvent motionEvent, int i) {
            C2760nb.this.m33588Nh(view, true);
        }

        @Override
        public boolean mo10135d(View view, MotionEvent motionEvent, int i) {
            return i == 0 && C2760nb.this.m33560bi();
        }
    }
    ...
    public class C2764d extends RecyclerView.AbstractC0910t {
        ...
        public void mo421b(RecyclerView recyclerView, int i, int i2) {
            ...
            this.f9368a = f;
            if (i2 < 0 && this.f9369b - f >= C1357a0.m37537p()) {
                C2760nb.this.m33568Xh(this.f9370c, true);
                this.f9369b = this.f9368a;
            } else if (this.f9368a - this.f9369b > C1357a0.m37536q()) {
                C2760nb.this.m33568Xh(this.f9370c, false);
                this.f9369b = this.f9368a;
            }
            if (Math.abs(this.f9368a - this.f9369b) > C1357a0.m37536q()) {
                this.f9368a = 0.0f;
                this.f9369b = 0.0f;
            }
        }
    ...
    public class C2765e implements AbstractView$OnTouchListenerC7889a.AbstractC7900k {
        ...
        public void mo7703f(AbstractView$OnTouchListenerC7889a aVar, boolean z) {
            if (z) {
                this.f9372a.m14412y2(this);
                C2760nb.this.m33578Sh();
            }
        }
    }
    ...
    public class C2766f extends AbstractRunnableC5910b {
        ...
        @Override
        public void mo1364b() {
            C1379j0.m37295y0(R.string.ProcessingFileWait, 0);
        }
    }
    ...
    public class C2767g implements x00.AbstractC3286q {
        ...
        @Override
        public void mo30851a(long j, TdApi.Chat chat, TdApi.MessageSendOptions messageSendOptions, ArrayList<TdApi.Function> arrayList) {
            Iterator it = this.f9375a.iterator();
            ArrayList arrayList2 = null;
            while (it.hasNext()) {
                TdApi.InputMessageContent B = this.f9376b.m2429h5().m23152B((TdApi.InputMessageContent) it.next(), C7316a.m17051j(j));
                if (!this.f9377c) {
                    C4779t2.m25603S4(this.f9376b, j, messageSendOptions, arrayList, B);
                } else if (C4779t2.m25565Z0(B) == 1) {
                    if (arrayList2 == null) {
                        arrayList2 = new ArrayList();
                    }
                    arrayList2.add(B);
                    if (arrayList2.size() == 10) {
                        C4779t2.m25609R4(this.f9376b, j, messageSendOptions, arrayList, arrayList2);
                    }
                } else {
                    C4779t2.m25609R4(this.f9376b, j, messageSendOptions, arrayList, arrayList2);
                    C4779t2.m25603S4(this.f9376b, j, messageSendOptions, arrayList, B);
        ...
        @Override
        public CharSequence mo30850b(long j) {
            Iterator it = this.f9375a.iterator();
            while (it.hasNext()) {
    ...
    public boolean m33614Ah(TdApi.LanguagePackInfo languagePackInfo, final String str, View view, int i) {
        if (i == R.id.btn_cancel) {
            C4868i.m24727c2().m24551y5(str);
        } else if (i == R.id.btn_done) {
            this.f30170b.m2757M1(languagePackInfo, new AbstractC5917i() {
                @Override
                public final void mo1322a(boolean z) {
                    C2760nb.m33533zh(str, z);
                }
            }, true);
    ...
    public void m33612Bh(final TdApi.LanguagePackInfo languagePackInfo, Map map, final String str) {
        TdApi.LanguagePackInfo languagePackInfo2;
        if (!m9347Sa() && (languagePackInfo2 = this.f9356J0) != null && languagePackInfo.f25408id.equals(languagePackInfo2.f25408id)) {
            ...
            u0Var.m23816b(C4779t2.m25454p0(map, C4403w.m27887e1(R.string.language_continueInLanguage), C3296xa.f11006a));
            cVar2.m23285a(3);
            ...
            cVar.m23285a(R.id.btn_languageSettings);
            u0Var.m23817a(R.string.MoreLanguages);
            cVar2.m23285a(1);
            cVar3.m23285a(R.drawable.baseline_language_24);
            C6924j2 ee2 = m9261ee(C1363c0.m37428l(this, C4779t2.m25454p0(map, C4403w.m27887e1(R.string.language_continueInLanguagePopupText), C3343ya.f11114a), null), cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), cVar3.m23281e(), new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean Ah;
                    Ah = C2760nb.this.m33614Ah(languagePackInfo, str, view, i);
                    return Ah;
                }
    ...
    public void m33610Ch(String[] strArr, final TdApi.LanguagePackInfo languagePackInfo, final String str, final Map map) {
        if (map == null || map.size() < strArr.length) {
            Log.m14709w("Suggested language is bad, ignoring. languagePackId:%s", languagePackInfo.f25408id);
            TdApi.LanguagePackInfo languagePackInfo2 = this.f9356J0;
            if (languagePackInfo2 != null && languagePackInfo.f25408id.equals(languagePackInfo2.f25408id)) {
                this.f9356J0 = null;
                return;
            }
            return;
        ...
        this.f30170b.m2485dd().post(new Runnable() {
            ...
            public final void run() {
                C2760nb.this.m33612Bh(languagePackInfo, map, str);
            }
        });
    }

    public void m33608Dh(int i, SparseIntArray sparseIntArray) {
        SyncAdapter.m14202e(this.f30168a, this.f30170b, true);
    }

    public void m33606Eh(C6924j2 j2Var) {
        this.f9360N0 = null;
    }

    public static boolean m33604Fh(C9180e2 e2Var, View view, boolean z) {
        int N0;
        if (!z || (N0 = e2Var.f29640a.m34227N0(R.id.btn_neverAllow)) == -1 || !e2Var.f29640a.m34243F0().get(N0).m32876D()) {
            return false;
        }
        C4868i.m24727c2().m24583u2(128L);
        return false;
    }

    public static String m33594Kh(Intent intent) {
        ...
        return m33550lh(intent.getStringExtra("android.intent.extra.SUBJECT"), stringExtra);
    }

    public static boolean m33557eh(p350yd.C10930q6 r19, java.util.ArrayList<org.drinkless.p210td.libcore.telegram.TdApi.InputMessageContent> r20, java.lang.String r21, android.net.Uri r22, java.lang.String r23) {
        throw new UnsupportedOperationException("Method not decompiled: p038ce.C2760nb.m33557eh(yd.q6, java.util.ArrayList, java.lang.String, android.net.Uri, java.lang.String):boolean");
    }

    public static String m33550lh(String str, String str2) {
        if (C5070i.m24062i(str2) && C5070i.m24062i(str)) {
            return null;
        }
        StringBuilder sb2 = new StringBuilder(C5070i.m24055p(str2) + 1 + C5070i.m24055p(str));
        if (!C5070i.m24062i(str) && (C5070i.m24062i(str2) || str2.startsWith("https://") || str2.startsWith("http://"))) {
            sb2.append(str);
        }
    ...
    public void m33548nh() {
        C6990p pVar;
        if (!m9347Sa() && (pVar = this.f9349C0) != null) {
            pVar.getChildAt(1).setVisibility(this.f30170b.m2348m6() ? 0 : 8);
        }
    }

    public void m33547oh(int i, View$OnClickListenerC2805o4 o4Var) {
    ...
    public static void m33546ph(View view) {
    }

    public void m33545qh(C10930q6 q6Var, ArrayList arrayList, boolean z) {
        x00 x00Var = new x00(this.f30168a, q6Var);
        x00Var.m30996Vi(new x00.C3281m(new C2767g(arrayList, q6Var, z)).m30887D(true));
        x00Var.m30962ej();
    }

    public void m33544rh(final C10930q6 q6Var, final ArrayList arrayList, final boolean z) {
        q6Var.m2485dd().post(new Runnable() {
            @Override
            public final void run() {
                C2760nb.this.m33545qh(q6Var, arrayList, z);
            }
        });
    }

    public void m33543sh(final C10930q6 q6Var, final ArrayList arrayList, final boolean z) {
        q6Var.m2573Y1(new Runnable() {
            @Override
            public final void run() {
                C2760nb.this.m33544rh(q6Var, arrayList, z);
            }
        });
    }

    public void m33542th(int i, boolean z) {
        if (z) {
            m33578Sh();
        } else {
            C1379j0.m37295y0(R.string.NoStorageAccess, 0);
        }
    }

    public void m33541uh(java.lang.String r7, p350yd.C10930q6 r8, android.content.Intent r9) {
        throw new UnsupportedOperationException("Method not decompiled: p038ce.C2760nb.m33541uh(java.lang.String, yd.q6, android.content.Intent):void");
    }

    public void m33540vh(final C4868i.C4874f fVar) {
        if (m9339Ta() && !m9347Sa() && !this.f30168a.m14413y1()) {
            m9261ee(C4403w.m27855m1(R.string.EmojiSetUpdated, fVar.f16661M), new int[]{R.id.btn_downloadFile, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.EmojiSetUpdate), C4403w.m27871i1(R.string.Cancel)}, new int[]{3, 1}, new int[]{R.drawable.baseline_sync_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean wh;
                    wh = C2760nb.this.m33539wh(fVar, view, i);
                    return wh;
                }
    ...
    public boolean m33539wh(C4868i.C4874f fVar, View view, int i) {
        if (i == R.id.btn_cancel) {
            C4868i.m24727c2().m24770W3();
            return true;
        } else if (i != R.id.btn_downloadFile) {
            return true;
        } else {
            C3411zs zsVar = new C3411zs(this.f30168a, this.f30170b);
    ...
    public static void m33533zh(String str, boolean z) {
        if (z) {
            C1379j0.m37295y0(R.string.language_appliedLanguage, 0);
            C4868i.m24727c2().m24551y5(str);
        }
    }
    ...
    public final void m33602Gh(View view) {
        if (this.f9349C0 != null) {
            ...
            do {
                ...
                left += view2.getLeft();
            } while (view2 != this.f30411v0);
            this.f9349C0.setTranslationX(Math.max(-C1357a0.m37544i(14.0f), (left - (this.f9349C0.getMeasuredWidth() / 2)) + (view.getMeasuredWidth() / 2)));
        }
    }

    public final void m33600Hh() {
        this.f30170b.m2930B4().m4697g0();
    ...
    public final void m33598Ih(AbstractC9323v4<?> v4Var, int i) {
        if (v4Var instanceof AbstractC9388z1) {
            v4Var.get();
            ((AbstractC9388z1) v4Var).mo8809n2().m39425k(new C2764d(i));
        }
    }
    ...
    public final View$OnClickListenerC2805o4 m33596Jh(int i, boolean z) {
        AbstractC10650f0 f0Var;
        View$OnClickListenerC2805o4 kk = new View$OnClickListenerC2805o4(this.f30168a, this.f30170b).m33342kk(this);
        TdApi.ChatListArchive chatListArchive = null;
        if (i == 2) {
            f0Var = C10619e0.m4434l(this.f30170b);
        } else if (i == 3) {
            f0Var = C10619e0.m4437i(this.f30170b);
        } else if (i == 4) {
            f0Var = C10619e0.m4439g(this.f30170b);
        } else if (i != 5) {
            f0Var = i != 6 ? null : C10619e0.m4433m(this.f30170b);
        } else {
            f0Var = C10619e0.m4440f(this.f30170b);
        }
        if (f0Var != null) {
            View$OnClickListenerC2805o4.C2813h hVar = new View$OnClickListenerC2805o4.C2813h(f0Var);
            if (z) {
                chatListArchive = C7317b.f23228b;
            }
            kk.m33357hk(hVar.m33269a(chatListArchive).m33268b(true));
        } else if (z) {
            kk.m33357hk(new View$OnClickListenerC2805o4.C2813h(C7317b.f23228b).m33268b(true));
        }
        return kk;
    }

    public final void m33592Lh(boolean z, boolean z2) {
        if (this.f9355I0 == null) {
            C6986o3 o3Var = new C6986o3(this.f30168a);
            this.f9355I0 = o3Var;
            o3Var.m18163l(new C2763c());
            this.f9355I0.m18169f(this);
            this.f9355I0.m18162m(C4403w.m27871i1(R.string.AppUpdateReady));
            this.f9362x0.addView(this.f9355I0);
        }
        C6986o3 o3Var2 = this.f9355I0;
        String i1 = C4403w.m27871i1(z ? R.string.AppUpdateInstall : R.string.AppUpdateRestart);
        final C5120j b0 = mo4347s().m14509b0();
    ...
    public final void m33590Mh(final int i) {
        int i2 = this.f9350D0;
            ...
            if (i == 0) {
                ...
                if (i == 1) {
                    if (this.f9350D0 != 0) {
                        ...
                        m33586Oh(!this.f9351E0);
                        i = this.f9350D0;
                    }
                }
                final View$OnClickListenerC2805o4 Jh = m33596Jh(i, this.f9351E0);
                this.f9354H0 = Jh;
                this.f9353G0 = i;
                Jh.m9255fd(new Runnable() {
                    @Override
                    public final void run() {
                        C2760nb.this.m33547oh(i, Jh);
                    }
                });
                m33598Ih(Jh, 0);
            }
            i = 0;
            final View$OnClickListenerC2805o4 Jh2 = m33596Jh(i, this.f9351E0);
            this.f9354H0 = Jh2;
            this.f9353G0 = i;
            Jh2.m9255fd(new Runnable() {
                @Override
                public final void run() {
                    C2760nb.this.m33547oh(i, Jh2);
                }
            });
            m33598Ih(Jh2, 0);
        }
    ...
    public final void m33588Nh(View view, boolean z) {
        if (z || this.f9349C0 != null) {
            FrameLayoutFix frameLayoutFix = null;
            int i = 0;
            boolean z2 = true;
            if (this.f9349C0 == null) {
                C2762b bVar = new C2762b(this.f30168a, this, true);
                this.f9349C0 = bVar;
                int i2 = -2;
                ...
                pVar.setPadding(pVar.getPaddingLeft(), this.f9349C0.getPaddingTop() + C1357a0.m37544i(14.0f), this.f9349C0.getPaddingRight(), this.f9349C0.getPaddingBottom() + C1357a0.m37544i(13.0f));
                this.f9349C0.setMinimumWidth(C1357a0.m37544i(112.0f));
                int i4 = 0;
                int i5 = 0;
                while (i4 < i3) {
                    int i6 = iArr[i4];
                    TextView b2Var = new C6847b2(this.f30168a);
                    ...
                    b2Var.setGravity(17);
                    b2Var.setPadding(C1357a0.m37544i(18.0f), C1357a0.m37544i(13.0f), C1357a0.m37544i(18.0f), C1357a0.m37544i(14.0f));
                    m9119z8(b2Var, i7);
                    ...
                    C1399s0.m37178j0(b2Var, C4403w.m27871i1(m9368P8(i6, b2Var, false, true)));
                ...
                this.f30170b.m2781K9().m1823p(this);
            }
            if (z) {
                this.f9349C0.getChildAt(1).setVisibility(this.f30170b.m2348m6() ? 0 : 8);
                if (this.f30170b.m2897D5().f33877b <= 0 && this.f9350D0 != 6) {
                    z2 = false;
                }
    ...
    public final void m33586Oh(boolean z) {
        if (this.f9351E0 != z) {
            this.f9351E0 = z;
        }
    }

    public final void m33584Ph(int i, MotionEvent motionEvent, float f, boolean z) {
        int i2 = this.f9347A0;
        if (i2 != i) {
            if (i2 != -1) {
    ...
    public final void m33582Qh(final C10930q6 q6Var, String str, final ArrayList<TdApi.InputMessageContent> arrayList, final boolean z) {
        if (!arrayList.isEmpty()) {
            q6Var.m2485dd().post(new Runnable() {
                @Override
                public final void run() {
                    C2760nb.this.m33543sh(q6Var, arrayList, z);
                }
            });
            return;
        }
    ...
    public void m33580Rh(C10930q6 q6Var, String str, Intent intent) {
        this.f9357K0 = q6Var;
        this.f9358L0 = str;
        this.f9359M0 = intent;
        m33578Sh();
    ...
    public boolean mo8863S8(C9270q1 q1Var, float f, float f2) {
        ...
        if (this.f30411v0 == null || f2 >= View$OnClickListenerC9170d1.m10065c3(true) || f2 < View$OnClickListenerC9170d1.getTopOffset() || f >= ((View) this.f30411v0).getMeasuredWidth()) {
            return true;
        }
        return !((C9391z4) this.f30411v0).m8807D1();
    }

    public final void m33578Sh() {
        ...
        if (intent != null) {
            ...
            if (s.m14413y1()) {
                ...
                new Thread(new Runnable() {
                    @Override
                    public final void run() {
                        C2760nb.this.m33541uh(str, q6Var, intent);
                    }
                }).start();
            } else {
    ...
    public final void m33576Th(C10930q6 q6Var, Intent intent) {
        ...
        while (it.hasNext()) {
            ...
            } else if (m33557eh(q6Var, arrayList, type, Y0, Kh)) {
                Kh = null;
            }
        }
        if (!C5070i.m24062i(Kh)) {
            arrayList.add(0, new TdApi.InputMessageText(new TdApi.FormattedText(Kh, null), false, false));
        }
        m33582Qh(q6Var, type, arrayList, true);
    }

    public final void m33574Uh(C10930q6 q6Var, Intent intent) {
        String type = intent.getType();
        ArrayList<TdApi.InputMessageContent> arrayList = new ArrayList<>();
        if (C5070i.m24062i(type) || !"text/x-vcard".equals(type)) {
            String Kh = m33594Kh(intent);
                    ...
                    if (openInputStream != null) {
                        ...
                        while (true) {
                            ...
                            if (split.length == 2) {
                                ...
                                if (z) {
                                    if (!split[0].startsWith("FN") && (!split[0].startsWith("ORG") || !C5070i.m24062i(str))) {
                                        if (split[0].startsWith("TEL")) {
                                            String D = C1363c0.m37473D(split[1]);
                                            if (!D.isEmpty()) {
                                                if (!arrayList.isEmpty()) {
                                                    Iterator<TdApi.InputMessageContent> it = arrayList.iterator();
                                                    while (it.hasNext()) {
                                                        TdApi.InputMessageContent next = it.next();
                                                        if ((next instanceof TdApi.InputMessageContact) && C5070i.m24068c(((TdApi.InputMessageContact) next).contact.phoneNumber, D)) {
                                                            break;
                                                        }
                                                    }
                                                }
                        ...
                        if (arrayList.isEmpty()) {
                            C1379j0.m37293z0("No phone number available to share", 0);
        ...
        m33582Qh(q6Var, type, arrayList, false);
    }
    ...
    public boolean m33572Vh(AbstractC9323v4<?> v4Var) {
        if (m9382Na()) {
            return false;
        }
    ...
    public final boolean m33570Wh() {
        final C4868i.C4874f r1 = C4868i.m24727c2().m24608r1();
        if (r1 == null) {
            return false;
        }
        this.f30170b.m2485dd().postDelayed(new Runnable() {
            @Override
            public final void run() {
                C2760nb.this.m33540vh(r1);
            }
        }, 100L);
        return true;
    }

    public final boolean m33568Xh(int i, boolean z) {
        View$OnClickListenerC2805o4 jh;
        if (m8857dg() != i) {
            return false;
        }
        if (z) {
            return m33572Vh(null);
        }
        if (m8857dg() == 0 && (jh = m33552jh()) != null && jh.m33301ti()) {
            return false;
        }
    ...
    public final boolean m33566Yh() {
        final String Dc = this.f30170b.m2890Dc();
        final TdApi.LanguagePackInfo X5 = C4868i.m24727c2().m24761X5(Dc, this.f30170b);
        if (X5 == null) {
            this.f9356J0 = null;
            return false;
        }
        TdApi.LanguagePackInfo languagePackInfo = this.f9356J0;
        if (languagePackInfo != null && languagePackInfo.f25408id.equals(X5.f25408id)) {
            return true;
        }
        this.f9356J0 = X5;
        final String[] A0 = C4403w.m28012A0(new int[]{R.string.language_continueInLanguage, R.string.language_continueInLanguagePopupText, R.string.language_appliedLanguage});
        this.f30170b.m2508c6(X5, A0, new AbstractC5918j() {
            @Override
            public final void mo1330a(Object obj) {
                C2760nb.this.m33610Ch(A0, X5, Dc, (Map) obj);
            }
        });
        return true;
    }
    ...
    public void mo417Z8() {
        ...
        this.f30170b.m2781K9().m1892X(this);
    }

    public final void m33564Zh() {
        if (!m33566Yh()) {
            m33570Wh();
        }
    }

    public final void m33562ai() {
        C6924j2 j2Var;
        if (!this.f9361O0) {
            C9180e2 e2Var = this.f9360N0;
            if ((e2Var == null || (j2Var = e2Var.f29644e) == null || j2Var.m18446A2()) && C4868i.m24727c2().m24764X2(128L)) {
                C9180e2 me2 = m9206me(new C9188f2(R.id.btn_notificationSettings).m10002j(new AbstractC9323v4.AbstractC9343r() {
                    @Override
                    public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
                        C2760nb.this.m33608Dh(i, sparseIntArray);
                    }
                    ...
                    public final void mo2999y4(C6924j2 j2Var2) {
                        C2760nb.this.m33606Eh(j2Var2);
                    }
                }).m9999m(C2242cb.f7815a).m10008d(R.string.NotificationSyncDecline).m9994r(R.string.NotificationSyncAccept).m10009c(false).m9996p(new C2964ra[]{new C2964ra(12, (int) R.id.btn_neverAllow, 0, (int) R.string.NeverShowAgain, false)}).m10010b(C4403w.m27984H0(this, R.string.NotificationSyncOffWarn, new Object[0])));
                this.f9360N0 = me2;
                if (me2 != null) {
                    this.f9361O0 = true;
                }
        ...
        if (i != R.id.user) {
            switch (i) {
                case R.id.btn_float_addContact:
                    m9291ac(new View$OnClickListenerC2393fk(this.f30168a, this.f30170b).m34657vg(2));
                    return true;
                ...
                case R.id.btn_float_compose:
                    ...
                    if (q1Var == null || this.f30159R == null || q1Var.m9741S() || this.f30159R.m10039o3() || (w1Var = this.f9363y0) == null) {
                        return false;
                    }
                    w1Var.m9072W1();
                    return false;
                case R.id.btn_float_newChannel:
                    m9291ac(new C2523i5(this.f30168a, this.f30170b));
                    return true;
                case R.id.btn_float_newChat:
                    RunnableC2374f5 f5Var2 = new RunnableC2374f5(this.f30168a, this.f30170b);
                    f5Var2.m34728zg(4);
                    m9291ac(f5Var2);
                    return true;
                case R.id.btn_float_newGroup:
                    RunnableC2374f5 f5Var3 = new RunnableC2374f5(this.f30168a, this.f30170b);
                    f5Var3.m34728zg(3);
                    m9291ac(f5Var3);
                    return true;
                case R.id.btn_float_newSecretChat:
                    RunnableC2374f5 f5Var4 = new RunnableC2374f5(this.f30168a, this.f30170b);
                    f5Var4.m34728zg(6);
                    m9291ac(f5Var4);
                    return true;
                default:
    ...
    @Override
    public int mo8855fg() {
        int i = C1357a0.m37544i(56.0f);
        return C4862d.m24935w().m24934x() ? i + C1357a0.m37544i(28.0f) : i;
    }

    public final void m33556fh(int i) {
        if (this.f9353G0 == i) {
            this.f9353G0 = -1;
            ...
            this.f30411v0.getTopView().m10154X1(0, C4403w.m27871i1(m33551kh()).toUpperCase());
            m8839sg(0, v4Var);
            if (m8857dg() == 0) {
                m33572Vh(null);
            }
    ...
    public String[] mo8852hg() {
        return new String[]{C4403w.m27871i1(m33551kh()).toUpperCase(), C4403w.m27871i1(R.string.Calls).toUpperCase()};
    }

    public final void m33554hh() {
        int i;
    ...
    public final void m33553ih() {
        if (this.f30170b.m2440ga().m3094p1()) {
            m33562ai();
        } else {
            m33549mh();
        }
    ...
    public final View$OnClickListenerC2805o4 m33552jh() {
    ...
    public boolean mo9546lf(TdApi.Chat chat) {
        View$OnClickListenerC2805o4 jh = m33552jh();
        AbstractC10650f0 fi = jh != null ? jh.m33369fi() : null;
        return (fi == null || !fi.mo4377k6()) ? super.mo9546lf(chat) : fi.mo1511a(chat);
    }
    ...
    public AbstractC9323v4<?> mo8846mg(Context context, int i) {
        ...
        if (i == 0) {
            v4Var = m33596Jh(this.f9350D0, this.f9351E0);
        } else if (i == 1) {
            v4Var = new View$OnClickListenerC2849p(this.f30168a, this.f30170b);
        } else if (i == 2) {
            v4Var = new View$OnClickListenerC2928qj(this.f30168a, this.f30170b);
        } else {
    ...
    public final void m33549mh() {
        C9180e2 e2Var = this.f9360N0;
        if (e2Var != null) {
            C6924j2 j2Var = e2Var.f29644e;
            if (j2Var != null) {
                j2Var.m18408y2(true);
            }
            this.f9360N0 = null;
    ...
    public void mo8845ng(Context context, FrameLayoutFix frameLayoutFix, ViewPager viewPager) {
        ...
        this.f30170b.m2712Oe().m2017g();
        this.f30170b.m2781K9().m1831n(this);
        boolean z = false;
        ...
        if (mo4347s().m14509b0().m23915M() == 4) {
            if (mo4347s().m14509b0().m23899p() == 1) {
                z = true;
            }
            m33592Lh(z, true);
        }
    ...
    public void mo9166sc() {
        super.mo9166sc();
        this.f30170b.m2930B4().m4709d0(this.f30170b.m2188w6(), 1);
        if (C1379j0.f5013g == 2) {
            C1379j0.f5013g = 0;
        }
        m33564Zh();
    ...
    public int mo9536vf() {
        View$OnClickListenerC2805o4 jh = m33552jh();
        AbstractC10650f0 fi = jh != null ? jh.m33369fi() : null;
        boolean z = jh != null && jh.m33413Wh().getConstructor() == 362770115;
        if (fi == null || !fi.mo4377k6()) {
            return z ? R.string.MessagesArchive : super.mo9536vf();
        }
        return fi.mo4380L(z);
    }
