...
public class s30 extends AbstractC9376x4<C3032a> implements ClipboardManager.OnPrimaryClipChangedListener {
    ...
    public static int m32043Eg(int i) {
        switch (i) {
    ...
    public void m32040Hg(View view) {
        mo4347s().m14424w0(this);
        mo4347s().m14551P1().m9718h0(this);
    }

    public boolean m32039Ig(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
        ...
        m8862Yf(trim);
        C4868i.m24727c2().m24597s4(C11541z.m41T(x9.f10183a.m110c()), trim);
        if (x9.f10185c != null && !x9.f10185c.m9347Sa()) {
            x9.f10185c.m34812hi(x9.f10183a);
        }
        return true;
    }

    public boolean m32038Jg(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
        String k6 = this.f30170b.m2380k6(str.trim());
        if (C5070i.m24068c(m9131x9().f10183a.m107f(), k6)) {
            return true;
        }
        C3032a x9 = m9131x9();
        x9.f10183a.m97p(k6);
        C4868i.m24727c2().m24581u4(C11541z.m41T(x9.f10183a.m110c()), k6);
        if (x9.f10185c != null && !x9.f10185c.m9347Sa()) {
            x9.f10185c.m34812hi(x9.f10183a);
        }
        this.f30170b.m2712Oe().m2004t(x9.f10183a.m110c());
        return true;
    }

    public boolean m32037Kg(View view, int i) {
        int i2;
        ...
        if (C4868i.m24727c2().m24629o4(i2) && (Zf = m8861Zf()) != null && Zf.m21464n() > 0) {
            for (int i3 = 0; i3 < Zf.m21464n(); i3++) {
                AbstractC9323v4<?> o = Zf.m21463o(i3);
                if (o instanceof AbstractC3204vo) {
                    ((AbstractC3204vo) o).m31305kg().getAdapter().m39316H();
                }
            }
        }
        return true;
    ...
    public void m32036Lg() {
        m9298Zb();
        if (m9131x9().f10185c != null && !m9131x9().f10185c.m9347Sa()) {
            m9131x9().f10185c.m34811ih(m9131x9().f10183a, false);
        }
    }

    public void m32035Mg(SparseIntArray sparseIntArray, int i, int i2, int i3) {
    ...
    public void m32044Dg(c40 c40Var, int i) {
        C6038h<AbstractC9323v4<?>> Zf = m8861Zf();
        if (Zf != null) {
            for (int i2 = 0; i2 < Zf.m21464n(); i2++) {
                AbstractC9323v4<?> o = Zf.m21463o(i2);
    ...
    public void mo9438Fd(View view, boolean z) {
        ...
        if (bg instanceof c40) {
            ((c40) bg).m31294xg(view != null);
        }
    }

    public void m32042Fg(int i) {
        C6038h<AbstractC9323v4<?>> Zf = m8861Zf();
        if (Zf != null) {
            int dg = m8857dg();
            if (dg > 0) {
                AbstractC9323v4<?> e = Zf.m21472e(dg);
                if ((e instanceof c40) && ((c40) e).m35310Eh(i)) {
                    return;
                }
            }
            for (int n = Zf.m21464n() - 1; n >= 0; n--) {
                AbstractC9323v4<?> o = Zf.m21463o(n);
                if ((o instanceof c40) && ((c40) o).m35310Eh(i)) {
                    m8836ug(Zf.m21468i(n), false);
                    return;
                }
            }
        }
    ...
    public void mo419J(int i, View view) {
        if (i == R.id.menu_btn_more) {
            ...
            if (!this.f10179A0) {
                ...
                u0Var.m23817a(R.string.ThemeEditName);
                cVar.m23285a(R.id.btn_wallpaper);
                u0Var.m23817a(R.string.Wallpaper);
            }
            cVar.m23285a(R.id.btn_showAdvanced);
            u0Var.m23817a(R.string.ThemeAdvanced);
            cVar.m23285a(R.id.btn_color);
            u0Var.m23817a(R.string.ThemeColorFormat);
            cVar.m23285a(R.id.btn_share);
            u0Var.m23817a(C4868i.m24727c2().m24550z(C11541z.m41T(((C3032a) m9131x9()).f10183a.m110c())) ? R.string.ThemeExport : R.string.Share);
            if (!this.f10179A0) {
                cVar.m23285a(R.id.btn_delete);
                u0Var.m23817a(R.string.ThemeRemove);
            }
            cVar.m23285a(R.id.btn_close);
            u0Var.m23817a(this.f10179A0 ? R.string.ThemeClose : R.string.ThemeMinimize);
            m9302Yd(cVar.m23281e(), u0Var.m23814d(), 0);
        } else if (i == R.id.menu_btn_search) {
            c40 c40Var = new c40(this.f30168a, this.f30170b);
            c40Var.m35260di(new c40.C2234n(((C3032a) m9131x9()).f10183a, 0).m35228d(this));
            m9291ac(c40Var);
        }
    }
    ...
    public void mo8864N0(int i) {
        switch (i) {
            case R.id.btn_close:
                ...
                return;
            case R.id.btn_color:
                m9227je(new int[]{R.id.btn_colorFormatHex, R.id.btn_colorFormatRgb, R.id.btn_colorFormatHsl}, new String[]{C4403w.m27871i1(R.string.ColorTypeHex), C4403w.m27871i1(R.string.ColorTypeRGBA), C4403w.m27871i1(R.string.ColorTypeHSLA)}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i2) {
                        boolean Kg;
                        Kg = s30.this.m32037Kg(view, i2);
                        return Kg;
                    }
            ...
            case R.id.btn_delete:
                this.f30170b.m2485dd().m3398y8(this, ((C3032a) m9131x9()).f10183a, new Runnable() {
                    @Override
                ...
                return;
            case R.id.btn_edit:
                m9364Pc(C4403w.m27871i1(R.string.ThemeEditName), C4403w.m27871i1(R.string.ThemeName), R.string.Save, R.string.Cancel, ((C3032a) m9131x9()).f10183a.m109d(), new AbstractC9323v4.AbstractC9336m() {
                    @Override
                    public final boolean mo4197a(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
                        boolean Ig;
                        Ig = s30.this.m32039Ig(y1Var, str);
                        return Ig;
                    }
                }, true);
                return;
            case R.id.btn_share:
                ...
                this.f30170b.m2485dd().m3693V2(this, rVar, true ^ rVar.m104i(), false);
                return;
            case R.id.btn_showAdvanced:
                c40 c40Var = new c40(this.f30168a, this.f30170b);
                c40Var.m35260di(new c40.C2234n(((C3032a) m9131x9()).f10183a, R.id.theme_category_settings));
                m9291ac(c40Var);
                return;
            case R.id.btn_wallpaper:
                m9364Pc(C4403w.m27871i1(R.string.ThemeEditWallpaper), C4403w.m27871i1(R.string.ThemeWallpaper), R.string.Save, R.string.Cancel, ((C3032a) m9131x9()).f10183a.m106g(this.f30170b), new AbstractC9323v4.AbstractC9336m() {
                    @Override
                    public final boolean mo4197a(View$OnFocusChangeListenerC7069y1 y1Var, String str) {
                        boolean Jg;
                        Jg = s30.this.m32038Jg(y1Var, str);
                        return Jg;
                    }
                }, true);
                return;
    ...
    public final void m32034Ng(String str) {
        ...
        if (!(str2 == null && str == null)) {
            if (str == null || !str.equals(str2)) {
                ...
                C6038h<AbstractC9323v4<?>> Zf = m8861Zf();
                if (Zf != null) {
                    final int n = Zf.m21464n();
                    final SparseIntArray sparseIntArray = new SparseIntArray(n);
                    for (int i = 0; i < n; i++) {
                        final int i2 = Zf.m21468i(i);
                        AbstractC9323v4<?> o = Zf.m21463o(i);
                        if (o instanceof c40) {
                            ((c40) o).m35262ci(str, new AbstractC5919k() {
                                @Override
                                public final void mo3250a(int i3) {
                                    s30.this.m32035Mg(sparseIntArray, i2, n, i3);
                                }
                            });
                        }
                    }
    ...
    public String[] mo8852hg() {
        ...
        int i = 0;
        for (int i2 : iArr) {
            strArr[i] = C4403w.m27871i1(m32043Eg(i2)).toUpperCase();
            i++;
        }
        return strArr;
    }
    ...
    public void mo9222kc() {
        super.mo9222kc();
        C1379j0.m37321l0(mo4347s(), 18);
    }

    @Override
    public void mo134m7(boolean z, C11510b bVar) {
        super.mo134m7(z, bVar);
        if (!(z || bVar == null || !c40.m35306Gh(bVar.m370g()))) {
            int dg = m8857dg();
            C6038h<AbstractC9323v4<?>> Zf = m8861Zf();
            if (Zf != null) {
                for (int i = 0; i < Zf.m21464n(); i++) {
                    if (dg != Zf.m21468i(i)) {
                        AbstractC9323v4<?> o = Zf.m21463o(i);
                        if (o instanceof c40) {
                            ((c40) o).m35250ii(bVar.m370g(), true);
                        }
                    }
                }
            }
    ...
    public AbstractC9323v4<?> mo8846mg(Context context, int i) {
        c40 c40Var = new c40(context, this.f30170b);
        c40Var.m35260di(new c40.C2234n(m9131x9().f10183a, this.f10180x0[i]));
        String str = this.f10181y0;
        if (str != null) {
            c40Var.m35262ci(str, null);
        }
        return c40Var;
    }
    ...
    public View mo9201nc(Context context) {
        ...
        int i = C1357a0.m37544i(52.0f) + C1357a0.m37544i(24.0f);
        c0Var.setLayoutParams(FrameLayoutFix.m18007t1(i, i, C4868i.m24727c2().m24672j1()));
        c0Var.m18790d(R.drawable.baseline_palette_24, 52.0f, 12.0f, R.id.theme_color_circleButtonTheme, R.id.theme_color_circleButtonThemeIcon);
        c0Var.setOnClickListener(new View.OnClickListener() {
            @Override
            public final void onClick(View view) {
                s30.this.m32040Hg(view);
            }
        });
        return c0Var;
    }
    ...
    public void mo9166sc() {
        ...
        C11541z.m7t().m21h(this.f30170b, x9.f10183a.m108e(), true, null);
