...
public class C9058b {
    ...
    public static class C9059a {
        ...
        static {
            ...
            try {
                f29040a[EnumC7313d.VIDEO.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
        }
    }

    public final MediaFormat m10592a(AbstractC1296b bVar, EnumC7313d dVar, MediaFormat mediaFormat) {
        bVar.mo6287h(dVar);
        try {
            ...
            while (mediaFormat2 == null) {
                mediaFormat2 = m10591b(dVar, bVar, aVar2, createDecoderByType, aVar, bufferInfo);
            }
            bVar.mo6282m();
            bVar.mo6290e();
            return mediaFormat2;
    ...
    public final MediaFormat m10591b(EnumC7313d dVar, AbstractC1296b bVar, AbstractC1296b.C1297a aVar, MediaCodec mediaCodec, C9057a aVar2, MediaCodec.BufferInfo bufferInfo) {
        MediaFormat c = m10590c(mediaCodec, aVar2, bufferInfo);
        if (c != null) {
            return c;
        }
        m10589d(dVar, bVar, aVar, mediaCodec, aVar2);
        return null;
    }

    public final MediaFormat m10590c(MediaCodec mediaCodec, C9057a aVar, MediaCodec.BufferInfo bufferInfo) {
        int dequeueOutputBuffer = mediaCodec.dequeueOutputBuffer(bufferInfo, 0L);
        if (dequeueOutputBuffer == -3) {
            aVar.m10593c();
            return m10590c(mediaCodec, aVar, bufferInfo);
    ...
    public final void m10589d(EnumC7313d dVar, AbstractC1296b bVar, AbstractC1296b.C1297a aVar, MediaCodec mediaCodec, C9057a aVar2) {
        if (bVar.mo6284k(dVar)) {
            int dequeueInputBuffer = mediaCodec.dequeueInputBuffer(0L);
            if (dequeueInputBuffer >= 0) {
                aVar.f4675a = aVar2.m10595a(dequeueInputBuffer);
                bVar.mo6289f(aVar);
    ...
    public final boolean m10588e(EnumC7313d dVar, MediaFormat mediaFormat) {
        if (dVar == EnumC7313d.VIDEO && !mediaFormat.containsKey("frame-rate")) {
            mediaFormat.setInteger("frame-rate", 24);
        }
        int i = C9059a.f29040a[dVar.ordinal()];
        if (i == 1) {
            return m10587f(mediaFormat);
        }
        if (i == 2) {
            return m10586g(mediaFormat);
        }
        throw new RuntimeException("Unexpected type: " + dVar);
    }

    public final boolean m10587f(MediaFormat mediaFormat) {
        return mediaFormat.containsKey("mime") && mediaFormat.containsKey("channel-count") && mediaFormat.containsKey("sample-rate");
    }

    public final boolean m10586g(MediaFormat mediaFormat) {
    ...
    public MediaFormat m10585h(AbstractC1296b bVar, EnumC7313d dVar, MediaFormat mediaFormat) {
        if (m10588e(dVar, mediaFormat)) {
            return mediaFormat;
        }
        MediaFormat a = m10592a(bVar, dVar, mediaFormat);
        if (m10588e(dVar, a)) {
            return a;
        }
