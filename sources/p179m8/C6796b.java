...
public final class C6796b {
    ...
    public static float m19031a(int[] iArr, int i) {
        return (i - iArr[2]) - (iArr[1] / 2.0f);
    }

    public final float m19030b(int r10, int r11, int r12, int r13) {
        throw new UnsupportedOperationException("Method not decompiled: p179m8.C6796b.m19030b(int, int, int, int):float");
    }

    public C6795a m19029c() {
        C6795a e;
        C6795a e2;
        int i = this.f21282c;
        int i2 = this.f21285f;
        ...
        for (int i5 = 0; i5 < i2; i5++) {
            ...
            iArr[2] = 0;
            int i7 = i;
            while (i7 < i3 && !this.f21280a.m24282d(i7, i6)) {
                i7++;
            }
            int i8 = 0;
            while (i7 < i3) {
                if (!this.f21280a.m24282d(i7, i6)) {
                    if (i8 == 1) {
                        i8++;
                    }
                    iArr[i8] = iArr[i8] + 1;
                    ...
                    i8++;
                    iArr[i8] = iArr[i8] + 1;
                } else if (m19028d(iArr) && (e2 = m19027e(iArr, i6, i7)) != null) {
                    return e2;
                } else {
                    iArr[0] = iArr[2];
                    iArr[1] = 1;
            ...
            if (m19028d(iArr) && (e = m19027e(iArr, i6, i3)) != null) {
                return e;
            }
        }
    ...
    public final boolean m19028d(int[] iArr) {
    ...
    public final C6795a m19027e(int[] iArr, int i, int i2) {
        int i3 = iArr[0] + iArr[1] + iArr[2];
        float a = m19031a(iArr, i2);
        float b = m19030b(i, (int) a, iArr[1] * 2, i3);
        if (Float.isNaN(b)) {
            return null;
        }
        float f = ((iArr[0] + iArr[1]) + iArr[2]) / 3.0f;
        for (C6795a aVar : this.f21281b) {
            if (aVar.m19033f(f, b, a)) {
                return aVar.m19032g(b, a, f);
            }
        }
