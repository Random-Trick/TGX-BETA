...
public final class C6798d extends C4530m {
    ...
    public boolean m19015f(float f, float f2, float f3) {
    ...
    public C6798d m19014g(float f, float f2, float f3) {
        int i = this.f21292d;
        int i2 = i + 1;
        float c = (i * m27487c()) + f2;
        float f4 = i2;
        return new C6798d(c / f4, ((this.f21292d * m27486d()) + f) / f4, ((this.f21292d * this.f21291c) + f3) / f4, i2);
    }
