...
public final class C0104k implements AbstractC8958f, AbstractC3470g {
    ...
    public static boolean m42307E(int i) {
        return i == 1836019574 || i == 1953653099 || i == 1835297121 || i == 1835626086 || i == 1937007212 || i == 1701082227 || i == 1835365473;
    }

    public static boolean m42306F(int i) {
        return i == 1835296868 || i == 1836476516 || i == 1751411826 || i == 1937011556 || i == 1937011827 || i == 1937011571 || i == 1668576371 || i == 1701606260 || i == 1937011555 || i == 1937011578 || i == 1937013298 || i == 1937007471 || i == 1668232756 || i == 1953196132 || i == 1718909296 || i == 1969517665 || i == 1801812339 || i == 1768715124;
    }

    public static int m42302m(int i) {
        if (i != 1751476579) {
    ...
    public static long[][] m42301n(C0105a[] aVarArr) {
    ...
    public static int m42299p(C0114r rVar, long j) {
        int a = rVar.m42258a(j);
        return a == -1 ? rVar.m42257b(j) : a;
    }

    public static C0111o m42297r(C0111o oVar) {
        return oVar;
    }

    public static AbstractC8958f[] m42296s() {
        return new AbstractC8958f[]{new C0104k()};
    }

    public static long m42295t(C0114r rVar, long j, long j2) {
        int p = m42299p(rVar, j);
        return p == -1 ? j2 : Math.min(rVar.f453c[p], j2);
    }

    public static int m42291x(C1189b0 b0Var) {
        b0Var.m38144P(8);
        int m = m42302m(b0Var.m38129n());
        if (m != 0) {
            return m;
        }
        b0Var.m38143Q(4);
        while (b0Var.m38142a() > 0) {
            int m2 = m42302m(b0Var.m38129n());
            if (m2 != 0) {
                return m2;
            }
        }
    ...
    public final boolean m42311A(AbstractC8959g gVar) {
        AbstractC0082a.C0083a peek;
        if (this.f387l == 0) {
            if (!gVar.mo10814d(this.f380e.m38139d(), 0, 8, true)) {
                m42292w();
                return false;
            }
            this.f387l = 8;
            this.f380e.m38144P(0);
            this.f386k = this.f380e.m38154F();
            this.f385j = this.f380e.m38129n();
        }
        long j = this.f386k;
        if (j == 1) {
            gVar.readFully(this.f380e.m38139d(), 8, 8);
            this.f387l += 8;
            this.f386k = this.f380e.m38151I();
        } else if (j == 0) {
            long a = gVar.mo6046a();
        ...
        if (this.f386k >= this.f387l) {
            ...
            } else if (m42306F(this.f385j)) {
                C1186a.m38184f(this.f387l == 8);
                C1186a.m38184f(this.f386k <= 2147483647L);
                C1189b0 b0Var = new C1189b0((int) this.f386k);
                System.arraycopy(this.f380e.m38139d(), 0, b0Var.m38139d(), 0, 8);
                this.f388m = b0Var;
                this.f384i = 1;
            } else {
                m42289z(gVar.mo6043r() - this.f387l);
                this.f388m = null;
                this.f384i = 1;
            }
            return true;
    ...
    public final boolean m42310B(AbstractC8959g gVar, C8971q qVar) {
        boolean z;
        long j = this.f386k - this.f387l;
        long r = gVar.mo6043r() + j;
        C1189b0 b0Var = this.f388m;
        if (b0Var != null) {
            gVar.readFully(b0Var.m38139d(), this.f387l, (int) j);
            if (this.f385j == 1718909296) {
                this.f398w = m42291x(b0Var);
            } else if (!this.f381f.isEmpty()) {
                this.f381f.peek().m42415e(new AbstractC0082a.C0084b(this.f385j, b0Var));
            }
        } else if (j < 262144) {
            gVar.mo10808n((int) j);
        } else {
            qVar.f28857a = gVar.mo6043r() + j;
            z = true;
            m42293v(r);
    ...
    public final int m42309C(AbstractC8959g gVar, C8971q qVar) {
        int i;
        C8971q qVar2;
        long r = gVar.mo6043r();
        if (this.f389n == -1) {
        ...
        C0105a aVar = ((C0105a[]) C1216l0.m37968j(this.f394s))[this.f389n];
        ...
        if (j2 < 0) {
            ...
            if (oVar.f426j == 0) {
                ...
                while (true) {
                    ...
                    int d = tVar.mo10795d(gVar, i3 - i4, false);
                    this.f390o += d;
                    this.f391p += d;
                    this.f392q -= d;
                }
            } else {
                byte[] d2 = this.f378c.m38139d();
                d2[0] = 0;
                d2[1] = 0;
                d2[2] = 0;
                ...
                while (this.f391p < i3) {
                    ...
                    if (i7 == 0) {
                        ...
                        this.f390o += i5;
                        this.f378c.m38144P(0);
                        int n = this.f378c.m38129n();
                        if (n >= 0) {
                            this.f392q = n;
                            this.f377b.m38144P(0);
                            tVar.mo10796c(this.f377b, 4);
                            this.f391p += 4;
                            i3 += i6;
                        } else {
                            throw C6556a2.m20112a("Invalid NAL length", null);
                        }
                    } else {
                        int d3 = tVar.mo10795d(gVar, i7, false);
                        this.f390o += d3;
                        this.f391p += d3;
                        this.f392q -= d3;
                    }
            ...
            if (uVar != null) {
                uVar.m10790c(tVar, j3, i9, i8, 0, null);
                if (i2 + 1 == aVar.f401b.f452b) {
                    uVar.m10792a(tVar, null);
                }
            } else {
                tVar.mo10794e(j3, i9, i8, 0, null);
            }
            aVar.f404e++;
            this.f389n = -1;
            this.f390o = 0;
    ...
    public final int m42308D(AbstractC8959g gVar, C8971q qVar) {
        int c = this.f382g.m42276c(gVar, qVar, this.f383h);
        if (c == 1 && qVar.f28857a == 0) {
            m42300o();
        }
        return c;
    }

    public final void m42305G(C0105a aVar, long j) {
        C0114r rVar = aVar.f401b;
        int a = rVar.m42258a(j);
        if (a == -1) {
            a = rVar.m42257b(j);
    ...
    public int mo1149e(AbstractC8959g gVar, C8971q qVar) {
        while (true) {
            ...
            if (i != 0) {
                if (i != 1) {
                    if (i == 2) {
                        return m42309C(gVar, qVar);
                    }
                    if (i == 3) {
                        return m42308D(gVar, qVar);
                    }
                    throw new IllegalStateException();
                } else if (m42310B(gVar, qVar)) {
                    return 1;
                }
            } else if (!m42311A(gVar)) {
                return -1;
            }
        }
    }
    ...
    public AbstractC3470g.C3471a mo1123i(long j) {
        ...
        long j5;
        int b;
        if (((C0105a[]) C1186a.m38185e(this.f394s)).length == 0) {
            return new AbstractC3470g.C3471a(C8972r.f28858c);
        }
        int i = this.f396u;
        if (i != -1) {
            ...
            j2 = rVar.f453c[p];
            if (j6 >= j || p >= rVar.f452b - 1 || (b = rVar.m42257b(j)) == -1 || b == p) {
                j5 = -1;
        ...
        while (true) {
            ...
            if (i2 != this.f396u) {
                ...
                long t = m42295t(rVar2, j, j2);
                if (j4 != -9223372036854775807L) {
                    j3 = m42295t(rVar2, j4, j3);
                }
                j2 = t;
            }
            i2++;
    ...
    public boolean mo1144j(AbstractC8959g gVar) {
        return C0110n.m42268d(gVar, (this.f376a & 2) != 0);
    }

    public final void m42300o() {
        this.f384i = 0;
        this.f387l = 0;
    }

    public final int m42298q(long j) {
        int i = -1;
        int i2 = -1;
        long j2 = Long.MAX_VALUE;
        boolean z = true;
        ...
        for (int i3 = 0; i3 < ((C0105a[]) C1216l0.m37968j(this.f394s)).length; i3++) {
            C0105a aVar = this.f394s[i3];
            int i4 = aVar.f404e;
            C0114r rVar = aVar.f401b;
            if (i4 != rVar.f452b) {
                long j5 = rVar.f453c[i4];
                long j6 = ((long[][]) C1216l0.m37968j(this.f395t))[i3][i4];
                long j7 = j5 - j;
    ...
    public final void m42294u(AbstractC8959g gVar) {
        this.f379d.m38148L(8);
        gVar.mo10806q(this.f379d.m38139d(), 0, 8);
        C0085b.m42404e(this.f379d);
        gVar.mo10808n(this.f379d.m38138e());
        gVar.mo10809m();
    }

    public final void m42293v(long j) {
    ...
    public final void m42292w() {
        if (this.f398w == 2 && (this.f376a & 2) != 0) {
            AbstractC8960h hVar = (AbstractC8960h) C1186a.m38185e(this.f393r);
            hVar.mo6039r(0, 4).mo10798a(new C6600g1.C6602b().m19870X(this.f399x == null ? null : new C4260a(this.f399x)).m19889E());
            hVar.mo6040m();
            hVar.mo6042a(new AbstractC3470g.C3472b(-9223372036854775807L));
        }
    }

    public final void m42290y(AbstractC0082a.C0083a aVar) {
        C4260a aVar2;
        C4260a aVar3;
        int i;
        List<C0114r> list;
        ...
        AbstractC0082a.C0084b g = aVar.m42413g(1969517665);
        if (g != null) {
            Pair<C4260a, C4260a> B = C0085b.m42411B(g);
        ...
        AbstractC0082a.C0083a f = aVar.m42414f(1835365473);
        C4260a n = f != null ? C0085b.m42395n(f) : null;
        List<C0114r> A = C0085b.m42412A(aVar, oVar, -9223372036854775807L, null, (this.f376a & 1) != 0, z, C0103j.f374a);
        AbstractC8960h hVar = (AbstractC8960h) C1186a.m38185e(this.f393r);
        int size = A.size();
        int i4 = 0;
        int i5 = -1;
        ...
        while (i4 < size) {
            ...
            if (rVar.f452b == 0) {
                ...
                C6600g1.C6602b b = oVar2.f422f.m19901b();
                b.m19871W(i2);
                if (oVar2.f418b == 2 && j2 > 0 && (i3 = rVar.f452b) > 1) {
                    b.m19878P(i3 / (((float) j2) / 1000000.0f));
                }
                C0101h.m42313k(oVar2.f418b, oVar, b);
                int i7 = oVar2.f418b;
                C4260a[] aVarArr = new C4260a[2];
                aVarArr[0] = aVar3;
                aVarArr[1] = this.f383h.isEmpty() ? null : new C4260a(this.f383h);
                C0101h.m42312l(i7, aVar2, n, b, aVarArr);
                aVar5.f402c.mo10798a(b.m19889E());
        ...
        this.f394s = aVarArr2;
        this.f395t = m42301n(aVarArr2);
        hVar.mo6040m();
        hVar.mo6042a(this);
    }

    public final void m42289z(long j) {
