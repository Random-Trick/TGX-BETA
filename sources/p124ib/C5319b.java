...
public class C5319b {
    ...
    public void m23293a(float f) {
        int i = this.f17495b + 1;
        float[] fArr = this.f17494a;
        m23291c(i, fArr.length == 0 ? 10 : fArr.length << 1);
    ...
    public void m23291c(int i, int i2) {
        float[] fArr = this.f17494a;
        if (fArr.length < i) {
    ...
    public float m23290d(int i) {
        return this.f17494a[i];
    }

    public float[] m23289e() {
        m23285i();
        return this.f17494a;
    }

    public boolean m23288f() {
