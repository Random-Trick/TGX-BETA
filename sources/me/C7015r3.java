...
public final class C7015r3 extends ImageView {
    public EnumC7018c f22239a = EnumC7018c.OFF;
    public AbstractRunnableC5910b f22240b;

    public class C7016a extends AbstractRunnableC5910b {
        public final EnumC7018c f22241M;
        ...
        @Override
        public void mo1364b() {
            if (C7015r3.this.f22240b == this) {
                C7015r3.this.setState(this.f22241M);
            }
        }
    }

    public static class C7017b {
        public static final int[] f22243a;
        ...
        static {
            ...
            try {
                f22243a[EnumC7018c.ON.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f22243a[EnumC7018c.ERROR.ordinal()] = 3;
    ...
    public static int m18095c(EnumC7018c cVar, EnumC7018c cVar2, boolean z) {
        int i = C7017b.f22243a[cVar2.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    public void m18094d() {
        if (this.f22239a == EnumC7018c.OFF) {
            setState(EnumC7018c.ON);
        }
    }

    public void m18093e(EnumC7018c cVar, boolean z) {
        if (cVar != this.f22239a) {
            AbstractRunnableC5910b bVar = this.f22240b;
            if (bVar != null) {
                removeCallbacks(bVar);
            }
            int c = m18095c(this.f22239a, cVar, z);
            if (c == 0) {
                setImageDrawable(null);
            } else {
                Drawable g = C1362c.m37485g(getResources(), c);
                setImageDrawable(g);
    ...
    public void m18091g(boolean z) {
        ...
        if (cVar != cVar2) {
            ...
            EnumC7018c cVar3 = this.f22239a;
            setState(cVar2);
            if (!z) {
                C7016a aVar = new C7016a(cVar3);
                this.f22240b = aVar;
                aVar.m21856e(C1379j0.m37316o());
                C1379j0.m37335e0(this.f22240b, 1000L);
            }
        }
    }
