...
public class C7035t3 extends C6847b2 {
    public C7035t3(Context context) {
        ...
        setTextColor(-1);
        setTextSize(1, 16.0f);
        setPadding(C1357a0.m37544i(10.0f), C1357a0.m37544i(10.0f), C1357a0.m37544i(10.0f), C1357a0.m37544i(10.0f));
        setGravity(17);
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f = i;
        canvas.drawRoundRect(a0, f, f, C1410y.m37042g(-1610612736));
        super.onDraw(canvas);
    }
}
