...
public class C6873e3 extends RelativeLayout implements AbstractC9165c2 {
    ...
    public C6873e3(Context context) {
        ...
        setMinimumHeight(C1357a0.m37541i(76.0f));
        setPadding(C1357a0.m37541i(16.0f), C1357a0.m37541i(18.0f), C1357a0.m37541i(16.0f), C1357a0.m37541i(18.0f));
        ...
        layoutParams2.addRule(C4403w.m27871i());
        layoutParams2.topMargin = C1357a0.m37541i(2.0f);
    ...
    public void m18709a(AbstractC9323v4<?> v4Var) {
        if (v4Var != null) {
    ...
    @Override
    public void mo8255s() {
        if (C1399s0.m37196Y(this.f21616a, C4403w.m27984G2())) {
            C1399s0.m37145y0(this.f21616a);
        }
        if (C1399s0.m37196Y(this.f21617b, C4403w.m27984G2())) {
            C1399s0.m37145y0(this.f21617b);
        }
    }

    public void setSubtitle(int i) {
        this.f21617b.setText(C4403w.m27869i1(i));
    }

    public void setTitle(int i) {
        this.f21616a.setText(C4403w.m27869i1(i));
    }
