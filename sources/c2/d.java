...
public class d {
    ...
    public static class a implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] evaluate(float f10, c.b[] bVarArr, c.b[] bVarArr2) {
            if (c.b(bVarArr, bVarArr2)) {
                if (!c.b(this.f4335a, bVarArr)) {
                    this.f4335a = c.f(bVarArr);
                }
                for (int i10 = 0; i10 < bVarArr.length; i10++) {
                    this.f4335a[i10].d(bVarArr[i10], bVarArr2[i10], f10);
                }
                return this.f4335a;
            }
    ...
    public static android.animation.Animator b(android.content.Context r18, android.content.res.Resources r19, android.content.res.Resources.Theme r20, org.xmlpull.v1.XmlPullParser r21, android.util.AttributeSet r22, android.animation.AnimatorSet r23, int r24, float r25) {
        throw new UnsupportedOperationException("Method not decompiled: c2.d.b(android.content.Context, android.content.res.Resources, android.content.res.Resources$Theme, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.animation.AnimatorSet, int, float):android.animation.Animator");
    }
    ...
    public static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k10 = i.k(resources, theme, attributeSet, c2.a.f4323j);
        int i10 = 0;
    ...
    public static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f10, XmlPullParser xmlPullParser) {
        TypedArray k10 = i.k(resources, theme, attributeSet, c2.a.f4320g);
        TypedArray k11 = i.k(resources, theme, attributeSet, c2.a.f4324k);
    ...
    public static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i10, XmlPullParser xmlPullParser) {
        ...
        if (z10) {
            if (i10 != 0) {
                keyframe = (i10 == 1 || i10 == 3) ? Keyframe.ofInt(f10, i.g(k10, xmlPullParser, "value", 0, 0)) : null;
            } else {
        ...
        if (h10 > 0) {
            keyframe.setInterpolator(c.a(context, h10));
        }
        k10.recycle();
        return keyframe;
    }
        ...
        while (true) {
            ...
            if (eventType == 3 || eventType == 1) {
                ...
                if (xmlPullParser.getName().equals("propertyValuesHolder")) {
                    TypedArray k10 = i.k(resources, theme, attributeSet, c2.a.f4322i);
                    String i11 = i.i(k10, xmlPullParser, "propertyName", 3);
                    int g10 = i.g(k10, xmlPullParser, "valueType", 2, 4);
    ...
    public static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f10, XmlPullParser xmlPullParser) {
        long g10 = i.g(typedArray, xmlPullParser, "duration", 1, 300);
        long g11 = i.g(typedArray, xmlPullParser, "startOffset", 2, 0);
