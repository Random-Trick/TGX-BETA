...
public class C6806c {
    ...
    public static class C6808b {
        ...
        public C6808b m18960a(AbstractC1296b bVar) {
            this.f21317b.add(bVar);
            this.f21318c.add(bVar);
            return this;
        }

        public C6806c m18959b() {
            if (this.f21319d == null) {
                ...
                if (i == 0 || i == 90 || i == 180 || i == 270) {
                    ...
                    if (this.f21321f == null) {
                        this.f21321f = C2044a.m35774b().m35770b();
                    }
                    if (this.f21322g == null) {
                        this.f21322g = C2048b.m35758a();
                    }
        ...
        public C6808b m18958c(AbstractC2055f fVar) {
            this.f21321f = fVar;
            return this;
        }

        public C6808b m18957d(AbstractC6805b bVar) {
            this.f21319d = bVar;
            return this;
        }

        public C6808b m18956e(int i) {
            this.f21324i = i;
            return this;
        }

        public C6808b m18955f(AbstractC2055f fVar) {
            this.f21322g = fVar;
            return this;
        }

        public Future<Void> m18954g() {
            return C6803a.m18992a().m18990c(m18959b());
        }
    }

    public List<AbstractC1296b> m18972m() {
        return this.f21306c;
    }

    public AbstractC10456a m18971n() {
        return this.f21313j;
    }

    public AbstractC3930a m18970o() {
        return this.f21312i;
    }

    public AbstractC2055f m18969p() {
        return this.f21307d;
    }

    public AbstractC0237a m18968q() {
        return this.f21304a;
    }

    public AbstractC6805b m18967r() {
        return this.f21314k;
    }

    public Handler m18966s() {
        return this.f21315l;
    }

    public AbstractC4177b m18965t() {
        return this.f21311h;
    }

    public AbstractC4333b m18964u() {
        return this.f21309f;
    }

    public List<AbstractC1296b> m18963v() {
        return this.f21305b;
    }
