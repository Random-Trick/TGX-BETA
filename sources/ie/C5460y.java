...
public final class C5460y implements C5428t.AbstractC5435c {
    public static final C5460y f17923a = new C5460y();

    @Override
    public int mo8941I() {
        return C5403h0.m22834c(this);
    }
    ...
    @Override
    public final int mo8933w() {
        int i;
        i = R.id.theme_color_iv_pageTitle;
        return i;
    }
