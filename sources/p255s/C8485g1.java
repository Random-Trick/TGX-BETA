...
public final class C8485g1 {
    ...
    public static final class C8486a extends CameraDevice.StateCallback {
        public final List<CameraDevice.StateCallback> f27527a = new ArrayList();
        ...
        public C8486a(List<CameraDevice.StateCallback> list) {
            for (CameraDevice.StateCallback stateCallback : list) {
                if (!(stateCallback instanceof C8487b)) {
                    this.f27527a.add(stateCallback);
                }
            }
        }
        ...
        public void onClosed(CameraDevice cameraDevice) {
            for (CameraDevice.StateCallback stateCallback : this.f27527a) {
    ...
    public static CameraDevice.StateCallback m12324a(List<CameraDevice.StateCallback> list) {
        if (list.isEmpty()) {
            return m12323b();
        }
        if (list.size() == 1) {
    ...
    public static CameraDevice.StateCallback m12323b() {
        return new C8487b();
    }
}
