...
public class C8597z0 {
    public static void m12023a(CaptureRequest.Builder builder, AbstractC10268n0 n0Var) {
        ...
        for (AbstractC10268n0.AbstractC10269a aVar : d.mo5425b()) {
            ...
            try {
                ...
                C0662u1.m40654c("CaptureRequestBuilder", "CaptureRequest.Key is not supported: " + key);
            }
        }
    }

    public static CaptureRequest m12022b(C10245j0 j0Var, CameraDevice cameraDevice, Map<AbstractC10287q0, Surface> map) {
        if (cameraDevice == null) {
            return null;
        }
        List<Surface> d = m12020d(j0Var.m5653d(), map);
        if (d.isEmpty()) {
            return null;
        }
        CaptureRequest.Builder createCaptureRequest = cameraDevice.createCaptureRequest(j0Var.m5651f());
        m12023a(createCaptureRequest, j0Var.m5654c());
        AbstractC10268n0 c = j0Var.m5654c();
        AbstractC10268n0.AbstractC10269a<Integer> aVar = C10245j0.f33027g;
        if (c.mo5422e(aVar)) {
        ...
        AbstractC10268n0.AbstractC10269a<Integer> aVar2 = C10245j0.f33028h;
        if (c2.mo5422e(aVar2)) {
    ...
    public static CaptureRequest m12021c(C10245j0 j0Var, CameraDevice cameraDevice) {
        if (cameraDevice == null) {
            return null;
        }
        CaptureRequest.Builder createCaptureRequest = cameraDevice.createCaptureRequest(j0Var.m5651f());
    ...
    public static List<Surface> m12020d(List<AbstractC10287q0> list, Map<AbstractC10287q0, Surface> map) {
