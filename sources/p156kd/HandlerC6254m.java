...
public class HandlerC6254m extends Handler {
    public void m20829a(C6257p pVar) {
        sendMessage(Message.obtain(this, 1, pVar));
    }

    public void m20828b(C6257p pVar, C6246h hVar, Bitmap bitmap) {
        sendMessage(Message.obtain(this, 2, new Object[]{pVar, hVar, bitmap}));
    }

    public void m20827c(C6257p pVar) {
    ...
    public void handleMessage(Message message) {
        ...
        if (i == 0) {
            ...
            ((C6257p) message.obj).m20811c();
        } else if (i == 2) {
            Object[] objArr = (Object[]) message.obj;
            ((C6257p) objArr[0]).m20815K((C6246h) objArr[1], (Bitmap) objArr[2]);
            objArr[0] = null;
            objArr[1] = null;
            objArr[2] = null;
        }
