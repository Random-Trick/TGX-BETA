...
public class C6259q {
    ...
    public void m20789a(C6246h hVar) {
        Bitmap e = m20785e(hVar);
        if (C7389v0.m16756A1(e)) {
            e.recycle();
        }
    }

    public Bitmap m20788b(C6246h hVar) {
    ...
    public void m20786d(C6246h hVar, Bitmap bitmap) {
    ...
    public Bitmap m20785e(C6246h hVar) {
        HashMap<C6246h, Bitmap> hashMap = this.f19778a;
        if (hashMap != null) {
