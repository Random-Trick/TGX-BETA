...
public final class C10258l2 {
    ...
    public final Map<String, C10260b> f33064b = new LinkedHashMap();
    ...
    public static final class C10260b {
        public final C10200b2 f33065a;
        public boolean f33066b = false;
    ...
    public C10200b2.C10206f m5625c() {
        ...
        for (Map.Entry<String, C10260b> entry : this.f33064b.entrySet()) {
        ...
        C0662u1.m40656a("UseCaseAttachState", "Active and attached use case: " + arrayList + " for camera: " + this.f33063a);
        return fVar;
    }

    public Collection<C10200b2> m5624d() {
        return Collections.unmodifiableCollection(m5620h(C10253k2.f33054a));
    }
    ...
    public C10200b2.C10206f m5623e() {
        ...
        C0662u1.m40656a("UseCaseAttachState", "All use case: " + arrayList + " for camera: " + this.f33063a);
        return fVar;
    }

    public Collection<C10200b2> m5622f() {
        return Collections.unmodifiableCollection(m5620h(C10249j2.f33043a));
    }

    public final C10260b m5621g(String str, C10200b2 b2Var) {
        C10260b bVar = this.f33064b.get(str);
        if (bVar != null) {
            return bVar;
        }
        C10260b bVar2 = new C10260b(b2Var);
        this.f33064b.put(str, bVar2);
        return bVar2;
    }
    ...
    public boolean m5619i(String str) {
        ...
        return this.f33064b.get(str).m5608b();
    }

    public void m5616l(String str) {
        this.f33064b.remove(str);
    }
    ...
    public void m5611q(String str, C10200b2 b2Var) {
        if (this.f33064b.containsKey(str)) {
            ...
            C10260b bVar2 = this.f33064b.get(str);
            bVar.m5605e(bVar2.m5608b());
            bVar.m5606d(bVar2.m5609a());
            this.f33064b.put(str, bVar);
        }
    }
}
