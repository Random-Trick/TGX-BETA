...
public abstract class AbstractC6391v0 extends AbstractC6332c1<Boolean> {
    ...
    @Override
    public final void mo20481a() {
    }

    @Override
    public final void mo20480b(Boolean bool) {
        C5217a aVar;
        PendingIntent pendingIntent = null;
        if (this.f20039d != 0) {
            this.f20041f.m20633k0(1, null);
    ...
    public abstract boolean mo20479f();

    public abstract void mo20478g(C5217a aVar);
}
