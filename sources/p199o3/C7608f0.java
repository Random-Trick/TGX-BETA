...
public class C7608f0 extends AbstractC4140o implements AbstractC1232u {
    public final Context f24343o1;
    public final AbstractC7634s.C7635a f24344p1;
    public final AbstractC7636t f24345q1;
    public int f24346r1;
    public boolean f24347s1;
    public C6600g1 f24348t1;
    public long f24349u1;
    public boolean f24350v1;
    public boolean f24351w1;
    public boolean f24352x1;
    public boolean f24353y1;
    public AbstractC6696s2.AbstractC6697a f24354z1;
    ...
    public final class C7610b implements AbstractC7636t.AbstractC7639c {
        ...
        public void mo15361a(boolean z) {
            C7608f0.this.f24344p1.m15412C(z);
        }

        @Override
        public void mo15360b(long j) {
            C7608f0.this.f24344p1.m15413B(j);
        }

        @Override
        public void mo15359c(int i, long j, long j2) {
            C7608f0.this.f24344p1.m15411D(i, j, j2);
        }

        @Override
        public void mo15358d(long j) {
            if (C7608f0.this.f24354z1 != null) {
                C7608f0.this.f24354z1.mo19465b(j);
            }
        }
        ...
        public void mo15356f(Exception exc) {
            C1230s.m37886d("MediaCodecAudioRenderer", "Audio sink error", exc);
            C7608f0.this.f24344p1.m15399l(exc);
        }

        @Override
        public void mo15355g() {
            if (C7608f0.this.f24354z1 != null) {
                C7608f0.this.f24354z1.mo19466a();
            }
        }
    }
    ...
    public C7608f0(Context context, AbstractC4134l.AbstractC4136b bVar, AbstractC4143q qVar, boolean z, Handler handler, AbstractC7634s sVar, AbstractC7636t tVar) {
        ...
        this.f24343o1 = context.getApplicationContext();
        this.f24345q1 = tVar;
        this.f24344p1 = new AbstractC7634s.C7635a(handler, sVar);
    ...
    public void mo15518J(boolean z, boolean z2) {
        super.mo15518J(z, z2);
        this.f24344p1.m15395p(this.f14014j1);
        if (m19922D().f21050a) {
            this.f24345q1.mo15366s();
        } else {
            this.f24345q1.mo15370o();
        }
    }

    @Override
    public void mo15517J0(Exception exc) {
        C1230s.m37886d("MediaCodecAudioRenderer", "Audio codec error", exc);
        this.f24344p1.m15400k(exc);
    }
    ...
    public void mo15516K0(String str, long j, long j2) {
        this.f24344p1.m15398m(str, j, j2);
    }
    ...
    public void mo15510N0(C6600g1 g1Var, MediaFormat mediaFormat) {
        int i;
        int i2;
        C6600g1 g1Var2 = this.f24348t1;
        int[] iArr = null;
        if (g1Var2 != null) {
            g1Var = g1Var2;
        } else if (m28729p0() != null) {
            if ("audio/raw".equals(g1Var.f20575U)) {
                i = g1Var.f20593j0;
            } else if (C1216l0.f4526a >= 24 && mediaFormat.containsKey("pcm-encoding")) {
                i = mediaFormat.getInteger("pcm-encoding");
            } else if (mediaFormat.containsKey("v-bits-per-sample")) {
                i = C1216l0.m37992U(mediaFormat.getInteger("v-bits-per-sample"));
            } else {
                i = "audio/raw".equals(g1Var.f20575U) ? g1Var.f20593j0 : 2;
            }
            C6600g1 E = new C6600g1.C6602b().m19858e0("audio/raw").m19869Y(i).m19880N(g1Var.f20594k0).m19879O(g1Var.f20595l0).m19886H(mediaFormat.getInteger("channel-count")).m19856f0(mediaFormat.getInteger("sample-rate")).m19889E();
            if (this.f24347s1 && E.f20591h0 == 6 && (i2 = g1Var.f20591h0) < 6) {
                iArr = new int[i2];
        ...
        try {
            this.f24345q1.mo15364u(g1Var, 0, iArr);
        } catch (AbstractC7636t.C7637a e) {
            throw m19924B(e, e.f24459a, 5001);
        }
    }
    ...
    public void mo15509P0() {
        super.mo15509P0();
        this.f24345q1.mo15369p();
    }

    @Override
    public void mo15508Q0(C8026g gVar) {
        if (this.f24350v1 && !gVar.isDecodeOnly()) {
            if (Math.abs(gVar.f26126N - this.f24349u1) > 500000) {
                this.f24349u1 = gVar.f26126N;
            }
            this.f24350v1 = false;
        }
    }
    ...
    public boolean mo15507S0(long j, long j2, AbstractC4134l lVar, ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, C6600g1 g1Var) {
        C1186a.m38185e(byteBuffer);
        if (this.f24348t1 != null && (i2 & 2) != 0) {
            ((AbstractC4134l) C1186a.m38185e(lVar)).mo28659h(i, false);
            return true;
        } else if (z) {
            if (lVar != null) {
                lVar.mo28659h(i, false);
            }
            this.f14014j1.f26119f += i3;
            this.f24345q1.mo15369p();
            return true;
        } else {
            try {
                if (!this.f24345q1.mo15365t(byteBuffer, j3, i3)) {
                    return false;
                }
                if (lVar != null) {
                    lVar.mo28659h(i, false);
                }
                this.f14014j1.f26118e += i3;
                return true;
            } catch (AbstractC7636t.C7638b e) {
                throw m19923C(e, e.f24462c, e.f24461b, 5001);
            } catch (AbstractC7636t.C7641e e2) {
                throw m19923C(e2, g1Var, e2.f24466b, 5002);
            }
        }
    }
    ...
    public C8028h mo15506T(C4139n nVar, C6600g1 g1Var, C6600g1 g1Var2) {
        ...
        int i = e.f26139e;
        if (m15494s1(nVar, g1Var2) > this.f24346r1) {
            i |= 64;
        }
        int i2 = i;
        return new C8028h(nVar.f13952a, g1Var, g1Var2, i2 != 0 ? 0 : e.f26138d, i2);
    }

    @Override
    public void mo15505X0() {
        try {
            this.f24345q1.mo15377h();
    ...
    public void mo15504d(C6613h2 h2Var) {
        this.f24345q1.mo15381d(h2Var);
    }

    @Override
    public boolean mo13706e() {
        return super.mo13706e() && this.f24345q1.mo15380e();
    }

    @Override
    public boolean mo13705f() {
        return this.f24345q1.mo15376i() || super.mo13705f();
    }
    ...
    public long mo15503g() {
        ...
        return this.f24349u1;
    }

    @Override
    public boolean mo15502i1(C6600g1 g1Var) {
        return this.f24345q1.mo15384a(g1Var);
    }

    @Override
    public C6613h2 mo15501j() {
        return this.f24345q1.mo15375j();
    }
    ...
    public int mo15500j1(AbstractC4143q qVar, C6600g1 g1Var) {
        ...
        boolean k1 = AbstractC4140o.m28737k1(g1Var);
        int i2 = 8;
        int i3 = 4;
        if (k1 && this.f24345q1.mo15384a(g1Var) && (!z || C4148v.m28679u() != null)) {
            return C6701t2.m19436b(4, 8, i);
        }
        if ("audio/raw".equals(g1Var.f20575U) && !this.f24345q1.mo15384a(g1Var)) {
            return C6701t2.m19437a(1);
        }
        if (!this.f24345q1.mo15384a(C1216l0.m37991V(2, g1Var.f20591h0, g1Var.f20592i0))) {
            return C6701t2.m19437a(1);
        }
        ...
        if (m && nVar.m28793o(g1Var)) {
            i2 = 16;
        }
        if (!m) {
            i3 = 3;
        }
        return C6701t2.m19436b(i3, i2, i);
    }
    ...
    public final int m15494s1(C4139n nVar, C6600g1 g1Var) {
        int i;
        if (!"OMX.google.raw.decoder".equals(nVar.f13952a) || (i = C1216l0.f4526a) >= 24 || (i == 23 && C1216l0.m37963l0(this.f24343o1))) {
    ...
    public void mo15492u(int i, Object obj) {
        if (i == 2) {
            this.f24345q1.mo15379f(((Float) obj).floatValue());
        } else if (i == 3) {
            this.f24345q1.mo15368q((C7602e) obj);
        } else if (i != 6) {
            switch (i) {
                case 9:
                    this.f24345q1.mo15362w(((Boolean) obj).booleanValue());
                    return;
                case 10:
                    this.f24345q1.mo15372m(((Integer) obj).intValue());
                    return;
                case 11:
                    this.f24354z1 = (AbstractC6696s2.AbstractC6697a) obj;
                    return;
                default:
            ...
            this.f24345q1.mo15367r((C7647x) obj);
        }
    }
    ...
    public List<C4139n> mo15491u0(AbstractC4143q qVar, C6600g1 g1Var, boolean z) {
        ...
        if (this.f24345q1.mo15384a(g1Var) && (u = C4148v.m28679u()) != null) {
            return Collections.singletonList(u);
        }
        List<C4139n> t = C4148v.m28680t(qVar.mo28717a(str, z, false), g1Var);
        if ("audio/eac3-joc".equals(str)) {
            ArrayList arrayList = new ArrayList(t);
            arrayList.addAll(qVar.mo28717a("audio/eac3", z, false));
            t = arrayList;
        }
    ...
    public MediaFormat m15490u1(C6600g1 g1Var, String str, int i, float f) {
        ...
        C1233v.m37872d(mediaFormat, "max-input-size", i);
        ...
        if (i2 >= 24 && this.f24345q1.mo15374k(C1216l0.m37991V(4, g1Var.f20591h0, g1Var.f20592i0)) == 2) {
    ...
    public AbstractC4134l.C4135a mo15488w0(C4139n nVar, C6600g1 g1Var, MediaCrypto mediaCrypto, float f) {
        this.f24346r1 = m15493t1(nVar, g1Var, m19919G());
        this.f24347s1 = m15497q1(nVar.f13952a);
        MediaFormat u1 = m15490u1(g1Var, nVar.f13954c, this.f24346r1, f);
        this.f24348t1 = "audio/raw".equals(nVar.f13953b) && !"audio/raw".equals(g1Var.f20575U) ? g1Var : null;
        return AbstractC4134l.C4135a.m28812a(nVar, u1, g1Var, mediaCrypto);
    }

    public final void m15487w1() {
        long n = this.f24345q1.mo15371n(mo13706e());
        if (n != Long.MIN_VALUE) {
            if (!this.f24351w1) {
                n = Math.max(this.f24349u1, n);
            }
            this.f24349u1 = n;
            this.f24351w1 = false;
        }
