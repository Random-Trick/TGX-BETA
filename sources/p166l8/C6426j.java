...
public final class C6426j {
    ...
    public static final C6426j[] f20109f = m20424b();
    ...
    public C6426j(int i, int[] iArr, C6428b... bVarArr) {
        ...
        int b = bVarArr[0].m20412b();
        int i2 = 0;
        for (C6427a aVar : bVarArr[0].m20413a()) {
            i2 += aVar.m20415a() * (aVar.m20414b() + b);
        }
        this.f20113d = i2;
    }

    public static C6426j[] m20424b() {
    ...
    public static C6426j m20423c(int i) {
        int i2 = 0;
        int i3 = 0;
    ...
    public static C6426j m20419g(int i) {
        if (i % 4 == 1) {
            try {
                return m20417i((i - 17) / 4);
    ...
    public static C6426j m20417i(int i) {
        if (i > 0 && i <= 40) {
            return f20109f[i - 1];
        }
    ...
    public C5022a m20425a() {
        int e = m20421e();
        C5022a aVar = new C5022a(e);
        aVar.m24276j(0, 0, 9, 9);
        int i = e - 8;
        aVar.m24276j(i, 0, 8, 9);
        aVar.m24276j(0, i, 9, 8);
        int length = this.f20111b.length;
        for (int i2 = 0; i2 < length; i2++) {
            int i3 = this.f20111b[i2] - 2;
            for (int i4 = 0; i4 < length; i4++) {
                if (!((i2 == 0 && (i4 == 0 || i4 == length - 1)) || (i2 == length - 1 && i4 == 0))) {
                    aVar.m24276j(this.f20111b[i4] - 2, i3, 5, 5);
                }
            }
        }
        int i5 = e - 17;
        aVar.m24276j(6, 9, 1, i5);
        aVar.m24276j(9, 6, i5, 1);
        if (this.f20110a > 6) {
            int i6 = e - 11;
            aVar.m24276j(i6, 0, 3, 6);
            aVar.m24276j(0, i6, 6, 3);
        }
        return aVar;
    }
    ...
    public C6428b m20420f(EnumC6422f fVar) {
