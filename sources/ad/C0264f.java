...
public class C0264f {
    public static String m41974a(int i) {
        int i2;
    ...
    public static String m41973b(EnumC9986b bVar) {
    ...
    public static boolean m41972c() {
        return C2059c.m35730b(C1379j0.m37309q(), "com.google.android.youtube");
    }

    public static String m41971d(String str) {
        int i;
        int i2;
        if (str == null) {
            return null;
    ...
    public static void m41970e(ProgressBar progressBar) {
        if (Build.VERSION.SDK_INT >= 21) {
            progressBar.getIndeterminateDrawable().setColorFilter(-1, PorterDuff.Mode.SRC_IN);
        }
    }

    public static void m41969f(View view) {
        try {
