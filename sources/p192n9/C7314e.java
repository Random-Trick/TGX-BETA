...
public final class C7314e {
    public static final EnumC7313d m17063a(MediaFormat mediaFormat) {
        C8298k.m12933e(mediaFormat, "$this$trackType");
    ...
    public static final EnumC7313d m17062b(MediaFormat mediaFormat) {
        C8298k.m12933e(mediaFormat, "$this$trackTypeOrNull");
        String string = mediaFormat.getString("mime");
        C8298k.m12935c(string);
        C8298k.m12934d(string, "getString(MediaFormat.KEY_MIME)!!");
        if (C11451n.m621x(string, "audio/", false, 2, null)) {
            return EnumC7313d.AUDIO;
        }
        String string2 = mediaFormat.getString("mime");
        C8298k.m12935c(string2);
        C8298k.m12934d(string2, "getString(MediaFormat.KEY_MIME)!!");
