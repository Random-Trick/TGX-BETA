...
public class RunnableC4027c extends View implements C3950k.AbstractC3952b, Runnable {
    ...
    public Bitmap f13527c = C1362c.m37474o(C1362c.m37483f(R.drawable.baseline_camera_alt_24));
    public Bitmap f13513N = C1362c.m37474o(C1362c.m37483f(R.drawable.baseline_close_24));
    public Bitmap f13512M = C1362c.m37474o(C1362c.m37483f(R.drawable.baseline_stop_24));

    public interface AbstractC4028a {
        void mo29214T6(RunnableC4027c cVar);

        boolean mo29153x6(RunnableC4027c cVar);

        void mo29150y(RunnableC4027c cVar);
    }
    ...
    public RunnableC4027c(Context context) {
        ...
        int i2 = i * 2;
        setLayoutParams(FrameLayoutFix.m18008s1(C1357a0.m37541i(56.0f) + i2, C1357a0.m37541i(56.0f) + i2));
        setPadding(i, i, i, i);
    }

    public static void m29273b(Canvas canvas, Bitmap bitmap, int i, int i2, float f) {
        if (f != 0.0f) {
            int width = i - (bitmap.getWidth() / 2);
            int height = i2 - (bitmap.getHeight() / 2);
            Paint u0 = C1410y.m37010u0();
    ...
    public final void m29274a() {
        removeCallbacks(this);
    }

    public final void m29272c(MotionEvent motionEvent) {
        if (this.f13514O) {
            this.f13514O = false;
            if (motionEvent != null) {
    ...
    public boolean m29271d(boolean z) {
        m29274a();
        if (this.f13515P) {
            this.f13515P = false;
    ...
    public final void m29270e() {
        postDelayed(this, ViewConfiguration.getLongPressTimeout());
    }

    public boolean m29269f() {
        if (this.f13515P) {
            return false;
        }
        this.f13525b.m29275a();
    ...
    public void m29268g() {
        AbstractC4028a aVar = this.f13526b0;
        if (aVar != null) {
            this.f13515P = aVar.mo29153x6(this);
            return;
        }
        this.f13515P = true;
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.f13523a.m29149yf()) {
            m29273b(canvas, this.f13513N, measuredWidth, measuredHeight, 1.0f - (this.f13517R / 0.5f));
            return;
        }
        float f = this.f13517R;
        if (f > 0.3f) {
            m29273b(canvas, this.f13512M, measuredWidth, measuredHeight, (f - 0.3f) / 0.7f);
        }
        float f2 = this.f13517R;
        if (f2 <= 0.5f) {
            m29273b(canvas, this.f13527c, measuredWidth, measuredHeight, 1.0f - (f2 / 0.5f));
        }
    }
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    ...
                    float d = C5069h.m24089d((-this.f13520U) / C1357a0.m37539k(150.0f));
                    float p = this.f13523a.m29165rf().mo27755p();
                    float o = this.f13523a.m29165rf().mo27756o();
                    if (!this.f13521V && this.f13520U < 0.0f && ((o - p) * d) + p >= this.f13522W) {
                        this.f13521V = true;
                    }
                    if (this.f13521V) {
                        this.f13523a.m29165rf().mo27769J(p + ((o - p) * d));
                    }
                } else if (action != 3) {
                    if (this.f13514O) {
                        super.onTouchEvent(motionEvent);
            ...
            m29271d(!this.f13516Q && motionEvent.getAction() == 1 && this.f13514O);
            this.f13514O = false;
        } else {
            this.f13521V = false;
            super.onTouchEvent(motionEvent);
    ...
    public void setInRecordMode(boolean z) {
        ...
        if (this.f13515P || !z) {
            ...
            this.f13518S.m29544i(z ? 1.0f : 0.0f);
            if (z) {
