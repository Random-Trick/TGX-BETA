...
public final class C1616h {
    ...
    public static C1616h m36228a(C1189b0 b0Var) {
        int i;
        int i2;
        try {
            b0Var.m38143Q(21);
            int D = b0Var.m38156D() & 3;
            ...
            while (i7 < D2) {
                ...
                while (i11 < J3) {
                    ...
                    System.arraycopy(b0Var.m38139d(), b0Var.m38138e(), bArr, length, J4);
                    if (D3 == 33 && i11 == 0) {
                        C1237x.C1238a h = C1237x.m37848h(bArr, length, length + J4);
                        int i12 = h.f4583h;
                        i10 = h.f4584i;
                        f = h.f4585j;
                        i2 = D3;
                        i = J3;
                        i9 = i12;
                        str = C1194e.m38094c(h.f4576a, h.f4577b, h.f4578c, h.f4579d, h.f4580e, h.f4581f);
                    } else {
                        i2 = D3;
                        i = J3;
                    }
            ...
            throw C6556a2.m20112a("Error parsing HEVC config", e2);
        }
    }
}
