...
public final class C1604a {
    ...
    public static byte[] m36294a(C1189b0 b0Var) {
        int J = b0Var.m38150J();
        int e = b0Var.m38138e();
        b0Var.m38143Q(J);
        return C1194e.m38093d(b0Var.m38139d(), e, J);
    }

    public static C1604a m36293b(C1189b0 b0Var) {
        float f;
        int i;
        try {
            b0Var.m38143Q(4);
            int D = (b0Var.m38156D() & 3) + 1;
            if (D != 3) {
                ArrayList arrayList = new ArrayList();
                int D2 = b0Var.m38156D() & 31;
                for (int i2 = 0; i2 < D2; i2++) {
                    arrayList.add(m36294a(b0Var));
                }
                ...
                int i4 = -1;
                if (D2 > 0) {
                    C1237x.C1240c l = C1237x.m37844l((byte[]) arrayList.get(0), D, ((byte[]) arrayList.get(0)).length);
                    int i5 = l.f4593e;
                    int i6 = l.f4594f;
                    float f2 = l.f4595g;
                    str = C1194e.m38096a(l.f4589a, l.f4590b, l.f4591c);
                    i4 = i5;
                    i = i6;
                    f = f2;
                } else {
            ...
            throw C6556a2.m20112a("Error parsing AVC config", e);
        }
    }
}
