...
public class C3812u6 implements Closeable {
    ...
    public static C3812u6 m29745B0(String str) {
        C3803t6 t6Var;
        C3804t7.m29748a();
        if (!C3804t7.m29747b()) {
    ...
    public C3812u6 mo29743t() {
        this.f12885M = m29746A0();
        return this;
    }

    public void mo29742y0(long j) {
        long A0 = m29746A0();
    ...
    public void mo29741z0(long j) {
        mo29742y0(m29746A0() - j);
    }
}
