...
public final class C7703i0 extends AbstractC8687w {
    ...
    public final NavigableMap f24687c = new TreeMap();
    ...
    public C7703i0(File file, File file2) {
        ...
        if (!a.isEmpty()) {
            long j = 0;
            for (File file3 : a) {
                this.f24687c.put(Long.valueOf(j), file3);
                j += file3.length();
            }
            return;
        }
    ...
    public final long mo11734m() {
        Map.Entry lastEntry = this.f24687c.lastEntry();
    ...
    public final InputStream mo11733t(long j, long j2) {
        ...
        long j3 = j + j2;
        if (j3 <= mo11734m()) {
            Long l = (Long) this.f24687c.floorKey(Long.valueOf(j));
            Long l2 = (Long) this.f24687c.floorKey(Long.valueOf(j3));
            if (l.equals(l2)) {
                return new C7698h0(m15202z0(j, l), j2);
            }
            ArrayList arrayList = new ArrayList();
            arrayList.add(m15202z0(j, l));
            Collection values = this.f24687c.subMap(l, false, l2, false).values();
            if (!values.isEmpty()) {
                arrayList.add(new C7715k2(Collections.enumeration(values)));
            }
            arrayList.add(new C7698h0(new FileInputStream((File) this.f24687c.get(l2)), j2 - (l2.longValue() - j)));
            return new SequenceInputStream(Collections.enumeration(arrayList));
        }
        throw new C7694g1(String.format("Trying to access archive out of bounds. Archive ends at: %s. Tried accessing: %s", Long.valueOf(mo11734m()), Long.valueOf(j3)));
    }

    public final InputStream m15202z0(long j, Long l) {
        FileInputStream fileInputStream = new FileInputStream((File) this.f24687c.get(l));
