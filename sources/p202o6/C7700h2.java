...
public final class C7700h2 implements AbstractC7680d4 {
    public static final C8646a f24671i = new C8646a("FakeAssetPackService");
    public static final AtomicInteger f24672j = new AtomicInteger(1);
    public final String f24673a;
    public final C7787z f24674b;
    public final C7714k1 f24675c;
    public final Context f24676d;
    public final C7775w2 f24677e;
    public final AbstractC8689y f24678f;
    public final C7765u2 f24679g;
    public final Handler f24680h = new Handler(Looper.getMainLooper());

    public C7700h2(File file, C7787z zVar, C7714k1 k1Var, Context context, C7775w2 w2Var, AbstractC8689y yVar, C7765u2 u2Var) {
        this.f24673a = file.getAbsolutePath();
        this.f24674b = zVar;
        this.f24675c = k1Var;
    ...
    public final void mo15141a(final int i, final String str) {
        f24671i.m11815d("notifyModuleCompleted", new Object[0]);
        ((Executor) this.f24678f.zza()).execute(new Runnable() {
            @Override
    ...
    public final AbstractC9854e mo15140b(int i, String str, String str2, int i2) {
        File[] m;
        int i3;
        f24671i.m11815d("getChunkFileDescriptor(session=%d, %s, %s, %d)", Integer.valueOf(i), str, str2, Integer.valueOf(i2));
        C9865p pVar = new C9865p();
        try {
        } catch (FileNotFoundException e) {
            f24671i.m11814e("getChunkFileDescriptor failed", e);
            pVar.m6734b(new C8258b("Asset Slice file not found.", e));
        } catch (C8258b e2) {
            f24671i.m11814e("getChunkFileDescriptor failed", e2);
            pVar.m6734b(e2);
        }
        for (File file : m15203m(str)) {
            if (C8684t.m11739a(file).equals(str2)) {
    ...
    public final void mo15139c(int i, String str, String str2, int i2) {
        f24671i.m11815d("notifyChunkTransferred", new Object[0]);
    }

    @Override
    public final void mo15138d(int i) {
        f24671i.m11815d("notifySessionFailed", new Object[0]);
    }

    @Override
    public final AbstractC9854e mo15137e(Map map) {
        f24671i.m11815d("syncPacks()", new Object[0]);
        return C9856g.m6747c(new ArrayList());
    }

    @Override
    public final void mo15136f(List list) {
        f24671i.m11815d("cancelDownload(%s)", list);
    }

    public final void m15207h(Intent intent) {
        this.f24674b.mo10756a(this.f24676d, intent);
    }
    ...
    public final void m15206i(int i, String str) {
        try {
            ...
            f24671i.m11814e("notifyModuleCompleted failed", e);
        }
    }

    public final Bundle m15205j(int i, String str, int i2) {
        Bundle bundle = new Bundle();
        bundle.putInt("app_version_code", this.f24677e.m15109a());
        ...
        for (File file : m) {
            ...
            String a = C8684t.m11739a(file);
            bundle.putParcelableArrayList(C8054b.m13690b("chunk_intents", str, a), arrayList2);
            bundle.putString(C8054b.m13690b("uncompressed_hash_sha256", str, a), m15204l(file));
            bundle.putLong(C8054b.m13690b("uncompressed_size", str, a), file.length());
            arrayList.add(a);
        }
        bundle.putStringArrayList(C8054b.m13691a("slice_ids", str), arrayList);
        bundle.putLong(C8054b.m13691a("pack_version", str), this.f24677e.m15109a());
        bundle.putInt(C8054b.m13691a("status", str), i2);
        bundle.putInt(C8054b.m13691a("error_code", str), 0);
        bundle.putLong(C8054b.m13691a("bytes_downloaded", str), m15208g(i2, j));
        bundle.putLong(C8054b.m13691a("total_bytes_to_download", str), j);
        bundle.putStringArrayList("pack_names", new ArrayList<>(Arrays.asList(str)));
        bundle.putLong("bytes_downloaded", m15208g(i2, j));
        bundle.putLong("total_bytes_to_download", j);
        final Intent putExtra = new Intent("com.google.android.play.core.assetpacks.receiver.ACTION_SESSION_UPDATE").putExtra("com.google.android.play.core.assetpacks.receiver.EXTRA_SESSION_STATE", bundle);
        this.f24680h.post(new Runnable() {
            @Override
            public final void run() {
    ...
    public final void mo15131k() {
        f24671i.m11815d("keepAlive", new Object[0]);
    }

    public final File[] m15203m(final String str) {
        File file = new File(this.f24673a);
        if (file.isDirectory()) {
            ...
            if (listFiles != null) {
                if (listFiles.length != 0) {
                    for (File file2 : listFiles) {
                        if (C8684t.m11739a(file2).equals(str)) {
                            return listFiles;
                        }
                    }
