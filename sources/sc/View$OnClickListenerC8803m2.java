...
public class View$OnClickListenerC8803m2 extends AbstractC8809o<Void> implements View.OnClickListener {
    ...
    public class C8805b extends C2546iq {
        ...
        @Override
        public void mo394V2(C2964ra raVar, C9137c cVar, boolean z) {
            if (raVar.m32835j() == R.id.btn_close) {
                cVar.setIconColorId(R.id.theme_color_textNeutral);
            } else {
                cVar.setIconColorId(R.id.theme_color_icon);
            }
    ...
    public ViewGroup mo405hf() {
        RecyclerView recyclerView = new RecyclerView(this.f30165a);
        recyclerView.setLayoutManager(new LinearLayoutManager(this.f30165a));
        C8805b bVar = new C8805b(this);
        recyclerView.setAdapter(bVar);
        bVar.m34113y2(new C2964ra[]{new C2964ra(2), new C2964ra(4, R.id.btn_close, R.drawable.baseline_check_circle_24, R.string.Continue).m32843d0(R.id.theme_color_textNeutral), new C2964ra(4, R.id.btn_openLink, R.drawable.baseline_help_24, R.string.SponsoredInfoAction)}, false);
        return recyclerView;
    }
    ...
    public View mo403oc(Context context) {
        ...
        this.f28423I0.m34113y2(new C2964ra[]{new C2964ra(14), new C2964ra(9, 0, 0, R.string.SponsoredInfoText), new C2964ra(2), new C2964ra(4, (int) R.id.btn_openLink, (int) R.drawable.baseline_language_24, (CharSequence) C4403w.m27869i1(R.string.url_promote), false).m32843d0(R.id.theme_color_textNeutral), new C2964ra(3), new C2964ra(9, 0, 0, R.string.SponsoredInfoText2)}, false);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_openLink) {
            this.f28440n0.m11112u2(false);
            C1405v.m37137F(Uri.parse(C4403w.m27869i1(R.string.url_promote)));
        }
    }
}
