...
public abstract class AbstractBinderC8679q0 extends BinderC8655e0 implements AbstractC8681r0 {
    ...
    public final boolean mo11748q(int i, Parcel parcel, Parcel parcel2, int i2) {
        C8683s0 s0Var = null;
        if (i == 2) {
            Bundle bundle = (Bundle) C8657f0.m11803a(parcel, Bundle.CREATOR);
            ...
            mo11745B(bundle, s0Var);
            return true;
        } else if (i != 3) {
            return false;
        } else {
            Bundle bundle2 = (Bundle) C8657f0.m11803a(parcel, Bundle.CREATOR);
