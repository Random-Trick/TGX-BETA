...
public final class C1560e0 extends AbstractC3457a {
    ...
    public static final class C1561a implements AbstractC3457a.AbstractC3463f {
        ...
        public AbstractC3457a.C3462e mo6780a(AbstractC8959g gVar, long j) {
            ...
            this.f5559b.m38151L(min);
            gVar.mo10805q(this.f5559b.m38142d(), 0, min);
            return m36470c(this.f5559b, j, r);
        }

        @Override
        public void mo6779b() {
            this.f5559b.m38150M(C1216l0.f4531f);
        }

        public final AbstractC3457a.C3462e m36470c(C1189b0 b0Var, long j, long j2) {
            int a;
            int a2;
            int f = b0Var.m38140f();
            long j3 = -1;
            ...
            while (b0Var.m38145a() >= 188 && (a2 = (a = C1577j0.m36399a(b0Var.m38142d(), b0Var.m38141e(), f)) + 188) <= f) {
                long c = C1577j0.m36397c(b0Var, a, this.f5560c);
                if (c != -9223372036854775807L) {
                    long b = this.f5558a.m38055b(c);
                    if (b > j) {
                        if (j5 == -9223372036854775807L) {
                            return AbstractC3457a.C3462e.m30470d(b, j2);
                        }
                        return AbstractC3457a.C3462e.m30469e(j2 + j4);
                    } else if (100000 + b > j) {
                        return AbstractC3457a.C3462e.m30469e(j2 + a);
                    } else {
                        j4 = a;
                        j5 = b;
                    }
            ...
            if (j5 != -9223372036854775807L) {
                return AbstractC3457a.C3462e.m30468f(j5, j2 + j3);
            }
