...
public final class C1559e implements AbstractC8958f {
    ...
    public static AbstractC8958f[] m36471d() {
    ...
    public void mo1152b(long j, long j2) {
        this.f5557c = false;
        this.f5555a.mo36335c();
    }

    @Override
    public int mo1149e(AbstractC8959g gVar, C8971q qVar) {
        int b = gVar.mo4414b(this.f5556b.m38142d(), 0, Log.TAG_VIDEO);
        if (b == -1) {
            return -1;
        }
        this.f5556b.m38147P(0);
        this.f5556b.m38148O(b);
        if (!this.f5557c) {
            this.f5555a.mo36332f(0L, 4);
            this.f5557c = true;
        }
        this.f5555a.mo36336b(this.f5556b);
        return 0;
    }

    @Override
    public void mo1148f(AbstractC8960h hVar) {
        this.f5555a.mo36333e(hVar, new AbstractC1571i0.C1575d(0, 1));
        hVar.mo6040m();
