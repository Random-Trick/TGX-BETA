...
public final class C1977x extends AbstractC1825m1 {
    ...
    @Override
    public final Set<Map.Entry> mo35839a() {
    ...
    public final void clear() {
        ...
        if (map2 == map) {
            ...
            C1736g1.m36034a(new C1963w(this));
        }
    }

    @Override
    public final boolean containsKey(@CheckForNull Object obj) {
        return C1839n1.m35973b(this.f7063c, obj);
    }
    ...
    public final Object get(@CheckForNull Object obj) {
        Collection collection = (Collection) C1839n1.m35974a(this.f7063c, obj);
        if (collection == null) {
            return null;
        }
        return this.f7062M.mo35885h(obj, collection);
    }
    ...
    public final Object remove(@CheckForNull Object obj) {
        ...
        Collection g = this.f7062M.mo35991g();
        g.addAll(collection);
