...
public class C6196a extends AbstractC6346h<C6202g> implements AbstractC5891f {
    ...
    public C6196a(@RecentlyNonNull Context context, @RecentlyNonNull Looper looper, boolean z, @RecentlyNonNull C6336e eVar, @RecentlyNonNull Bundle bundle, @RecentlyNonNull AbstractC5867f.AbstractC5869b bVar, @RecentlyNonNull AbstractC5867f.AbstractC5870c cVar) {
        ...
        this.f19602u0 = eVar.m20600i();
    }

    @RecentlyNonNull
    public static Bundle m21074n0(@RecentlyNonNull C6336e eVar) {
        eVar.m20601h();
        Integer i = eVar.m20600i();
        Bundle bundle = new Bundle();
        bundle.putParcelable("com.google.android.gms.signin.internal.clientRequestedAccount", eVar.m20608a());
        if (i != null) {
    ...
    public final Bundle mo943D() {
        if (!m20668B().getPackageName().equals(this.f19600s0.m20605d())) {
            this.f19601t0.putString("com.google.android.gms.signin.internal.realClientPackageName", this.f19600s0.m20605d());
        }
    ...
    @Override
    public final void mo21078c() {
        m20636i(new AbstractC6325c.C6329d());
    }

    @Override
    public final void mo21077f(AbstractC6201f fVar) {
        C6378r.m20505l(fVar, "Expecting a valid ISignInCallbacks");
        try {
            Account b = this.f19600s0.m20607b();
            ((C6202g) m20665G()).m21070I1(new C6205j(1, new C6369o0(b, ((Integer) C6378r.m20506k(this.f19602u0)).intValue(), "<<default account>>".equals(b.name) ? C4271a.m28313a(m20668B()).m28312b() : null)), fVar);
        } catch (RemoteException e) {
            Log.w("SignInClientImpl", "Remote service probably died when signIn is called");
            try {
                fVar.mo21073r0(new C6207l(1, new C5217a(8, null), null));
    ...
    @Override
    public final void mo21076k(@RecentlyNonNull AbstractC6355k kVar, boolean z) {
        try {
            ((C6202g) m20665G()).m21071H1(kVar, ((Integer) C6378r.m20506k(this.f19602u0)).intValue(), z);
        } catch (RemoteException unused) {
    ...
    @Override
    public final void mo21075l() {
        try {
            ((C6202g) m20665G()).m21072G1(((Integer) C6378r.m20506k(this.f19602u0)).intValue());
        } catch (RemoteException unused) {
