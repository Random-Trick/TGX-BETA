...
public class C7844p {
    public static FrameLayout.LayoutParams m14881a(int i, float f, int i2, float f2, float f3, float f4, float f5) {
        ...
        layoutParams.setMargins(C1357a0.m37541i(f2), C1357a0.m37541i(f3), C1357a0.m37541i(f4), C1357a0.m37541i(f5));
        return layoutParams;
    }
    ...
    public static LinearLayout.LayoutParams m14879c(int i, int i2, float f, int i3, int i4, int i5, int i6, int i7) {
        ...
        layoutParams.setMargins(C1357a0.m37541i(i4), C1357a0.m37541i(i5), C1357a0.m37541i(i6), C1357a0.m37541i(i7));
