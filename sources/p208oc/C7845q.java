        ...
        if (this.f25084J0 != 0) {
            ...
            while (i2 < this.f25087M.size()) {
                ...
                if (gVar.f26854n || gVar.f26855o != 0.0f) {
                    ...
                    gVar.f26846f.reset();
                    int max = Math.max(i, this.f25139m0 - horizontalPadding2);
                    int min = Math.min(this.f25084J0.f26325b.length - 1, this.f25141n0 + horizontalPadding2);
                    boolean z = true;
                    int i3 = 0;
                    while (max <= min) {
                        if (iArr[max] < 0) {
                            ...
                            float f7 = (this.f25084J0.f26325b[max] * f5) - horizontalPadding;
                            float f8 = this.f25131i0;
                            float f9 = (iArr[max] - f8) / (this.f25129h0 - f8);
                            ...
                            if (AbstractC7821f.f25065H1) {
                                ...
                                gVar.f26846f.moveTo(f7, measuredHeight);
                                z = false;
                            } else {
                                gVar.f26846f.lineTo(f7, measuredHeight);
                            }
                        }
                        max++;
                        f5 = f2;
                    ...
                    if (i8 == 2) {
                        ...
                        if (!AbstractC7821f.f25065H1) {
                            ...
                            canvas.drawLines(gVar.f26851k, 0, i3, gVar.f26843c);
                        }
                        canvas.restore();
                    } else {
                        throw null;
    ...
    public void mo14860t(Canvas canvas) {
        ...
        if (this.f25084J0 != 0) {
            for (int i = 0; i < size; i++) {
                ...
                if (gVar.f26854n || gVar.f26855o != 0.0f) {
                    gVar.f26845e.reset();
                    int length = this.f25084J0.f26325b.length;
                    int[] iArr = gVar.f26841a.f26332a;
                    gVar.f26846f.reset();
                    int i2 = 0;
                    for (int i3 = 0; i3 < length; i3++) {
                        if (iArr[i3] >= 0) {
                            T t = this.f25084J0;
                            float f = t.f26325b[i3] * this.f25122d1;
                            boolean z = AbstractC7821f.f25066I1;
                            float f2 = z ? this.f25086L0 : t.f26328e;
                            float f3 = z ? this.f25088M0 : t.f26329f;
                            float f4 = (1.0f - ((iArr[i3] - f3) / (f2 - f3))) * this.f25120c1;
                            if (AbstractC7821f.f25065H1) {
                                if (i2 == 0) {
                                ...
                                gVar.f26845e.moveTo(f, f4);
                            } else {
                                gVar.f26845e.lineTo(f, f4);
                            }
                        }
                    }
                    gVar.f26850j = i2;
