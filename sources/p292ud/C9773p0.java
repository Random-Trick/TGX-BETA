...
public class C9773p0 implements AbstractC11158z0, C9736e.AbstractC9738b {
    ...
    public final C10536ab f31935C;
    public boolean f31936D;
    public int f31937E;
    public int f31938a;
    public int f31943f;
    public int f31947j;
    public C10930q6 f31948k;
    public TdApi.Message f31949l;
    public int f31950m;
    public float f31951n;
    public int f31956s;
    public long f31957t;
    public long f31958u;
    public long f31959v;
    ...
    public TdApi.GetInlineQueryResults f31962y;
    public String f31963z;
    public final C6227d<AbstractC9777d> f31939b = new C6227d<>(false, false, null);
    public final C6227d<AbstractC9778e> f31940c = new C6227d<>(false, false, null);
    public final C6233h<String, AbstractC9779f> f31941d = new C6233h<>(false, false, null);
    public final HandlerC9774a f31942e = new HandlerC9774a(this);
    public final List<TdApi.Message> f31944g = new ArrayList();
    public final List<TdApi.Message> f31945h = new ArrayList();
    public final HashMap<Integer, List<TdApi.File>> f31946i = new HashMap<>();
    public long f31952o = -1;
    public long f31953p = -1;
    public boolean f31954q = false;
    public int f31955r = C4868i.m24727c2().m24562x1();
    public final C9736e f31934B = new C9736e(this, this);

    public static class HandlerC9774a extends Handler {
        public final C9773p0 f31964a;
        ...
        public void handleMessage(Message message) {
            this.f31964a.m7095M0(message);
        }
    }

    public static class C9775b {
        public final List<TdApi.Message> f31965a;
        public final int f31966b;
        public int f31967c;
        public String f31968d;
        public String f31969e;
        public long f31970f;
        public List<TdApi.Message> f31971g;
        ...
        public TdApi.GetInlineQueryResults f31978n;
        ...
        public C9775b m6993p(TdApi.GetInlineQueryResults getInlineQueryResults, String str) {
            this.f31978n = getInlineQueryResults;
            this.f31979o = str;
            m6990s(C5070i.m24062i(str), true);
            return this;
        }
    ...
    public static boolean m7118B(TdApi.File file, TdApi.File file2) {
        ...
        if (file == null || file2 == null || (i = file.f25376id) != file2.f25376id) {
            return false;
        }
        if (i != -1) {
            return true;
        ...
        String str = null;
        String str2 = remoteFile != null ? remoteFile.f25420id : null;
        TdApi.RemoteFile remoteFile2 = file2.remote;
        if (remoteFile2 != null) {
            str = remoteFile2.f25420id;
        }
        return C5070i.m24068c(str2, str);
    }

    public static boolean m7116C(TdApi.Message message, long j, long j2, int i) {
        return message != null && message.chatId == j && message.f25409id == j2 && C4779t2.m25460o1(message) == i;
    }

    public static boolean m7114D(TdApi.Message message, TdApi.Message message2) {
        return (message == null && message2 == null) || message == message2 || (message != null && message2 != null && message.chatId == message2.chatId && message.f25409id == message2.f25409id && m7118B(C4779t2.m25495j1(message), C4779t2.m25495j1(message2)));
    }
    ...
    public static void m7011y0(C6233h<String, AbstractC9779f> hVar, C10930q6 q6Var, long j, long j2, int i, int i2, float f, long j3, long j4, boolean z) {
        Iterator<AbstractC9779f> d = hVar.m21020d(m7059e0(q6Var, j, j2));
        if (d != null) {
            while (d.hasNext()) {
    ...
    public void m7117B0(TdApi.Message message) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            TdApi.Message message2 = this.f31949l;
            if (message2 == null) {
                return;
            }
            if (!m7114D(message2, message) || this.f31950m != 3) {
                m7099K0(message, true, true, this.f31948k, null);
                return;
            }
            return;
        }
    ...
    public void m7115C0(boolean z, boolean z2) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            HandlerC9774a aVar = this.f31942e;
            aVar.sendMessage(Message.obtain(aVar, 2, z ? 1 : 0, z2 ? 1 : 0));
            return;
        }
        int W = m7076W(m7080U(), z, z2);
        if (W != -1) {
            m7099K0(this.f31944g.get(W), z2, true, this.f31948k, null);
        } else {
            m7099K0(null, z2, true, this.f31948k, null);
        }
    }
    ...
    public final void m7110F(TdApi.Message message) {
        int i = 0;
        for (TdApi.Message message2 : this.f31945h) {
            if (m7114D(message2, message)) {
                this.f31945h.remove(i);
                return;
            }
            i++;
        }
    ...
    public final void m7109F0(int i) {
        ...
        synchronized (this) {
            TdApi.Message message = this.f31949l;
            if (!(message == null || (i2 = this.f31950m) == 0)) {
                if (i != 0) {
                    boolean z2 = i == 1;
                    if (i2 == 3) {
                        z = true;
                ...
                m7099K0(message, true, false, this.f31948k, null);
            }
        }
    }
    ...
    public final void m7108G(int i) {
        int U;
        if (this.f31949l == null) {
            return;
        }
        if ((this.f31957t != 0 || this.f31962y != null) && !this.f31944g.isEmpty() && this.f31950m != 0 && (U = m7080U()) != -1) {
            boolean z = true;
            boolean z2 = U + 25 >= this.f31944g.size();
            if (U >= 25) {
                z = false;
            }
            m7097L0(z2, z, i);
    ...
    public long m7100K(C10930q6 q6Var, TdApi.Message message) {
        ...
        synchronized (this) {
            TdApi.Message message2 = this.f31949l;
            j = (message2 == null || !m7112E(this.f31948k, q6Var, message2, message)) ? -1L : this.f31953p;
        }
        return j;
    }
    ...
    public long m7098L() {
        synchronized (this) {
            if (this.f31950m == 0 || this.f31944g.isEmpty()) {
                return 0L;
            }
            return this.f31957t;
        }
    ...
    public long m7096M(C10930q6 q6Var, TdApi.Message message) {
        ...
        synchronized (this) {
            TdApi.Message message2 = this.f31949l;
            j = (message2 == null || !m7112E(this.f31948k, q6Var, message2, message)) ? -1L : this.f31952o;
        }
        return j;
    }
    ...
    public final void m7095M0(Message message) {
        ...
        switch (message.what) {
            case 0:
                long f = C5063c.m24141f(message.arg1, message.arg2);
            ...
            case 5:
                ...
                return;
            case 6:
                m7077V0((TdApi.Message) message.obj, C5063c.m24141f(message.arg1, message.arg2));
                return;
            case 7:
                if (message.arg1 == 1) {
                    z = true;
    ...
    public int m7092O(C10930q6 q6Var, TdApi.Message message) {
        ...
        synchronized (this) {
            TdApi.Message message2 = this.f31949l;
            i = (message2 == null || !m7112E(this.f31948k, q6Var, message2, message)) ? 0 : this.f31950m;
        }
        return i;
    }
    ...
    public void m7091O0(C10930q6 q6Var, long j, long[] jArr) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            HandlerC9774a aVar = this.f31942e;
            aVar.sendMessage(Message.obtain(aVar, 0, C5063c.m24134m(j), C5063c.m24133n(j), new Object[]{q6Var, jArr}));
            return;
        }
        synchronized (this) {
            if (!(this.f31949l == null || this.f31950m == 0)) {
                C10930q6 q6Var2 = this.f31948k;
                if (q6Var2 != null && q6Var2.m2188w6() == q6Var.m2188w6()) {
                    int U = m7080U();
                    if (U != -1) {
                        for (int size = this.f31944g.size() - 1; size >= 0; size--) {
                            TdApi.Message message = this.f31944g.get(size);
                            long j2 = message.chatId;
                            if (!(j2 == 0 || j2 != j || C5062b.m24154s(jArr, message.f25409id) == -1)) {
                                if (size == U) {
    ...
    public void m7089P0(TdApi.Message message, boolean z) {
        synchronized (this) {
            TdApi.Message message2 = this.f31949l;
            if (message2 != null && this.f31950m != 0 && message2.content.getConstructor() == 276722716 && this.f31944g.size() > 1) {
    ...
    public int m7088Q() {
        int i;
        synchronized (this) {
            i = this.f31950m == 0 ? this.f31955r : this.f31955r | this.f31956s;
        }
        return i;
    }
    ...
    public final void m7087Q0(AbstractC9777d dVar) {
        synchronized (this) {
            this.f31939b.add(dVar);
        }
    }

    public final int m7086R() {
        return m7090P(this.f31949l, this.f31955r) | this.f31956s;
    }
    ...
    public final void m7085R0(TdApi.Message message, int i, boolean z) {
        ...
        if (i < 0 || i >= this.f31944g.size()) {
            throw new IllegalStateException();
        } else if (this.f31944g.size() == 1) {
            m7052g1(z);
        } else {
            boolean D = m7114D(message, this.f31949l);
            this.f31944g.remove(i);
            m7025r0(this.f31940c, this.f31948k, message, i, D);
            if (z) {
                this.f31945h.add(message);
                this.f31956s |= Log.TAG_COMPRESS;
            }
        }
    }
    ...
    public final void m7083S0(AbstractC9778e eVar) {
        synchronized (this) {
            this.f31940c.remove(eVar);
        }
    }

    public boolean m7082T() {
        Iterator<AbstractC9778e> it = this.f31940c.iterator();
        while (it.hasNext()) {
            if (m7066b0(it.next())) {
                return true;
            }
    ...
    public final void m7081T0(C10930q6 q6Var, TdApi.Message message, AbstractC9779f fVar) {
        synchronized (this) {
            this.f31941d.m21017g(m7059e0(q6Var, message.chatId, message.f25409id), fVar);
        }
    }

    public final int m7080U() {
        return m7078V(this.f31949l);
    }

    public void m7079U0() {
        synchronized (this) {
            m7108G((this.f31956s & Log.TAG_ROUND) != 0 ? 2 : 1);
        }
    }
    ...
    public final int m7078V(TdApi.Message message) {
        ...
        int i = 0;
        for (TdApi.Message message2 : this.f31944g) {
    ...
    public void m7077V0(TdApi.Message message, long j) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            HandlerC9774a aVar = this.f31942e;
            aVar.sendMessage(Message.obtain(aVar, 6, C5063c.m24134m(j), C5063c.m24133n(j), message));
            return;
        }
        synchronized (this) {
            TdApi.Message message2 = this.f31949l;
            if (message2 != null && m7114D(message2, message)) {
                this.f31935C.m4729Y().m7382v0(j, this.f31953p);
            }
        }
    }
    ...
    public final int m7076W(int i, boolean z, boolean z2) {
        ...
        if ((this.f31956s & Log.TAG_ROUND) != 0) {
            z = !z;
        }
        int N = m7094N(m7090P(this.f31944g.get(i), this.f31955r));
        if (N == 4 && !z2) {
            return i;
        }
        if (z) {
            int i3 = i + 1;
            if (i3 < this.f31944g.size()) {
                return i3;
            }
            if (N != 0 || z2) {
                i2 = 0;
    ...
    public void m7075W0(int i, boolean z) {
        ...
        synchronized (this) {
            int h = C5063c.m24139h(this.f31937E, i, z);
            int i2 = this.f31937E;
            if (i2 != h) {
                boolean z2 = i2 != 0;
                boolean z3 = h != 0;
                this.f31937E = h;
                if (!(z2 == z3 || (message = this.f31949l) == null)) {
                    if (z3 && this.f31950m == 3) {
                        this.f31936D = true;
                        m7105H0(this.f31948k, message, null);
                    } else if (!z3 && this.f31950m == 2 && this.f31936D) {
                        this.f31936D = false;
                        m7105H0(this.f31948k, message, null);
                    }
                }
    ...
    public boolean m7074X(int i) {
        ...
        synchronized (this) {
            TdApi.Message message = this.f31949l;
            z = message != null && C4779t2.m25460o1(message) == i;
        }
        return z;
    }
    ...
    public void m7073X0(C10930q6 q6Var, long j, long j2, int i, float f, long j3, long j4, boolean z) {
        TdApi.Message message;
        synchronized (this) {
            if (this.f31948k == q6Var && (message = this.f31949l) != null && message.chatId == j && message.f25409id == j2 && C4779t2.m25460o1(message) == i && !(this.f31951n == f && this.f31952o == j3 && this.f31953p == j4 && this.f31954q == z)) {
                this.f31951n = f;
                this.f31953p = j4;
                this.f31952o = j3;
                this.f31954q = z;
                m7011y0(this.f31941d, q6Var, j, j2, i, -1, f, j3, j4, z);
            }
        }
    }
    ...
    public boolean m7072Y(long j, long j2) {
        ...
        synchronized (this) {
            TdApi.Message message = this.f31949l;
            z = message != null && message.chatId == j && message.f25409id == j2;
        }
        return z;
    }
    ...
    public final void m7069Z0(int i) {
        if (this.f31955r != i) {
            this.f31955r = i;
            C4868i.m24727c2().m24596s5(i);
            synchronized (this) {
                m7033n0(this.f31940c, m7086R());
            }
        }
    }
    ...
    public void m7067a1(int i) {
        ...
        } else if (this.f31938a != i) {
            this.f31938a = i;
            synchronized (this) {
                m7015w0(this.f31939b, i);
            }
        }
    }
    ...
    public final TdApi.GetInlineQueryResults m7062d0() {
        TdApi.GetInlineQueryResults getInlineQueryResults = this.f31962y;
        return new TdApi.GetInlineQueryResults(getInlineQueryResults.botUserId, getInlineQueryResults.chatId, getInlineQueryResults.userLocation, getInlineQueryResults.query, this.f31963z);
    }
    ...
    public void m7061d1(boolean z) {
        ...
        m7099K0(null, z, false, this.f31948k, null);
    }
    ...
    public void mo7060e() {
        TdApi.Message message;
        synchronized (this) {
            C10930q6 q6Var = this.f31948k;
            if (!(q6Var == null || (message = this.f31949l) == null)) {
                m7021t0(this.f31939b, q6Var, message);
            }
        }
    }
    ...
    public void m7055f1(TdApi.File[] fileArr) {
        ...
        synchronized (this) {
            ...
            z = false;
            if (message != null) {
                int o1 = C4779t2.m25460o1(message);
                int length = fileArr.length;
                int i = 0;
                while (true) {
                    if (i >= length) {
                        break;
                    } else if (o1 == fileArr[i].f25376id) {
                        z = true;
                        break;
                    } else {
                        i++;
    ...
    public final void m7053g0(C10930q6 q6Var, TdApi.Message message, long j) {
        ...
        synchronized (this) {
            C10930q6 q6Var2 = this.f31948k;
            if (q6Var2 != null && q6Var2.m2188w6() == q6Var.m2188w6() && (message2 = this.f31949l) != null && message2.f25409id == j && message2.chatId == message.chatId) {
                this.f31949l = message;
                m7037l1();
            }
            this.f31941d.m21018f(m7059e0(q6Var, message.chatId, j), m7059e0(q6Var, message.chatId, message.f25409id));
        }
    }
    ...
    public final void m7051h(TdApi.File file) {
        int i;
        if (file != null && (i = file.f25376id) >= 0) {
            List<TdApi.File> list = this.f31946i.get(Integer.valueOf(i));
            if (list == null) {
                list = new ArrayList<>();
                this.f31946i.put(Integer.valueOf(file.f25376id), list);
            }
            list.add(file);
        }
    }
    ...
    public void m7050h0(int i, int i2) {
        synchronized (this) {
            TdApi.Message message = this.f31949l;
            if (!(message == null || this.f31950m == 0 || message.content.getConstructor() != 276722716)) {
                TdApi.Message remove = this.f31944g.remove(i);
                this.f31944g.add(i2, remove);
                m7029p0(this.f31940c, this.f31948k, remove, i, i2);
                this.f31956s |= Log.TAG_COMPRESS;
            }
        }
    }
    ...
    public final void m7048i(int i, TdApi.Message message) {
        this.f31944g.add(i, message);
        m7051h(C4779t2.m25495j1(message));
    }

    public void m7046i1(int i) {
        m7069Z0(i ^ this.f31955r);
    }

    public final void m7045j(TdApi.Message message) {
        this.f31944g.add(message);
        m7051h(C4779t2.m25495j1(message));
    }
    ...
    public float m7041k0(long j, float f) {
        float g0;
        synchronized (this) {
            g0 = this.f31935C.m4729Y().m7393g0(j, f);
        }
        return g0;
    }
    ...
    public final void m7037l1() {
        TdApi.Message message = this.f31949l;
        if (message == null || !(message.content.getConstructor() == 527777781 || this.f31949l.content.getConstructor() == 963323014)) {
            this.f31934B.m7305m(null);
        } else {
            this.f31934B.m7305m(this.f31949l);
        }
    }

    public final void m7036m(List<TdApi.Message> list) {
        this.f31944g.addAll(list);
        for (TdApi.Message message : list) {
            m7051h(C4779t2.m25495j1(message));
        }
    }
    ...
    public final void m7034n(C10930q6 q6Var, TdApi.Message message) {
        ...
        synchronized (this) {
            if (this.f31948k == q6Var && (message2 = this.f31949l) != null) {
                long j = message2.chatId;
                long j2 = message.chatId;
                if (j == j2 && j2 != 0 && message2.content.getConstructor() == message.content.getConstructor() && C4779t2.m25728A3(this.f31949l) == C4779t2.m25728A3(message) && (this.f31943f & 4) != 0) {
                    int size = this.f31944g.size();
                    m7045j(message);
                    m7031o0(this.f31940c, q6Var, message, size);
                }
            }
            m7108G(0);
        }
    ...
    public void m7032o(TdApi.Message message) {
        synchronized (this) {
            ...
            if (U != -1) {
                ...
                int t = m7022t(this.f31948k, message, U, V);
                if (t != 0) {
                    if ((this.f31956s & Log.TAG_ROUND) == 0) {
                        U++;
                    }
                    if (t == 2) {
                        TdApi.Message remove = this.f31944g.remove(V);
                        if (V <= U) {
                            U--;
                        }
                        this.f31944g.add(U, remove);
                        m7029p0(this.f31940c, this.f31948k, message, V, U);
                    } else {
                        m7048i(U, message);
                        m7031o0(this.f31940c, this.f31948k, message, U);
                        if (t == 3) {
                            m7110F(message);
                        }
                    }
    ...
    public final void m7030p(AbstractC9777d dVar) {
        synchronized (this) {
            ...
            TdApi.Message message = this.f31949l;
            if (message != null) {
                dVar.mo6983Y1(this.f31948k, message, C4779t2.m25460o1(message), this.f31950m, this.f31951n, false);
            }
        }
    }
    ...
    public final void m7028q(AbstractC9778e eVar, boolean z) {
        TdApi.Message message;
        synchronized (this) {
            this.f31940c.add(eVar);
            if (z && this.f31950m != 0 && !this.f31944g.isEmpty() && (message = this.f31949l) != null) {
                eVar.mo6982B3(this.f31948k, message, m7080U(), this.f31944g, this.f31957t, this.f31956s | m7090P(this.f31949l, this.f31955r), this.f31950m);
            }
        }
        if (m7066b0(eVar)) {
            this.f31935C.m4729Y().m7399U();
        }
    }
    ...
    public final void m7026r(C10930q6 q6Var, TdApi.Message message, AbstractC9779f fVar) {
        synchronized (this) {
            ...
            boolean z = false;
            int o1 = message2 != null ? C4779t2.m25460o1(message2) : 0;
            if (j2 == message.chatId && j == message.f25409id && C4779t2.m25460o1(message) == o1) {
                z = true;
            }
            this.f31941d.m21022b(m7059e0(q6Var, message.chatId, message.f25409id), fVar);
            if (z) {
                fVar.mo6972z1(q6Var, message.chatId, message.f25409id, o1, this.f31950m);
                float f = this.f31951n;
                if (f != 0.0f) {
                    fVar.mo6973V2(q6Var, message.chatId, message.f25409id, o1, f, this.f31952o, this.f31953p, this.f31954q);
                }
            }
        }
    }
    ...
    public final int m7022t(C10930q6 q6Var, TdApi.Message message, int i, int i2) {
        TdApi.Message message2;
        if (this.f31948k == q6Var && (message2 = this.f31949l) != null && this.f31950m != 0 && message2.content.getConstructor() == message.content.getConstructor()) {
            if (i2 != -1) {
                return (this.f31956s & Log.TAG_ROUND) != 0 ? (i2 == i || i - 1 == i2) ? 0 : 2 : (i2 == i || i + 1 == i2) ? 0 : 2;
            }
            long j = this.f31957t;
    ...
    public final boolean m7018v(TdApi.Message message) {
        TdApi.Message message2 = this.f31949l;
        if (message2 == null || this.f31950m == 0 || message2.content.getConstructor() != message.content.getConstructor() || this.f31945h.isEmpty()) {
            return false;
        }
        for (TdApi.Message message3 : this.f31945h) {
    ...
    public boolean m7014x(TdApi.Message message) {
        synchronized (this) {
            ...
            return this.f31935C.m4729Y().m7388p0();
        }
    }
    ...
    public void m7009z0(C10930q6 q6Var, TdApi.UpdateFile updateFile) {
        ...
        synchronized (this) {
            C10930q6 q6Var2 = this.f31948k;
            if (!(q6Var2 == null || q6Var2.m2188w6() != q6Var.m2188w6() || (list = this.f31946i.get(Integer.valueOf(updateFile.file.f25376id))) == null)) {
