...
public class MediaRecyclerView extends RecyclerView {
    public AbstractC7925b f25735u1;
    public boolean f25736v1;
    ...
    public class C7924a extends RecyclerView.AbstractC0910t {
        ...
        public void mo421b(RecyclerView recyclerView, int i, int i2) {
            MediaRecyclerView.this.setScrollbarsVisible(((LinearLayoutManager) MediaRecyclerView.this.getLayoutManager()).m39552X1() != 0);
        }
    }

    public interface AbstractC7925b {
        void mo14147a(MediaRecyclerView mediaRecyclerView, int i, int i2);
    }
    ...
    public int getVerticalScrollbarPosition() {
        ...
        if (linearLayoutManager.m39556T1() != 0 || (C = linearLayoutManager.mo39265C(0)) == null) {
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.f25735u1 != null && Math.max(getMeasuredWidth(), getMeasuredHeight()) > 0) {
            this.f25735u1.mo14147a(this, getMeasuredWidth(), getMeasuredHeight());
        }
    }
