...
public abstract class AbstractView$OnTouchListenerC4202a implements View.OnTouchListener {
    ...
    public static class C4203a {
        ...
        public void m28457a() {
            if (this.f14220f != 0) {
                ...
                float g = m28451g(m28453e(currentAnimationTimeMillis));
        ...
        public final float m28453e(long j) {
            ...
            if (j3 < 0 || j < j3) {
                return AbstractView$OnTouchListenerC4202a.m28474e(((float) (j - j2)) / this.f14215a, 0.0f, 1.0f) * 0.5f;
            }
            float f = this.f14224j;
            return (1.0f - f) + (f * AbstractView$OnTouchListenerC4202a.m28474e(((float) (j - j3)) / this.f14225k, 0.0f, 1.0f));
        }
        ...
        public final float m28451g(float f) {
            return ((-4.0f) * f * f) + (f * 4.0f);
        }

        public boolean m28450h() {
            return this.f14223i > 0 && AnimationUtils.currentAnimationTimeMillis() > this.f14223i + ((long) this.f14225k);
        }

        public void m28449i() {
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.f14225k = AbstractView$OnTouchListenerC4202a.m28473f((int) (currentAnimationTimeMillis - this.f14219e), 0, this.f14216b);
            this.f14224j = m28453e(currentAnimationTimeMillis);
            this.f14223i = currentAnimationTimeMillis;
        }

        public void m28448j(int i) {
            this.f14216b = i;
        }

        public void m28447k(int i) {
            this.f14215a = i;
        }

        public void m28446l(float f, float f2) {
            this.f14217c = f;
            this.f14218d = f2;
        }
    ...
    public class RunnableC4204b implements Runnable {
        ...
        public void run() {
            ...
            if (aVar.f14209X) {
                if (aVar.f14207V) {
                    aVar.f14207V = false;
                    aVar.f14212a.m28445m();
                }
                C4203a aVar2 = AbstractView$OnTouchListenerC4202a.this.f14212a;
                if (aVar2.m28450h() || !AbstractView$OnTouchListenerC4202a.this.m28459u()) {
                ...
                aVar2.m28457a();
                AbstractView$OnTouchListenerC4202a.this.mo28428j(aVar2.m28456b(), aVar2.m28455c());
                C1489y.m36752U(AbstractView$OnTouchListenerC4202a.this.f14214c, this);
            }
        }
    }
    ...
    public AbstractView$OnTouchListenerC4202a(View view) {
        ...
        m28464p(f3, f3);
        m28468l(1);
        m28466n(Float.MAX_VALUE, Float.MAX_VALUE);
        m28461s(0.2f, 0.2f);
        m28460t(1.0f, 1.0f);
        m28469k(f14197a0);
        m28462r(500);
    ...
    public static float m28474e(float f, float f2, float f3) {
        return f > f3 ? f3 : f < f2 ? f2 : f;
    }

    public static int m28473f(int i, int i2, int i3) {
        return i > i3 ? i3 : i < i2 ? i2 : i;
    }

    public abstract boolean mo28430a(int i);

    public abstract boolean mo28429b(int i);
    ...
    public final float m28475d(int i, float f, float f2, float f3) {
        float h = m28471h(this.f14199N[i], f2, this.f14200O[i], f);
        ...
        float f7 = f4 * f3;
        if (i2 > 0) {
            return m28474e(h * f7, f5, f6);
        }
        return -m28474e((-h) * f7, f5, f6);
    }

    public final float m28472g(float f, float f2) {
        if (f2 == 0.0f) {
            return 0.0f;
        }
        int i = this.f14201P;
    ...
    public final float m28471h(float f, float f2, float f3, float f4) {
        float f5;
        float e = m28474e(f * f2, 0.0f, f3);
        float g = m28472g(f2 - f4, e) - m28472g(f4, e);
        if (g < 0.0f) {
    ...
    public final void m28470i() {
        if (this.f14207V) {
            ...
            this.f14212a.m28449i();
        }
    }

    public abstract void mo28428j(int i, int i2);

    public AbstractView$OnTouchListenerC4202a m28469k(int i) {
        this.f14202Q = i;
        return this;
    }

    public AbstractView$OnTouchListenerC4202a m28468l(int i) {
        this.f14201P = i;
        return this;
    }

    public AbstractView$OnTouchListenerC4202a m28467m(boolean z) {
        if (this.f14210Y && !z) {
            m28470i();
        }
        this.f14210Y = z;
    ...
    public AbstractView$OnTouchListenerC4202a m28466n(float f, float f2) {
    ...
    public AbstractView$OnTouchListenerC4202a m28465o(float f, float f2) {
    ...
    public AbstractView$OnTouchListenerC4202a m28464p(float f, float f2) {
    ...
    public AbstractView$OnTouchListenerC4202a m28463q(int i) {
        this.f14212a.m28448j(i);
        return this;
    }

    public AbstractView$OnTouchListenerC4202a m28462r(int i) {
        this.f14212a.m28447k(i);
        return this;
    }

    public AbstractView$OnTouchListenerC4202a m28461s(float f, float f2) {
    ...
    public AbstractView$OnTouchListenerC4202a m28460t(float f, float f2) {
    ...
    public boolean m28459u() {
        C4203a aVar = this.f14212a;
        int f = aVar.m28452f();
        int d = aVar.m28454d();
        return (f != 0 && mo28429b(f)) || (d != 0 && mo28430a(d));
    }

    public final void m28458v() {
        int i;
        ...
        if (this.f14206U || (i = this.f14202Q) <= 0) {
            ...
            C1489y.m36751V(this.f14214c, this.f14198M, i);
        }
        this.f14206U = true;
    }
}
