...
public final class C4969i {
    ...
    public static synchronized C4969i m24359c(Context context) {
        C4969i iVar;
        synchronized (C4969i.class) {
            if (f16899e == null) {
                f16899e = new C4969i(context, C9979a.m6312a().mo6311a(1, new ThreadFactoryC8371a("MessengerIpcClient"), C9984f.f32465b));
            }
            iVar = f16899e;
        }
        return iVar;
    ...
    public final synchronized int m24361a() {
        int i;
        i = this.f16903d;
        this.f16903d = i + 1;
        return i;
    ...
    public final AbstractC6775l<Void> m24358d(int i, Bundle bundle) {
        return m24357e(new C4978r(m24361a(), 2, bundle));
    }

    public final synchronized <T> AbstractC6775l<T> m24357e(AbstractC4981u<T> uVar) {
        ...
        if (!this.f16902c.m24350e(uVar)) {
            ServiceConnectionC4970j jVar = new ServiceConnectionC4970j(this);
            this.f16902c = jVar;
            jVar.m24350e(uVar);
        }
        return uVar.f16922b.m19086a();
    }

    public final AbstractC6775l<Bundle> m24355g(int i, Bundle bundle) {
        return m24357e(new C4983w(m24361a(), 1, bundle));
    }
}
