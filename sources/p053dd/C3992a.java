...
public class C3992a extends FrameLayoutFix implements AbstractC9165c2, AbstractC9208i2, TextWatcher, View$OnClickListenerC9170d1.AbstractC9173c {
    ...
    public interface AbstractC3995c {
        void mo29400H3(int i);

        void mo29399T();

        void mo29398Y2(int i);

        View mo29397o();

        void mo29396p3(long j);

        void mo29395q(String str);
    }
    ...
    public C3992a(Context context) {
        ...
        int i = C1357a0.m37541i(12.0f) + C1357a0.m37541i(8.0f) + (C1357a0.m37541i(16.0f) * 4);
        this.f13374R = i;
        FrameLayout.LayoutParams s12 = FrameLayoutFix.m18008s1(-1, i);
        if (C4403w.m27984G2()) {
            s12.rightMargin = C1357a0.m37541i(60.0f);
        } else {
            s12.leftMargin = C1357a0.m37541i(60.0f);
        }
        ...
        FrameLayout.LayoutParams s13 = FrameLayoutFix.m18008s1(-1, C4896n.m24478e());
        if (C4403w.m27984G2()) {
            s13.rightMargin = C1357a0.m37541i(68.0f);
        } else {
            s13.leftMargin = C1357a0.m37541i(68.0f);
        }
    ...
    public void m29410F1(C4618d7 d7Var) {
        this.f13373Q.add(d7Var);
        this.f13371O.m29356i(d7Var);
    }

    public boolean m29409G1() {
        return this.f13371O.m29348q();
    }

    public void m29408I1() {
        this.f13369M.setText("");
    }

    public void m29407J1() {
        AbstractC3995c cVar;
        if (!this.f13379W) {
    ...
    public final void m29403O1(int i) {
        this.f13371O.m29343v(this.f13373Q.remove(i));
    }

    public void m29402Q1(C4618d7 d7Var) {
        long s = d7Var.m26869s();
        Iterator<C4618d7> it = this.f13373Q.iterator();
        int i = 0;
        while (it.hasNext()) {
            if (it.next().m26869s() == s) {
                m29403O1(i);
                return;
            }
            i++;
    ...
    public void mo8402i0(float f, float f2, float f3, boolean z) {
        ...
        if (this.f13383d0 != a) {
            ...
            int i = this.f13376T;
            if (i != 0) {
                setTranslationY((-this.f13376T) * (1.0f - (a / (i / C4896n.m24477f(false)))));
            }
        }
    }
    ...
    public void mo9775k0(View$OnClickListenerC9170d1 d1Var, int i) {
        this.f13375S = i;
        C1399s0.m37155t0(this.f13370N, i);
        C1399s0.m37155t0(this.f13369M, i);
    }
    ...
    public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
        ...
        if (cVar != null) {
            cVar.mo29395q(charSequence.toString());
        }
    }
    ...
    public void mo8255s() {
        ...
        if (!(headerEditText == null || headerEditText.getGravity() == (C4403w.m27989F1() | 16))) {
            this.f13369M.mo8255s();
            if (C1399s0.m37177i0((FrameLayout.LayoutParams) this.f13369M.getLayoutParams(), C4403w.m27984G2() ? 0 : C1357a0.m37541i(68.0f), this.f13375S, C4403w.m27984G2() ? C1357a0.m37541i(68.0f) : 0, 0)) {
                C1399s0.m37145y0(this.f13369M);
            }
        }
        ...
        if (scrollView != null) {
            if (C1399s0.m37177i0((FrameLayout.LayoutParams) scrollView.getLayoutParams(), C4403w.m27984G2() ? 0 : C1357a0.m37541i(60.0f), this.f13375S, C4403w.m27984G2() ? C1357a0.m37541i(60.0f) : 0, 0)) {
                C1399s0.m37145y0(this.f13370N);
            }
        }
    }
    ...
    public void setHint(int i) {
        this.f13369M.setHint(C4403w.m27869i1(i));
    }
}
