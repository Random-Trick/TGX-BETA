...
public final class C3990l extends C3976f {
    ...
    public static final class C3991a {
        ...
        public static AbstractC3989k m29416b(C3991a aVar, String str, int i, Object obj) {
            if ((i & 1) != 0) {
                str = "com.android.org.conscrypt";
            }
            return aVar.m29417a(str);
        }

        public final AbstractC3989k m29417a(String str) {
            C8298k.m12933e(str, "packageName");
            try {
                Class<?> cls = Class.forName(str + ".OpenSSLSocketImpl");
                Class<?> cls2 = Class.forName(str + ".OpenSSLSocketFactoryImpl");
                Class<?> cls3 = Class.forName(str + ".SSLParametersImpl");
                C8298k.m12934d(cls3, "paramsClass");
                return new C3990l(cls, cls2, cls3);
            } catch (Exception e) {
                C2083h.f7326c.m35677g().m35689j("unable to load android socket classes", 5, e);
                return null;
            }
        }
    ...
    public C3990l(Class<? super SSLSocket> cls, Class<? super SSLSocketFactory> cls2, Class<?> cls3) {
        ...
        C8298k.m12933e(cls2, "sslSocketFactoryClass");
        C8298k.m12933e(cls3, "paramClass");
        this.f13367h = cls2;
        this.f13368i = cls3;
    }
}
