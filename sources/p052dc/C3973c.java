...
public final class C3973c {
    ...
    static {
        ...
        C8298k.m12934d(name2, "OkHttpClient::class.java.name");
        linkedHashMap.put(name2, "okhttp.OkHttpClient");
        String name3 = C1314e.class.getName();
        C8298k.m12934d(name3, "Http2::class.java.name");
        linkedHashMap.put(name3, "okhttp.Http2");
        String name4 = C10180e.class.getName();
        C8298k.m12934d(name4, "TaskRunner::class.java.name");
        linkedHashMap.put(name4, "okhttp.TaskRunner");
        linkedHashMap.put("okhttp3.mockwebserver.MockWebServer", "okhttp.MockWebServer");
        f13345b = C5295h0.m23416l(linkedHashMap);
    }

    public final void m29442a(String str, int i, String str2, Throwable th) {
        int min;
        C8298k.m12933e(str, "loggerName");
        C8298k.m12933e(str2, "message");
        String d = m29439d(str);
    ...
    public final void m29441b() {
        for (Map.Entry<String, String> entry : f13345b.entrySet()) {
            m29440c(entry.getKey(), entry.getValue());
        }
    }

    public final void m29440c(String str, String str2) {
        Level level;
        Logger logger = Logger.getLogger(str);
        if (f13344a.add(logger)) {
            C8298k.m12934d(logger, "logger");
    ...
    public final String m29439d(String str) {
