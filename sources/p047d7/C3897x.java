...
public class C3897x<T> implements AbstractC6794b<Set<T>> {
    ...
    public static C3897x<?> m29623b(Collection<AbstractC6794b<?>> collection) {
        return new C3897x<>((Set) collection);
    }

    public synchronized void m29624a(AbstractC6794b<T> bVar) {
    ...
    public final synchronized void m29621d() {
