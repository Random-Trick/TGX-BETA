...
public class C11190g {
    public static final C11199i[] f35852d;
    public static final C11199i[] f35853e;
    public static final C11199i[] f35854f;
    public static final C11199i[] f35856h;
    public static final C11199i[][] f35857i;
    public final List<Map<String, C11189f>> f35859a;
    public final ByteOrder f35860b;
    public static final String[] f35851c = {"", "BYTE", "STRING", "USHORT", "ULONG", "URATIONAL", "SBYTE", "UNDEFINED", "SSHORT", "SLONG", "SRATIONAL", "SINGLE", "DOUBLE", "IFD"};
    public static final C11199i[] f35855g = {new C11199i("SubIFDPointer", 330, 4), new C11199i("ExifIFDPointer", 34665, 4), new C11199i("GPSInfoIFDPointer", 34853, 4), new C11199i("InteroperabilityIFDPointer", 40965, 4)};
    public static final HashSet<String> f35858j = new HashSet<>(Arrays.asList("FNumber", "ExposureTime", "GPSTimeStamp"));

    public static class C11191a {
        public static final int[] f35861a;
        public static final int[] f35862b;
        ...
        static {
            ...
            try {
                f35862b[EnumC11196c.MANUAL.ordinal()] = 2;
            ...
            try {
                f35861a[EnumC10275o.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f35861a[EnumC10275o.FIRED.ordinal()] = 3;
    ...
    public static final class C11192b {
        public static final Pattern f35863c = Pattern.compile("^(\\d{2}):(\\d{2}):(\\d{2})$");
        public static final Pattern f35864d = Pattern.compile("^(\\d{4}):(\\d{2}):(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");
        public static final Pattern f35865e = Pattern.compile("^(\\d{4})-(\\d{2})-(\\d{2})\\s(\\d{2}):(\\d{2}):(\\d{2})$");
        public static final List<HashMap<String, C11199i>> f35866f = Collections.list(new C11193a());
        public final List<Map<String, C11189f>> f35867a = Collections.list(new C11194b());
        public final ByteOrder f35868b;

        public class C11193a implements Enumeration<HashMap<String, C11199i>> {
            public int f35869a = 0;

            public HashMap<String, C11199i> nextElement() {
                C11199i[] iVarArr;
                HashMap<String, C11199i> hashMap = new HashMap<>();
                for (C11199i iVar : C11190g.f35857i[this.f35869a]) {
                    hashMap.put(iVar.f35885b, iVar);
                }
                this.f35869a++;
                return hashMap;
            }
            ...
            public boolean hasMoreElements() {
                return this.f35869a < C11190g.f35857i.length;
            }
        }

        public class C11194b implements Enumeration<Map<String, C11189f>> {
            public int f35870a = 0;
            ...
            @Override
            public boolean hasMoreElements() {
                return this.f35870a < C11190g.f35857i.length;
            }
        }

        public class C11195c implements Enumeration<Map<String, C11189f>> {
            public final Enumeration<Map<String, C11189f>> f35872a;

            public C11195c() {
                this.f35872a = Collections.enumeration(C11192b.this.f35867a);
            }

            public Map<String, C11189f> nextElement() {
                return new HashMap(this.f35872a.nextElement());
            }

            @Override
            public boolean hasMoreElements() {
                return this.f35872a.hasMoreElements();
            }
        }

        public C11192b(ByteOrder byteOrder) {
            this.f35868b = byteOrder;
        }
        ...
        public C11190g m1259a() {
            ...
            return new C11190g(this.f35868b, list);
        }

        public C11192b m1257c(String str, String str2) {
            m1255e(str, str2, this.f35867a);
            return this;
        }
        ...
        public C11192b m1253g(EnumC10275o oVar) {
            ...
            int i2 = C11191a.f35861a[oVar.ordinal()];
            if (i2 == 1) {
                i = 0;
            } else if (i2 == 2) {
                i = 32;
            } else if (i2 != 3) {
                C0662u1.m40643k("ExifData", "Unknown flash state: " + oVar);
                return this;
            } else {
                i = 1;
            }
        ...
        public C11192b m1247m(int i) {
            ...
            if (i == 0) {
                ...
                C0662u1.m40643k("ExifData", "Unexpected orientation value: " + i + ". Must be one of 0, 90, 180, 270.");
                i2 = 0;
            } else {
                i2 = 8;
            }
        ...
        public C11192b m1246n(EnumC11196c cVar) {
            String str;
            int i = C11191a.f35862b[cVar.ordinal()];
            if (i != 1) {
    ...
    static {
        ...
        f35856h = iVarArr4;
        f35857i = new C11199i[][]{iVarArr, iVarArr2, iVarArr3, iVarArr4};
    }

    public C11190g(ByteOrder byteOrder, List<Map<String, C11189f>> list) {
        C1132h.m38319h(list.size() == f35857i.length, "Malformed attributes list. Number of IFDs mismatch.");
        this.f35860b = byteOrder;
        this.f35859a = list;
    }
    ...
    public Map<String, C11189f> m1261b(int i) {
        int length = f35857i.length;
        C1132h.m38324c(i, 0, length, "Invalid IFD index: " + i + ". Index should be between [0, EXIF_TAGS.length] ");
        return this.f35859a.get(i);
    }
