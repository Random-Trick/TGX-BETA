...
public final class C5041b implements Comparable<C5041b> {
    ...
    public static final C5041b f17051O = C5043c.m24198a();
    ...
    public C5041b(int i, int i2, int i3) {
        ...
        this.f17054b = i2;
        this.f17055c = i3;
        this.f17052M = m24199b(i, i2, i3);
    }

    public int compareTo(C5041b bVar) {
        C8298k.m12934e(bVar, "other");
        return this.f17052M - bVar.f17052M;
    }

    public final int m24199b(int r5, int r6, int r7) {
        throw new UnsupportedOperationException("Method not decompiled: p107ha.C5041b.m24199b(int, int, int):int");
    }
