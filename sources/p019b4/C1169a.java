...
public final class C1169a implements AbstractC1178g {
    ...
    public final class C1171b implements AbstractC3470g {
        ...
        @Override
        public long mo1126d() {
            return C1169a.this.f4405d.m38212b(C1169a.this.f4407f);
        }
        ...
        public AbstractC3470g.C3471a mo1123i(long j) {
            return new AbstractC3470g.C3471a(new C8972r(j, C1216l0.m37957q((C1169a.this.f4403b + ((C1169a.this.f4405d.m38211c(j) * (C1169a.this.f4404c - C1169a.this.f4403b)) / C1169a.this.f4407f)) - 30000, C1169a.this.f4403b, C1169a.this.f4404c - 1)));
        }
    }

    public C1169a(AbstractC1180i iVar, long j, long j2, long j3, long j4, boolean z) {
        C1186a.m38192a(j >= 0 && j2 > j);
        this.f4405d = iVar;
        this.f4403b = j;
        this.f4404c = j2;
        if (j3 == j2 - j || z) {
    ...
    public void mo38202c(long j) {
        this.f4409h = C1216l0.m37957q(j, 0L, this.f4407f - 1);
        this.f4406e = 2;
    ...
    public final long m38236i(AbstractC8959g gVar) {
        if (this.f4410i == this.f4411j) {
            return -1L;
        }
        long r = gVar.mo6043r();
        if (!this.f4402a.m38216d(gVar, this.f4411j)) {
            long j = this.f4410i;
            if (j != r) {
                return j;
            }
        ...
        this.f4402a.m38219a(gVar, false);
        gVar.mo10808m();
        long j2 = this.f4409h;
        ...
        long j8 = this.f4411j;
        long j9 = this.f4410i;
        return C1216l0.m37957q((gVar.mo6043r() - j7) + ((j4 * (j8 - j9)) / (this.f4413l - this.f4412k)), j9, j8 - 1);
    }

    public long m38235j(AbstractC8959g gVar) {
        this.f4402a.m38218b();
        if (this.f4402a.m38217c(gVar)) {
            this.f4402a.m38219a(gVar, false);
            C1177f fVar = this.f4402a;
            gVar.mo10807n(fVar.f4438h + fVar.f4439i);
            long j = this.f4402a.f4433c;
            while (true) {
                C1177f fVar2 = this.f4402a;
                if ((fVar2.f4432b & 4) == 4 || !fVar2.m38217c(gVar) || gVar.mo6043r() >= this.f4404c || !this.f4402a.m38219a(gVar, true)) {
                    break;
                }
                C1177f fVar3 = this.f4402a;
                if (!C8962i.m10827e(gVar, fVar3.f4438h + fVar3.f4439i)) {
                    break;
                }
    ...
    public final void m38234k(AbstractC8959g gVar) {
        while (true) {
            this.f4402a.m38217c(gVar);
            this.f4402a.m38219a(gVar, false);
            C1177f fVar = this.f4402a;
