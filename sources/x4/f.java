...
public final class f {
    public static void a(Spannable spannable, int i10, int i11, g gVar, d dVar, Map<String, g> map, int i12) {
        ...
        if (j10 == 2) {
            ...
            if (!(d10 == null || (e10 = e(d10, map)) == null)) {
                if (e10.g() != 1 || e10.f(0).f26011b == null) {
                    s.f("TtmlRenderUtil", "Skipping rubyText node without exactly one text child.");
                } else {
                    String str = (String) l0.j(e10.f(0).f26011b);
                    g f11 = f(e10.f26015f, e10.l(), map);
                    int i16 = f11 != null ? f11.i() : -1;
                    if (i16 == -1 && (f10 = f(d10.f26015f, d10.l(), map)) != null) {
                        i16 = f10.i();
                    }
        ...
        if (gVar.n()) {
            c.a(spannable, new u4.a(), i10, i11, 33);
        }
        int f12 = gVar.f();
        if (f12 == 1) {
    ...
    public static d d(d dVar, Map<String, g> map) {
        while (dVar != null) {
            g f10 = f(dVar.f26015f, dVar.l(), map);
            if (f10 != null && f10.j() == 1) {
                return dVar;
            }
            dVar = dVar.f26019j;
    ...
    public static d e(d dVar, Map<String, g> map) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            g f10 = f(dVar2.f26015f, dVar2.l(), map);
            if (f10 != null && f10.j() == 3) {
                return dVar2;
            }
