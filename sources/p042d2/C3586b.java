...
public class C3586b extends AbstractC3585a {
    ...
    @Override
    public void mo29936A(byte[] bArr) {
        if (bArr != null) {
    ...
    @Override
    public void mo29935C(CharSequence charSequence) {
        TextUtils.writeToParcel(charSequence, this.f12221e, 0);
    }

    @Override
    public void mo29934E(int i) {
        this.f12221e.writeInt(i);
    }

    @Override
    public void mo29933G(Parcelable parcelable) {
        this.f12221e.writeParcelable(parcelable, 0);
    }

    @Override
    public void mo29932I(String str) {
        this.f12221e.writeString(str);
    }

    @Override
    public void mo29931a() {
        int i = this.f12225i;
        if (i >= 0) {
    ...
    @Override
    public AbstractC3585a mo29930b() {
    ...
    @Override
    public boolean mo29929g() {
        return this.f12221e.readInt() != 0;
    }

    @Override
    public byte[] mo29928i() {
    ...
    @Override
    public void mo29921y(boolean z) {
