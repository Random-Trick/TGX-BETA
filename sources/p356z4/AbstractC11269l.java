...
public abstract class AbstractC11269l extends AbstractC11280t {
    ...
    public static final class C11270a {
        ...
        public int m1014b(int i) {
            return this.f36122c[i];
        }

        public C7233t0 m1013c(int i) {
            return this.f36123d[i];
        }

        public int m1012d(int i, int i2, int i3) {
            return C6701t2.m19435c(this.f36125f[i][i2][i3]);
        }
    ...
    public static C6644l3 m1020f(AbstractC11271m[] mVarArr, C11270a aVar) {
        ...
        for (int i5 = 0; i5 < e.f23029a; i5++) {
            C7227r0 b2 = e.m17245b(i5);
            int[] iArr2 = new int[b2.f23023a];
            Arrays.fill(iArr2, 0);
            aVar2.m757d(new C6644l3.C6645a(b2, iArr2, C1234w.m37863h(b2.m17272b(0).f20575U), new boolean[b2.f23023a]));
        }
    ...
    public static int m1019g(AbstractC6705u2[] u2VarArr, C7227r0 r0Var, int[] iArr, boolean z) {
        ...
        for (int i2 = 0; i2 < u2VarArr.length; i2++) {
            ...
            for (int i4 = 0; i4 < r0Var.f23023a; i4++) {
                i3 = Math.max(i3, C6701t2.m19435c(u2Var.mo11839a(r0Var.m17272b(i4))));
            }
    ...
    public static int[] m1018h(AbstractC6705u2 u2Var, C7227r0 r0Var) {
        int[] iArr = new int[r0Var.f23023a];
        for (int i = 0; i < r0Var.f23023a; i++) {
            iArr[i] = u2Var.mo11839a(r0Var.m17272b(i));
        }
        return iArr;
    }
    ...
    public final C11282u mo959e(AbstractC6705u2[] u2VarArr, C7233t0 t0Var, AbstractC7230t.C7231a aVar, AbstractC6604g3 g3Var) {
        ...
        for (int i4 = 0; i4 < t0Var.f23029a; i4++) {
            ...
            int g = m1019g(u2VarArr, b, iArr2, C1234w.m37863h(b.m17272b(0).f20575U) == 5);
            if (g == u2VarArr.length) {
                iArr = new int[b.f23023a];
            } else {
        ...
        for (int i6 = 0; i6 < u2VarArr.length; i6++) {
            int i7 = iArr2[i6];
            t0VarArr[i6] = new C7233t0((C7227r0[]) C1216l0.m37945u0(r0VarArr[i6], i7));
            iArr3[i6] = (int[][]) C1216l0.m37945u0(iArr3[i6], i7);
            strArr[i6] = u2VarArr[i6].mo11838b();
            iArr4[i6] = u2VarArr[i6].mo19431k();
        }
        C11270a aVar2 = new C11270a(strArr, iArr4, t0VarArr, i3, iArr3, new C7233t0((C7227r0[]) C1216l0.m37945u0(r0VarArr[u2VarArr.length], iArr2[u2VarArr.length])));
