...
public final class a {
    public static final ThreadLocal<double[]> f22832a = new ThreadLocal<>();
    ...
    public static int l(int i10, int i11, int i12, int i13, int i14) {
        if (i14 == 0) {
            return 0;
        }
    ...
    public static double[] o() {
        ThreadLocal<double[]> threadLocal = f22832a;
