...
public abstract class AbstractC11374k {
    public static final AbstractC11374k f36329a = new C11375a();
    public static final AbstractC11374k f36330b = new C11376b(-1);
    public static final AbstractC11374k f36331c = new C11376b(1);
    ...
    public static class C11375a extends AbstractC11374k {
        ...
        public AbstractC11374k mo800d(int i, int i2) {
            return m801k(C0199c.m42104e(i, i2));
        }

        @Override
        public AbstractC11374k mo799e(long j, long j2) {
            return m801k(C0201d.m42096a(j, j2));
        }
        ...
        public AbstractC11374k mo797g(boolean z, boolean z2) {
            return m801k(C0197a.m42110a(z, z2));
        }

        @Override
        public AbstractC11374k mo796h(boolean z, boolean z2) {
            return m801k(C0197a.m42110a(z2, z));
        }
        ...
        public AbstractC11374k m801k(int i) {
            if (i < 0) {
                return AbstractC11374k.f36330b;
            }
            return i > 0 ? AbstractC11374k.f36331c : AbstractC11374k.f36329a;
        }
    }
