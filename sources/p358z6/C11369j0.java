...
public final class C11369j0<K, V> extends AbstractC11401r<K, V> {
    public static final AbstractC11401r<Object, Object> f36315Q = new C11369j0(null, new Object[0], 0);
    public final transient int[] f36316N;
    public final transient Object[] f36317O;
    public final transient int f36318P;

    public static class C11370a<K, V> extends AbstractC11404s<Map.Entry<K, V>> {
        public final transient Object[] f36319M;
        public final transient int f36320N;
        public final transient int f36321O;
        public final transient AbstractC11401r<K, V> f36322c;
        ...
        public class C11371a extends AbstractC11396q<Map.Entry<K, V>> {
            ...
            public Map.Entry<K, V> get(int i) {
                C10433i.m5131g(i, C11370a.this.f36321O);
                int i2 = i * 2;
                return new AbstractMap.SimpleImmutableEntry(C11370a.this.f36319M[C11370a.this.f36320N + i2], C11370a.this.f36319M[i2 + (C11370a.this.f36320N ^ 1)]);
            }

            @Override
            public int size() {
                return C11370a.this.f36321O;
            }
        ...
        public boolean contains(Object obj) {
            ...
            return value != null && value.equals(this.f36322c.get(key));
        }
    ...
    public static final class C11372b<K> extends AbstractC11404s<K> {
        public final transient AbstractC11396q<K> f36324M;
        public final transient AbstractC11401r<K, ?> f36325c;
        ...
        public boolean contains(@NullableDecl Object obj) {
            return this.f36325c.get(obj) != null;
        }
    ...
    public static final class C11373c extends AbstractC11396q<Object> {
        public final transient int f36326M;
        public final transient int f36327N;
        public final transient Object[] f36328c;
        ...
        public Object get(int i) {
            C10433i.m5131g(i, this.f36327N);
            return this.f36328c[(i * 2) + this.f36326M];
        }
    ...
    public AbstractC11404s<Map.Entry<K, V>> mo746d() {
        return new C11370a(this, this.f36317O, 0, this.f36318P);
    }

    @Override
    public AbstractC11404s<K> mo745e() {
        return new C11372b(this, new C11373c(this.f36317O, 0, this.f36318P));
    }

    @Override
    public AbstractC11384o<V> mo744f() {
        return new C11373c(this.f36317O, 1, this.f36318P);
    }

    @Override
    @NullableDecl
    public V get(@NullableDecl Object obj) {
        return (V) m810n(this.f36316N, this.f36317O, this.f36318P, 0, obj);
    }
