...
public final class C11381m0<T> extends AbstractC11362g0<T> implements Serializable {
    public final AbstractC11362g0<? super T> f36340a;

    public C11381m0(AbstractC11362g0<? super T> g0Var) {
        this.f36340a = (AbstractC11362g0) C10433i.m5129i(g0Var);
    }

    @Override
    public int compare(T t, T t2) {
        return this.f36340a.compare(t2, t);
    }

    @Override
    public <S extends T> AbstractC11362g0<S> mo788d() {
        return (AbstractC11362g0<? super T>) this.f36340a;
    }
    ...
    public boolean equals(@NullableDecl Object obj) {
        ...
        if (obj instanceof C11381m0) {
            return this.f36340a.equals(((C11381m0) obj).f36340a);
        }
        return false;
    }
