...
public final class C1311d {
    ...
    public final C4552h m37779a(C4552h hVar) {
        C8298k.m12933e(hVar, "name");
        int r = hVar.m27406r();
        for (int i = 0; i < r; i++) {
            byte b = (byte) 65;
            byte b2 = (byte) 90;
            byte d = hVar.m27414d(i);
            if (b <= d && b2 >= d) {
                throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + hVar.m27404u());
            }
        }
        return hVar;
    }

    public final Map<C4552h, Integer> m37778b() {
        return f4733b;
    }

    public final C1309c[] m37777c() {
        return f4732a;
    }

    public final Map<C4552h, Integer> m37776d() {
        ...
        C8298k.m12934d(unmodifiableMap, "Collections.unmodifiableMap(result)");
    ...
    public static final class C1312a {
        ...
        public C1312a(AbstractC4537a0 a0Var, int i, int i2) {
            ...
            this.f4736b = C4560o.m27380b(a0Var);
            C1309c[] cVarArr = new C1309c[8];
            this.f4737c = cVarArr;
            this.f4738d = cVarArr.length - 1;
        }

        public final void m37775a() {
            int i = this.f4742h;
            int i2 = this.f4740f;
            if (i >= i2) {
                return;
        ...
        public final void m37774b() {
            C5294h.m23427j(this.f4737c, null, 0, 0, 6, null);
            this.f4738d = this.f4737c.length - 1;
            this.f4739e = 0;
            this.f4740f = 0;
        }

        public final int m37773c(int i) {
            return this.f4738d + 1 + i;
        }

        public final int m37772d(int i) {
            int i2;
            int i3 = 0;
            if (i > 0) {
        ...
        public final List<C1309c> m37771e() {
            List<C1309c> S = C5312v.m23330S(this.f4735a);
            this.f4735a.clear();
            return S;
        }

        public final C4552h m37770f(int i) {
            if (m37768h(i)) {
                return C1311d.f4734c.m37777c()[i].f4730b;
            }
            int c = m37773c(i - C1311d.f4734c.m37777c().length);
            if (c >= 0) {
                C1309c[] cVarArr = this.f4737c;
                if (c < cVarArr.length) {
        ...
        public final void m37769g(int i, C1309c cVar) {
            this.f4735a.add(cVar);
            int i2 = cVar.f4729a;
            if (i != -1) {
                C1309c cVar2 = this.f4737c[m37773c(i)];
                C8298k.m12935c(cVar2);
                i2 -= cVar2.f4729a;
            }
            int i3 = this.f4742h;
            if (i2 > i3) {
            ...
            int d = m37772d((this.f4740f + i2) - i3);
            if (i == -1) {
                ...
                this.f4737c[i + m37773c(i) + d] = cVar;
            }
            this.f4740f += i2;
        }

        public final boolean m37768h(int i) {
            return i >= 0 && i <= C1311d.f4734c.m37777c().length - 1;
        }

        public final int m37767i() {
            return C9489b.m8522b(this.f4736b.readByte(), 255);
        }

        public final C4552h m37766j() {
            int i = m37767i();
            boolean z = (i & Log.TAG_YOUTUBE) == 128;
            long m = m37763m(i, 127);
            if (!z) {
                return this.f4736b.mo27332o(m);
            }
            C4549e eVar = new C4549e();
            C1347k.f4926d.m37585b(this.f4736b, m, eVar);
            return eVar.m27440J0();
        }

        public final void m37765k() {
            while (!this.f4736b.mo27341B()) {
                int b = C9489b.m8522b(this.f4736b.readByte(), 255);
                if (b == 128) {
                    throw new IOException("index == 0");
                } else if ((b & Log.TAG_YOUTUBE) == 128) {
                    m37764l(m37763m(b, 127) - 1);
                } else if (b == 64) {
                    m37761o();
                } else if ((b & 64) == 64) {
                    m37762n(m37763m(b, 63) - 1);
                } else if ((b & 32) == 32) {
                    int m = m37763m(b, 31);
                    this.f4742h = m;
                    ...
                    m37760p(m37763m(b, 15) - 1);
                }
            }
        }

        public final void m37764l(int i) {
            if (m37768h(i)) {
                this.f4735a.add(C1311d.f4734c.m37777c()[i]);
                return;
            }
            int c = m37773c(i - C1311d.f4734c.m37777c().length);
            if (c >= 0) {
        ...
        public final int m37763m(int i, int i2) {
            int i3 = i & i2;
            if (i3 < i2) {
                return i3;
            }
        ...
        public final void m37762n(int i) {
            m37769g(-1, new C1309c(m37770f(i), m37766j()));
        }

        public final void m37761o() {
            m37769g(-1, new C1309c(C1311d.f4734c.m37779a(m37766j()), m37766j()));
        }

        public final void m37760p(int i) {
            this.f4735a.add(new C1309c(m37770f(i), m37766j()));
        }

        public final void m37759q() {
            this.f4735a.add(new C1309c(C1311d.f4734c.m37779a(m37766j()), m37766j()));
        }
    ...
    public static final class C1313b {
        ...
        public final void m37757b() {
            C5294h.m23427j(this.f4746d, null, 0, 0, 6, null);
            this.f4747e = this.f4746d.length - 1;
            this.f4748f = 0;
            this.f4749g = 0;
        }

        public final int m37756c(int i) {
            int i2;
            int i3 = 0;
            if (i > 0) {
        ...
        public final void m37755d(C1309c cVar) {
            int i = cVar.f4729a;
            int i2 = this.f4745c;
            if (i > i2) {
                m37757b();
        ...
        public final void m37754e(int i) {
            this.f4750h = i;
        ...
        public final void m37753f(C4552h hVar) {
            C8298k.m12933e(hVar, "data");
            if (this.f4751i) {
                C1347k kVar = C1347k.f4926d;
                if (kVar.m37583d(hVar) < hVar.m27406r()) {
                    C4549e eVar = new C4549e();
                    kVar.m37584c(hVar, eVar);
                    C4552h J0 = eVar.m27440J0();
                    m37751h(J0.m27406r(), 127, Log.TAG_YOUTUBE);
                    this.f4752j.mo27347k0(J0);
                    return;
                }
            }
            m37751h(hVar.m27406r(), 127, 0);
            this.f4752j.mo27347k0(hVar);
        }

        public final void m37752g(java.util.List<p025bc.C1309c> r14) {
            throw new UnsupportedOperationException("Method not decompiled: p025bc.C1311d.C1313b.m37752g(java.util.List):void");
        }

        public final void m37751h(int i, int i2, int i3) {
            if (i < i2) {
                this.f4752j.mo27351C(i | i3);
                return;
            }
            this.f4752j.mo27351C(i3 | i2);
            int i4 = i - i2;
            while (i4 >= 128) {
                this.f4752j.mo27351C(128 | (i4 & 127));
                i4 >>>= 7;
            }
            this.f4752j.mo27351C(i4);
        }
