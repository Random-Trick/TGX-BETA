...
public final class C10147u {
    public static Map<String, String> m5900a(Locale locale) {
        ...
        m5899b(hashMap, locale.getLanguage());
        ...
        sb2.append("_");
        sb2.append(valueOf2);
        m5899b(hashMap, sb2.toString());
        return hashMap;
    }

    public static void m5899b(Map<String, String> map, String str) {
        if ("af".equals(str)) {
