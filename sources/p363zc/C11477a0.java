...
public class C11477a0 {
    ...
    public class C11478a implements AbstractC5117h0 {
        public final Runnable f36458a;
        public final Runnable f36459b;
        public final AbstractC9323v4 f36460c;

        public C11478a(Runnable runnable, Runnable runnable2, AbstractC9323v4 v4Var) {
            this.f36458a = runnable;
            this.f36459b = runnable2;
            this.f36460c = v4Var;
        }
        ...
        public boolean mo493A3(View view, int i) {
            ...
            if (id2 == R.id.btn_cancel) {
                ...
                this.f36459b.run();
                this.f36460c.mo4348c().m2485dd().m3858E7(this.f36460c, C4403w.m27821u1(R.string.url_privacyPolicy, new Object[0]), new HandlerC10770jj.C10788q().m3322i());
                return true;
            }
        }
    ...
    public static void m499c(C6924j2 j2Var, int i) {
        if (j2Var.getChildAt(1) instanceof C9319v1) {
            ...
            imageView.setColorFilter(C1410y.m37001z(C11524j.m228N(R.id.theme_color_fillingPositiveContent)));
            imageView.setLayoutParams(new LinearLayout.LayoutParams(-1, C1357a0.m37541i(132.0f)));
    ...
    public static void m496f(AbstractView$OnTouchListenerC7889a aVar, CharSequence charSequence, CharSequence charSequence2, Runnable runnable, Runnable runnable2) {
        CharSequence h1 = C4403w.m27873h1(R.string.format_doubleLines, C11506y.f36522a, charSequence, charSequence2);
        AbstractC9323v4<?> F = aVar.m14552P1().m9763F();
        if (F == null) {
            runnable2.run();
        } else {
            m499c(F.m9261ee(h1, new int[]{R.id.btn_done, R.id.btn_privacyPolicy, R.id.btn_cancel}, new String[]{C4403w.m27869i1(R.string.Continue), C4403w.m27869i1(R.string.PrivacyPolicy), C4403w.m27869i1(R.string.Cancel)}, new int[]{3, 1, 1}, new int[]{R.drawable.baseline_check_circle_24, R.drawable.baseline_policy_24, R.drawable.baseline_cancel_24}, new C11478a(runnable2, runnable, F)), R.drawable.baseline_location_on_48);
        }
    }

    public static void m495g(AbstractView$OnTouchListenerC7889a aVar, String str, Runnable runnable, Runnable runnable2) {
        String str2 = "@" + str;
        m496f(aVar, C4403w.m27853m1(R.string.LocationAlertBot, str2), C4403w.m27853m1(R.string.LocationAlertBotDisclaimer, str2), runnable, runnable2);
    }

    public static void m494h(AbstractView$OnTouchListenerC7889a aVar, boolean z, Runnable runnable, Runnable runnable2) {
        boolean z2 = true;
        boolean z3 = aVar.m14467m0(z) != 0;
        ...
        if (z2) {
            String i1 = C4403w.m27869i1(z ? R.string.LocationAlertLiveLocation : R.string.LocationAlertLocation);
            String i12 = C4403w.m27869i1(R.string.LocationAlertLocationDisclaimer);
            if (!z) {
                runnable = RunnableC11507z.f36523a;
            }
