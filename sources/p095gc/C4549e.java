...
public final class C4549e implements AbstractC4551g, AbstractC4550f, Cloneable, ByteChannel {
    ...
    public final C4549e m27448B0() {
        C4549e eVar = new C4549e();
        if (size() != 0) {
            C4568v vVar = this.f14970a;
            C8298k.m12935c(vVar);
            C4568v d = vVar.m27323d();
            eVar.f14970a = d;
            d.f15010g = d;
            d.f15009f = d;
    ...
    public final C4549e m27447C0(C4549e eVar, long j, long j2) {
        C8298k.m12933e(eVar, "out");
        C4542c.m27477b(size(), j, j2);
        if (j2 != 0) {
    ...
    public final byte m27446D0(long j) {
        C4542c.m27477b(size(), j, 1L);
        C4568v vVar = this.f14970a;
        if (vVar == null) {
            C8298k.m12935c(null);
            throw null;
    ...
    public long m27445E0(byte b, long j, long j2) {
        C4568v vVar;
        int i;
        long j3 = 0;
        if (0 <= j && j2 >= j) {
    ...
    public long m27444F0(C4552h hVar) {
        C8298k.m12933e(hVar, "targetBytes");
        return m27443G0(hVar, 0L);
    }

    public long m27443G0(C4552h hVar, long j) {
        int i;
        int i2;
        C8298k.m12933e(hVar, "targetBytes");
        long j2 = 0;
        if (j >= 0) {
            ...
            if (size() - j < j) {
                ...
                if (hVar.m27406r() == 2) {
                    byte d = hVar.m27414d(0);
                    byte d2 = hVar.m27414d(1);
                    while (j2 < size()) {
                        byte[] bArr = vVar.f15004a;
            ...
            if (hVar.m27406r() == 2) {
                byte d3 = hVar.m27414d(0);
                byte d4 = hVar.m27414d(1);
                while (j2 < size()) {
    ...
    public String mo27340H(long j) {
        if (j >= 0) {
            ...
            byte b = (byte) 10;
            long E0 = m27445E0(b, 0L, j2);
            if (E0 != -1) {
                return C5072a.m24042b(this, E0);
            }
            if (j2 < size() && m27446D0(j2 - 1) == ((byte) 13) && m27446D0(j2) == b) {
                return C5072a.m24042b(this, j2);
            }
            C4549e eVar = new C4549e();
            m27447C0(eVar, 0L, Math.min(32, size()));
            throw new EOFException("\\n not found: limit=" + Math.min(size(), j) + " content=" + eVar.m27440J0().mo27314i() + (char) 8230);
        }
        throw new IllegalArgumentException(("limit < 0: " + j).toString());
    }

    public int m27442H0(byte[] bArr, int i, int i2) {
        C8298k.m12933e(bArr, "sink");
        ...
        byte[] bArr2 = vVar.f15004a;
        int i3 = vVar.f15005b;
        C5294h.m23433d(bArr2, bArr, i, i3, i3 + min);
        vVar.f15005b += min;
        m27433Q0(size() - min);
        if (vVar.f15005b != vVar.f15006c) {
            return min;
        }
        this.f14970a = vVar.m27325b();
        C4570w.m27319b(vVar);
        return min;
    }

    public byte[] m27441I0() {
        return mo27334g0(size());
    }

    public C4552h m27440J0() {
        return mo27332o(size());
    }

    public void m27439K0(byte[] bArr) {
        C8298k.m12933e(bArr, "sink");
        int i = 0;
        while (i < bArr.length) {
            int H0 = m27442H0(bArr, i, bArr.length - i);
            if (H0 != -1) {
                i += H0;
            } else {
                throw new EOFException();
    ...
    public int m27438L0() {
        return C4542c.m27476c(readInt());
    }

    public short m27437M0() {
        return C4542c.m27475d(readShort());
    }

    public String m27436N0(long j, Charset charset) {
        ...
        if (!(i >= 0 && j <= ((long) Integer.MAX_VALUE))) {
            ...
            if (i2 + j > vVar.f15006c) {
                return new String(mo27334g0(j), charset);
            }
            int i3 = (int) j;
    ...
    public String m27435O0() {
        return m27436N0(this.f14971b, C11436c.f36399b);
    }

    public String m27434P0(long j) {
        return m27436N0(j, C11436c.f36399b);
    }

    public final void m27433Q0(long j) {
        this.f14971b = j;
    }

    public final C4552h m27432R0() {
        if (size() <= ((long) Integer.MAX_VALUE)) {
            return m27431S0((int) size());
        }
        throw new IllegalStateException(("size > Int.MAX_VALUE: " + size()).toString());
    }

    public final C4552h m27431S0(int i) {
        if (i == 0) {
            return C4552h.f14972M;
        }
        C4542c.m27477b(size(), 0L, i);
        C4568v vVar = this.f14970a;
        int i2 = 0;
        int i3 = 0;
        int i4 = 0;
    ...
    public String mo27339T(Charset charset) {
        C8298k.m12933e(charset, "charset");
        return m27436N0(this.f14971b, charset);
    }

    public final C4568v m27430T0(int i) {
        boolean z = true;
        if (i < 1 || i > 8192) {
            z = false;
        }
        if (z) {
            ...
            C4568v vVar2 = vVar.f15010g;
            C8298k.m12935c(vVar2);
            return (vVar2.f15006c + i > 8192 || !vVar2.f15008e) ? vVar2.m27324c(C4570w.m27318c()) : vVar2;
        }
        throw new IllegalArgumentException("unexpected capacity".toString());
    }

    public C4549e mo27347k0(C4552h hVar) {
        C8298k.m12933e(hVar, "byteString");
        hVar.mo27308v(this, 0, hVar.m27406r());
        return this;
    }

    public C4549e mo27346l0(byte[] bArr) {
        C8298k.m12933e(bArr, "source");
        return mo27349U(bArr, 0, bArr.length);
    }

    public C4549e mo27349U(byte[] bArr, int i, int i2) {
        C8298k.m12933e(bArr, "source");
        long j = i2;
        C4542c.m27477b(bArr.length, i, j);
        int i3 = i2 + i;
        while (i < i3) {
            C4568v T0 = m27430T0(1);
            int min = Math.min(i3 - i, 8192 - T0.f15006c);
            int i4 = i + min;
            C5294h.m23433d(bArr, T0.f15004a, T0.f15006c, i, i4);
            T0.f15006c += min;
            i = i4;
        }
        m27433Q0(size() + j);
    ...
    public long m27426X0(AbstractC4537a0 a0Var) {
    ...
    public C4549e mo27348W(long j) {
        ...
        C4568v T0 = m27430T0(i);
        byte[] bArr = T0.f15004a;
        int i2 = T0.f15006c;
        for (int i3 = (i2 + i) - 1; i3 >= i2; i3--) {
            bArr[i3] = C5072a.m24043a()[(int) (15 & j)];
            j >>>= 4;
        }
        T0.f15006c += i;
        m27433Q0(size() + i);
    ...
    public C4549e mo27343w(int i) {
        C4568v T0 = m27430T0(4);
        byte[] bArr = T0.f15004a;
        int i2 = T0.f15006c;
        int i3 = i2 + 1;
    ...
    public C4549e mo27344r(int i) {
        C4568v T0 = m27430T0(2);
        byte[] bArr = T0.f15004a;
        int i2 = T0.f15006c;
        int i3 = i2 + 1;
    ...
    public C4549e m27421c1(String str, int i, int i2, Charset charset) {
        ...
        if (i >= 0) {
            if (i2 >= i) {
                ...
                if (!z) {
                ...
                } else if (C8298k.m12936b(charset, C11436c.f36399b)) {
                    return m27419e1(str, i, i2);
                } else {
                    ...
                    return mo27349U(bytes, 0, bytes.length);
                }
            } else {
    ...
    public C4549e mo27350O(String str) {
        C8298k.m12933e(str, "string");
        return m27419e1(str, 0, str.length());
    }
    ...
    public C4549e m27419e1(String str, int i, int i2) {
        C8298k.m12933e(str, "string");
        if (i >= 0) {
            if (i2 >= i) {
                if (i2 <= str.length()) {
    ...
    public C4549e m27418f1(int i) {
        if (i < 128) {
            ...
            throw new IllegalArgumentException("Unexpected code point: 0x" + C4542c.m27473f(i));
        }
        return this;
    }
        ...
        if (eVar != this) {
            ...
            while (j > 0) {
                ...
                if (j < i - vVar.f15005b) {
                    ...
                    if (vVar2 != null && vVar2.f15008e) {
                        if ((vVar2.f15006c + j) - (vVar2.f15007d ? 0 : vVar2.f15005b) <= ((long) Log.TAG_LUX)) {
                            ...
                            vVar5.m27321f(vVar2, (int) j);
                            eVar.m27433Q0(eVar.size() - j);
                            m27433Q0(size() + j);
                            return;
                        }
                    }
                    C4568v vVar6 = eVar.f14970a;
                    C8298k.m12935c(vVar6);
                    eVar.f14970a = vVar6.m27322e((int) j);
                }
                C4568v vVar7 = eVar.f14970a;
                C8298k.m12935c(vVar7);
                long j2 = vVar7.f15006c - vVar7.f15005b;
                eVar.f14970a = vVar7.m27325b();
                ...
                if (vVar8 == null) {
                    ...
                    C8298k.m12935c(vVar8);
                    C4568v vVar9 = vVar8.f15010g;
                    C8298k.m12935c(vVar9);
                    vVar9.m27324c(vVar7).m27326a();
                }
                eVar.m27433Q0(eVar.size() - j2);
                m27433Q0(size() + j2);
                j -= j2;
    ...
    public C4552h mo27332o(long j) {
        if (!(j >= 0 && j <= ((long) Integer.MAX_VALUE))) {
            ...
            return new C4552h(mo27334g0(j));
        } else {
            C4552h S0 = m27431S0((int) j);
            mo27337a0(j);
            return S0;
        }
    }
    ...
    public String toString() {
        return m27432R0().toString();
    }

    @Override
    public long mo27329v0() {
        throw new UnsupportedOperationException("Method not decompiled: p095gc.C4549e.mo27329v0():long");
    }
