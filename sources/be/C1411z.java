...
public final class C1411z {
    ...
    public static final Paint m36999a(Paint paint, int i) {
    ...
    public static final Paint m36998b(int i) {
        return m36996d(i, 0.0f, 2, null);
    }

    public static final Paint m36997c(int i, float f) {
        int i2;
        if (!(f == 1.0f)) {
            i2 = C5064d.m24131a(f, C11524j.m228N(i));
        } else {
            i2 = C11524j.m228N(i);
        }
        switch (i) {
            case R.id.theme_color_avatar_content:
                Paint paint = f5203k;
                if (paint != null) {
                    return m36999a(paint, i2);
                }
                Paint a = m36999a(paint, i2);
                f5203k = a;
                C8298k.m12936c(a);
                return a;
            case R.id.theme_color_background_icon:
                Paint paint2 = f5195c;
                if (paint2 != null) {
                    return m36999a(paint2, i2);
                }
                Paint a2 = m36999a(paint2, i2);
                f5195c = a2;
                C8298k.m12936c(a2);
                return a2;
            case R.id.theme_color_badgeFailedText:
                Paint paint3 = f5214v;
                if (paint3 != null) {
                    return m36999a(paint3, i2);
                }
                Paint a3 = m36999a(paint3, i2);
                f5214v = a3;
                C8298k.m12936c(a3);
                return a3;
            case R.id.theme_color_badgeMuted:
                Paint paint4 = f5215w;
                if (paint4 != null) {
                    return m36999a(paint4, i2);
                }
                Paint a4 = m36999a(paint4, i2);
                f5215w = a4;
                C8298k.m12936c(a4);
                return a4;
            case R.id.theme_color_badgeMutedText:
                Paint paint5 = f5216x;
                if (paint5 != null) {
                    return m36999a(paint5, i2);
                }
                Paint a5 = m36999a(paint5, i2);
                f5216x = a5;
                C8298k.m12936c(a5);
                return a5;
            case R.id.theme_color_badgeText:
                Paint paint6 = f5213u;
                if (paint6 != null) {
                    return m36999a(paint6, i2);
                }
                Paint a6 = m36999a(paint6, i2);
                f5213u = a6;
                C8298k.m12936c(a6);
                return a6;
            case R.id.theme_color_bubbleIn_time:
                Paint paint7 = f5181D;
                if (paint7 != null) {
                    return m36999a(paint7, i2);
                }
                Paint a7 = m36999a(paint7, i2);
                f5181D = a7;
                C8298k.m12936c(a7);
                return a7;
            case R.id.theme_color_bubbleOut_file:
                Paint paint8 = f5185H;
                if (paint8 != null) {
                    return m36999a(paint8, i2);
                }
                Paint a8 = m36999a(paint8, i2);
                f5185H = a8;
                C8298k.m12936c(a8);
                return a8;
            case R.id.theme_color_bubbleOut_inlineIcon:
                Paint paint9 = f5183F;
                if (paint9 != null) {
                    return m36999a(paint9, i2);
                }
                Paint a9 = m36999a(paint9, i2);
                f5183F = a9;
                C8298k.m12936c(a9);
                return a9;
            case R.id.theme_color_bubbleOut_messageAuthor:
                ...
                if (paint10 != null) {
                    return m36999a(paint10, i2);
                }
                Paint a10 = m36999a(paint10, i2);
                f5188K = a10;
                C8298k.m12936c(a10);
                return a10;
            case R.id.theme_color_bubbleOut_ticks:
                ...
                if (paint11 != null) {
                    return m36999a(paint11, i2);
                }
                Paint a11 = m36999a(paint11, i2);
                f5186I = a11;
                C8298k.m12936c(a11);
                return a11;
            case R.id.theme_color_bubbleOut_ticksRead:
                ...
                if (paint12 != null) {
                    return m36999a(paint12, i2);
                }
                Paint a12 = m36999a(paint12, i2);
                f5187J = a12;
                C8298k.m12936c(a12);
                return a12;
            case R.id.theme_color_bubbleOut_time:
                ...
                if (paint13 != null) {
                    return m36999a(paint13, i2);
                }
                Paint a13 = m36999a(paint13, i2);
                f5182E = a13;
                C8298k.m12936c(a13);
                return a13;
            case R.id.theme_color_bubbleOut_waveformActive:
                ...
                if (paint14 != null) {
                    return m36999a(paint14, i2);
                }
                Paint a14 = m36999a(paint14, i2);
                f5184G = a14;
                C8298k.m12936c(a14);
                return a14;
            case R.id.theme_color_bubble_mediaOverlayText:
                ...
                if (paint15 != null) {
                    return m36999a(paint15, i2);
                }
                Paint a15 = m36999a(paint15, i2);
                f5180C = a15;
                C8298k.m12936c(a15);
                return a15;
            case R.id.theme_color_bubble_mediaTimeText:
                ...
                if (paint16 != null) {
                    return m36999a(paint16, i2);
                }
                Paint a16 = m36999a(paint16, i2);
                f5178A = a16;
                C8298k.m12936c(a16);
                return a16;
            case R.id.theme_color_bubble_mediaTimeText_noWallpaper:
                ...
                if (paint17 != null) {
                    return m36999a(paint17, i2);
                }
                Paint a17 = m36999a(paint17, i2);
                f5179B = a17;
                C8298k.m12936c(a17);
                return a17;
            case R.id.theme_color_chatListIcon:
                ...
                if (paint18 != null) {
                    return m36999a(paint18, i2);
                }
                Paint a18 = m36999a(paint18, i2);
                f5211s = a18;
                C8298k.m12936c(a18);
                return a18;
            case R.id.theme_color_chatListMute:
                ...
                if (paint19 != null) {
                    return m36999a(paint19, i2);
                }
                Paint a19 = m36999a(paint19, i2);
                f5210r = a19;
                C8298k.m12936c(a19);
                return a19;
            case R.id.theme_color_chatListVerify:
                ...
                if (paint20 != null) {
                    return m36999a(paint20, i2);
                }
                Paint a20 = m36999a(paint20, i2);
                f5212t = a20;
                C8298k.m12936c(a20);
                return a20;
            case R.id.theme_color_chatSendButton:
                ...
                if (paint21 != null) {
                    return m36999a(paint21, i2);
                }
                Paint a21 = m36999a(paint21, i2);
                f5217y = a21;
                C8298k.m12936c(a21);
                return a21;
            case R.id.theme_color_file:
                ...
                if (paint22 != null) {
                    return m36999a(paint22, i2);
                }
                Paint a22 = m36999a(paint22, i2);
                f5189L = a22;
                C8298k.m12936c(a22);
                return a22;
            case R.id.theme_color_headerButtonIcon:
                ...
                if (paint23 != null) {
                    return m36999a(paint23, i2);
                }
                Paint a23 = m36999a(paint23, i2);
                f5206n = a23;
                C8298k.m12936c(a23);
                return a23;
            case R.id.theme_color_headerIcon:
                ...
                if (paint24 != null) {
                    return m36999a(paint24, i2);
                }
                Paint a24 = m36999a(paint24, i2);
                f5205m = a24;
                C8298k.m12936c(a24);
                return a24;
            case R.id.theme_color_headerText:
                ...
                if (paint25 != null) {
                    return m36999a(paint25, i2);
                }
                Paint a25 = m36999a(paint25, i2);
                f5204l = a25;
                C8298k.m12936c(a25);
                return a25;
            case R.id.theme_color_icon:
                ...
                if (paint26 != null) {
                    return m36999a(paint26, i2);
                }
                Paint a26 = m36999a(paint26, i2);
                f5196d = a26;
                C8298k.m12936c(a26);
                return a26;
            case R.id.theme_color_iconActive:
                ...
                if (paint27 != null) {
                    return m36999a(paint27, i2);
                }
                Paint a27 = m36999a(paint27, i2);
                f5197e = a27;
                C8298k.m12936c(a27);
                return a27;
            case R.id.theme_color_iconLight:
                ...
                if (paint28 != null) {
                    return m36999a(paint28, i2);
                }
                Paint a28 = m36999a(paint28, i2);
                f5198f = a28;
                C8298k.m12936c(a28);
                return a28;
            case R.id.theme_color_iconNegative:
                ...
                if (paint29 != null) {
                    return m36999a(paint29, i2);
                }
                Paint a29 = m36999a(paint29, i2);
                f5200h = a29;
                C8298k.m12936c(a29);
                return a29;
            case R.id.theme_color_iconPositive:
                ...
                if (paint30 != null) {
                    return m36999a(paint30, i2);
                }
                Paint a30 = m36999a(paint30, i2);
                f5199g = a30;
                C8298k.m12936c(a30);
                return a30;
            case R.id.theme_color_inlineIcon:
                ...
                if (paint31 != null) {
                    return m36999a(paint31, i2);
                }
                Paint a31 = m36999a(paint31, i2);
                f5201i = a31;
                C8298k.m12936c(a31);
                return a31;
            case R.id.theme_color_messageAuthor:
                ...
                if (paint32 != null) {
                    return m36999a(paint32, i2);
                }
                Paint a32 = m36999a(paint32, i2);
                f5218z = a32;
                C8298k.m12936c(a32);
                return a32;
            case R.id.theme_color_passcodeIcon:
                ...
                if (paint33 != null) {
                    return m36999a(paint33, i2);
                }
                Paint a33 = m36999a(paint33, i2);
                f5207o = a33;
                C8298k.m12936c(a33);
                return a33;
            case R.id.theme_color_playerCoverIcon:
                ...
                if (paint34 != null) {
                    return m36999a(paint34, i2);
                }
                Paint a34 = m36999a(paint34, i2);
                f5202j = a34;
                C8298k.m12936c(a34);
                return a34;
            case R.id.theme_color_textLight:
                ...
                if (paint35 != null) {
                    return m36999a(paint35, i2);
                }
                Paint a35 = m36999a(paint35, i2);
                f5193a = a35;
                C8298k.m12936c(a35);
                return a35;
            case R.id.theme_color_textSecure:
                ...
                if (paint36 != null) {
                    return m36999a(paint36, i2);
                }
                Paint a36 = m36999a(paint36, i2);
                f5194b = a36;
                C8298k.m12936c(a36);
                return a36;
            case R.id.theme_color_ticks:
                ...
                if (paint37 != null) {
                    return m36999a(paint37, i2);
                }
                Paint a37 = m36999a(paint37, i2);
                f5208p = a37;
                C8298k.m12936c(a37);
                return a37;
            case R.id.theme_color_ticksRead:
                ...
                if (paint38 != null) {
                    return m36999a(paint38, i2);
                }
                Paint a38 = m36999a(paint38, i2);
                f5209q = a38;
                C8298k.m12936c(a38);
                return a38;
            case R.id.theme_color_waveformActive:
                ...
                if (paint39 != null) {
                    return m36999a(paint39, i2);
                }
                Paint a39 = m36999a(paint39, i2);
                f5190M = a39;
                C8298k.m12936c(a39);
                return a39;
            case R.id.theme_color_waveformInactive:
                ...
                if (paint40 != null) {
                    return m36999a(paint40, i2);
                }
                Paint a40 = m36999a(paint40, i2);
                f5191N = a40;
                C8298k.m12936c(a40);
                return a40;
            case R.id.theme_color_white:
                ...
                if (paint41 != null) {
                    return m36999a(paint41, i2);
                }
                Paint a41 = m36999a(paint41, i2);
                f5192O = a41;
                C8298k.m12936c(a41);
                return a41;
            default:
    ...
    public static Paint m36996d(int i, float f, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            f = 1.0f;
        }
        return m36997c(i, f);
