...
public class C1367d0 {
    ...
    public final String[] m37406a(String str) {
        String[][] strArr;
    ...
    public String[] m37405b(String str) {
        String[][] strArr;
    ...
    public String[][] m37404c() {
        return this.f4984b;
    }

    public String[] m37403d() {
        String e = m37402e();
        if (e == null) {
            return null;
        }
    ...
    public String m37402e() {
        TelephonyManager telephonyManager = (TelephonyManager) C1379j0.m37309q().getSystemService("phone");
        if (telephonyManager == null) {
            return m37401f();
        }
        String simCountryIso = telephonyManager.getSimCountryIso();
        if (C5070i.m24061i(simCountryIso)) {
            return m37401f();
        }
        return simCountryIso.toUpperCase();
    }

    public String m37401f() {
    ...
    public String[] m37400g(C10930q6 q6Var) {
        String line1Number;
        String[] a;
        try {
            if (q6Var.m2332n6()) {
                ...
                return new String[]{P1, C1363c0.m37410w("+" + P1 + Q1).substring(P1.length() + 1)};
            }
            ...
            if (telephonyManager != null && Build.VERSION.SDK_INT < 23 && (line1Number = telephonyManager.getLine1Number()) != null && !line1Number.isEmpty()) {
                String D = C1363c0.m37470D(line1Number);
                if (!D.isEmpty() && (a = m37406a(telephonyManager.getSimCountryIso())) != null) {
