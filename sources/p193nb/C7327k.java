...
public final class C7327k {
    ...
    public static final class C7328a<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            return C5906a.m21862a(Integer.valueOf(((TdApi.TextEntity) t).offset), Integer.valueOf(((TdApi.TextEntity) t2).offset));
        }
    }
    ...
    public static final class C7330c<T> implements Comparator {
        public final TdApi.ChatList f23234a;

        public C7330c(TdApi.ChatList chatList) {
            this.f23234a = chatList;
        }

        @Override
        public final int compare(T t, T t2) {
            return C5906a.m21862a(Long.valueOf(C7317b.m17042b((TdApi.Chat) t2, this.f23234a)), Long.valueOf(C7317b.m17042b((TdApi.Chat) t, this.f23234a)));
        }
    }

    public static final class C7331d<T> implements Comparator {
        public final TdApi.ChatList f23235a;

        public C7331d(TdApi.ChatList chatList) {
            this.f23235a = chatList;
        }

        @Override
        public final int compare(T t, T t2) {
            return C5906a.m21862a(Long.valueOf(C7317b.m17042b((TdApi.Chat) t2, this.f23235a)), Long.valueOf(C7317b.m17042b((TdApi.Chat) t, this.f23235a)));
        }
    }
    ...
    public static final class C7332e<T> implements Comparator {
        @Override
        public final int compare(T t, T t2) {
            return C5906a.m21862a(Boolean.valueOf(((TdApi.Session) t2).isCurrent), Boolean.valueOf(((TdApi.Session) t).isCurrent));
        }
    }
    ...
    public static final class C7333f<T> implements Comparator {
        @Override
        public final int compare(T t, T t2) {
            return C5906a.m21862a(Boolean.valueOf(C7321e.m16953e1((TdApi.LanguagePackInfo) t2)), Boolean.valueOf(C7321e.m16953e1((TdApi.LanguagePackInfo) t)));
        }
    }

    public static final class C7334g<T> implements Comparator {
        public final Comparator f23236a;

        public C7334g(Comparator comparator) {
            this.f23236a = comparator;
        }

        @Override
        public final int compare(T t, T t2) {
            int compare = this.f23236a.compare(t, t2);
            return compare != 0 ? compare : C5906a.m21862a(Boolean.valueOf(((TdApi.LanguagePackInfo) t).isBeta), Boolean.valueOf(((TdApi.LanguagePackInfo) t2).isBeta));
        }
    }

    public static final class C7335h<T> implements Comparator {
        public final Comparator f23237a;

        public C7335h(Comparator comparator) {
            this.f23237a = comparator;
        }

        @Override
        public final int compare(T t, T t2) {
            int compare = this.f23237a.compare(t, t2);
            return compare != 0 ? compare : C5906a.m21862a(Long.valueOf(((TdApi.Chat) t2).f25367id), Long.valueOf(((TdApi.Chat) t).f25367id));
        }
    }

    public static final class C7336i<T> implements Comparator {
        public final Comparator f23238a;

        public C7336i(Comparator comparator) {
            this.f23238a = comparator;
        }

        @Override
        public final int compare(T t, T t2) {
            int compare = this.f23238a.compare(t, t2);
            return compare != 0 ? compare : C5906a.m21862a(Long.valueOf(((TdApi.Chat) t2).f25367id), Long.valueOf(((TdApi.Chat) t).f25367id));
        }
    }
    ...
    public static final class C7337j<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            return compare != 0 ? compare : C5906a.m21862a(Integer.valueOf(((TdApi.TextEntity) t2).length), Integer.valueOf(((TdApi.TextEntity) t).length));
        }
    }
    ...
    public static final class C7339l<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            return compare != 0 ? compare : C5906a.m21862a(Boolean.valueOf(((TdApi.Session) t2).isPasswordPending), Boolean.valueOf(((TdApi.Session) t).isPasswordPending));
        }
    }
    ...
    public static final class C7340m<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            return compare != 0 ? compare : C5906a.m21862a(Integer.valueOf(((TdApi.Session) t2).lastActiveDate), Integer.valueOf(((TdApi.Session) t).lastActiveDate));
        }
    }
    ...
    public static final class C7341n<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            return compare != 0 ? compare : C5906a.m21862a(Boolean.valueOf(((TdApi.LanguagePackInfo) t2).isOfficial), Boolean.valueOf(((TdApi.LanguagePackInfo) t).isOfficial));
        }
    }
    ...
    public static final class C7342o<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            boolean z = true;
            Boolean valueOf = Boolean.valueOf(!C7321e.m16953e1(languagePackInfo) && C8298k.m12937b(this.f23245b, languagePackInfo.f25405id));
            TdApi.LanguagePackInfo languagePackInfo2 = (TdApi.LanguagePackInfo) t;
            if (C7321e.m16953e1(languagePackInfo2) || !C8298k.m12937b(this.f23245b, languagePackInfo2.f25405id)) {
                z = false;
            }
            return C5906a.m21862a(valueOf, Boolean.valueOf(z));
        }
    }
    ...
    public static final class C7343p<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            C8298k.m12936c(messageInteractionInfo);
            ...
            C8298k.m12936c(messageInteractionInfo2);
            return C5906a.m21862a(valueOf, Integer.valueOf(messageInteractionInfo2.viewCount));
        }
    }
    ...
    public static final class C7344q<T> implements Comparator {
        ...
        public final int compare(T t, T t2) {
            ...
            TdApi.MessageInteractionInfo messageInteractionInfo2 = ((TdApi.Message) t).interactionInfo;
            C8298k.m12936c(messageInteractionInfo2);
            return C5906a.m21862a(valueOf, Integer.valueOf(messageInteractionInfo2.forwardCount));
        }
    }

    public static final void m16816a(List<TdApi.TextEntity> list) {
        C8298k.m12934e(list, "<this>");
        C5308r.m23355q(list, new C7338k(new C7329b()));
    }

    public static final void m16815b(List<TdApi.Chat> list, TdApi.ChatList chatList) {
        C8298k.m12934e(list, "<this>");
        C5308r.m23355q(list, new C7336i(new C7331d(chatList)));
    }

    public static final void m16814c(TdApi.Chat[] chatArr, TdApi.ChatList chatList) {
        C8298k.m12934e(chatArr, "<this>");
        C5294h.m23424l(chatArr, new C7335h(new C7330c(chatList)));
    }

    public static final void m16813d(TdApi.LanguagePackInfo[] languagePackInfoArr, String str) {
        C8298k.m12934e(languagePackInfoArr, "<this>");
        C8298k.m12934e(str, "activeLanguagePackId");
        C5294h.m23424l(languagePackInfoArr, new C7342o(new C7341n(new C7334g(new C7333f())), str));
    }

    public static final void m16812e(TdApi.Session[] sessionArr) {
        C8298k.m12934e(sessionArr, "<this>");
        C5294h.m23424l(sessionArr, new C7340m(new C7339l(new C7332e())));
    }

    public static final void m16811f(TdApi.TextEntity[] textEntityArr) {
        C8298k.m12934e(textEntityArr, "<this>");
        C5294h.m23424l(textEntityArr, new C7337j(new C7328a()));
    }
    ...
    public static final List<TdApi.Message> m16810g(List<TdApi.Message> list) {
        ...
        return C5312v.m23333O(arrayList, new C7344q(new C7343p()));
    }
}
