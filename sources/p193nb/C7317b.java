...
public final class C7317b {
    public static final TdApi.ChatListMain f23224a = new TdApi.ChatListMain();
    public static final TdApi.ChatListArchive f23225b = new TdApi.ChatListArchive();
    ...
    public static final TdApi.ChatPosition m17043a(TdApi.Chat chat, TdApi.ChatList chatList) {
        ...
        C8298k.m12935d(chatPositionArr, "positions");
        return (TdApi.ChatPosition) C5296i.m23387t(chatPositionArr, m17039e(chatPositionArr, chatList, 0, 4, null));
    }
    ...
    public static final int m17040d(TdApi.ChatPosition[] chatPositionArr, TdApi.ChatList chatList, int i) {
        ...
        if (i >= 0 && i < chatPositionArr.length) {
            if (C7321e.m17015C(chatPositionArr[i].list, chatList == null ? f23224a : chatList)) {
                return i;
            }
        }
        ...
        while (i2 < length) {
            i2++;
            if (C7321e.m17015C(chatPositionArr[i2].list, chatList == null ? f23224a : chatList)) {
                return i2;
            }
        }
        return -1;
