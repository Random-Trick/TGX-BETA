...
public class C9494a1 extends View$OnClickListenerC6902i implements AbstractC6828a, AbstractC5911c, AbstractC10747j0, AbstractC10748j1, C11059v7.AbstractC11068i, C11052v1.AbstractC11053a {
    public TdApi.Message f30733l0;
    public String f30734m0;
    public boolean f30735n0;
    public boolean f30736o0;
    public C4779t2.C4783d f30737p0;
    public final C3965r<RunnableC5390g> f30738q0;
    public final C3965r<C9497c> f30739r0;
    public final C3965r<C9496b> f30740s0;
    public int f30742u0;
    public int f30743v0;
    public boolean f30744w0;
    public final AbstractC4345j f30732k0 = new C4343h(this);
    public float f30741t0 = -1.0f;
    ...
    public static class C9495a<T extends C3955n.AbstractC3959d> implements C3955n.AbstractC3959d {
        ...
        public final int mo7991d(boolean z) {
            return this.f30745a.mo7991d(z);
        }

        @Override
        public final int mo7990g(boolean z) {
            return this.f30745a.mo7990g(z);
        }

        @Override
        public final int getHeight() {
            return this.f30745a.getHeight();
        }

        @Override
        public final int getWidth() {
            return this.f30745a.getWidth();
        }
    }

    public static class C9496b extends C9495a<AbstractC9622o0> implements AbstractC5911c {
        public final C6238b f30746b;
    ...
    public C9494a1(Context context, C10930q6 q6Var) {
        ...
        this.f30738q0 = new C3965r<>(r0Var, decelerateInterpolator, 180L);
        this.f30739r0 = new C3965r<>(new C3965r.AbstractC3966a() {
            @Override
            public final void mo7848a(C3965r rVar) {
                C9494a1.this.m8468u1(rVar);
            }
        }, decelerateInterpolator, 180L);
        this.f30740s0 = new C3965r<>(new C3965r.AbstractC3966a() {
            @Override
            public final void mo7848a(C3965r rVar) {
                C9494a1.this.m8467v1(rVar);
            }
        }, decelerateInterpolator, 180L);
        setLayoutParams(new ViewGroup.LayoutParams(-1, C2139ap.m35479W(C3563j.f11957L0)));
        C10189d.m5794j(this);
        C11052v1.m1768b().m1769a(this);
    }

    public void m8494B1(long j, long j2, TdApi.MessageContent messageContent) {
        TdApi.Message message = this.f30733l0;
    ...
    public void m8492C1(TdApi.User user) {
        TdApi.Message message = this.f30733l0;
        if (message != null && message.senderId.getConstructor() == -336109341 && ((TdApi.MessageSenderUser) this.f30733l0.senderId).userId == user.f25439id) {
            m8485I1();
        }
    }

    private TdApi.FormattedText getContentText() {
        C4779t2.C4783d dVar = this.f30737p0;
        if (dVar != null) {
            return dVar.m25376b(true);
        }
        return null;
    }

    private float getLinePadding() {
        float f = this.f30741t0;
        if (f != -1.0f) {
            return f;
        }
        return 6.0f;
    ...
    private int getTextHorizontalOffset() {
        return ((int) (this.f30740s0.m29465r().m29475k() + (this.f30740s0.m29465r().m29474l() * C1357a0.m37541i(8.0f)))) + C1357a0.m37541i(getLinePadding());
    }

    private String getTitle() {
        if (!C5070i.m24061i(this.f30734m0)) {
            return this.f30734m0;
        }
        TdApi.Message message = this.f30733l0;
        if (message != null) {
            return this.f21820b.m2167xb(message, true, false);
        }
        return null;
    }
    ...
    public static int m8472o1(int i, int i2, int i3, int i4) {
        if (i == 0) {
            return C1357a0.m37541i(2.0f) + C1357a0.m37541i(18.0f);
        }
        return 0;
    }

    public void m8471q1(C4779t2.C4783d dVar, C4779t2.C4783d dVar2) {
        if (this.f30737p0 == dVar) {
            this.f30737p0 = dVar2;
            m8486H1();
            m8477d1(true);
        }
    ...
    public void m8470r1(long j, long j2, final C4779t2.C4783d dVar, final C4779t2.C4783d dVar2) {
        this.f21820b.m2549Za(new Runnable() {
            @Override
    ...
    public void m8466z1(long j) {
        TdApi.Message message = this.f30733l0;
        if (message != null && message.senderId.getConstructor() == -239660751 && ((TdApi.MessageSenderChat) this.f30733l0.senderId).chatId == j) {
            m8485I1();
        }
    }
    ...
    public void m8490E1(TdApi.Message message, TdApi.SearchMessagesFilter searchMessagesFilter, String str, boolean z) {
        this.f30735n0 = z;
        TdApi.Message message2 = this.f30733l0;
        if (message2 == message) {
            setForcedTitle(str);
            return;
        }
        ...
        this.f30733l0 = message;
        this.f30734m0 = str;
        if (message != null) {
            m8488F1(message);
            m8476e1();
            m18493w0(null, message.chatId, null, new C7319d(message.chatId, message.f25406id), searchMessagesFilter);
        } else {
            m18511K();
            this.f30737p0 = null;
            this.f30740s0.m29462u(null, false);
            this.f30740s0.m29463t(false);
        }
        invalidate();
    }
    ...
    public void m8488F1(TdApi.Message message) {
        ...
        if (constructor == -336109341) {
            this.f21820b.m2480e2().m1720L(((TdApi.MessageSenderUser) message.senderId).userId, this);
        } else if (constructor == -239660751) {
            this.f21820b.m2781K9().m1870d0(((TdApi.MessageSenderChat) message.senderId).chatId, this);
        }
        this.f21820b.m2781K9().m1858g0(message.chatId, this);
    }

    public void m8487G1(TdApi.Message message) {
        int constructor = message.senderId.getConstructor();
        if (constructor == -336109341) {
            this.f21820b.m2480e2().m1702P1(((TdApi.MessageSenderUser) message.senderId).userId, this);
        } else if (constructor == -239660751) {
            this.f21820b.m2781K9().m1818q0(((TdApi.MessageSenderChat) message.senderId).chatId, this);
        }
        this.f21820b.m2781K9().m1806t0(message.chatId, this);
    }
    ...
    public void mo8229b() {
        this.f30744w0 = false;
        Iterator<C3955n.C3958c<C9496b>> it = this.f30740s0.iterator();
        while (it.hasNext()) {
            it.next().f13320a.f30746b.m21001b();
        }
    }
    ...
    public final void m8478c1(int i, boolean z) {
        ...
        if (!C7321e.m16965a1(contentText)) {
            gVar = new RunnableC5390g.C5392b(this.f21820b, contentText, (HandlerC10770jj.C10788q) null, i, C1410y.m37083A0(14.0f), C5428t.AbstractC5441d.f17872C).m22864z(this.f30732k0).m22876n(i2 != 0 ? C9671v0.f31394a : null).m22868v().m22878l().m22880j().m22889a(8).m22884f();
        } else {
            gVar = null;
        }
        C3965r<C9497c> rVar = this.f30739r0;
        if (!(gVar == null && i2 == 0)) {
            cVar = new C9497c(gVar, mo14042X(i2, R.id.theme_color_icon));
        }
        rVar.m29462u(cVar, z);
    }
    ...
    public final void m8477d1(boolean z) {
        ...
        TdApi.Message message = this.f30733l0;
        if (message != null) {
            o0Var = AbstractC9622o0.m7982o(this.f21820b, message, this.f30737p0, C1357a0.m37541i(40.0f), C1357a0.m37541i(3.0f));
            if (o0Var == null && this.f30736o0 && (U2 = this.f21820b.m2632U2(this.f30733l0.chatId)) != null && (chatPhotoInfo = U2.photo) != null) {
                o0Var = AbstractC9622o0.m7986k(this.f21820b, chatPhotoInfo, C1357a0.m37541i(40.0f), C1357a0.m37541i(3.0f));
            }
        } else {
            o0Var = null;
        }
        if (o0Var == null) {
            this.f30740s0.m29462u(null, z);
        } else if (z || this.f30740s0.isEmpty()) {
            ...
            this.f30740s0.m29462u(new C9496b(o0Var, bVar), z);
        } else {
            C9496b bVar2 = this.f30740s0.m29461v().f13320a;
            bVar2.f30746b.m20999d();
            bVar2.f30745a = o0Var;
            o0Var.mo7955f(bVar2.f30746b, false);
        }
    }
    ...
    public final void m8476e1() {
        ...
        TdApi.Message message = this.f30733l0;
        C4779t2.C4783d R0 = C4779t2.m25612R0(q6Var, message.chatId, message);
        this.f30737p0 = R0;
        if (R0.m25373e() && (!this.f30735n0 || !this.f30737p0.m25372f())) {
            this.f30737p0.m25371g(new C4779t2.C4783d.AbstractC4784a() {
                @Override
    ...
    public final void m8475g1(boolean z) {
        int n1 = m8473n1();
        if (this.f30742u0 != n1 || !z) {
            this.f30742u0 = n1;
            if (n1 > 0) {
                if (!z || this.f30738q0.isEmpty()) {
                    m8474i1(n1, false);
                } else {
                    Iterator<C3955n.C3958c<RunnableC5390g>> it = this.f30738q0.iterator();
                    while (it.hasNext()) {
                        it.next().f13320a.m22910q(n1);
                    }
                }
                if (!z || this.f30739r0.isEmpty()) {
                    m8478c1(n1, false);
                } else {
                    Iterator<C3955n.C3958c<C9497c>> it2 = this.f30739r0.iterator();
                    while (it2.hasNext()) {
                        ((RunnableC5390g) it2.next().f13320a.f30745a).m22910q(n1);
                    }
                }
            } else {
                this.f30738q0.m29462u(null, false);
                this.f30739r0.m29462u(null, false);
            }
            invalidate();
        }
    }
    ...
    public final void m8474i1(int i, boolean z) {
        ...
        this.f30738q0.m29462u(!C5070i.m24061i(title) ? new RunnableC5390g.C5392b(this.f21820b, title, (HandlerC10770jj.C10788q) null, i, C1410y.m37083A0(14.0f), C5428t.AbstractC5441d.f17878I).m22864z(this.f30732k0).m22868v().m22886d().m22887c(m8491D1()).m22884f() : null, z);
    }
    ...
    public final int m8473n1() {
        return Math.max(0, (((getMeasuredWidth() - (C1357a0.m37541i(8.0f) * 2)) - getTextHorizontalOffset()) - C1357a0.m37541i(getLinePadding())) - this.f30743v0);
    }
    ...
    public void onDraw(Canvas canvas) {
        if (this.f30733l0 != null) {
            int i = C1357a0.m37541i(getLinePadding()) + C1357a0.m37541i(8.0f) + getTextHorizontalOffset();
            Iterator<C3955n.C3958c<C9496b>> it = this.f30740s0.iterator();
            while (it.hasNext()) {
                C3955n.C3958c<C9496b> next = it.next();
                C9496b bVar = next.f13320a;
                ((AbstractC9622o0) bVar.f30745a).m7993a(this, canvas, bVar.f30746b, (i - ((AbstractC9622o0) bVar.f30745a).getWidth()) - C1357a0.m37541i(8.0f), (C2139ap.m35479W(C3563j.f11957L0) - C1357a0.m37541i(40.0f)) / 2.0f, next.m29491s());
            }
            int i2 = C1357a0.m37541i(7.0f) + C1357a0.m37541i(14.0f) + C1357a0.m37541i(5.0f);
            Iterator<C3955n.C3958c<RunnableC5390g>> it2 = this.f30738q0.iterator();
            while (it2.hasNext()) {
                C3955n.C3958c<RunnableC5390g> next2 = it2.next();
                next2.f13320a.m22891z(canvas, i, C1357a0.m37541i(7.0f), null, next2.m29491s());
            }
            Iterator<C3955n.C3958c<C9497c>> it3 = this.f30739r0.iterator();
            while (it3.hasNext()) {
                C3955n.C3958c<C9497c> next3 = it3.next();
                C9497c cVar = next3.f13320a;
                if (cVar.f30747b != null) {
                    C1362c.m37487b(canvas, cVar.f30747b, i, (i2 + ((cVar.f30745a != 0 ? ((RunnableC5390g) cVar.f30745a).m22955a0(false) : C1357a0.m37541i(14.0f)) / 2.0f)) - (next3.f13320a.f30747b.getMinimumHeight() / 2.0f), C1411z.m36997c(R.id.theme_color_icon, next3.m29491s()));
                }
                C9497c cVar2 = next3.f13320a;
                if (cVar2.f30745a != 0) {
                    ((RunnableC5390g) cVar2.f30745a).m22891z(canvas, i, i2, null, next3.m29491s());
                }
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        Iterator<C3955n.C3958c<C9497c>> it = this.f30739r0.iterator();
        while (it.hasNext()) {
            C9497c cVar = it.next().f13320a;
            if (cVar.f30745a != 0 && ((RunnableC5390g) cVar.f30745a).m22967U0(this, motionEvent)) {
                return true;
            }
        }
    ...
    public void setForcedTitle(String str) {
        if (!C5070i.m24067c(this.f30734m0, str)) {
            this.f30734m0 = str;
            m8485I1();
        }
    }
