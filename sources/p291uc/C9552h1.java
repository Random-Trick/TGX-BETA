...
public class C9552h1 extends SparseDrawableView implements AbstractC5911c, C9678w2.AbstractC9685g {
    public C6257p f30960N;
    public C6240c f30961O;
    public C6240c f30962P;
    public C6238b f30964R;
    public C9565i1 f30965S;
    public C9678w2 f30966T;
    public float f30968V;
    public float f30969W;
    public AbstractRunnableC5910b f30970a0;
    public AbstractC4761s4 f30971b;
    public int f30972c;
    public boolean f30967U = true;
    public final C6257p f30959M = new C6257p(this, C1357a0.m37544i(20.5f));
    public RunnableC6507m f30963Q = new RunnableC6507m(this);
    ...
    public class C9553a extends AbstractRunnableC5910b {
        ...
        @Override
        public void mo1364b() {
            C9552h1.this.f30972c &= -9;
            C9552h1.this.f30970a0 = null;
    ...
    public static void m8348Q0(View$OnClickListenerC2971rh rhVar, AbstractC4761s4 s4Var, float f, float f2) {
        long t1 = s4Var.m25806t1(f, f2);
        if (t1 == 0) {
            rhVar.m32369ip(s4Var, f, f2);
        } else {
            rhVar.m32356jp(t1, s4Var, f, f2);
        }
    }
    ...
    public boolean m8331j0(View$OnClickListenerC2971rh rhVar, TdApi.MessageSender messageSender, TdApi.ChatMemberStatus chatMemberStatus, TdApi.ChatMember chatMember, AbstractC4761s4 s4Var, View view, int i) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_messageCopy:
                if (C4779t2.m25655L(s4Var.m25994Z3())) {
                    formattedText = C7321e.m16899w1(s4Var.m25994Z3().content);
                } else {
                    formattedText = s4Var instanceof C4656h6 ? ((C4656h6) s4Var).m26618ma() : null;
                }
                if (formattedText == null) {
                    return true;
                }
                C1379j0.m37328i(C4779t2.m25428s5(formattedText), R.string.CopiedText);
                return true;
    ...
    public void m8329q0(final View$OnClickListenerC2971rh rhVar, C5320c cVar, C5146u0 u0Var, C5320c cVar2, C5320c cVar3, final TdApi.MessageSender messageSender, final TdApi.ChatMemberStatus chatMemberStatus, final AbstractC4761s4 s4Var, final TdApi.ChatMember chatMember) {
        rhVar.m9261ee(null, cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), cVar3.m23281e(), new AbstractC5117h0() {
            @Override
    ...
    public static void m8324v0(View$OnClickListenerC2971rh rhVar, AbstractC4761s4 s4Var, C5320c cVar, C5146u0 u0Var, C5320c cVar2, C5320c cVar3, TdApi.MessageSender messageSender, TdApi.ChatMemberStatus chatMemberStatus, final AbstractC5918j jVar, TdApi.Object object) {
        if (object.getConstructor() == 1829953909) {
            ...
            if (C4779t2.m25655L(s4Var.m25994Z3()) || ((s4Var instanceof C4656h6) && ((C4656h6) s4Var).m26618ma().text.trim().length() > 0)) {
                cVar.m23285a(R.id.btn_messageCopy);
            ...
            if (!K6) {
                ...
                if (rhVar.mo4348c().m2379k7(C7321e.m16982S0(messageSender))) {
                    ...
                    u0Var.m23816b(C4403w.m27867j1(R.string.ViewMessagesFromUser, rhVar.mo4348c().m2135zb(messageSender, true)));
                }
                cVar2.m23285a(R.drawable.baseline_person_24);
                cVar3.m23285a(1);
            }
            if (chatMemberStatus != null && (!C4779t2.m25624P2(chatMember.status) || !C4779t2.m25624P2(chatMemberStatus))) {
                int P = C4779t2.m25627P(chatMemberStatus, chatMember.status);
                if (!(P == 0 || P == 1)) {
                ...
                int R = C4779t2.m25614R(chatMemberStatus, chatMember.status);
                if (!(R == 0 || (messageSender.getConstructor() == -239660751 && C7321e.m16986Q0(messageSender) == rhVar.mo9464C9()))) {
                    if (!K6 || (K6 && R == 2)) {
                        ...
                        cVar3.m23285a(R == 1 ? 2 : 1);
                        cVar2.m23285a(R.drawable.baseline_block_24);
                        if (R == 1) {
                            u0Var.m23817a(messageSender.getConstructor() == -239660751 ? rhVar.mo4348c().m2784K6(C7321e.m16986Q0(messageSender)) ? R.string.BanChannel : R.string.BanChat : R.string.RestrictUser);
                        } else if (R == 2) {
                            u0Var.m23817a(messageSender.getConstructor() == -239660751 ? rhVar.mo4348c().m2784K6(C7321e.m16986Q0(messageSender)) ? R.string.EditChannelRestrictions : R.string.EditGroupRestrictions : R.string.EditUserRestrictions);
                        } else if (R == 3) {
                    ...
                    if (messageSender.getConstructor() != -239660751) {
                        ...
                        u0Var.m23817a(K6 ? R.string.ChannelRemoveUser : R.string.RemoveFromGroup);
                        cVar3.m23285a(2);
                    }
                }
            }
    ...
    public final void m8360B0() {
        ...
        if ((i & 2) != 0) {
            ...
            this.f30972c = i & (-5);
            if (this.f30971b.mo25296m8(this, this.f30968V, this.f30969W) || m8354J0()) {
                setLongPressed(true);
            }
        }
    }
    ...
    public final boolean m8359C0(float f, float f2) {
        C9270q1 bc;
        AbstractC4761s4 s4Var = this.f30971b;
        if (s4Var != null && !(s4Var instanceof C4791t4)) {
            View$OnClickListenerC2971rh a7 = s4Var.m25982a7();
            if ((a7.m9339Ta() || a7.m9300Z9().m9339Ta()) && (bc = a7.m9300Z9().m9284bc()) != null && !bc.m9741S() && !bc.m9756I().m10039o3()) {
                if (a7.m9374Oa()) {
                    if (!this.f30971b.m25848p0()) {
                        return false;
                    }
                    m8348Q0(a7, this.f30971b, this.f30968V, this.f30969W);
                    return true;
                } else if (a7.m32556Uk()) {
                    a7.m32734Go(this.f30971b);
                    return true;
                } else if (this.f30971b.mo26060S7(this, a7)) {
                    return true;
                } else {
    ...
    public final boolean m8357F0(float f, float f2, TdApi.ChatMember chatMember) {
        View$OnClickListenerC2971rh a7 = this.f30971b.m25982a7();
        boolean z = !this.f30971b.m25947e6();
        if (this.f30971b.m26003Y5()) {
            m8333g1(a7, this.f30971b);
            return true;
        }
        AbstractC4761s4 s4Var = this.f30971b;
        if (!(s4Var instanceof C4583a5)) {
            ...
            Object M = m8351M(a7, this.f30971b, chatMember, cVar, cVar2, u0Var, false);
            if (cVar.m23280f()) {
                return false;
            }
            a7.m32484Zq(this.f30971b, cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), M, chatMember, false);
            return true;
        } else if (z) {
            return m8336e1(a7, (C4583a5) s4Var, chatMember);
        } else {
            a7.m32484Zq(s4Var, new int[]{R.id.btn_messageDelete}, new String[]{C4403w.m27871i1(R.string.Delete)}, new int[]{R.drawable.baseline_delete_24}, null, chatMember, true);
            return true;
        }
    }
    ...
    public final boolean m8354J0() {
        AbstractC9323v4<?> q9;
        AbstractC4761s4 s4Var = this.f30971b;
        if (!(s4Var instanceof C4791t4) && !s4Var.m25947e6() && (q9 = AbstractC9323v4.m9183q9(this)) != null && (q9 instanceof View$OnClickListenerC2971rh)) {
            View$OnClickListenerC2971rh rhVar = (View$OnClickListenerC2971rh) q9;
            AbstractC4761s4 s4Var2 = this.f30971b;
            if (s4Var2 instanceof C4583a5) {
                return m8359C0(0.0f, 0.0f);
            }
            if (s4Var2.m25848p0()) {
                m8348Q0(rhVar, this.f30971b, this.f30968V, this.f30969W);
                return true;
            }
        }
        return false;
    ...
    public final void m8352L(C9552h1 h1Var) {
        AbstractC4761s4 s4Var = this.f30971b;
        if (s4Var != null) {
            s4Var.m26153J6(h1Var, this.f30959M);
            if ((this.f30972c & 32) != 0) {
                this.f30971b.m26111N8(this.f30962P);
            }
        }
    }
    ...
    public final void m8350M0() {
        ...
        if ((i & 8) == 0) {
            this.f30972c = i | 8;
            this.f30970a0 = new C9553a();
            cancelLongPress();
            postDelayed(this.f30970a0, ViewConfiguration.getLongPressTimeout());
        }
    }

    public final void m8349O0() {
        this.f30972c &= -9;
        AbstractRunnableC5910b bVar = this.f30970a0;
        if (bVar != null) {
            bVar.m21858c();
            removeCallbacks(this.f30970a0);
            this.f30970a0 = null;
        }
    }
    ...
    public void m8345T(long j, long j2, int i) {
        AbstractC4761s4 s4Var = this.f30971b;
        if (s4Var != null && j == s4Var.m26146K2()) {
            if ((this.f30972c & Log.TAG_YOUTUBE) != 0) {
                if (this.f30971b.m26051T5(j2)) {
                    this.f30971b.mo25335L8(this.f30964R, true, i);
                }
            } else if (j2 == this.f30971b.m26116N3()) {
                if (this.f30963Q != null && this.f30971b.mo25870m7()) {
                    this.f30971b.mo26161I8(this.f30963Q);
                }
                if (this.f30971b.mo25830q7()) {
                    C6257p pVar = this.f30960N;
                    if (pVar != null) {
                        this.f30971b.mo26151J8(pVar);
                    }
                    C6240c cVar = this.f30961O;
                    if (cVar != null && cVar.isEmpty()) {
                        this.f30971b.mo26122M8(this.f30961O);
                    }
                }
                if ((this.f30972c & 64) != 0 && (getParent() instanceof C9565i1)) {
                    ((C9565i1) getParent()).m8228c(this.f30971b);
                }
            }
        }
    }
    ...
    public void m8344U0() {
        this.f30964R = new C6238b(this);
        this.f30972c |= Log.TAG_YOUTUBE;
    }
    ...
    public void m8342Z() {
        C6257p pVar = this.f30959M;
        if (pVar != null) {
            pVar.mo20250Z();
        }
        C6257p pVar2 = this.f30960N;
        if (pVar2 != null) {
            pVar2.mo20250Z();
        }
        C6240c cVar = this.f30961O;
        ...
        C6240c cVar2 = this.f30962P;
        if (cVar2 != null) {
            cVar2.mo20250Z();
        }
        RunnableC6507m mVar = this.f30963Q;
        if (mVar != null) {
            mVar.mo20250Z();
        }
        C6238b bVar = this.f30964R;
        if (bVar != null) {
            bVar.mo4501a3();
        }
        AbstractC4761s4 s4Var = this.f30971b;
    ...
    public void m8341b0(long j, long j2) {
        C6240c cVar;
        AbstractC4761s4 s4Var = this.f30971b;
        if (s4Var != null && j == s4Var.m26146K2() && j2 == this.f30971b.m26116N3() && (cVar = this.f30961O) != null) {
            this.f30971b.mo26122M8(cVar);
        }
    }

    public void m8340c1() {
        this.f30962P = new C6240c(this, 0);
        this.f30972c |= 32;
    }

    public void m8339d0() {
        AbstractC4761s4 s4Var;
        if ((this.f30972c & 32) != 0 && (s4Var = this.f30971b) != null) {
            s4Var.m26111N8(this.f30962P);
        }
    }
    ...
    public void m8338d1(final boolean z) {
        ...
        if (s4Var != null) {
            ...
            setPivotX(s4Var.m25746z0());
            setPivotY(this.f30971b.m26252A0());
            if (C4868i.m24727c2().m24664k1(2L) || C5069h.m24080n(0, 1000) == 500) {
                kVar = new C3950k(0, new C3950k.AbstractC3952b() {
                    ...
                    public void mo35Y0(int i, float f3, C3950k kVar2) {
                        C3953l.m29528a(this, i, f3, kVar2);
                    }
                }, C2057b.f7280b, 900L);
            } else {
                kVar = new C3950k(0, new C3950k.AbstractC3952b() {
    ...
    public void m8337e0(long j, long j2) {
        AbstractC4761s4 s4Var;
        if (this.f30972c * 32 != 0 && (s4Var = this.f30971b) != null && s4Var.m26146K2() == j && this.f30971b.m26116N3() == j2) {
            this.f30971b.m26111N8(this.f30962P);
        }
    }
    ...
    public final boolean m8336e1(View$OnClickListenerC2971rh rhVar, C4583a5 a5Var, TdApi.ChatMember chatMember) {
        ...
        if (!(a5Var.m25994Z3() == null || (messageContent = a5Var.m25994Z3().content) == null)) {
        ...
        if (rhVar.m32674Li() && a5Var.mo25807t0()) {
            cVar.m23285a(R.id.btn_messageReply);
            u0Var.m23817a(R.string.Reply);
            cVar2.m23285a(R.drawable.baseline_reply_24);
        }
        if (rhVar.mo4348c().m2272r2(a5Var.m25994Z3())) {
            cVar.m23285a(R.id.btn_messageCopyLink);
            u0Var.m23817a(R.string.CopyLink);
            cVar2.m23285a(R.drawable.baseline_link_24);
        }
        if (this.f30971b.m25896k0()) {
        ...
        rhVar.m32484Zq(a5Var, cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), null, chatMember, true);
        return true;
    }

    public final void m8333g1(final View$OnClickListenerC2971rh rhVar, final AbstractC4761s4 s4Var) {
        final TdApi.MessageSender messageSender = s4Var.m25994Z3().senderId;
    ...
    public AbstractC6264v getAnyReceiver() {
        C6257p pVar = this.f30960N;
        return pVar != null ? pVar : this.f30963Q;
    }
    ...
    public final void m8332i1(View$OnClickListenerC2971rh rhVar, boolean z, TdApi.MessageSender messageSender, TdApi.ChatMemberStatus chatMemberStatus, TdApi.ChatMember chatMember) {
        if (z && C4779t2.m25614R(chatMemberStatus, chatMember.status) == 1) {
            chatMember = null;
        }
        ...
        u7Var.m31378sg(new View$OnClickListenerC3141u7.C3145d(rhVar.mo9464C9(), messageSender, z, chatMemberStatus, chatMember2).m31352b());
        rhVar.m9291ac(u7Var);
    }
    ...
    public final boolean m8330n1(float f) {
        ...
        AbstractC4761s4 s4Var = this.f30971b;
        if (s4Var != null && !s4Var.m25947e6()) {
            AbstractC4761s4 s4Var2 = this.f30971b;
            if (!(s4Var2 instanceof C4791t4) && !(s4Var2 instanceof C4583a5) && !s4Var2.mo25842p6() && !C1379j0.m37310r(getContext()).m14528V0().m6909c0()) {
                View$OnClickListenerC2971rh a7 = this.f30971b.m25982a7();
                int i = (f > 0.0f ? 1 : (f == 0.0f ? 0 : -1));
                if ((i < 0 && !a7.m32674Li()) || (R = m8347R()) == null) {
                    return false;
                }
                C9547g3 messagesTouchHelper = R.getMessagesTouchHelper();
                if (C4403w.m27986G2()) {
                    if (((messagesTouchHelper.m8370M() && f > 0.0f) || (messagesTouchHelper.m8369N() && i < 0)) && this.f30968V < a7.get().getMeasuredWidth() - View$OnClickListenerC2971rh.m32803Bk()) {
                        a7.m32380hr(m8346S());
                        return true;
                    }
                } else if (((messagesTouchHelper.m8370M() && i < 0) || (messagesTouchHelper.m8369N() && f > 0.0f)) && this.f30968V > View$OnClickListenerC2971rh.m32803Bk()) {
                    a7.m32380hr(m8346S());
                    return true;
                }
            }
    ...
    public void onDraw(Canvas canvas) {
        this.f30971b.m26056T0(this, canvas, this.f30959M, this.f30962P, this.f30961O, this.f30960N, this.f30963Q, this.f30964R);
    }

    @Override
    public void onMeasure(int i, int i2) {
        if ((this.f30972c & 64) != 0) {
            super.onMeasure(i, i2);
        } else {
            int measuredWidth = ((View) getParent()).getMeasuredWidth();
            AbstractC4761s4 s4Var = this.f30971b;
            if (s4Var != null) {
                s4Var.m25935g0(measuredWidth);
            }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if ((s4Var.m26146K2() == 0 && !(this.f30971b instanceof C4791t4)) || this.f30971b.m25982a7().m9332Ua()) {
            return false;
        }
        if ((this.f30971b.m25982a7().m32569Tk() && !this.f30971b.m26072R6().m7692h1() && !this.f30971b.m26072R6().m7663n1()) || C1379j0.m37310r(getContext()).m14528V0().m6909c0()) {
            return false;
        }
        int action = motionEvent.getAction();
        if (action != 0) {
            if (action == 1) {
                if ((this.f30972c & 16) != 0) {
                ...
                if ((i & 4) != 0) {
                    this.f30972c = i & (-5);
                    return this.f30971b.mo25218f8(this, motionEvent);
                }
                if ((i & 2) != 0) {
                    this.f30972c = i & (-3);
                ...
                float abs = Math.abs(this.f30968V - motionEvent.getX());
                float abs2 = Math.abs(this.f30969W - motionEvent.getY());
                float max = Math.max(abs, abs2);
                if ((this.f30972c & 8) != 0 && max > C1357a0.m37537p()) {
                    m8349O0();
                }
                MessagesRecyclerView R = m8347R();
                if (R == null || R.m14142J1() || abs2 >= C1357a0.m37537p() || abs <= C1357a0.m37537p() || !m8330n1(motionEvent.getX() - this.f30968V)) {
                    int i2 = this.f30972c;
                    if ((i2 & 4) != 0) {
                        return this.f30971b.mo25218f8(this, motionEvent);
                    }
                    if ((i2 & 2) != 0) {
                        if (max <= C1357a0.m37537p()) {
                            return true;
                        }
                        this.f30972c &= -3;
                    }
        ...
        } else if (this.f30971b.m25748y9(motionEvent)) {
            return false;
        } else {
            View$OnClickListenerC2971rh a7 = this.f30971b.m25982a7();
            if (a7.m32451cl()) {
            ...
            this.f30968V = motionEvent.getX();
            float y = motionEvent.getY();
            this.f30969W = y;
            if (this.f30971b.mo26057T(this.f30968V, y)) {
                m8350M0();
            } else {
                m8349O0();
            }
            if (a7.m9374Oa() || !this.f30971b.mo25218f8(this, motionEvent)) {
                this.f30972c |= 2;
            } else {
                this.f30972c |= 4;
            }
    ...
    public void setCustomMeasureDisabled(boolean z) {
        this.f30972c = C5063c.m24139h(this.f30972c, 64, z);
    }
    ...
    public void setMessage(AbstractC4761s4 s4Var) {
        ...
        AbstractC4761s4 s4Var2 = this.f30971b;
        if (s4Var2 != null) {
            s4Var2.m26132L7(this);
        }
        if (this.f30971b == null || getMeasuredHeight() != J3 || currentHeight != J3) {
            this.f30971b = s4Var;
            if ((this.f30972c & 64) == 0) {
                requestLayout();
            }
        } else if (this.f30971b.m26165I3() != s4Var.m26165I3()) {
            this.f30971b = s4Var;
            m8352L(this);
        } else {
            this.f30971b = s4Var;
        ...
        s4Var.m26091P8();
        s4Var.m26171H8(this.f30959M);
        if ((this.f30972c & 1) != 0) {
            this.f30961O.mo20260D0(s4Var.mo26075R3(true));
            s4Var.mo26122M8(this.f30961O);
            if (s4Var.mo25870m7()) {
                this.f30960N.m20820G(null);
                s4Var.mo26161I8(this.f30963Q);
            } else {
                this.f30963Q.m20232r(null);
                this.f30960N.mo20260D0(s4Var.mo26075R3(false));
                s4Var.mo26151J8(this.f30960N);
            }
        }
        if ((this.f30972c & Log.TAG_YOUTUBE) != 0) {
            s4Var.mo25335L8(this.f30964R, false, -1);
        }
        AbstractC4761s4 s4Var3 = this.f30971b;
        if (s4Var3 != null) {
            s4Var3.m26193F7(this);
            if (Build.VERSION.SDK_INT >= 21 && this.f30966T.m7615x3()) {
                invalidateOutline();
            }
        }
    }
    ...
    public void m8323w0() {
        if (!this.f30967U) {
            this.f30967U = true;
            this.f30959M.mo20246f();
            this.f30963Q.mo20246f();
            if ((this.f30972c & 32) != 0) {
                this.f30962P.mo20246f();
            }
            if ((1 & this.f30972c) != 0) {
                this.f30960N.mo20246f();
                this.f30961O.mo20246f();
            }
            if ((this.f30972c & Log.TAG_YOUTUBE) != 0) {
                this.f30964R.m21002b();
            }
        }
    }
    ...
    public void m8321x0() {
        if (this.f30967U) {
            this.f30967U = false;
            this.f30959M.mo20248b();
            this.f30963Q.mo20248b();
            if ((this.f30972c & 32) != 0) {
                this.f30962P.mo20248b();
            }
            if ((this.f30972c & 1) != 0) {
                this.f30960N.mo20248b();
                this.f30961O.mo20248b();
            }
            if ((this.f30972c & Log.TAG_YOUTUBE) != 0) {
                this.f30964R.m20995i();
            }
        }
    }
}
