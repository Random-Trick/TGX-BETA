...
public class RunnableC9558i0 extends C6831a2 implements C5976u.AbstractC5985i, Runnable, View$OnClickListenerC9694y.AbstractC9704j, Comparator<Object>, C5078d.AbstractC5080b, AbstractC9165c2, C11052v1.AbstractC11053a, AbstractC5911c {
    public View$OnClickListenerC2971rh f30977P;
    public boolean f30978Q;
    public TextPaint f30979R;
    public String f30980S = "";
    public String f30981T = "";
    public String f30982U = "";
    public int f30983V;
    public int f30984W;
    public int f30985a0;
    public final int f30986b0;
    public final C10930q6 f30987c0;
    public final C5976u f30988d0;
    public AbstractC9563e f30989e0;
    public boolean f30990f0;
    public AbstractC9564f f30991g0;
    public CharSequence f30992h0;
    public boolean f30993i0;
    public boolean f30994j0;
    public Spannable f30995k0;
    public int f30996l0;
    public Object[] f30997m0;
    public CharSequence f30998n0;
    public float f30999o0;
    public int f31000p0;
    public InputConnection f31001q0;
    public AlertDialog f31002r0;
    public boolean f31003s0;
    public String f31004t0;
    public boolean f31005u0;
    public boolean f31006v0;
    public boolean f31007w0;
    public boolean f31008x0;
    ...
    public class C9559a implements TextWatcher {
        ...
        public final void m8242a(Spannable spannable, int i, int i2) {
            ...
            if (i3 > 0) {
                ...
                while (true) {
                    ...
                    if (!Character.isLetterOrDigit(codePointAt) && !Character.isWhitespace(codePointAt) && !RunnableC5390g.m22973R0(codePointAt)) {
                        z = false;
                        break;
                    }
        ...
        public void afterTextChanged(Editable editable) {
            if (!RunnableC9558i0.this.f30994j0 && !RunnableC9558i0.this.f31003s0) {
                if (RunnableC9558i0.this.f30978Q) {
                    RunnableC9558i0.this.f30994j0 = true;
                    m8241b(editable);
                    RunnableC9558i0.this.f30994j0 = false;
                    RunnableC9558i0.this.f30978Q = false;
                } else if (editable.length() > 0) {
                    RunnableC9558i0.this.f30994j0 = true;
                    RunnableC9558i0.this.f30995k0 = editable;
                    m8241b(editable);
                    if (RunnableC9558i0.this.f30977P != null) {
                        RunnableC9558i0.this.f30977P.m32741Fr(editable, true);
                    }
                    ...
                    RunnableC9558i0.this.f30994j0 = false;
                } else if (RunnableC9558i0.this.f30977P != null) {
                    RunnableC9558i0.this.f30977P.m32741Fr("", true);
                }
            }
        }
            ...
            if (!(objArr == null || objArr.length == 0)) {
                ...
                for (Object obj : objArr) {
                    ...
                    if (!(spanStart == -1 || spanEnd == -1)) {
                        ...
                        if (characterStyleArr2 != null && characterStyleArr2.length > 0) {
                            ...
                            while (i < length) {
                                ...
                                if (characterStyle instanceof ImageSpan) {
                                    ...
                                    AbstractC5090k E = C5078d.m23986z().m24028E(RunnableC9558i0.m8258q0(((ImageSpan) characterStyle).getSource()), null);
                                    if (E != null) {
                        ...
                        C5078d.m23986z().m24022K(editable, spanStart, spanEnd, null, RunnableC9558i0.this);
                        if (arrayList2 != null && !arrayList2.isEmpty()) {
                            ...
                            for (int size = arrayList2.size() - 1; size >= 0; size--) {
                                ...
                                if (!(spanStart3 == -1 || spanEnd3 == -1)) {
                                    ...
                                    if (obj2 instanceof AbstractC5090k) {
                                        String charSequence = ((AbstractC5090k) obj2).mo23968a().toString();
                            ...
                            if (!(selectionStart == -1 || selectionEnd == -1)) {
                                ...
                                if (selectionStart >= selectionEnd) {
                                    C1399s0.m37169m0(RunnableC9558i0.this, Math.min(selectionStart, length3));
                                } else {
                                    C1399s0.m37167n0(RunnableC9558i0.this, Math.min(selectionStart, length3), Math.max(selectionEnd, length3));
                                }
                            }
                            arrayList2.clear();
                        }
        ...
        public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
            if (RunnableC9558i0.this.f31003s0) {
                RunnableC9558i0.this.f30992h0 = charSequence;
                return;
            }
        ...
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            ...
            for (int i2 = 0; i2 < menu.size(); i2++) {
                try {
                    ...
                    item.setTitle(textEntityType != null ? C4403w.m27888d3(C4403w.m27869i1(i), C4403w.m27967L(textEntityType)) : C4403w.m27869i1(i));
                } catch (Throwable unused) {
                }
            }
            if (RunnableC5390g.m22979O0(RunnableC9558i0.this.getText().toString(), RunnableC9558i0.this.getSelectionStart(), RunnableC9558i0.this.getSelectionEnd())) {
    ...
    public class C9561c implements C9186f1.AbstractC9187a {
        ...
        public void mo8240a(int i) {
            if (RunnableC9558i0.this.f30996l0 != 0) {
                RunnableC9558i0 i0Var = RunnableC9558i0.this;
                i0Var.m8247w0(i0Var.f30996l0, RunnableC9558i0.this.f30997m0);
            }
        }

        @Override
        public int mo8239b() {
            return RunnableC9558i0.this.f30996l0;
        }
    }
    ...
    public RunnableC9558i0(Context context, C10930q6 q6Var) {
        super(context);
        this.f30987c0 = q6Var;
        this.f30988d0 = new C5976u(C1379j0.m37307r(context), q6Var, this);
        TextPaint textPaint = new TextPaint(5);
        this.f30979R = textPaint;
        textPaint.setColor(C11524j.m207X0());
        this.f30979R.setTypeface(C1389o.m37258k());
        this.f30979R.setTextSize(C1357a0.m37552C(18.0f));
        setGravity(C4403w.m27989F1() | 48);
        setTypeface(C1389o.m37258k());
        setTextSize(2, 18.0f);
        int i = C1357a0.m37541i(12.0f);
        this.f30986b0 = i;
        int i2 = C1357a0.m37541i(60.0f);
        this.f30985a0 = i2;
        setPadding(i2, i, C1357a0.m37541i(55.0f), i);
        setImeOptions(268435456);
        setInputType(getInputType() | Log.TAG_VIDEO | Log.TAG_CONTACT);
        setSingleLine(false);
        setMaxLines(8);
        setMinimumHeight(C1357a0.m37541i(49.0f));
        setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
        C1399s0.m37166o(this);
    ...
    public static boolean m8280e0(Spanned spanned, CharacterStyle characterStyle) {
        ...
        if (!C4779t2.m25668J(characterStyle)) {
            return false;
        }
        if (characterStyle instanceof URLSpan) {
            ...
            return !C1363c0.m37457Q(charSequence) || C1363c0.m37463K(url, charSequence);
        }
        return true;
    }
    ...
    public void m8276g0(final long j, final long j2, final long j3, final boolean z, final TdApi.InputMessageContent inputMessageContent) {
        this.f30987c0.m2485dd().m3787L8(this.f30977P, j, false, new HandlerC10770jj.AbstractC10786o() {
            @Override
    ...
    public void m8274h0(Uri uri, int i, final long j, long j2, boolean z, final long j3, final long j4, final boolean z2) {
        ...
        try {
            ...
            if (i == 3) {
                try {
                    InputStream openInputStream2 = C1379j0.m37309q().getContentResolver().openInputStream(uri);
            ...
            if (i == 3 && z3) {
                inputMessageContent = this.f30987c0.m2429h5().m23151B(new TdApi.InputMessageAnimation(C4779t2.m25670I4(null, uri2, 0, j2), null, null, 0, i2, i3, null), j5);
            } else if (i == 4 || (i != 1 && !uri2.contains("sticker") && Math.max(i2, i3) > 512)) {
                inputMessageContent = this.f30987c0.m2429h5().m23151B(new TdApi.InputMessagePhoto(C5335c.m23205x(uri2, 0, j2, false, 0), null, null, i2, i3, null, 0), j5);
            } else {
                inputMessageContent = this.f30987c0.m2429h5().m23151B(new TdApi.InputMessageSticker(C5335c.m23205x(uri2, 0, j2, true, Log.TAG_GIF_LOADER), null, i2, i3, null), j5);
            }
            final TdApi.InputMessageContent inputMessageContent2 = inputMessageContent;
            if (z) {
                this.f30987c0.m2485dd().post(new Runnable() {
                    @Override
                ...
                this.f30987c0.m2231tb(j, j3, j4, z2, false, inputMessageContent2);
            }
        } catch (Throwable th2) {
    ...
    public boolean m8272i0(C4113c cVar, int i, Bundle bundle) {
        final int i2;
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null && rhVar.m32761Ek()) {
            ClipDescription b = cVar.m28897b();
            ...
            final Uri a = cVar.m28898a();
            final long currentTimeMillis = System.currentTimeMillis();
            final long C9 = this.f30977P.mo9464C9();
            final long qk = this.f30977P.m32266qk();
            final long ko = this.f30977P.m32341ko();
            final boolean lo = this.f30977P.m32328lo();
            final boolean ui = this.f30977P.m32216ui();
    ...
    public boolean m8270j0(URLSpan uRLSpan, int i, int i2, View$OnFocusChangeListenerC7069y1 y1Var, String str) {
        if (C5070i.m24061i(str)) {
            if (uRLSpan != null) {
                ...
                this.f30988d0.m21686V();
            }
            return true;
        } else if (!C1363c0.m37457Q(str)) {
            return false;
        } else {
    ...
    public void m8268k0(boolean z, TdApi.MessageSchedulingState messageSchedulingState, boolean z2) {
        this.f30977P.m32677Kp(true, z, messageSchedulingState);
    }

    public void m8266l0(DialogInterface dialogInterface, int i) {
        this.f31002r0 = null;
        C4868i.m24726c2().m24582u2(2L);
        C4868i.m24726c2().m24830N5(true);
        this.f30988d0.m21686V();
    }
    ...
    public void m8264m0(DialogInterface dialogInterface, int i) {
        this.f31002r0 = null;
        C4868i.m24726c2().m24582u2(2L);
        C4868i.m24726c2().m24830N5(false);
        this.f30988d0.m21686V();
    }
    ...
    public static String m8258q0(String str) {
        ...
        if (str.indexOf("twimg.com/emoji/v2/") != -1) {
            ...
            return C5078d.m24026G(m8285b0(str2, 8), "UTF-32BE");
        }
        ...
        if (indexOf != -1) {
            ...
            if (i2 < i) {
                return C5078d.m24026G(m8285b0(str.substring(i2, i), 8), "UTF-16");
            }
        }
        return null;
    }
    ...
    public final void m8316A0(String str, String str2) {
        if (!this.f30980S.equals(str2) || !this.f30981T.equals(str)) {
            this.f30980S = str2;
            this.f30981T = str;
            int i = 0;
            this.f30983V = str.length() > 0 ? (int) C7389v0.m16680T1(this.f30981T, this.f30979R) : 0;
            if (str2.length() > 0) {
                i = (int) C7389v0.m16680T1(this.f30980S, this.f30979R);
            }
            this.f30984W = i;
            m8263n0();
            invalidate();
    ...
    public void m8310D0(TdApi.Chat chat, C4737p7 p7Var, boolean z) {
        ...
        Object[] objArr = null;
        TdApi.ChatMemberStatus K3 = this.f30987c0.m2787K3(chat.f25367id);
        if (this.f30987c0.m2784K6(chat.f25367id)) {
            i = z ? R.string.ChannelSilentBroadcast : R.string.ChannelBroadcast;
        } else if (!this.f30987c0.m2568Y6(chat) || !C7321e.m16974W0(K3)) {
            TdApi.MessageSender messageSender = chat.messageSenderId;
            if (messageSender == null || this.f30987c0.m2395j7(messageSender)) {
                if (p7Var != null) {
                    i3 = p7Var.m26300a() ? R.string.Comment : R.string.MessageReply;
                }
                i = i3;
            } else {
                if (p7Var != null) {
                    i2 = p7Var.m26300a() ? R.string.CommentAsX : R.string.MessageReplyAsX;
                } else {
                    i2 = R.string.MessageAsX;
                }
                objArr = new Object[]{this.f30987c0.m2151yb(chat.messageSenderId)};
                i = i2;
            }
        } else if (p7Var != null) {
            i = p7Var.m26300a() ? R.string.CommentAnonymously : R.string.MessageReplyAnonymously;
        } else {
    ...
    public void m8291W() {
        int max;
        if (this.f30996l0 != 0 && this.f30977P != null && this.f31000p0 != (max = Math.max(0, (getMeasuredWidth() - this.f30977P.m32358jk()) - getPaddingLeft()))) {
            this.f31000p0 = max;
            float f = max;
            if (this.f30999o0 <= f) {
                setHint(this.f30998n0);
            } else {
                setHint(TextUtils.ellipsize(this.f30998n0, getPaint(), f, TextUtils.TruncateAt.END));
            }
        }
    }
    ...
    public final void m8290X(String str) {
        int i = 0;
        String substring = str.substring(0, this.f30981T.length());
        if (!substring.equals(this.f30981T)) {
            this.f30981T = substring;
            if (substring.length() > 0) {
                i = (int) C7389v0.m16680T1(this.f30981T, this.f30979R);
            }
            this.f30983V = i;
            m8263n0();
        }
    ...
    public void m8288Z(final URLSpan uRLSpan, final int i, final int i2) {
        if (i >= 0 && i2 >= 0 && i <= getText().length() && i2 <= getText().length()) {
            AbstractC9323v4 v4Var = this.f30977P;
            if (v4Var == null) {
                AbstractC9563e eVar = this.f30989e0;
            ...
            if (v4Var2 != null) {
                v4Var2.m9364Pc(C4403w.m27869i1(R.string.CreateLink), C4403w.m27869i1(R.string.URL), R.string.CreateLinkDone, R.string.CreateLinkCancel, uRLSpan != null ? uRLSpan.getURL() : null, new AbstractC9323v4.AbstractC9336m() {
                    @Override
    ...
    public TdApi.WebPage mo8287a(TdApi.FormattedText formattedText) {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null) {
            return rhVar.m32410fk(formattedText);
        }
        return null;
    }
    ...
    public final void m8286a0() {
        if (this.f31008x0) {
            ...
            try {
                super.setEnabled(this.f31008x0);
            } catch (Throwable th2) {
                Log.m14708w(th2);
            }
        }
    ...
    public void mo7521b(C4828x xVar, String str) {
        String str2;
        boolean z = !C5070i.m24061i(str) || xVar.m25120f0();
        if (C5070i.m24061i(str)) {
            str = xVar.m25124b0(false);
        }
        if (str != null && xVar.m26332t() != -1 && xVar.m26331u() != -1) {
            Editable text = getText();
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(text);
            if (z) {
                SpannableStringBuilder spannableStringBuilder2 = new SpannableStringBuilder(str + " ");
                spannableStringBuilder2.setSpan(C4779t2.m25669I5(new TdApi.TextEntityTypeMentionName(xVar.m25123c0().f25439id)), 0, str.length(), 33);
                str2 = spannableStringBuilder2;
            } else {
                str2 = str + " ";
            }
            try {
                text.replace(xVar.m26331u(), Math.min(text.length(), xVar.m26332t()), str2);
            } catch (Throwable unused) {
            }
            try {
                m8249v0(xVar.m26353K(spannableStringBuilder, str2), false);
                C1399s0.m37169m0(this, xVar.m26331u() + str2.length());
    ...
    public void mo8284c(ArrayList<AbstractC4718o<?>> arrayList, boolean z) {
        ...
        if (eVar == null || !eVar.mo8234o3(this)) {
            ((AbstractView$OnTouchListenerC7889a) getContext()).m14412y3(this.f30977P, this.f30987c0, arrayList, z, this.f30988d0);
        } else {
            this.f30989e0.mo8233r0(this, arrayList, z);
        }
    }

    public final boolean m8283c0() {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        return rhVar == null || rhVar.m32461bl();
    }

    @Override
    public int compare(Object obj, Object obj2) {
        return Integer.compare(this.f30995k0.getSpanStart(obj), this.f30995k0.getSpanStart(obj2));
    }

    @Override
    public boolean mo8282d() {
        return !m8283c0() && this.f30987c0.m2384k2(this.f30977P.m32528Wj());
    }
    ...
    public void mo7520e(C4809v vVar) {
        String h = vVar.m26340h();
        if (h != null && vVar.m26328x()) {
            Editable text = getText();
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(text);
            String str = h + " ";
            try {
                text.replace(vVar.m26331u(), vVar.m26332t(), str);
            } catch (Throwable unused) {
            }
            try {
                m8249v0(vVar.m26353K(spannableStringBuilder, str), false);
                C1399s0.m37169m0(this, vVar.m26331u() + str.length());
            } catch (Throwable unused2) {
            }
        }
    }
    ...
    public final TdApi.FormattedText mo8279f(boolean z) {
        ...
        TdApi.FormattedText formattedText = new TdApi.FormattedText(spannableStringBuilder.toString(), C4779t2.m25392x5(spannableStringBuilder, false));
        if (z) {
    ...
    public long mo8277g() {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null) {
            return rhVar.m32515Xj();
        }
        AbstractC9563e eVar = this.f30989e0;
        if (eVar == null || !eVar.mo8234o3(this)) {
            return 0L;
        }
        return this.f30989e0.mo8232z(this);
    }
    ...
    public C5976u getInlineSearchContext() {
        return this.f30988d0;
    }

    public String getInput() {
        String obj = getText().toString();
        return (this.f30980S.length() == 0 || this.f30981T.length() == 0 || !obj.endsWith(this.f30980S)) ? obj : obj.substring(0, obj.lastIndexOf(this.f30980S));
    }
    ...
    public void mo8273i(ArrayList<AbstractC4718o<?>> arrayList) {
        AbstractC9563e eVar = this.f30989e0;
        if (eVar == null || !eVar.mo8234o3(this)) {
            ((AbstractView$OnTouchListenerC7889a) getContext()).m14542S(this.f30977P, arrayList, this.f30988d0);
        } else {
            this.f30989e0.mo8236W5(this, arrayList);
        }
    }
    ...
    public boolean mo8271j() {
        return !m8283c0() && this.f30987c0.m2804J2(this.f30977P.m32528Wj());
    }

    @Override
    public boolean mo8269k(CharSequence charSequence, CharSequence charSequence2, C5088i iVar, int i, int i2) {
        AbstractC5090k E = C5078d.m23986z().m24028E(charSequence2, iVar);
        if (E == null) {
            return true;
        }
        this.f30995k0.setSpan(E, i, i2 + i, 33);
        return true;
    }
    ...
    public TdApi.Chat mo8267l() {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null) {
            return rhVar.m32528Wj();
        }
        AbstractC9563e eVar = this.f30989e0;
        if (eVar == null || !eVar.mo8234o3(this)) {
            return null;
        }
        return this.f30989e0.mo8235h7(this);
    }
    ...
    public void mo8265m() {
        ...
        AbstractC9563e eVar = this.f30989e0;
        if (eVar == null || !eVar.mo8234o3(this)) {
            ((AbstractView$OnTouchListenerC7889a) getContext()).m14412y3(this.f30977P, this.f30987c0, null, false, null);
        } else {
            this.f30989e0.mo8233r0(this, null, false);
        }
    }
    ...
    public void mo7519n(AbstractC4718o<?> oVar) {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null) {
            rhVar.m32144zp(oVar.m26334r(), oVar.m26336p(), true, true, false, null);
        }
    }

    public final void m8263n0() {
        int measuredWidth;
        this.f30982U = this.f30980S;
        if (this.f30984W > 0 && this.f30984W > (measuredWidth = (getMeasuredWidth() - this.f30983V) - C1357a0.m37541i(110.0f))) {
            this.f30982U = (String) TextUtils.ellipsize(this.f30980S, this.f30979R, measuredWidth, TextUtils.TruncateAt.END);
        }
    }
    ...
    public long mo8262o() {
        ...
        return this.f30989e0.mo8237D5(this);
    }

    public final boolean m8261o0() {
        View$OnClickListenerC2971rh rhVar;
        return C4868i.m24726c2().m24791T2() && !this.f31007w0 && (rhVar = this.f30977P) != null && rhVar.m32540Vk();
    }
    ...
    public void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (this.f30982U.length() > 0 && this.f30981T.length() > 0 && getLineCount() == 1) {
            String obj = getText().toString();
            if (obj.toLowerCase().equals(this.f30981T.toLowerCase())) {
                m8290X(obj);
                canvas.drawText(this.f30982U, this.f30985a0 + this.f30983V, getBaseline(), this.f30979R);
            }
        }
    }
    ...
    public void mo7518p(C4776t tVar) {
        String Z = tVar.m25732Z();
        if (Z != null && tVar.m26328x()) {
            Editable text = getText();
            SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(text);
            if (!(text.length() == tVar.m26332t() && tVar.m26331u() == 0)) {
                Z = Z + " ";
            }
            try {
                text.replace(tVar.m26331u(), tVar.m26332t(), Z);
            } catch (Throwable unused) {
            }
            try {
                m8249v0(tVar.m26353K(spannableStringBuilder, Z), false);
                C1399s0.m37169m0(this, tVar.m26331u() + Z.length());
            } catch (Throwable unused2) {
            }
        }
    }
    ...
    public void m8260p0(String str) {
        ...
        spannableString.setSpan(C5078d.m23986z().m24028E(str, null), 0, spannableString.length(), 33);
        if (selectionStart == selectionEnd) {
            getText().insert(selectionStart, spannableString);
        } else {
            getText().replace(selectionStart, selectionEnd, spannableString);
        }
        C1399s0.m37169m0(this, length);
    }
    ...
    public final void m8256r0(CharSequence charSequence) {
        ...
        int selectionStart = getSelectionStart();
        int selectionEnd = getSelectionEnd();
        if (this.f30977P != null) {
            C5976u uVar = this.f30988d0;
            if (selectionStart != selectionEnd) {
                selectionStart = -1;
            }
            uVar.m21653o0(charSequence, charSequence2, selectionStart);
            this.f30977P.m32236so(charSequence);
        } else {
            AbstractC9563e eVar = this.f30989e0;
            if (eVar != null) {
                if (eVar.mo8234o3(this)) {
                    C5976u uVar2 = this.f30988d0;
                    if (selectionStart != selectionEnd) {
                        selectionStart = -1;
                    }
                    uVar2.m21653o0(charSequence, charSequence2, selectionStart);
                }
                this.f30989e0.mo8238D4(this, charSequence2);
            }
        }
        if (!this.f31007w0 && (str = this.f31004t0) != null && !str.equals(charSequence2)) {
            m8249v0(this.f31004t0, true);
        }
        if (!this.f30978Q && (rhVar = this.f30977P) != null) {
            rhVar.m32234sq(charSequence.length() > 0);
            if (!this.f30977P.m32448cl()) {
                this.f31005u0 = true;
            }
        }
    ...
    public void run() {
        Editable text = getText();
        if (m8261o0() && this.f30977P != null && !C5070i.m24060j(text) && text.charAt(text.length() - 1) == '\n') {
            text.delete(text.length() - 1, text.length());
            this.f30977P.m32665Lo(false, null, new HandlerC10770jj.AbstractC10786o() {
                @Override
    ...
    public void m8254s0() {
        this.f30988d0.m21706J0(false, false);
    }

    public void setCommandListProvider(C5976u.AbstractC5986j jVar) {
        this.f30988d0.m21710H0(jVar);
    }
    ...
    public void setDraft(TdApi.InputMessageContent inputMessageContent) {
        ...
        if (inputMessageContent == null || inputMessageContent.getConstructor() != 247050392) {
            ...
            charSequence = C4779t2.m25441q5(inputMessageText.text);
            this.f31006v0 = inputMessageText.disableWebPagePreview;
        }
        String trim = getInput().trim();
        boolean z = true;
        this.f30977P.m32509Xp(true, trim.length() > 0);
        if (!charSequence.equals(trim)) {
            ...
            this.f30977P.m32741Fr(charSequence.toString(), false);
        }
    }
    ...
    public void setIgnoreAnyChanges(boolean z) {
        if (this.f31003s0 != z) {
            ...
            CharSequence charSequence = this.f30992h0;
    ...
    public void mo7517t(C4747r rVar, boolean z) {
        ...
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar != null) {
            TdApi.Chat Wj = rhVar.m32528Wj();
            if (z) {
                if ((Wj == null || !C7316a.m17049l(C7316a.m17044q(Wj.f25367id))) && rVar.m26272b0() != null) {
                    sb2 = new StringBuilder();
                    sb2.append(rVar.m26273a0());
                    sb2.append('@');
                    str = rVar.m26272b0();
                } else {
                    sb2 = new StringBuilder();
    ...
    public void m8253t0(TdApi.Chat chat, C4737p7 p7Var, boolean z) {
        ...
        if (this.f30987c0.m2220u6(chat)) {
            if (p7Var != null) {
                inputMessageContent = p7Var.m26297d();
            } else {
    ...
    public boolean mo8252u(String str, TdApi.WebPage webPage) {
        ...
        if (this.f31006v0) {
            this.f31006v0 = false;
            rhVar.m32580Sk(str, webPage);
            return false;
        }
        rhVar.m32508Xq(str, webPage);
        return true;
    }
    ...
    public boolean mo8250v() {
        return this.f30989e0 == null && ((AbstractView$OnTouchListenerC7889a) getContext()).m14503d0();
    }
    ...
    public void m8249v0(CharSequence charSequence, boolean z) {
        ...
        if (z) {
            C1399s0.m37169m0(this, charSequence != null ? charSequence.length() : 0);
        }
        this.f31007w0 = false;
    }
    ...
    public int mo8248w(int i, String str) {
        View$OnClickListenerC2971rh rhVar = this.f30977P;
        if (rhVar == null || !rhVar.m32396gl()) {
            return 0;
        }
        if (!C4868i.m24726c2().m24763X2(2L)) {
            return C4868i.m24726c2().m24798S2() ? 0 : 2;
        }
        AlertDialog alertDialog = this.f31002r0;
        if (alertDialog != null && alertDialog.isShowing()) {
            return 1;
        }
        AlertDialog.Builder builder = new AlertDialog.Builder(this.f30977P.mo4347s(), C11524j.m150v());
        builder.setTitle(C4403w.m27869i1(R.string.AppName));
        builder.setMessage(C4403w.m27869i1(R.string.SecretLinkPreviewAlert));
        builder.setPositiveButton(C4403w.m27869i1(R.string.SecretLinkPreviewEnable), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i2) {
                RunnableC9558i0.this.m8266l0(dialogInterface, i2);
            }
        });
        builder.setNegativeButton(C4403w.m27869i1(R.string.SecretLinkPreviewDisable), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i2) {
        ...
        this.f31002r0 = this.f30977P.m9344Sd(builder);
        return 1;
    }

    public void m8247w0(int i, Object... objArr) {
        String j1 = C4403w.m27865j1(i, objArr);
        this.f30996l0 = i;
        this.f30997m0 = objArr;
        if (!C5070i.m24067c(j1, this.f30998n0)) {
            this.f30998n0 = j1;
            if (this.f30977P == null) {
                setHint(j1);
                return;
            }
            this.f30999o0 = C7389v0.m16680T1(j1, getPaint());
            this.f31000p0 = 0;
            m8291W();
        }
    }
    ...
    public void m8246x0(boolean z, String str) {
        this.f30988d0.m21706J0(z, getText().toString().equals(str));
    }
