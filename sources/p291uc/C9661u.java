...
public class C9661u extends RecyclerView.AbstractC0890h<C9663b> {
    public final Context f31380M;
    public final View$OnClickListenerC9694y f31381N;
    public final ArrayList<AbstractC4718o<?>> f31382O = new ArrayList<>();
    public final C11537v f31383P;
    public C10930q6 f31384Q;
    ...
    public static class C9663b extends RecyclerView.AbstractC0886d0 {
        ...
        public class C9664a extends C6879f3 {
            public final AbstractC9662a f31386Q;
            ...
            public void onMeasure(int i, int i2) {
                setMeasuredDimension(View.getDefaultSize(getSuggestedMinimumWidth(), i), View.MeasureSpec.makeMeasureSpec(this.f31386Q.mo7565L(), Log.TAG_TDLIB_OPTIONS));
            }
        }
        ...
        public class C9665b extends C6847b2 {
            ...
            public void onDraw(Canvas canvas) {
                super.onDraw(canvas);
                canvas.drawRect(0.0f, getMeasuredHeight() - Math.max(1, C1357a0.m37544i(0.5f)), getMeasuredWidth(), getMeasuredHeight(), C1410y.m37042g(C11524j.m223P0()));
            }
        }
        ...
        public static C9663b m7830O(Context context, C10930q6 q6Var, int i, boolean z, View$OnClickListenerC6902i.AbstractC6906d dVar, View.OnClickListener onClickListener, View.OnLongClickListener onLongClickListener, C2099j.AbstractC2102c cVar, AbstractC9662a aVar, C11537v vVar) {
            if (i == 0) {
                ...
                bVar.setPadding(C1357a0.m37544i(16.0f), 0, C1357a0.m37544i(16.0f), C1357a0.m37544i(1.0f));
                bVar.setTypeface(C1389o.m37263i());
                ...
                C1399s0.m37196a0(bVar);
                C10189d.m5794j(bVar);
                bVar.setLayoutParams(new RecyclerView.LayoutParams(-1, C1357a0.m37544i(36.0f) + C1357a0.m37544i(1.0f)));
    ...
    public int mo6150F(int i) {
        ...
        int v = this.f31382O.get(i2).m26331v();
        if (v == 6) {
            return 4;
        }
        if (v == 15) {
    ...
    public void m7840a0(ArrayList<AbstractC4718o<?>> arrayList) {
        int D = mo6153D();
        this.f31382O.addAll(arrayList);
        m39311M(D, arrayList.size());
    }
    ...
    public void mo6146Q(C9663b bVar, int i) {
        ...
        if (n != 0) {
            if (n == 1) {
                AbstractC4718o<?> oVar = this.f31382O.get(i - 1);
                ((C10185a) bVar.f3479a).setInlineResult(oVar);
                bVar.f3479a.setTag(oVar);
            } else if (n == 2) {
                C4729p pVar = (C4729p) this.f31382O.get(i - 1);
                ((TextView) bVar.f3479a).setText(pVar.m26313a0().toUpperCase());
                bVar.f3479a.setTag(pVar);
            } else if (n == 3) {
                AbstractC4718o<?> oVar2 = this.f31382O.get(i - 1);
                ((C2099j) bVar.f3479a).setSticker(((C4575a0) oVar2).m27300Z());
                bVar.f3479a.setTag(oVar2);
            } else if (n == 4) {
                AbstractC4718o<?> oVar3 = this.f31382O.get(i - 1);
                ((C10036a) bVar.f3479a).setGif(((C4801u) oVar3).m25225Z());
                bVar.f3479a.setTag(oVar3);
            } else if (n == 5) {
                C4847z zVar = (C4847z) this.f31382O.get(i - 1);
                ((C9628p) bVar.f3479a).m7960B0(zVar.m25051a0(), zVar.m25050b0(), zVar.m25052Z());
                bVar.f3479a.setTag(zVar);
            }
        } else if (bVar.f3479a.getMeasuredHeight() != this.f31381N.mo7565L()) {
            bVar.f3479a.requestLayout();
        }
    }

    public C9663b mo6145S(ViewGroup viewGroup, int i) {
        Context context = this.f31380M;
        C10930q6 q6Var = this.f31384Q;
        boolean z = this.f31385R;
        View$OnClickListenerC9694y yVar = this.f31381N;
        return C9663b.m7830O(context, q6Var, i, z, yVar, yVar, yVar, yVar, yVar, this.f31383P);
    }
