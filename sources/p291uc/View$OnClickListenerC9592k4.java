...
public class View$OnClickListenerC9592k4 extends RecyclerView.AbstractC0890h<C9593a> implements View.OnClickListener, AbstractC11508a {
    public static final int[] f31099T = {2040615, 2957363, 8923969, 6311250, 5930367, 5726831, 3757446, 4689847, 7781324, 8310740, 12772324, 11917257, 9160616, 16641969, 16776621, 15423082, 15626350, 15835038, 13661014, 16306846, 15065270, 13883841, 15198420, 13490923, 13947373, 13553358, 15593713};
    public final AbstractC9323v4<?> f31100M;
    public ArrayList<C11520h> f31101N;
    public C11520h f31102O;
    public final int f31104Q;
    public C11520h f31105R;
    public int f31106S = -1;
    public final ArrayList<RecyclerView> f31103P = new ArrayList<>();
    ...
    public static class C9594b extends SparseDrawableView implements C3950k.AbstractC3952b, AbstractC5911c {
        ...
        public C11520h f31108N;
        public float f31109O;
        public C3950k f31110P;
        public final C1359b.C1360a f31111Q = new C1359b.C1360a();
        public final C6257p f31112b = new C6257p(this, 0);
        public final C6257p f31113c = new C6257p(this, 0);
        ...
        public void mo4501a3() {
            this.f31112b.mo20249Z();
            this.f31113c.mo20249Z();
        }

        public void m8068b() {
            this.f31112b.mo20247b();
            this.f31113c.mo20247b();
        }

        public void m8067f() {
            this.f31112b.mo20245f();
            this.f31113c.mo20245f();
        }
        ...
        public void onDraw(Canvas canvas) {
            int i;
            Drawable X;
            C11520h hVar = this.f31108N;
            if (hVar == null || hVar.m319R()) {
                canvas.drawColor(C11524j.m199b());
            } else if (this.f31108N.m315V()) {
                canvas.drawColor(this.f31108N.m294i());
            } else if (this.f31108N.m316U()) {
                C1359b.m37507l(canvas, this.f31111Q, 0, 0, getMeasuredWidth(), getMeasuredHeight(), this.f31108N.m326K(), this.f31108N.m286m(), this.f31108N.m329H(), 1.0f);
            } else if (this.f31108N.m317T()) {
                C1359b.m37503p(canvas, this.f31111Q, 0, 0, getMeasuredWidth(), getMeasuredHeight(), this.f31108N.m276r(), 1.0f);
            } else if (this.f31108N.m313X()) {
                if (this.f31108N.m311Z()) {
                    C1359b.m37507l(canvas, this.f31111Q, 0, 0, getMeasuredWidth(), getMeasuredHeight(), this.f31108N.m326K(), this.f31108N.m286m(), this.f31108N.m329H(), 1.0f);
                } else if (this.f31108N.m312Y()) {
                    C1359b.m37503p(canvas, this.f31111Q, 0, 0, getMeasuredWidth(), getMeasuredHeight(), this.f31108N.m276r(), 1.0f);
                } else {
                    canvas.drawColor(this.f31108N.m294i());
                }
                float F = this.f31108N.m331F();
                int i2 = (F > 1.0f ? 1 : (F == 1.0f ? 0 : -1));
                if (i2 != 0) {
                    C6257p pVar = this.f31113c;
                    pVar.mo20250U(F * pVar.mo20252R0());
                }
                this.f31113c.draw(canvas);
                if (i2 != 0) {
                    this.f31113c.mo20253P();
                }
            } else {
                if (this.f31113c.mo20246c0()) {
                    if (this.f31112b.mo20246c0()) {
                        this.f31112b.mo20255N(canvas);
                    }
                    this.f31112b.draw(canvas);
                }
                this.f31113c.draw(canvas);
            }
            float f = this.f31107M ? this.f31109O : 1.0f;
            int measuredWidth = getMeasuredWidth() / 2;
            int measuredHeight = getMeasuredHeight() / 2;
            C11520h hVar2 = this.f31108N;
            boolean z = hVar2 != null && hVar2.m320Q();
            float f2 = z ? 1.0f : this.f31109O;
            float f3 = 0.0f;
            if (f2 != 0.0f) {
                canvas.drawCircle(measuredWidth, measuredHeight, C1357a0.m37541i(28.0f), C1410y.m37039g(C5064d.m24130b((int) (f2 * 86.0f), 0)));
                if (z) {
                    Paint W = C1410y.m37055W(-1);
                    W.setAlpha((int) ((1.0f - this.f31109O) * 255.0f));
                    C1362c.m37487b(canvas, mo14042X(R.drawable.baseline_image_24, 0), measuredWidth - (X.getMinimumWidth() / 2), measuredHeight - (X.getMinimumHeight() / 2), W);
                    W.setAlpha(255);
                }
                float f4 = f <= 0.3f ? 0.0f : (f - 0.3f) / 0.7f;
                if (f4 > 0.0f) {
                    int b = C5064d.m24130b((int) (this.f31109O * 255.0f), -1);
                    ...
                    canvas.save();
                    canvas.translate((measuredWidth / 2) + C1357a0.m37541i(13.0f), measuredHeight + C1357a0.m37541i(1.0f));
                    canvas.rotate(-45.0f);
                    int i4 = C1357a0.m37541i(14.0f);
                    int i5 = C1357a0.m37541i(7.0f);
                    int i6 = C1357a0.m37541i(4.0f);
                    int i7 = C1357a0.m37541i(11.0f);
                    int i8 = C1357a0.m37541i(2.0f);
                    float f6 = i6;
                    canvas.drawRect(f6, i7 - i5, i6 + i8, i + ((int) (i5 * f5)), C1410y.m37039g(b));
                    canvas.drawRect(f6, i7 - i8, i6 + ((int) (i4 * f3)), i7, C1410y.m37039g(b));
                    canvas.restore();
                }
            }
        }
        ...
        public void onMeasure(int i, int i2) {
            ...
            this.f31112b.mo20256K0(0, 0, measuredWidth, measuredHeight);
            this.f31113c.mo20256K0(0, 0, measuredWidth, measuredHeight);
        }
        ...
        public final void m8066t(float f) {
            if (this.f31110P == null) {
                this.f31110P = new C3950k(0, this, C2057b.f7280b, 180L, this.f31109O);
            }
            this.f31110P.m29544i(f);
        }

        public final void m8065u(float f) {
            C3950k kVar = this.f31110P;
            if (kVar != null) {
                kVar.m29541l(f);
            }
            setFactor(f);
        ...
        public void m8064v(C11520h hVar) {
            this.f31108N = hVar;
            this.f31112b.m20819G(hVar.m330G(true));
            this.f31113c.m20819G(hVar.m330G(false));
        }
        ...
        public void m8062y(C11520h hVar, boolean z) {
            ...
            if (hVar != null) {
                if (hVar.m313X()) {
                    this.f31113c.setColorFilter(hVar.m335B());
                    this.f31112b.m20819G(null);
                } else {
                    this.f31113c.mo20260D();
                    this.f31112b.m20819G(hVar.m330G(true));
                }
                this.f31113c.m20819G(hVar.m330G(false));
            } else {
                this.f31112b.m20819G(null);
                this.f31113c.m20819G(null);
            }
            m8063x(z, false);
        }
    }
    ...
    public View$OnClickListenerC9592k4(AbstractC9323v4<?> v4Var, int i) {
        this.f31100M = v4Var;
        this.f31104Q = i;
        this.f31102O = v4Var.mo4348c().m2294pc().m4148I(C11524j.m177i0());
    ...
    public static int m8086f0(RecyclerView recyclerView, LinearLayoutManager linearLayoutManager, int i, int i2) {
        ...
        if (C4403w.m27984G2()) {
            return i3 + (linearLayoutManager.m39232T(C) - recyclerView.getMeasuredWidth());
        }
        return i3 - linearLayoutManager.m39237Q(C);
    }
    ...
    public static ArrayList<C11520h> m8081k0(C10930q6 q6Var, List<C11520h> list, int i) {
        ...
        try {
            ...
            if (C5070i.m24061i(str)) {
                C6246h i2 = C4356b0.m28201k().m28203i();
                str = i2 != null ? i2.mo20875q() : "custom";
            }
        ...
        ArrayList<C11520h> arrayList = new ArrayList<>(list.size() + i4 + i3 + f31099T.length);
        if (i4 != 0) {
            arrayList.add(hVar);
        }
        if (i3 != 0) {
        ...
        for (int i5 : v) {
            ...
            if (h0 != null) {
                ...
                while (true) {
                    ...
                    if (C5070i.m24067c(next.m268w(), h0.m268w())) {
        ...
        for (int length = f31099T.length - 1; length >= 0; length--) {
            int i6 = f31099T[length];
            while (true) {
                if (size < 0) {
                    z = false;
                    break;
    ...
    public void m8078n0(List list) {
        final ArrayList<C11520h> k0 = m8081k0(this.f31100M.mo4348c(), list, this.f31104Q);
    ...
    @Override
    public int mo6153D() {
        ArrayList<C11520h> arrayList = this.f31101N;
        if (arrayList != null) {
    ...
    public int mo6150F(int i) {
        return this.f31101N != null ? 0 : 1;
    }

    @Override
    public void mo6619P(RecyclerView recyclerView) {
        this.f31103P.add(recyclerView);
        int j0 = m8082j0(this.f31102O);
        if (j0 != -1) {
            ((LinearLayoutManager) recyclerView.getLayoutManager()).m39522z2(j0, (C1357a0.m37543g() / 2) - (C1357a0.m37541i(105.0f) / 2));
        }
    }

    @Override
    public void mo6614T(RecyclerView recyclerView) {
        this.f31103P.remove(recyclerView);
    }
    ...
    public void m8084h0(boolean z, int i) {
        Iterator<RecyclerView> it = this.f31103P.iterator();
        while (it.hasNext()) {
            RecyclerView next = it.next();
            LinearLayoutManager linearLayoutManager = (LinearLayoutManager) next.getLayoutManager();
            if (next.getMeasuredWidth() == 0) {
                linearLayoutManager.mo39018x1(i);
            } else {
                int measuredWidth = next.getMeasuredWidth() / 2;
                int i2 = C1357a0.m37541i(105.0f);
                int i3 = C1357a0.m37541i(3.0f);
                if (z) {
                    int f0 = m8086f0(next, linearLayoutManager, i2, i3);
                    int i4 = i2 + i3;
                    int max = Math.max(0, Math.min(((this.f31101N.size() * i4) + i3) - next.getMeasuredWidth(), ((i4 * i) - measuredWidth) + (i2 / 2) + i3));
                    if (max != f0) {
                        next.m39496D1();
                        next.mo8024v1(C4403w.m27984G2() ? f0 - max : max - f0, 0);
                    }
                } else {
                    linearLayoutManager.m39522z2(i, (measuredWidth - (i2 / 2)) - i3);
                }
            }
        }
    }
    ...
    public final int m8082j0(C11520h hVar) {
        ...
        if (this.f31106S != -1 && C11520h.m298g(this.f31105R, hVar)) {
            return this.f31106S;
        }
        int i = 0;
        Iterator<C11520h> it = this.f31101N.iterator();
        while (it.hasNext()) {
            C11520h next = it.next();
    ...
    public void mo6146Q(C9593a aVar, int i) {
        ...
        if (aVar.m39332n() == 0 && (arrayList = this.f31101N) != null) {
            C11520h hVar = arrayList.get(i);
            ((C9594b) aVar.f3479a).m8062y(hVar, C11520h.m298g(hVar, this.f31102O));
        }
    }
    ...
    public void onClick(View view) {
        ...
        if (wallpaper.m320Q()) {
            ...
            this.f31100M.mo4348c().m2294pc().m4096s0(wallpaper, true, C11524j.m177i0());
        }
    }

    public C9593a mo6145S(ViewGroup viewGroup, int i) {
        return C9593a.m8069O(this.f31100M.mo4347s(), i, this, null);
    }

    @Override
    public void mo377q(C10930q6 q6Var, C11520h hVar, int i) {
        if (this.f31100M.mo4348c() == q6Var && C11524j.m177i0() == i) {
            ArrayList<C11520h> arrayList = this.f31101N;
            if (arrayList != null && !arrayList.isEmpty() && hVar != null && hVar.m320Q()) {
                int i2 = 0;
                if (!C11520h.m298g(this.f31101N.get(0), hVar)) {
                    C11520h hVar2 = this.f31101N.get(0);
                    this.f31101N.set(0, hVar);
                    int j0 = m8082j0(hVar);
                    if (j0 != -1) {
                        Iterator<RecyclerView> it = this.f31103P.iterator();
                        while (it.hasNext()) {
                            View C = it.next().getLayoutManager().mo39262C(j0);
    ...
    public final void m8079m0(ArrayList<C11520h> arrayList) {
        int D = mo6153D();
        this.f31101N = arrayList;
        C11520h I = this.f31100M.mo4348c().m2294pc().m4148I(C11524j.m177i0());
        this.f31102O = I;
        int j0 = m8082j0(I);
        if (j0 == -1) {
            j0 = 0;
    ...
    public final void m8072t0(C11520h hVar) {
        if (!C11520h.m298g(this.f31102O, hVar)) {
            C11520h hVar2 = this.f31102O;
            this.f31102O = hVar;
            m8071u0(hVar2, false);
            m8071u0(hVar, true);
            m8085g0(true);
