...
public class RunnableC9651s3 implements Client.AbstractC7865g, Runnable, AbstractC5911c {
    public static int f31326n0;
    public static int f31327o0;
    public static int f31328p0;
    public static int f31329q0;
    public long f31330M;
    public TdApi.MessageSender f31331N;
    public String f31332O;
    public int f31333P;
    public int f31334Q;
    public int f31335R;
    public String f31336S;
    public C4779t2.C4783d f31337T;
    public C6246h f31338U;
    public C6246h f31339V;
    public Path f31340W;
    public boolean f31341X;
    public RunnableC5390g f31342Y;
    public RunnableC5390g f31343Z;
    public final C10930q6 f31344a;
    public View f31345a0;
    public final AbstractC4761s4 f31346b;
    public AbstractC4345j f31347b0;
    public long f31348c;
    public Path f31349c0;
    public int f31350d0;
    public int f31351e0;
    public int f31352f0;
    public int f31353g0;
    ...
    public int f31355i0;
    public int f31356j0;
    public TdApi.Function f31357k0;
    public TdApi.Message f31358l0;
    public volatile boolean f31359m0;
    ...
    public class C9652a implements AbstractC5408k {
        ...
        @Override
        public int mo7855c() {
            return RunnableC9651s3.this.f31346b.m25923h2();
        }
    ...
    public class C9653b implements AbstractC5408k {
        ...
        @Override
        public int mo7855c() {
            return RunnableC9651s3.this.f31346b.m26155J4();
        }
    ...
    public int m7906G() {
        return C11524j.m228N(this.f31333P);
    }
    ...
    public static C5457w0 m7869p() {
        return C1410y.m37086A0(13.0f);
    }

    public static C5457w0 m7865t(boolean z) {
        return C1410y.m37086A0(z ? 15.0f : 13.0f);
    }

    public static int m7861x() {
        return f31329q0 + C1357a0.m37544i(10.0f);
    }

    public static void m7860y() {
        f31326n0 = C1357a0.m37544i(3.0f);
        f31328p0 = C1357a0.m37544i(7.0f);
        f31327o0 = C1357a0.m37544i(34.0f);
        f31329q0 = C1357a0.m37544i(41.0f);
    }

    public final boolean m7912A() {
        AbstractC4761s4 s4Var = this.f31346b;
        if (s4Var != null) {
            return s4Var.m26134L5();
        }
        TdApi.Message message = this.f31358l0;
    ...
    public boolean m7911B(float f, float f2, boolean z) {
        ...
        if (f >= i && f <= i + m7883b0(z)) {
            int i2 = this.f31356j0;
            if (f2 >= i2 && f2 <= i2 + f31329q0) {
                return true;
            }
        }
        return false;
    ...
    public final boolean m7910C() {
        return this.f31346b != null;
    }

    public final boolean m7909D() {
        AbstractC4761s4 s4Var = this.f31346b;
        return s4Var != null && s4Var.m25919h6();
    }

    public final boolean m7908E() {
        AbstractC4761s4 s4Var = this.f31346b;
        return s4Var != null && s4Var.m25900j6();
    }

    public void m7902K(int i) {
        if (this.f31334Q != i && i > 0) {
            this.f31334Q = i;
            m7877h();
        }
    }
    ...
    public final void m7901L(int i, int i2, int i3, int i4) {
        if (this.f31349c0 == null) {
            this.f31349c0 = new Path();
        }
        int i5 = C1357a0.m37544i(C11524j.m208X());
        if (this.f31350d0 != i || this.f31351e0 != i2 || this.f31352f0 != i3 || this.f31353g0 != i4 || this.f31354h0 != i5) {
            this.f31350d0 = i;
            this.f31351e0 = i2;
            this.f31352f0 = i3;
            this.f31353g0 = i4;
            ...
            a0.set(i, i2, i3, i4);
            float f = i5;
            this.f31349c0.addRoundRect(a0, f, f, Path.Direction.CCW);
        }
    }
    ...
    public void m7900M() {
        TdApi.Message B0;
        AbstractC4761s4 s4Var = this.f31346b;
        if (s4Var == null || (B0 = s4Var.m26072R6().m7808E0().m8125B0(this.f31348c, this.f31330M)) == null) {
            this.f31335R |= 16;
            if (m7910C()) {
                this.f31357k0 = new TdApi.GetMessage(this.f31348c, this.f31346b.m25994Z3().replyToMessageId);
                this.f31344a.m2270r4().m14783o(new TdApi.GetRepliedMessage(this.f31348c, this.f31346b.m26116N3()), this);
                return;
            }
            this.f31344a.m2270r4().m14783o(new TdApi.GetMessage(this.f31348c, this.f31330M), this);
            return;
        }
    ...
    public boolean m7899N(View view, MotionEvent motionEvent) {
        RunnableC5390g gVar;
        return ((this.f31335R & 2) == 0 || (gVar = this.f31343Z) == null || !gVar.m22968U0(view, motionEvent)) ? false : true;
    }
    ...
    public void m7896Q(C6240c cVar) {
        cVar.mo20260D0(this.f31341X ? (m7910C() ? f31329q0 : f31327o0) / 2 : 0);
        cVar.m20978j(this.f31338U, this.f31339V);
    }
    ...
    public void m7893T(CharSequence charSequence, TdApi.Message message, boolean z) {
        m7887Z(m7867r(charSequence, message));
        int h = C5063c.m24139h(this.f31335R, 8, !C5070i.m24062i(charSequence));
        this.f31335R = h;
        this.f31335R = C5063c.m24139h(h, 32, z);
        m7888Y(message, false, false);
    }
    ...
    public void m7892U(String str, C4779t2.C4783d dVar, TdApi.Minithumbnail minithumbnail, TdApi.File file) {
        C6246h hVar;
        C6250i iVar = null;
        if (file == null || C4779t2.m25605S2(file)) {
            hVar = null;
        } else {
            C6246h hVar2 = new C6246h(this.f31344a, file);
            hVar2.m20931Z(true);
            hVar2.mo20768t0(f31327o0);
            hVar2.m20910k0();
            hVar2.m20898s0(2);
            hVar = hVar2;
        }
    ...
    public final void m7888Y(TdApi.Message message, boolean z, boolean z2) {
        ...
        this.f31358l0 = message;
        boolean z4 = false;
        if ((this.f31335R & Log.TAG_YOUTUBE) == 0 || this.f31344a.m2411i7(message)) {
            this.f31333P = 0;
        } else {
            this.f31333P = C4779t2.m25625P1(new C10712hc(this.f31344a, message.chatId, message.senderId).m4214b());
        }
        ...
        switch (message.content.getConstructor()) {
            case TdApi.MessagePhoto.CONSTRUCTOR:
                ...
                photoSize = C4630f0.m26740k0(this.f31344a, photo.sizes, message.chatId);
                TdApi.PhotoSize H0 = C7321e.m17004H0(photo);
                thumbnail = (H0 == null || H0 == photoSize) ? null : C4779t2.m25656K5(photoSize);
            ...
            case TdApi.MessageChatChangePhoto.CONSTRUCTOR:
                ...
                photoSize = C4630f0.m26740k0(this.f31344a, chatPhoto.sizes, message.chatId);
                TdApi.PhotoSize I0 = C7321e.m17002I0(chatPhoto.sizes);
                thumbnail = (I0 == null || I0 == photoSize) ? null : C4779t2.m25656K5(photoSize);
            ...
            case TdApi.MessageGame.CONSTRUCTOR:
                ...
                photoSize = C4630f0.m26740k0(this.f31344a, photo2.sizes, message.chatId);
            ...
            case TdApi.MessageSticker.CONSTRUCTOR:
                ...
                if (sticker != null) {
                    ...
                    if (thumbnail4 == null) {
                        thumbnail4 = C4779t2.m25649L5(sticker);
                    }
            ...
            case TdApi.MessageText.CONSTRUCTOR:
                ...
                if (webPage != null) {
                    ...
                    if (photo3 != null) {
                        photoSize = C4630f0.m26740k0(this.f31344a, photo3.sizes, message.chatId);
        ...
        C6246h D5 = C4779t2.m25705D5(this.f31344a, thumbnail);
        boolean z6 = D5 != null && thumbnail.format.getConstructor() == -53588974;
        if (D5 == null && photoSize != null) {
            D5 = new C6246h(this.f31344a, photoSize.photo);
        }
        if (D5 != null) {
            D5.m20898s0(z6 ? 1 : 2);
            if (!z6) {
        ...
        if (minithumbnail != null) {
            ...
            iVar.m20931Z(true);
            iVar.m20898s0(z6 ? 1 : 2);
            hVar = iVar;
        } else {
            hVar = null;
        }
        C4779t2.C4783d R0 = C4779t2.m25613R0(this.f31344a, message.chatId, message);
        if (!m7912A() || (messageForwardInfo = message.forwardInfo) == null) {
            this.f31331N = message.senderId;
            if (this.f31344a.m2613V6(message)) {
            ...
            switch (messageForwardInfo.origin.getConstructor()) {
                case TdApi.MessageForwardOriginMessageImport.CONSTRUCTOR:
                    this.f31332O = ((TdApi.MessageForwardOriginMessageImport) message.forwardInfo.origin).senderName;
                    this.f31331N = null;
                    break;
                case TdApi.MessageForwardOriginUser.CONSTRUCTOR:
                    this.f31331N = new TdApi.MessageSenderUser(((TdApi.MessageForwardOriginUser) message.forwardInfo.origin).senderUserId);
                    this.f31332O = null;
                    break;
                case TdApi.MessageForwardOriginHiddenUser.CONSTRUCTOR:
                    this.f31332O = ((TdApi.MessageForwardOriginHiddenUser) message.forwardInfo.origin).senderName;
                    this.f31331N = null;
                    break;
                case TdApi.MessageForwardOriginChannel.CONSTRUCTOR:
                    ...
                    this.f31331N = new TdApi.MessageSenderChat(messageForwardOriginChannel.chatId);
                    if (!C5070i.m24062i(messageForwardOriginChannel.authorSignature)) {
                ...
                case TdApi.MessageForwardOriginChat.CONSTRUCTOR:
                    ...
                    this.f31331N = new TdApi.MessageSenderChat(messageForwardOriginChat.senderChatId);
                    this.f31332O = messageForwardOriginChat.authorSignature;
                    break;
                default:
                    throw new IllegalArgumentException(message.forwardInfo.origin.toString());
            }
        }
        if (C5063c.m24145b(this.f31335R, 8)) {
            j1 = this.f31336S;
        } else if (this.f31331N == null) {
            j1 = this.f31332O;
        } else if (C5070i.m24062i(this.f31332O)) {
            j1 = this.f31344a.m2135zb(this.f31331N, m7910C());
        } else {
            j1 = C4403w.m27867j1(m7912A() ? R.string.format_channelAndSignature : R.string.format_chatAndSignature, this.f31344a.m2135zb(this.f31331N, m7910C()), this.f31332O);
        }
        String str2 = j1;
        if (Thread.currentThread() == C4383l.m28061a().m28058d() || z2) {
            this.f31337T = R0;
            m7887Z(str2);
            this.f31338U = hVar;
            this.f31340W = path;
    ...
    public final void m7887Z(CharSequence charSequence) {
        this.f31336S = charSequence != null ? charSequence.toString() : null;
    }
    ...
    public int m7883b0(boolean z) {
        ...
        if (!m7863v()) {
            ...
            int i5 = f31326n0;
            i = max2 + i4 + i5 + i5 + i4;
            i2 = m7910C() ? f31329q0 : f31327o0;
        }
        return i + i2 + (z ? C1357a0.m37544i(3.0f) : 0);
    }

    public final void m7878g() {
        AbstractC5411l0[] l0VarArr;
        int n = m7871n();
        C4779t2.C4783d dVar = this.f31337T;
        RunnableC5390g.C5392b j = new RunnableC5390g.C5392b(dVar != null ? dVar.m25376c(true) : C4403w.m27871i1(R.string.LoadingMessage), n, m7910C() ? AbstractC4761s4.m26126M4() : m7869p(), m7872m()).m22869v().m22866y(8).m22879l().m22881j();
        C4779t2.C4783d dVar2 = this.f31337T;
        AbstractC4345j jVar = null;
        if (dVar2 == null || C7321e.m16965a1(dVar2.f16272d)) {
            l0VarArr = null;
        } else {
            C10930q6 q6Var = this.f31344a;
            TdApi.FormattedText formattedText = this.f31337T.f16272d;
            l0VarArr = AbstractC5411l0.m22791E(q6Var, formattedText.text, formattedText.entities, null);
        }
        RunnableC5390g.C5392b i = j.m22882i(l0VarArr);
        AbstractC4345j jVar2 = this.f31347b0;
        if (jVar2 != null) {
            jVar = jVar2;
        } else {
            View view = this.f31345a0;
            if (view != null) {
                jVar = new C4343h(view);
            }
        }
        final RunnableC5390g f = i.m22865z(jVar).m22885f();
    ...
    public final void m7876i() {
        ...
        if (str == null) {
            str = C4403w.m27871i1(m7912A() ? R.string.LoadingChannel : R.string.LoadingUser);
        }
        this.f31342Y = new RunnableC5390g.C5392b(str, n, m7865t(m7910C()), m7866s()).m22869v().m22884g().m22889b().m22887d().m22865z(this.f31347b0).m22885f();
    }
    ...
    public boolean m7875j(long j) {
        ...
        m7890W(C4403w.m27871i1(R.string.Error), new C4779t2.C4783d((C4779t2.C4787f) null, (int) R.string.DeletedMessage), null, null, null, false, true);
        return true;
    }
    ...
    public void m7874k(Canvas canvas, int i, int i2, int i3, int i4, AbstractC6264v vVar, boolean z) {
        ...
        int i9;
        AbstractC4761s4 s4Var = this.f31346b;
        boolean z2 = s4Var != null && s4Var.m26059S8();
        this.f31355i0 = i;
        this.f31356j0 = i2;
        boolean D = m7909D();
        RectF a0 = C1410y.m37053a0();
        if (z2) {
            int i10 = C1357a0.m37544i(8.0f);
            int i11 = C1357a0.m37544i(12.0f);
            a0.top = i2 - i10;
            a0.bottom = f31329q0 + i2 + i10;
            a0.left = i - i11;
            a0.right = i + i4;
            float I = C11524j.m238I();
            canvas.drawRoundRect(a0, I, I, C1410y.m37042g(this.f31346b.m25933g2()));
        }
        if (m7863v()) {
            int i12 = f31326n0;
            int i13 = i12 + i12;
            if (z) {
                i8 = (i3 - i13) - (m7910C() ? f31329q0 : f31327o0);
            } else {
                i8 = i13 + i;
            }
            if (m7910C()) {
                int i14 = f31329q0;
                vVar.mo20257K0(i8, i2, i8 + i14, i14 + i2);
            } else {
                int i15 = f31327o0;
                vVar.mo20257K0(i8, i2, i8 + i15, i15 + i2);
            }
            if (Build.VERSION.SDK_INT >= 19) {
                m7901L(vVar.getLeft(), vVar.getTop(), vVar.getRight(), vVar.getBottom());
                i9 = C10192g.m5789b(canvas, this.f31349c0);
            } else {
                i9 = Integer.MIN_VALUE;
            }
            if (vVar.mo20247c0()) {
                vVar.mo20255O(canvas, this.f31340W);
            }
            vVar.draw(canvas);
        ...
        if (m7910C()) {
            int o = m7870o();
            RunnableC5390g gVar = this.f31342Y;
            if (gVar != null) {
                int i16 = i + o;
                gVar.m22902u(canvas, i16, gVar.getWidth() + i16, 0, i2 + C1357a0.m37544i(1.0f));
            }
            RunnableC5390g gVar2 = this.f31343Z;
            if (gVar2 != null) {
                int i17 = i + o;
                gVar2.m22902u(canvas, i17, i17 + gVar2.getWidth(), 0, i2 + C1357a0.m37544i(22.0f));
            }
            if (z) {
                a0.set(i3 - f31326n0, i2, i3, f31329q0 + i2);
            } else {
                a0.set(i, i2, f31326n0 + i, f31329q0 + i2);
            }
            int i18 = f31326n0;
            float f = i18 / 2;
            float f2 = i18 / 2;
            if (z2) {
                i6 = this.f31346b.m25923h2();
            } else {
                if (D) {
            ...
            canvas.drawRoundRect(a0, f, f2, C1410y.m37042g(i6));
            return;
        }
        if (m7863v()) {
            int i19 = f31326n0;
            i5 = i + i19 + f31328p0 + i19 + f31327o0;
        } else {
            i5 = f31326n0 + i + f31328p0;
        }
        RunnableC5390g gVar3 = this.f31342Y;
        if (gVar3 != null) {
            gVar3.m22902u(canvas, i5, i5 + gVar3.getWidth(), 0, i2 + C1357a0.m37544i(1.0f));
        }
        RunnableC5390g gVar4 = this.f31343Z;
        if (gVar4 != null) {
            gVar4.m22902u(canvas, i5, i5 + gVar4.getWidth(), 0, i2 + C1357a0.m37544i(19.0f));
        }
        C1410y.m37053a0().set(i, i2, f31326n0 + i, f31327o0 + i2);
        RectF a02 = C1410y.m37053a0();
        int i20 = f31326n0;
        canvas.drawRoundRect(a02, i20 / 2, i20 / 2, C1410y.m37042g(C11524j.m228N(R.id.theme_color_messageVerticalLine)));
    }

    public String m7873l() {
        TdApi.MessageSender messageSender = this.f31331N;
        return messageSender != null ? this.f31344a.m2151yb(messageSender) : this.f31332O;
    }

    public final AbstractC5408k m7872m() {
        AbstractC4761s4 s4Var = this.f31346b;
        if (s4Var != null) {
            return s4Var.m26059S8() ? new C9652a() : new C9653b();
        }
        if (C5063c.m24145b(this.f31335R, 2)) {
    ...
    public final int m7870o() {
        if (m7863v()) {
            int i = f31326n0;
            return f31328p0 + i + i + f31329q0;
        }
        return f31328p0 + f31326n0;
    }

    public final int m7868q() {
        RunnableC5390g gVar = this.f31343Z;
        if (gVar != null) {
    ...
    public final CharSequence m7867r(CharSequence charSequence, TdApi.Message message) {
        ...
        if (message != null) {
            return this.f31344a.m2655S9(message, false, m7910C());
        }
        return C4403w.m27871i1(m7912A() ? R.string.LoadingChannel : R.string.LoadingUser);
    }
    ...
    public void run() {
        ...
        if (view != null) {
            ...
            if (this.f31346b != null) {
                KeyEvent.Callback callback = this.f31345a0;
        ...
        AbstractC4345j jVar = this.f31347b0;
        if (jVar != null) {
            jVar.invalidate();
            if (m7910C()) {
                this.f31346b.m26173H5();
            }
        }
    }
    ...
    public final AbstractC5408k m7866s() {
        ...
        if (s4Var.m26059S8()) {
            final AbstractC4761s4 s4Var2 = this.f31346b;
            ...
            return new AbstractC5408k() {
                ...
                public final int mo7855c() {
                    return AbstractC4761s4.this.m25923h2();
                }
            ...
            if (m7908E()) {
                return this.f31346b.m26156J2();
            }
            return this.f31346b.m26176H2();
        }
    }
    ...
    public void mo255t2(TdApi.Object object) {
        if (!this.f31359m0) {
            ...
            if (constructor == -1679978726) {
                TdApi.Function function = this.f31357k0;
                if (function != null) {
                    this.f31357k0 = null;
                    this.f31344a.m2270r4().m14783o(function, this);
                    return;
                }
                m7890W(C4403w.m27871i1(R.string.Error), C4779t2.m25482l0(object) == 404 ? new C4779t2.C4783d((C4779t2.C4787f) null, (int) R.string.DeletedMessage) : new C4779t2.C4783d((C4779t2.C4787f) null, 0, C4779t2.m25379z5(object), true), null, null, null, false, false);
                this.f31358l0 = null;
    ...
    public final boolean m7863v() {
        return (this.f31338U == null && this.f31339V == null) ? false : true;
    }

    public boolean m7862w() {
        return this.f31358l0 != null;
    }
    ...
    public RunnableC9651s3(AbstractC4761s4 s4Var) {
        ...
        this.f31344a = s4Var.mo4348c();
        this.f31346b = s4Var;
        TdApi.Message Z3 = s4Var.m25994Z3();
        this.f31348c = Z3.chatId;
        this.f31330M = Z3.replyToMessageId;
    }
}
