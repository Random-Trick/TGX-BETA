...
public class l implements w1 {
    ...
    public static f2 b() {
        ...
        g2.b bVar = g2.b.YUV;
        f2Var.a(g2.a(bVar, g2.a.ANALYSIS));
        f2Var.a(g2.a(bVar, g2.a.PREVIEW));
        f2Var.a(g2.a(bVar, g2.a.MAXIMUM));
        return f2Var;
    }
    ...
    public static boolean h() {
        ...
        return f24668c.contains(Build.MODEL.toUpperCase(Locale.US));
    }

    public List<f2> c(String str, int i10) {
        if (f()) {
            return e(str);
        }
        if (h()) {
    ...
    public final List<f2> d(int i10) {
        ArrayList arrayList = new ArrayList();
        if (i10 == 0) {
            arrayList.add(f24666a);
            arrayList.add(f24667b);
        }
        return arrayList;
    }

    public final List<f2> e(String str) {
        ArrayList arrayList = new ArrayList();
        if (str.equals("1")) {
            arrayList.add(f24666a);
        }
