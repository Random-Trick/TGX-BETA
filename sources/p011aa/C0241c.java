...
public class C0241c {
    ...
    public final void m42025a(MediaFormat mediaFormat) {
    ...
    public void m42024b(EnumC7313d dVar, MediaFormat mediaFormat) {
    ...
    public final void m42023c(MediaFormat mediaFormat) {
        String string = mediaFormat.getString("mime");
