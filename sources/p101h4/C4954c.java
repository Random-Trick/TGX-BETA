...
public final class C4954c {
    ...
    public static void m24387b(DataOutputStream dataOutputStream, String str) {
        dataOutputStream.writeBytes(str);
        dataOutputStream.writeByte(0);
    }

    public byte[] m24388a(C4951a aVar) {
        this.f16871a.reset();
        try {
            m24387b(this.f16872b, aVar.f16868a);
            String str = aVar.f16869b;
            if (str == null) {
                str = "";
            }
            m24387b(this.f16872b, str);
