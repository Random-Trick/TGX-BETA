...
public class n {
    public static Map<x2, Rect> a(Rect rect, boolean z10, Rational rational, int i10, int i11, int i12, Map<x2, Size> map) {
        h.b(rect.width() > 0 && rect.height() > 0, "Cannot compute viewport crop rects zero sized sensor rect.");
        RectF rectF = new RectF(rect);
        HashMap hashMap = new HashMap();
        RectF rectF2 = new RectF(rect);
        for (Map.Entry<x2, Size> entry : map.entrySet()) {
        ...
        RectF g10 = g(rectF2, a.d(i10, rational), i11, z10, i12, i10);
        ...
        for (Map.Entry entry2 : hashMap.entrySet()) {
            ...
            Rect rect2 = new Rect();
            rectF5.round(rect2);
            hashMap2.put((x2) entry2.getKey(), rect2);
        }
        return hashMap2;
    }

    public static RectF b(boolean z10, int i10, RectF rectF, RectF rectF2) {
        boolean z11 = true;
