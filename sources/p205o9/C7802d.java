...
public final class C7802d implements AbstractC10012l<List<? extends AbstractC1296b>> {
    public final List<AbstractC1296b> f24987M;
    public final C10007i f24988a;
    public final List<AbstractC1296b> f24989b;
    public final List<AbstractC1296b> f24990c;
    ...
    public C7802d(List<? extends AbstractC1296b> list, List<? extends AbstractC1296b> list2) {
        ...
        if (i == 0) {
            ...
            C5309s.m23354r(this.f24989b, list);
            list3 = f;
        } else {
            list.size();
            list3 = list;
        ...
        C10007i iVar2 = this.f24988a;
        iVar2.m6267c("computing audioSources, valid=" + i2);
        if (i2 == 0) {
            arrayList = C5304n.m23366f();
            C5309s.m23354r(this.f24989b, list2);
        } else {
            int size = list2.size();
            list4 = list2;
            if (i2 != size) {
    ...
    public final List<AbstractC1296b> m15047h() {
        return C5312v.m23321z(C5312v.m23338J(mo6241a(), mo6240b()));
    }
    ...
    public List<AbstractC1296b> mo6239d(EnumC7313d dVar) {
        C8298k.m12934e(dVar, "type");
        int i = C7801c.f24986a[dVar.ordinal()];
        if (i == 1) {
            return this.f24987M;
        }
        if (i == 2) {
    ...
    public final void m15037y() {
        this.f24988a.m6267c("release(): releasing...");
        m15044r(mo6240b());
        m15044r(mo6241a());
        m15044r(this.f24989b);
        this.f24988a.m6267c("release(): released.");
    }
