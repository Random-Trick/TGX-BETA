...
public final class C7811i {
    public final C10007i f25025a;
    public final AbstractC10012l<EnumC7311c> f25026b;
    public final AbstractC10012l<MediaFormat> f25027c;
    public final AbstractC10012l<EnumC7311c> f25028d;
    ...
    public C7811i(AbstractC10012l<AbstractC2055f> lVar, C7802d dVar, int i, boolean z) {
        ...
        this.f25028d = C10014m.m6221c(b3, a3.m17064a() ? a3 : cVar);
    }
    ...
    public final C5048h<MediaFormat, EnumC7311c> m14986e(EnumC7313d dVar, AbstractC2055f fVar, List<? extends AbstractC1296b> list) {
        ...
        sb2.append(", strategy=");
        sb2.append(C8307t.m12919b(fVar.getClass()).mo5851a());
        iVar.m6267c(sb2.toString());
        if (list == null) {
            return C5054l.m24189a(new MediaFormat(), EnumC7311c.ABSENT);
        }
        ...
        for (AbstractC1296b bVar2 : list) {
            ...
            if (n != null) {
                C8298k.m12934d(n, "it.getTrackFormat(type) ?: return@mapNotNull null");
                mediaFormat = bVar.m10585h(bVar2, dVar, n);
            } else {
                mediaFormat = null;
            }
            if (mediaFormat != null) {
        ...
        if (size == list.size()) {
            ...
            EnumC7311c a = fVar.mo35739a(arrayList, mediaFormat2);
            C8298k.m12934d(a, "strategy.createOutputFormat(inputs, output)");
            return C5054l.m24189a(mediaFormat2, a);
        }
