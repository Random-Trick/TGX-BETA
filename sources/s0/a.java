...
public class a {
    ...
    public final float f22392e;
    public final float f22393f;
    public final float f22394g;
    public final float f22395h;
    public final float f22396i;
    ...
    public static a c(int i10) {
        return d(i10, j.f22429k);
    }

    public static a d(int i10, j jVar) {
        float pow;
        float[] f10 = b.f(i10);
        float[][] fArr = b.f22397a;
    ...
    public static a e(float f10, float f11, float f12) {
        return f(f10, f11, f12, j.f22429k);
    }
    ...
    public static int m(float f10, float f11, float f12) {
        return n(f10, f11, f12, j.f22429k);
    }
    ...
    public int o(j jVar) {
        ...
        float[][] fArr = b.f22398b;
        return t0.a.c((fArr[0][0] * f18) + (fArr[0][1] * f19) + (fArr[0][2] * f20), (fArr[1][0] * f18) + (fArr[1][1] * f19) + (fArr[1][2] * f20), (f18 * fArr[2][0]) + (f19 * fArr[2][1]) + (f20 * fArr[2][2]));
    }
