...
public class C5543g implements AbstractC5525g {
    ...
    public void m22482a(C5543g gVar) {
        this.count += gVar.count;
        this.f18075b += gVar.f18075b;
        m22480e(gVar.sum);
        m22480e(gVar.f18074a);
    ...
    public String toString() {
        ...
        objArr[2] = Double.valueOf(m22481d());
        objArr[3] = Double.valueOf(this.min);
        objArr[4] = Double.valueOf(this.count > 0 ? m22481d() / this.count : 0.0d);
