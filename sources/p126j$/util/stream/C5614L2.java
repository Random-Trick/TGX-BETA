...
final class C5614L2 extends AbstractC5709g2 {
    ...
    public C5614L2(AbstractC5686c cVar) {
        ...
        this.f18183u = true;
        this.f18184v = Comparator.CC.m22611a();
    }
    ...
    public AbstractC5632P0 mo22142B0(AbstractC5572D0 d0, AbstractC5468G g, AbstractC5531m mVar) {
        if (EnumC5705f3.SORTED.m22266d(d0.mo22302Z()) && this.f18183u) {
            return d0.mo22305R(g, false, mVar);
        }
        Object[] p = d0.mo22305R(g, true, mVar).mo22153p(mVar);
    ...
    public AbstractC5759q2 mo22137E0(int i, AbstractC5759q2 q2Var) {
        ...
        return (!EnumC5705f3.SORTED.m22266d(i) || !this.f18183u) ? EnumC5705f3.SIZED.m22266d(i) ? new C5639Q2(q2Var, this.f18184v) : new C5619M2(q2Var, this.f18184v) : q2Var;
    }
}
