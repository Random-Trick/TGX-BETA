...
abstract class AbstractC5722j0 extends AbstractC5686c implements AbstractC5732l0 {
    ...
    public static AbstractC5462A m22239L0(AbstractC5468G g) {
        if (g instanceof AbstractC5462A) {
            return (AbstractC5462A) g;
        }
        if (AbstractC5640Q3.f18220a) {
            AbstractC5640Q3.m22369a(AbstractC5686c.class, "using IntStream.adapt(Spliterator<Integer> s)");
            throw null;
        }
    ...
    public final Object m22238M0(AbstractC5542x xVar, AbstractC5539u uVar, BiConsumer biConsumer) {
        C5776u uVar2 = new C5776u(biConsumer, 1);
        Objects.requireNonNull(xVar);
        Objects.requireNonNull(uVar);
        return m22297t0(new C5583F1(2, uVar2, uVar, xVar, 4));
    }

    public final AbstractC5777u0 m22237N0(AbstractC5532n nVar) {
        Objects.requireNonNull(nVar);
        return new C5556A(this, this, 2, EnumC5705f3.f18366p | EnumC5705f3.f18364n, nVar, 1);
    }

    public final AbstractC5690c3 m22236O0(AbstractC5531m mVar) {
        Objects.requireNonNull(mVar);
        return new C5796y(this, this, 2, EnumC5705f3.f18366p | EnumC5705f3.f18364n, mVar, 1);
    }

    public final C5548l m22235P0(AbstractC5528j jVar) {
        Objects.requireNonNull(jVar);
        return (C5548l) m22297t0(new C5603J1(2, jVar, 2));
    }

    public final AbstractC5462A spliterator() {
        return m22239L0(super.spliterator());
    }

    public void mo22221e(AbstractC5530l lVar) {
        Objects.requireNonNull(lVar);
        m22297t0(new C5656V(lVar, false));
    }
    ...
    public Iterator iterator() {
        return AbstractC5482V.m22593g(spliterator());
    }
