...
final class C5609K2 extends AbstractC5757q0 {
    ...
    public AbstractC5632P0 mo22141B0(AbstractC5572D0 d0, AbstractC5468G g, AbstractC5531m mVar) {
        ...
        long[] jArr = (long[]) ((AbstractC5622N0) d0.mo22304R(g, true, mVar)).mo22156l();
        Arrays.sort(jArr);
    ...
    public AbstractC5759q2 mo22136E0(int i, AbstractC5759q2 q2Var) {
        ...
        return EnumC5705f3.SORTED.m22265d(i) ? q2Var : EnumC5705f3.SIZED.m22265d(i) ? new C5634P2(q2Var) : new C5594H2(q2Var);
    }
}
