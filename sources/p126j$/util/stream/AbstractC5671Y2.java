...
public abstract class AbstractC5671Y2 implements AbstractC5466E {
    ...
    abstract void mo22346b(Object obj, int i, Object obj2);

    abstract AbstractC5466E mo22345c(Object obj, int i, int i2);
    ...
    abstract AbstractC5466E mo22344d(int i, int i2, int i3, int i4);
    ...
    @Override
    public void m22338n(Object obj) {
        int i;
        ...
        if (i2 < i3 || (i2 == i3 && this.f18269c < this.f18270d)) {
            ...
            while (true) {
                ...
                z2.mo22334u(obj2, i4, z2.mo22333v(obj2), obj);
                i4 = 0;
                i2++;
            }
            this.f18272f.mo22334u(this.f18267a == i ? this.f18271e : this.f18272f.f18283f[i], i4, this.f18270d, obj);
    ...
    @Override
    public boolean m22340l(Object obj) {
        Objects.requireNonNull(obj);
        int i = this.f18267a;
        int i2 = this.f18268b;
        ...
        int i3 = this.f18269c;
        this.f18269c = i3 + 1;
        mo22346b(obj2, i3, obj);
        if (this.f18269c == this.f18272f.mo22333v(this.f18271e)) {
            this.f18269c = 0;
    ...
    public AbstractC5466E trySplit() {
        ...
        if (i < i2) {
            int i3 = this.f18269c;
            AbstractC5675Z2 z2 = this.f18272f;
            AbstractC5466E d = mo22344d(i, i2 - 1, i3, z2.mo22333v(z2.f18283f[i2 - 1]));
            int i4 = this.f18268b;
            this.f18267a = i4;
            this.f18269c = 0;
            ...
            AbstractC5466E c = mo22345c(this.f18271e, i6, i7);
            this.f18269c += i7;
            return c;
        }
    }
