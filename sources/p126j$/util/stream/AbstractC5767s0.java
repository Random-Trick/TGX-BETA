...
public abstract class AbstractC5767s0 extends AbstractC5686c implements AbstractC5777u0 {
    ...
    public static AbstractC5464C m22196L0(AbstractC5468G g) {
        if (g instanceof AbstractC5464C) {
            return (AbstractC5464C) g;
        }
        if (AbstractC5640Q3.f18220a) {
            AbstractC5640Q3.m22370a(AbstractC5686c.class, "using LongStream.adapt(Spliterator<Long> s)");
            throw null;
        }
    ...
    public final Object m22195M0(AbstractC5542x xVar, AbstractC5540v vVar, BiConsumer biConsumer) {
        C5776u uVar = new C5776u(biConsumer, 2);
        Objects.requireNonNull(xVar);
        Objects.requireNonNull(vVar);
        return m22298t0(new C5583F1(3, uVar, vVar, xVar, 0));
    }

    public final AbstractC5777u0 m22194N0(AbstractC5537s sVar) {
        Objects.requireNonNull(sVar);
        return new C5556A(this, this, 3, EnumC5705f3.f18366p | EnumC5705f3.f18364n, sVar, 2);
    }

    public final AbstractC5690c3 m22193O0(AbstractC5536r rVar) {
        Objects.requireNonNull(rVar);
        return new C5796y(this, this, 3, EnumC5705f3.f18366p | EnumC5705f3.f18364n, rVar, 2);
    }

    public final C5549m m22192P0(AbstractC5533o oVar) {
        Objects.requireNonNull(oVar);
        return (C5549m) m22298t0(new C5603J1(3, oVar, 3));
    }

    public final AbstractC5464C spliterator() {
        return m22196L0(super.spliterator());
    }

    public void mo22172b(AbstractC5535q qVar) {
        Objects.requireNonNull(qVar);
        m22298t0(new C5660W(qVar, false));
    }
    ...
    public Iterator iterator() {
        return AbstractC5482V.m22593h(spliterator());
    }
    ...
    public final long sum() {
        return ((Long) m22298t0(new C5658V1(3, C5676a.f18299p, 0L))).longValue();
    }

    @Override
    public AbstractC5711h unordered() {
        return !m22296y0() ? this : new C5697e0(this, this, 3, EnumC5705f3.f18368r, 1);
    }

    @Override
    final AbstractC5632P0 mo22189v0(AbstractC5572D0 d0, AbstractC5468G g, boolean z, AbstractC5531m mVar) {
        return AbstractC5572D0.m22440K(d0, g, z);
    }

    @Override
    final void mo22188w0(AbstractC5468G g, AbstractC5759q2 q2Var) {
        AbstractC5535q qVar;
        AbstractC5464C L0 = m22196L0(g);
        if (q2Var instanceof AbstractC5535q) {
            qVar = (AbstractC5535q) q2Var;
        } else if (!AbstractC5640Q3.f18220a) {
            qVar = new C5742n0(q2Var, 0);
        } else {
            AbstractC5640Q3.m22370a(AbstractC5686c.class, "using LongStream.adapt(Sink<Long> s)");
            throw null;
        }
        while (!q2Var.mo22131t() && L0.mo22166g(qVar)) {
        }
    }
