...
final class C5760q3 extends AbstractC5715h3 implements AbstractC5811y {
    ...
    void mo22167e() {
        ...
        this.f18387h = t2;
        this.f18384e = this.f18381b.mo22299r0(new C5755p3(t2, 0));
    ...
    public boolean tryAdvance(AbstractC5525g gVar) {
        ...
        if (b) {
            ...
            long j = this.f18386g;
            int x = t2.m22330x(j);
            gVar.mo22150c((t2.f18342c == 0 && x == 0) ? ((double[]) t2.f18282e)[(int) j] : ((double[][]) t2.f18283f)[x][(int) (j - t2.f18343d[x])]);
        }
        return b;
    }
    ...
    public void forEachRemaining(AbstractC5525g gVar) {
        ...
        Objects.requireNonNull(gVar);
        m22252d();
        this.f18381b.mo22300q0(new C5755p3(gVar, 1), this.f18383d);
        this.f18388i = true;
    }
