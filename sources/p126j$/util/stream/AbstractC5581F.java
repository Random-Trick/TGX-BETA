...
abstract class AbstractC5581F extends AbstractC5686c implements AbstractC5591H {
    ...
    public static AbstractC5811y m22394L0(AbstractC5468G g) {
        if (g instanceof AbstractC5811y) {
            return (AbstractC5811y) g;
        }
        if (AbstractC5640Q3.f18220a) {
            AbstractC5640Q3.m22370a(AbstractC5686c.class, "using DoubleStream.adapt(Spliterator<Double> s)");
            throw null;
        }
    ...
    public final Object m22393M0(AbstractC5542x xVar, AbstractC5538t tVar, BiConsumer biConsumer) {
        C5776u uVar = new C5776u(biConsumer, 0);
        Objects.requireNonNull(xVar);
        Objects.requireNonNull(tVar);
        return m22298t0(new C5583F1(4, uVar, tVar, xVar, 1));
    }

    public final AbstractC5777u0 m22392N0(AbstractC5527i iVar) {
        Objects.requireNonNull(iVar);
        return new C5556A(this, this, 4, EnumC5705f3.f18366p | EnumC5705f3.f18364n, iVar, 0);
    }

    public final AbstractC5690c3 m22391O0(AbstractC5526h hVar) {
        Objects.requireNonNull(hVar);
        return new C5796y(this, this, 4, EnumC5705f3.f18366p | EnumC5705f3.f18364n, hVar, 0);
    }

    public final C5547k m22390P0(AbstractC5523e eVar) {
        Objects.requireNonNull(eVar);
        return (C5547k) m22298t0(new C5603J1(4, eVar, 0));
    }

    public final AbstractC5811y spliterator() {
        return m22394L0(super.spliterator());
    }

    public void mo22386d(AbstractC5525g gVar) {
        Objects.requireNonNull(gVar);
        m22298t0(new C5652U(gVar, false));
    }
    ...
    public Iterator iterator() {
        return AbstractC5482V.m22595f(spliterator());
    }
