...
public class C9880h {
    ...
    public static C3865d<?> m6699b(String str, String str2) {
        return C3865d.m29703i(AbstractC9878f.m6703a(str, str2), AbstractC9878f.class);
    }

    public static C3865d<?> m6698c(final String str, final AbstractC9881a<Context> aVar) {
        return C3865d.m29702j(AbstractC9878f.class).m29694b(C3890q.m29635i(Context.class)).m29691e(new AbstractC3876h() {
            @Override
    ...
    public static AbstractC9878f m6697d(String str, AbstractC9881a aVar, AbstractC3870e eVar) {
        return AbstractC9878f.m6703a(str, aVar.mo6696a((Context) eVar.mo29679a(Context.class)));
    }
}
