...
public class C5976u implements C5996x0.AbstractC6003g, View$OnClickListenerC9694y.AbstractC9702h {
    ...
    public final AbstractC5988l f18999N = new AbstractC5988l() {
        @Override
        public final void mo21605a(String str) {
            C5976u.this.m21661k0(str);
        }
    };
    ...
    public class C5977a extends AbstractC5123k {
        ...
        public void m21629e(TdApi.Sticker[] stickerArr, String str, boolean z, int i, int[] iArr) {
            if (!m23881b()) {
                C5976u.this.m21687U(stickerArr, str, z);
                if (!z && i == 0) {
                    C5976u.this.m21714F0(str, true, iArr);
                }
            }
        }
            ...
            if (object.getConstructor() == 1974859260) {
                ...
                if (iArr2 == null || iArr2.length <= 0) {
                    ...
                    for (TdApi.Sticker sticker : stickers.stickers) {
                        if (Arrays.binarySearch(this.f19035b, sticker.sticker.f25373id) < 0) {
                ...
                if (this.f19036c) {
                    ...
                    for (TdApi.Sticker sticker2 : stickerArr3) {
                        iArr[i] = sticker2.sticker.f25373id;
                        i++;
                    }
                    Arrays.sort(iArr);
                }
                ...
                dd.post(new Runnable() {
                    ...
                    public final void run() {
                        C5976u.C5977a.this.m21629e(stickerArr3, str, z, i2, iArr3);
                    }
                });
            }
        }
    ...
    public class C5978b extends AbstractC5123k {
        ...
        public void m21627e(String str, TdApi.User user) {
            String str2;
            String X = C5976u.this.m21684X();
            if (!m23881b() && X != null && str.toLowerCase().equals(X.toLowerCase()) && (str2 = user.username) != null && str2.toLowerCase().equals(X.toLowerCase())) {
                C5976u.this.m21711H(user);
            }
        }
        ...
        public void mo7438c(TdApi.Object object) {
            final TdApi.User b4;
            if (C4779t2.m25625P0(object) != 0 && (b4 = C5976u.this.f19014b.m2525b4((TdApi.Chat) object)) != null && b4.type.getConstructor() == 1262387765 && ((TdApi.UserTypeBot) b4.type).isInline) {
                HandlerC10770jj dd = C5976u.this.f19014b.m2485dd();
                final String str = this.f19037b;
                dd.post(new Runnable() {
                    @Override
                    public final void run() {
                        C5976u.C5978b.this.m21627e(str, b4);
                    }
                });
            }
        }
    ...
    public class C5979c extends AbstractC5123k {
        ...
        public void m21624f(String str, TdApi.Location location, TdApi.InlineQueryResults inlineQueryResults, ArrayList arrayList) {
            if (!m23881b() && C5976u.this.m21684X() != null) {
                C5976u.this.m21694P0(str, location, inlineQueryResults.nextOffset, arrayList);
            }
        }

        public void m21623g() {
            if (!m23881b() && C5976u.this.m21684X() != null) {
                C5976u.this.m21704K0(false);
                C5976u.this.m21683Y();
            }
        }
        ...
        public void mo7438c(TdApi.Object object) {
            ...
            if (constructor != -1679978726) {
                if (constructor == 1000709656) {
                    ...
                    long j = 0;
                    final ArrayList p0 = C5976u.m21651p0(C5976u.this.f19012a, C5976u.this.f19014b, C5976u.this.f19018d0 != null ? C5976u.this.f19018d0.f25439id : 0L, this.f19045c, inlineQueryResults, inlineQueryResults.switchPmText, inlineQueryResults.switchPmParameter, this.f19039M, inlineQueryResults.nextOffset);
                    HandlerC10770jj dd = C5976u.this.f19014b.m2485dd();
                    ...
                    Runnable xVar = new Runnable() {
                        @Override
                        public final void run() {
                            C5976u.C5979c.this.m21624f(str, location, inlineQueryResults, p0);
                        }
                    };
            ...
            } else if (C4779t2.m25481l0(object) != 406) {
                if (C4779t2.m25481l0(object) == 502) {
                    C1379j0.m37308q0(this.f19042P);
                }
            } else {
                return;
            }
    ...
    public class C5980d extends AbstractC5123k {
        ...
        public void m21620f(String str, TdApi.InlineQueryResults inlineQueryResults, ArrayList arrayList) {
            if (!m23881b() && C5976u.this.f19011Z != null && str.equals(C5976u.this.f19011Z)) {
                C5976u.this.m21705K();
                C5976u.this.m21713G(inlineQueryResults.nextOffset, arrayList);
            }
        }

        public void m21619g(String str) {
            if (!m23881b() && C5976u.this.f19011Z != null && str.equals(C5976u.this.f19011Z)) {
                C5976u.this.m21705K();
                C5976u.this.m21704K0(false);
            }
        ...
        public void mo7438c(TdApi.Object object) {
            if (object.getConstructor() != 1000709656) {
                ...
                dd.post(new Runnable() {
                    @Override
                    public final void run() {
                        C5976u.C5980d.this.m21619g(str);
                    }
                });
                return;
            }
            final TdApi.InlineQueryResults inlineQueryResults = (TdApi.InlineQueryResults) object;
            final ArrayList p0 = C5976u.m21651p0(C5976u.this.f19012a, C5976u.this.f19014b, C5976u.this.f19018d0 != null ? C5976u.this.f19018d0.f25439id : 0L, this.f19048b, inlineQueryResults, null, null, this.f19049c, inlineQueryResults.nextOffset);
            HandlerC10770jj dd2 = C5976u.this.f19014b.m2485dd();
            final String str2 = this.f19046M;
            dd2.post(new Runnable() {
                @Override
                public final void run() {
                    C5976u.C5980d.this.m21620f(str2, inlineQueryResults, p0);
                }
            });
        }
    }
    ...
    public class C5981e implements Client.AbstractC7865g {
        ...
        public void m21617b(ArrayList arrayList, String str) {
        ...
        public void mo255t2(TdApi.Object object) {
            ...
            dd.post(new Runnable() {
                @Override
                public final void run() {
                    C5976u.C5981e.this.m21617b(arrayList, str);
                }
            });
        }
    }
    ...
    public class C5982f extends AbstractC5123k {
        ...
        public void m21615e(String str, ArrayList arrayList, ArrayList arrayList2) {
            if (!m23881b() && C5070i.m24067c(C5976u.this.f19004S, str)) {
                if (arrayList.isEmpty()) {
                    if (arrayList2.isEmpty()) {
                        C5976u.this.m21683Y();
                    }
                } else if (arrayList2.isEmpty()) {
                    C5976u.this.m21692Q0(arrayList);
                } else {
                    arrayList2.ensureCapacity(arrayList2.size() + arrayList.size());
                    arrayList2.addAll(arrayList);
                    C5976u.this.m21692Q0(arrayList2);
                }
            }
        }
        ...
        public void mo7438c(TdApi.Object object) {
            ...
            int constructor = object.getConstructor();
            if (constructor == -1679978726) {
                Log.m14709w("Cannot invoke %s: %s", this.f19053N.toString(), C4779t2.m25378z5(object));
                ...
                if (chatMemberArr.length > 0) {
                    ...
                    for (TdApi.ChatMember chatMember : chatMemberArr) {
                        if (chatMember.memberId.getConstructor() == -336109341 && C5976u.m21682Z(arrayList, ((TdApi.MessageSenderUser) chatMember.memberId).userId) == -1) {
                            ...
                            xVar.m26346U(this.f19058c, this.f19052M);
                            arrayList2.add(xVar);
                        }
                    }
                }
                ...
                if (jArr.length > 0) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (C5976u.m21682Z(arrayList, next.f25439id) == -1) {
                            C4828x xVar2 = new C4828x(C5976u.this.f19012a, C5976u.this.f19014b, next, false);
                            xVar2.m26346U(this.f19058c, this.f19052M);
            ...
            dd.post(new Runnable() {
                @Override
                public final void run() {
                    C5976u.C5982f.this.m21615e(str, arrayList2, arrayList3);
                }
            });
        }
    }
    ...
    public class C5983g extends AbstractC5123k {
        ...
        public void m21613e(String str, ArrayList arrayList) {
            if (!m23881b() && C5070i.m24067c(C5976u.this.f19004S, str)) {
                if (arrayList == null || arrayList.isEmpty()) {
                    C5976u.this.m21683Y();
                } else {
                    C5976u.this.m21696O0(arrayList);
                }
            }
        }
            ...
            if (object.getConstructor() == 676798885) {
                ...
                if (strArr.length != 0) {
                    ...
                    for (String str : strArr) {
                        ...
                        vVar.m26346U(this.f19063c, this.f19059M);
                        arrayList.add(vVar);
                    }
                } else {
                    arrayList = null;
                ...
                dd.post(new Runnable() {
                    @Override
                    public final void run() {
                        C5976u.C5983g.this.m21613e(str2, arrayList);
                    }
                });
            }
        }
    ...
    public class C5984h extends AbstractRunnableC5910b {
        ...
        public void m21609j(String str, ArrayList arrayList, ArrayList arrayList2) {
            if (m21856d() && C5070i.m24067c(str, C5976u.this.f19004S)) {
                if (arrayList == null || arrayList.isEmpty()) {
                    C5976u.this.m21698N0(arrayList2);
                    return;
                }
                arrayList.addAll(arrayList2);
                C5976u.this.m21698N0(arrayList);
            }
        }

        public void m21608k(final ArrayList arrayList, int i, int i2, final String str, TdApi.Object object) {
            String[] strArr;
            boolean z;
                ...
                for (String str2 : emojis.emojis) {
                    if (arrayList != null) {
                        ...
                        while (it.hasNext()) {
                            ...
                            if ((oVar instanceof C4776t) && C5078d.m23999m(str2, ((C4776t) oVar).m25732Z())) {
                                z = true;
                                break;
                            }
                        }
                    ...
                    z = false;
                    if (!z) {
                        arrayList2.add(new C4776t(C5976u.this.f19012a, C5976u.this.f19014b, new C7888N.Suggestion(str2, null, null), null).m26346U(i, i2));
                    }
                }
                if (!arrayList2.isEmpty()) {
                    C5976u.this.f19014b.m2485dd().post(new Runnable() {
                        @Override
                        public final void run() {
                            C5976u.C5984h.this.m21609j(str, arrayList, arrayList2);
                        }
                    });
                }
            }
        ...
        public void m21607l(String str, ArrayList arrayList) {
            if (m21856d() && C5070i.m24067c(str, C5976u.this.f19004S)) {
                if (arrayList == null || arrayList.isEmpty()) {
                    C5976u.this.m21683Y();
                } else {
    ...
    public interface AbstractC5986j {
        ArrayList<AbstractC4718o<?>> mo21606a(String str, String str2, AbstractC5988l lVar);
    }
        ...
        public C9773p0.C9775b mo6986s5(TdApi.Message message) {
            ...
            if (arrayList != null && !arrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if ((next instanceof C4756s) && (a0 = ((C4756s) next).m26266a0()) != null && a0.content.getConstructor() == constructor) {
                        if (arrayList2 == null) {
    ...
    public interface AbstractC5988l {
        void mo21605a(String str);
    }

    public interface AbstractC5989m {
        boolean mo21604a(char c);
    }
    ...
    public C5976u(final AbstractView$OnTouchListenerC7889a aVar, C10930q6 q6Var, AbstractC5985i iVar) {
        ...
        this.f18998M = x0Var;
        x0Var.m21579z(new C5996x0.AbstractC6004h() {
            @Override
            public final void mo21576a(boolean z, Runnable runnable, AbstractC5096a aVar2) {
                C5976u.this.m21673e0(aVar, z, runnable, aVar2);
            }
        });
        this.f19014b = q6Var;
        this.f19016c = iVar;
    ...
    public static void m21712G0(char c, String str, int i, int[] iArr, AbstractC5989m mVar) {
        int i2 = -1;
        ...
        if (i3 != -1 && (str.charAt(i3) != c || (i3 > 0 && !C1363c0.m37459O(str.charAt(i3 - 1))))) {
            i3 = -1;
        }
        if (i3 != -1 && !z) {
    ...
    public static String m21690R0(InputMethodSubtype inputMethodSubtype) {
        Locale r0;
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            if (!C5070i.m24061i(languageTag)) {
                return languageTag;
            }
        }
        String locale = inputMethodSubtype.getLocale();
        if (C5070i.m24061i(locale) || (r0 = C7389v0.m16589r0(locale)) == null) {
            return null;
        }
        return C2060d.m35728a(r0);
    }

    public static int m21682Z(ArrayList<AbstractC4718o<?>> arrayList, long j) {
        if (arrayList != null && !arrayList.isEmpty()) {
            int i = 0;
            Iterator<AbstractC4718o<?>> it = arrayList.iterator();
            while (it.hasNext()) {
                AbstractC4718o<?> next = it.next();
                if ((next instanceof C4828x) && ((C4828x) next).m25122d0() == j) {
                    return i;
                }
                i++;
            }
    ...
    public void m21677c0(int i, String str, TdApi.WebPage webPage) {
        if (this.f19031q0 == i) {
            this.f19016c.mo8252u(str, webPage);
        }
    }

    public void m21673e0(final AbstractView$OnTouchListenerC7889a aVar, boolean z, Runnable runnable, final AbstractC5096a aVar2) {
        if (z) {
            aVar.m14570K2(false, true, aVar2);
        } else {
            C11477a0.m495g(aVar, m21684X(), runnable, new Runnable() {
                @Override
                public final void run() {
    ...
    public void m21671f0(int i, String str, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            if (((TdApi.Error) object).code != 404) {
                Log.m14709w("Cannot load link preview: %s", C4779t2.m25378z5(object));
            }
            m21688T(i, null, null);
        } else if (constructor != -577333714) {
            Log.unexpectedTdlibResponse(object, TdApi.GetWebPagePreview.class, TdApi.WebPage.class);
        } else {
            m21688T(i, str, (TdApi.WebPage) object);
        }
    }

    public void m21669g0(final int i, final String str) {
        if (this.f19031q0 == i) {
            this.f19014b.m2270r4().m14783o(new TdApi.GetWebPagePreview(this.f19016c.mo8279f(true)), new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
                    C5976u.this.m21671f0(i, str, object);
                }
            });
        }
    }

    public void m21667h0(boolean[] zArr, String str, boolean z) {
        if (!zArr[0]) {
            zArr[0] = true;
            if (str != null && str.equals(m21684X())) {
                m21722B0(this.f19018d0.username, this.f19004S.substring(str.length() + 2), null, z);
            }
        }
    }

    public void m21665i0(boolean[] zArr, String str) {
        if (!zArr[0]) {
            zArr[0] = true;
            if (str != null && str.equals(m21684X())) {
                this.f19019e0 = true;
                C4868i.m24726c2().m24708e4(this.f19018d0.f25439id);
                m21720C0(this.f19004S.substring(str.length() + 2), true, true);
            }
        }
    }

    public static void m21663j0(DialogInterface dialogInterface, int i) {
        C4868i.m24726c2().m24582u2(1L);
    }

    public static boolean m21659l0(char c) {
        return c == '_' || Character.isLetterOrDigit(c);
    }

    public static ArrayList<AbstractC4718o<?>> m21651p0(AbstractView$OnTouchListenerC7889a aVar, C10930q6 q6Var, long j, String str, TdApi.InlineQueryResults inlineQueryResults, String str2, String str3, TdApi.GetInlineQueryResults getInlineQueryResults, String str4) {
        ...
        for (TdApi.InlineQueryResult inlineQueryResult : inlineQueryResults.results) {
            AbstractC4718o<?> W = AbstractC4718o.m26344W(aVar, q6Var, str, inlineQueryResult, kVar);
            if (W != null) {
                W.m26351N(arrayList);
                W.m26347T(inlineQueryResults.inlineQueryId);
                arrayList.add(W);
            }
        }
        return arrayList;
    ...
    public final void m21724A0(int i, int i2, String str, String str2) {
        if (this.f19008W != 4) {
            m21683Y();
        }
    ...
    public final void m21722B0(String str, String str2, Location location, boolean z) {
        AbstractC9323v4<?> s;
        m21704K0(true);
        m21705K();
        ...
        if (o != 0 && C5070i.m24061i(str2) && C4868i.m24726c2().m24763X2(1L) && C7316a.m17051j(this.f19016c.mo8262o()) && (s = C1379j0.m37305s()) != null) {
            s.m9439Fc(R.string.AppName, C4403w.m27869i1(R.string.SecretChatContextBotAlert), C4403w.m27869i1(R.string.Confirm), DialogInterface$OnClickListenerC5941g.f18870a, 3);
        }
        this.f19014b.m2270r4().m14783o(getInlineQueryResults, this.f19021g0);
    }

    public final void m21720C0(String str, boolean z, boolean z2) {
        m21704K0(true);
        this.f18998M.m21584u(this.f19004S, null, 7000L, z, z2);
    }

    public final void m21718D0(int i, int i2, final String str, String str2, boolean z) {
        ...
        boolean z2 = true;
        boolean z3 = i == 0 && !m21681a0() && this.f19016c.mo8271j();
        if (z3) {
            ...
            while (it.hasNext()) {
                AbstractC4718o<?> next = it.next();
                if (str2.isEmpty() || ((C4828x) next).m25118h0(str2, false)) {
                    next.m26346U(i, i2);
                    arrayList.add(next);
                }
            }
        ...
        if (l == null || !C4779t2.m25637N2(l.type)) {
            if (!arrayList.isEmpty()) {
                m21692Q0(arrayList);
    ...
    public final boolean m21716E0(int i) {
        int i2;
        boolean z;
        this.f19005T = true;
        this.f19006U = i;
        if (this.f19004S.charAt(0) == '/') {
            ...
            while (true) {
                if (i3 >= length) {
                    z = true;
                    break;
                } else if (!C4779t2.m25428s4(this.f19004S.charAt(i3))) {
                    z = false;
                    break;
                } else {
                    i3++;
            ...
            if (z) {
                m21708I0(5);
                m21633y0(this.f19004S.substring(1));
                return false;
            }
        }
        m21712G0('@', this.f19004S, i, this.f19023i0, f18996s0);
        int[] iArr = this.f19023i0;
        if (iArr[0] == -1 || iArr[1] == -1) {
            m21712G0('#', this.f19004S, i, iArr, f18995r0);
            int[] iArr2 = this.f19023i0;
            if (iArr2[0] == -1 || iArr2[1] == -1) {
                m21712G0(':', this.f19004S, i, iArr2, f18997t0);
                ...
                m21631z0(i4, i5, str, str.substring(iArr4[0] + 1, iArr4[1]));
                return true;
            }
            m21708I0(2);
            ...
            m21724A0(i6, i7, str2, str2.substring(iArr5[0] + 1, iArr5[1]));
            return true;
        }
        ...
        m21718D0(i8, i9, str3, str3.substring(iArr6[0] + 1, iArr6[1]), z2);
        return true;
    }

    public final void m21714F0(String str, boolean z, int[] iArr) {
        TdApi.Function function;
        ...
        if (K1 != 2) {
            ...
            m21714F0(str, true, iArr);
        }
    }

    public final void m21713G(String str, ArrayList<AbstractC4718o<?>> arrayList) {
        m21705K();
        this.f19011Z = str;
    ...
    public final void m21711H(TdApi.User user) {
        this.f19018d0 = user;
        this.f19019e0 = ((TdApi.UserTypeBot) user.type).needLocation && C4868i.m24726c2().m24577v(this.f19018d0.f25439id);
        String X = m21684X();
        ...
        m21708I0(6);
        m21641u0(this.f19004S.substring(user.username.length() + 2), true);
    }

    public void m21710H0(AbstractC5986j jVar) {
        this.f19000O = jVar;
    }

    public final void m21709I() {
    ...
    public final void m21708I0(int i) {
        int i2 = this.f19002Q;
        if (i2 != i) {
            boolean z = true;
            boolean z2 = i2 == 6;
    ...
    public void m21706J0(boolean z, boolean z2) {
        if (m21689S() != z) {
            if (z) {
                this.f19001P |= 2;
            } else {
            ...
            if (!this.f19004S.trim().isEmpty() && z2) {
                ...
                this.f19004S = "";
                this.f19003R = "";
                m21653o0(charSequence, str, this.f19007V);
            }
        }
    }

    public final void m21705K() {
    ...
    public final void m21704K0(boolean z) {
        if (this.f19013a0 != z) {
            this.f19013a0 = z;
    ...
    public void m21702L0(boolean z) {
        if (z) {
            this.f19001P |= 1;
        } else {
            this.f19001P &= -2;
    ...
    public final void m21701M() {
        this.f18998M.m21596h();
    }

    public final void m21700M0(ArrayList<AbstractC4718o<?>> arrayList) {
        this.f19008W = 3;
        this.f19016c.mo8284c(arrayList, true);
    }

    public final void m21699N() {
    ...
    public final void m21698N0(ArrayList<AbstractC4718o<?>> arrayList) {
        this.f19008W = 5;
        this.f19016c.mo8284c(arrayList, false);
    }

    public final void m21697O() {
        m21695P();
        m21703L();
        m21701M();
        m21707J();
    ...
    public final void m21696O0(ArrayList<AbstractC4718o<?>> arrayList) {
        this.f19008W = 4;
        this.f19016c.mo8284c(arrayList, false);
    }

    public final void m21695P() {
    ...
    public final void m21694P0(String str, TdApi.Location location, String str2, ArrayList<AbstractC4718o<?>> arrayList) {
        this.f19009X = str;
        this.f19011Z = str2;
    ...
    public final void m21692Q0(ArrayList<AbstractC4718o<?>> arrayList) {
        this.f19008W = 2;
        this.f19016c.mo8284c(arrayList, false);
    }

    public final void m21691R() {
        this.f19016c.mo8252u(null, null);
    }

    public final boolean m21689S() {
        return (this.f19001P & 2) != 0;
    }

    public final void m21688T(final int i, final String str, final TdApi.WebPage webPage) {
        C1379j0.m37334d0(new Runnable() {
            @Override
            public final void run() {
                C5976u.this.m21677c0(i, str, webPage);
            }
        });
    }

    public final void m21687U(TdApi.Sticker[] stickerArr, String str, boolean z) {
    ...
    public void m21686V() {
        m21661k0(this.f19004S);
    }

    @Override
    public void mo4376V3(C5996x0 x0Var, String str, Location location) {
        if (this.f19004S.equals(str)) {
            m21722B0(this.f19018d0.username, m21685W(), location, false);
        }
    }

    public final String m21685W() {
        String X = m21684X();
        if (X != null) {
    ...
    public String m21684X() {
        if (!m21681a0() && !m21689S() && this.f19004S.length() > 1 && this.f19004S.charAt(0) == '@') {
            int length = this.f19004S.length();
            for (int i = 1; i < length; i++) {
                char charAt = this.f19004S.charAt(i);
                if (!C4779t2.m25414u4(charAt)) {
                    if (charAt == ' ') {
    ...
    public boolean m21681a0() {
        return (this.f19001P & 1) != 0;
    }

    public boolean m21679b0() {
        return this.f19013a0 || this.f19016c.mo8250v();
    }

    public void m21657m0(int i) {
        this.f19007V = i;
    ...
    public void m21661k0(String str) {
        if (!this.f19004S.isEmpty() && this.f19004S.equals(str)) {
            this.f19004S = "";
            this.f19003R = "";
            m21653o0(str, str, this.f19007V);
        }
    }
    ...
    public void mo4362n5(C5996x0 x0Var, int i, String str, Location location) {
        ...
        if (this.f19004S.equals(str)) {
            m21722B0(this.f19018d0.username, W, location, false);
        }
    }

    public void m21653o0(CharSequence charSequence, String str, int i) {
        this.f19007V = i;
        if (!C5070i.m24067c(this.f19004S, str)) {
            this.f19004S = str;
            boolean z = false;
            this.f19005T = false;
            m21697O();
            if (str.trim().isEmpty()) {
                m21693Q();
                m21708I0(0);
            } else if (C1374h.m37379j(charSequence)) {
                m21693Q();
                if (m21681a0() || m21689S()) {
                    m21708I0(0);
                } else {
                    m21708I0(4);
                    m21714F0(str, false, null);
                }
            } else {
                String X = m21684X();
                if (X != null) {
                    m21649q0(X, this.f19004S.substring(X.length() + 2), i);
                } else {
                    m21693Q();
                    z = m21716E0(i);
                }
    ...
    public final void m21649q0(String str, String str2, int i) {
        ...
        if (str3 == null || !str3.toLowerCase().equals(str.toLowerCase())) {
            ...
            if (user == null) {
                ...
                m21720C0(str2, str2 != null && str2.isEmpty(), false);
            } else {
                m21722B0(user.username, str2, null, false);
            }
        }
    }

    public final void m21647r0(final int i, final String str) {
        int w = !C5070i.m24061i(str) ? this.f19016c.mo8248w(i, str) : 2;
    ...
    public final void m21645s0(String str) {
        boolean z;
        List<String> v0;
        this.f19030p0.clear();
        if (!C5070i.m24061i(str) && (v0 = C4779t2.m25411v0(this.f19016c.mo8279f(true))) != null && !v0.isEmpty()) {
        ...
        if (size == 0 || !this.f19016c.mo8282d()) {
            ...
            m21647r0(i2, this.f19029o0.get(0));
        }
    }

    public void m21643t0(long j) {
    ...
    public final void m21641u0(String str, final boolean z) {
        TdApi.User user = this.f19018d0;
        if (!((TdApi.UserTypeBot) user.type).needLocation) {
            m21722B0(user.username, str, null, z);
        } else if (this.f19019e0) {
            m21720C0(str, true, false);
        } else {
            final boolean[] zArr = new boolean[1];
            final String X = m21684X();
            C11477a0.m495g(this.f19012a, X, new Runnable() {
                @Override
                public final void run() {
                    C5976u.this.m21667h0(zArr, X, z);
                }
            }, new Runnable() {
                @Override
                public final void run() {
                    C5976u.this.m21665i0(zArr, X);
                }
            });
        }
    }

    public void m21639v0() {
        String str = this.f19011Z;
        if (str != null && !str.isEmpty() && this.f19022h0 == null) {
            String str2 = this.f19009X;
            TdApi.GetInlineQueryResults getInlineQueryResults = new TdApi.GetInlineQueryResults(this.f19018d0.f25439id, this.f19016c.mo8262o(), this.f19010Y, str2, this.f19011Z);
    ...
    public final void m21633y0(String str) {
        ArrayList<AbstractC4718o<?>> a;
        AbstractC5986j jVar = this.f19000O;
        if (jVar == null || (a = jVar.mo21606a(str, this.f19004S, this.f18999N)) == null || a.isEmpty()) {
            m21683Y();
        } else {
            m21700M0(a);
        }
    ...
    public final void m21631z0(int i, int i2, String str, String str2) {
        if (this.f19008W != 5) {
            m21683Y();
        }
        ArrayList arrayList = new ArrayList();
        InputMethodManager inputMethodManager = (InputMethodManager) C1379j0.m37315n().getSystemService("input_method");
        if (inputMethodManager != null) {
            String str3 = null;
            try {
                str3 = m21690R0(inputMethodManager.getCurrentInputMethodSubtype());
            } catch (Throwable unused) {
            }
            if (C5070i.m24061i(str3)) {
                try {
                    str3 = m21690R0(inputMethodManager.getLastInputMethodSubtype());
            ...
            try {
                if (Build.VERSION.SDK_INT >= 24) {
                    ...
                    for (int i3 = 0; i3 < locales.size(); i3++) {
                        String a = C2060d.m35728a(locales.get(i3));
                        if (!C5070i.m24061i(a) && !arrayList.contains(a)) {
                            arrayList.add(a);
                        }
                    }
                } else {
                    String a2 = C2060d.m35728a(Resources.getSystem().getConfiguration().locale);
                    if (!C5070i.m24061i(a2)) {
                        arrayList.add(a2);
                    }
                }
        ...
        C4383l.m28059a().m28058b(new C5984h(str2, i, i2, arrayList, str));
    }
}
