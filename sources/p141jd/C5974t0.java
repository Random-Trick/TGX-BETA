...
public class C5974t0 implements C10651f1.AbstractC10652a, C3950k.AbstractC3952b, View$OnClickListenerC6902i.AbstractC6905c, C6957m1.AbstractC6962e, AbstractC10748j1, Handler.Callback, C4336c.AbstractC4337a {
    ...
    public interface AbstractC5975a {
        boolean mo21728G(C5974t0 t0Var, boolean z, boolean z2);

        void mo21727L4(C5974t0 t0Var, boolean z, float f, boolean z2);

        void mo21726S1(C5974t0 t0Var, boolean z, boolean z2);
    }
    ...
    public C5974t0(AbstractView$OnTouchListenerC7889a aVar, C10930q6 q6Var, long j, long j2, View view, boolean z, AbstractC5975a aVar2) {
        ...
        this.f18967Q = z;
        this.f18974X = aVar2;
        this.f18973W = C1362c.m37482g(aVar.getResources(), R.drawable.baseline_location_on_18);
        C4336c cVar = null;
    ...
    public boolean m21777A(C6957m1.AbstractC6964g gVar, C3950k kVar, float f, Object obj) {
        C9180e2 e2Var = this.f18993n0;
        if (e2Var != null) {
            e2Var.f29641e.m18408y2(true);
            this.f18993n0 = null;
        }
        return gVar.mo18302a(kVar, f, obj);
    }

    public void m21772J(C2964ra raVar, C9256o0 o0Var, C7025s3 s3Var, boolean z) {
        TdApi.Message message = (TdApi.Message) raVar.m32844d();
        TdApi.Chat U2 = this.f18963M.m2632U2(message.chatId);
        o0Var.m9788W0(this.f18963M.m2931B3(message.chatId, U2, false), C4779t2.m25709D0(this.f18963M, U2));
        o0Var.setText(this.f18963M.m2661S3(U2));
        o0Var.m18493w0(null, message.chatId, null, new C7319d(message.chatId, message.f25406id), null);
    ...
    public static void m21771K(C9180e2 e2Var) {
        e2Var.f29641e.m18408y2(true);
    }

    public boolean m21770L(final C9180e2 e2Var, View view, boolean z) {
        if (z) {
            return false;
        }
        m21755a0(0L, new Runnable() {
            @Override
            public final void run() {
                C5974t0.m21771K(C9180e2.this);
            }
        });
        return true;
    }

    public void m21769M(C9180e2[] e2VarArr, View view, int i, C2964ra raVar, TextView textView, C2546iq iqVar) {
        TdApi.Message message = (TdApi.Message) raVar.m32844d();
        TdApi.Location location = ((TdApi.MessageLocation) message.content).location;
        this.f18963M.m2485dd().m3479q7(new C10534a9(this.f18981c, this.f18963M), new AbstractView$OnClickListenerC3344yb.C3351f(location.latitude, location.longitude, message).m30702a(message.chatId, message.messageThreadId).m30700c(true));
        e2VarArr[0].f29641e.m18408y2(true);
    }

    public boolean m21768N(long j, Runnable runnable, View view, int i) {
    ...
    public static int m21735t() {
        return C1357a0.m37541i(36.0f);
    }

    public void m21731x(ArrayList arrayList) {
        if (!this.f18994o0) {
            m21761U(arrayList);
        }
    }

    public void m21730y(TdApi.Object object) {
        if (!this.f18994o0) {
            ...
            C1379j0.m37334d0(new Runnable() {
                @Override
                public final void run() {
                    C5974t0.this.m21731x(arrayList);
                }
            });
        }
    }
    ...
    public void mo3385B6(C6957m1.C6963f fVar, int i, Object obj) {
        if (i == R.id.btn_messageLiveStop) {
            m21755a0(((View$OnClickListenerC2971rh) obj).mo9464C9(), new Runnable() {
                @Override
                public final void run() {
                    C5974t0.this.m21729z();
                }
            });
        }
    }
    ...
    public C6957m1.AbstractC6962e mo9611I4(View view, C6957m1.C6963f fVar, C5320c cVar, C5320c cVar2, C5146u0 u0Var, AbstractC9323v4<?> v4Var) {
        ...
        fVar.m18332N(new C6957m1.AbstractC6964g() {
            ...
            public final boolean mo18302a(C3950k kVar, float f, Object obj) {
                boolean A;
                A = C5974t0.this.m21777A(y, kVar, f, obj);
                return A;
            }
        });
        cVar.m23284a(R.id.btn_messageLiveStop);
        u0Var.m23816a(R.string.StopLiveLocationShort);
    ...
    public void m21767O(float f, float f2) {
        View view = this.f18966P;
        if (view == null) {
            return;
        }
        if (f >= view.getMeasuredWidth() - C1357a0.m37541i(50.0f)) {
            m21755a0(this.f18964N, null);
        } else {
            m21765Q(false);
        }
    }

    public boolean m21766P(MotionEvent motionEvent) {
        C4336c cVar = this.f18972V;
        return cVar != null && cVar.m28246e(this.f18966P, motionEvent);
    }
    ...
    public void mo45P5(int i, float f, float f2, C3950k kVar) {
        if (i == 0) {
            ...
            if (aVar != null) {
                aVar.mo21727L4(this, this.f18977a.m29583h(), f, false);
            }
    ...
    public C5974t0 m21765Q(boolean z) {
        AbstractC9323v4<?> F;
        ArrayList<TdApi.Message> arrayList = this.f18968R;
        if (arrayList == null || arrayList.isEmpty() || this.f18981c.m14552P1() == null || (F = this.f18981c.m14552P1().m9763F()) == null) {
            return this;
        }
        long j = this.f18964N;
        int i = 1;
        ...
        if (j == 0 || z) {
            ...
            f2Var.m9995r(R.string.StopAllLocationSharings);
            f2Var.m9996q(R.id.theme_color_textNegative);
            f2Var.m10011b(C4403w.m27844o2(R.string.SharingLiveLocationToChats, this.f18968R.size()));
            int size = this.f18968R.size() + 2;
            C2964ra[] raVarArr = new C2964ra[size];
            C2964ra E = new C2964ra(35).m32867J(C1357a0.m37541i(12.0f)).m32872E(true);
            raVarArr[size - 1] = E;
            raVarArr[0] = E;
            Iterator<TdApi.Message> it = this.f18968R.iterator();
            while (it.hasNext()) {
                int i2 = i + 1;
                raVarArr[i] = new C2964ra(86, i2).m32870G(it.next());
                i = i2;
            }
            f2Var.m10001l(false);
            f2Var.m9997p(raVarArr);
            f2Var.m10005h(new C9188f2.AbstractC9189a() {
                @Override
                public final void mo9987a(C2964ra raVar, C9256o0 o0Var, C7025s3 s3Var, boolean z2) {
                    C5974t0.this.m21772J(raVar, o0Var, s3Var, z2);
                }
            });
            f2Var.m10000m(new C9180e2.AbstractC9181a() {
                @Override
                public final boolean mo10016a(C9180e2 e2Var, View view, boolean z2) {
                    boolean L;
                    L = C5974t0.this.m21770L(e2Var, view, z2);
                    return L;
                }
            });
            f2Var.m9999n(new AbstractC9323v4.AbstractC9337n() {
                @Override
                public final void mo3907a(View view, int i3, C2964ra raVar, TextView textView, C2546iq iqVar) {
                    C5974t0.this.m21769M(e2VarArr, view, i3, raVar, textView, iqVar);
                }
            });
            f2Var.m9988y(new C10534a9(this.f18981c, this.f18963M));
        ...
        TdApi.Location location = ((TdApi.MessageLocation) message.content).location;
        this.f18963M.m2485dd().m3479q7(a9Var, new AbstractView$OnClickListenerC3344yb.C3351f(location.latitude, location.longitude, message).m30702a(j, j2).m30700c(true));
        return this;
    }
    ...
    public final void m21764R(TdApi.Message message) {
    ...
    public final void m21774G(long[] jArr) {
        ArrayList<TdApi.Message> arrayList;
        if (!this.f18994o0 && (arrayList = this.f18968R) != null && !arrayList.isEmpty()) {
            ...
            for (int size = this.f18968R.size() - 1; size >= 0; size--) {
                ...
                if (C5062b.m24153s(jArr, message.f25406id) != -1) {
                    this.f18968R.remove(size);
                    m21762T(message, false);
                    i++;
                    if (i == jArr.length) {
                        break;
                    }
    ...
    public final void m21762T(TdApi.Message message, boolean z) {
        if (z) {
    ...
    public final void m21761U(ArrayList<TdApi.Message> arrayList) {
        if (!this.f18994o0) {
            this.f18968R = arrayList;
            if (arrayList != null && !arrayList.isEmpty()) {
                Iterator<TdApi.Message> it = arrayList.iterator();
                while (it.hasNext()) {
                    m21762T(it.next(), true);
                }
            }
            m21751c0(true);
    ...
    public final void m21760W(boolean z, boolean z2) {
        if (this.f18975Y != z) {
            this.f18975Y = z;
            m21751c0(z2);
        }
    ...
    public final void m21759X(boolean z, boolean z2) {
        AbstractC5975a aVar;
        AbstractC5975a aVar2;
        boolean h = this.f18977a.m29583h();
        if (!(h == z || (aVar2 = this.f18974X) == null || aVar2.mo21728G(this, z, z2))) {
            z2 = false;
        }
        this.f18977a.m29575p(z, z2);
        if (h != z && (aVar = this.f18974X) != null) {
            aVar.mo21726S1(this, z, z2);
        }
    }
    ...
    public final boolean m21758Y(String str, String str2) {
        boolean z;
        C5386e eVar = this.f18986g0;
        if (!C5070i.m24067c(eVar != null ? eVar.f17711a : null, str)) {
            this.f18986g0 = new C5386e(str);
            z = true;
        } else {
            z = false;
        }
        if (!C5070i.m24067c(this.f18987h0, str2)) {
            this.f18987h0 = str2;
            z = true;
        }
        if (z) {
    ...
    public void mo35Y0(int i, float f, C3950k kVar) {
        ...
        if (i == 1 && (aVar = this.f18974X) != null) {
            aVar.mo21727L4(this, this.f18977a.m29583h(), f, true);
        }
    }

    public final boolean m21757Z(String str, String str2) {
        boolean z;
        ...
        if (!C5070i.m24067c(this.f18978a0, str2)) {
            this.f18978a0 = str2;
        } else {
            z2 = z;
        }
    ...
    public void m21755a0(final long j, final Runnable runnable) {
        AbstractC9323v4<?> F;
        C9270q1 P1 = this.f18981c.m14552P1();
        if (P1 != null && !P1.m9737X() && (F = P1.m9763F()) != null) {
            C5320c cVar = new C5320c(2);
            C5146u0 u0Var = new C5146u0(2);
            C5320c cVar2 = new C5320c(2);
            cVar.m23284a(R.id.btn_stopAllLiveLocations);
            u0Var.m23816a(R.string.StopLiveLocation);
            cVar2.m23284a(R.drawable.baseline_remove_circle_24);
            cVar.m23284a(R.id.btn_cancel);
            u0Var.m23816a(R.string.Cancel);
            cVar2.m23284a(R.drawable.baseline_cancel_24);
            F.m9261ee(j != 0 ? C4403w.m27853m1(R.string.StopLiveLocationInfoX, this.f18963M.m2691Q3(j)) : C4403w.m27869i1(R.string.StopLiveLocationInfo), cVar.m23280e(), u0Var.m23813d(), new int[]{2, 1}, cVar2.m23280e(), new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean N;
                    N = C5974t0.this.m21768N(j, runnable, view, i);
                    return N;
                }
    ...
    public final void m21753b0(boolean z) {
        String str;
        C5386e eVar;
        float f;
        String str2;
        ...
        if (view != null) {
            ...
            float i = measuredWidth - C1357a0.m37541i(104.0f);
            if (z) {
                eVar = this.f18986g0;
                str = this.f18987h0;
            } else {
            ...
            if (i <= 0.0f || eVar == null || str == null) {
                ...
                TextPaint p0 = C1410y.m37020p0(eVar.f17712b);
                ...
                float f3 = i - T1;
                if (f3 > 0.0f) {
                    String charSequence2 = TextUtils.ellipsize(str, C1410y.m37036h0(), f3, TextUtils.TruncateAt.END).toString();
                    f2 = C7389v0.m16680T1(charSequence2, C1410y.m37036h0());
                    str3 = charSequence2;
                }
                str2 = str3;
                str3 = charSequence;
    ...
    public final void m21751c0(boolean z) {
        String str;
        String str2;
        String str3;
        if (this.f18966P != null) {
            ...
            if (this.f18964N != 0) {
                ...
                if (g2 != null) {
                    if (this.f18968R.size() == 2) {
                        ...
                        str3 = C4403w.m27869i1(R.string.AttachLiveLocation);
                    }
                    str4 = str3;
                    str2 = " " + g2;
                } else {
            ...
            boolean z3 = !C5070i.m24061i(str) && m21757Z(str, g);
            if (!C5070i.m24061i(str4) && m21758Y(str4, str2)) {
                z3 = true;
            }
            this.f18979b.m29575p(!C5070i.m24061i(str4), z && this.f18977a.m29584g() > 0.0f);
            if (!C5070i.m24061i(str) || !C5070i.m24061i(g)) {
                z2 = true;
            }
            m21759X(z2, z);
            if (z3 && this.f18977a.m29583h()) {
    ...
    public boolean handleMessage(Message message) {
        m21764R((TdApi.Message) message.obj);
        return true;
    }
    ...
    public void mo4350k1(C10930q6 q6Var, TdApi.Message message) {
        if (this.f18963M.m2188w6() == q6Var.m2188w6()) {
            m21734u(message.chatId, message.f25406id);
        }
    }
    ...
    public void mo4041l0(long j, final long j2, final TdApi.MessageContent messageContent) {
        if (messageContent.getConstructor() == 303973492 && ((TdApi.MessageLocation) messageContent).livePeriod > 0) {
            C1379j0.m37334d0(new Runnable() {
                @Override
                public final void run() {
                    C5974t0.this.m21776D(j2, messageContent);
                }
            });
        }
    }

    public final void m21773I(TdApi.Message message) {
        if (!this.f18994o0) {
            ArrayList<TdApi.Message> arrayList = this.f18968R;
            if (arrayList != null) {
                Iterator<TdApi.Message> it = arrayList.iterator();
    ...
    public C5974t0 m21739o() {
        ...
        if (this.f18964N != 0) {
            ...
            this.f18977a.m29575p(false, false);
            AbstractC5975a aVar = this.f18974X;
            if (aVar != null) {
                aVar.mo21727L4(this, false, 0.0f, true);
            }
        }
        return this;
    }
    ...
    public void m21738q(Canvas canvas, int i) {
        int measuredWidth;
        Drawable drawable;
        int i2;
        int i3;
        ...
        if (view != null) {
            ...
            float g = this.f18977a.m29584g();
            int i4 = (int) (255.0f * g);
            if (i4 != 0) {
                int i5 = C1357a0.m37541i(56.0f) / 2;
                int t = i + (m21735t() / 2);
                Paint i6 = this.f18967Q ? C1410y.m37035i() : C1410y.m37068J();
                i6.setAlpha(i4);
                C1362c.m37487b(canvas, this.f18973W, i5 - (drawable.getMinimumWidth() / 2), t - (this.f18973W.getMinimumHeight() / 2), i6);
                i6.setAlpha(255);
                int c = this.f18967Q ? C11524j.m196c() : C11524j.m159q0();
                float f2 = t;
                long B = C1359b.m37522B(canvas, i5, f2, C5064d.m24130b(i4, c), false, this.f18992m0);
                if (B != -1) {
                    this.f18992m0 = SystemClock.uptimeMillis() + B;
                    int i7 = C1357a0.m37541i(15.0f);
                    int i8 = C1357a0.m37541i(24.0f);
                    this.f18966P.postInvalidateDelayed(B, i5 - i7, t - i8, i5 + i7, t + i8);
                }
                C1359b.m37504o(canvas, measuredWidth - (C1357a0.m37541i(50.0f) / 2), f2, 1.0f, C1357a0.m37541i(9.0f), C1410y.m37053Y(C5064d.m24131a(g, c), C1357a0.m37541i(2.0f)));
                if (this.f18967Q) {
                    i3 = C11524j.m213U0();
                    i2 = C11524j.m215T0();
                } else {
                ...
                int i9 = i3;
                int i10 = i2;
                float g2 = this.f18979b.m29584g();
                if (g2 == 1.0f || (eVar2 = this.f18976Z) == null) {
                    f = g2;
                } else {
                    f = g2;
                    m21737r(canvas, i, eVar2, this.f18980b0, this.f18983d0, this.f18982c0, this.f18984e0, i9, i10, g, -g2);
                }
                if (f != 0.0f && (eVar = this.f18986g0) != null) {
                    m21737r(canvas, i, eVar, this.f18988i0, this.f18990k0, this.f18989j0, this.f18991l0, i9, i10, g, 1.0f - f);
                }
            }
        }
    }

    public final void m21737r(Canvas canvas, int i, C5386e eVar, String str, float f, String str2, float f2, int i2, int i3, float f3, float f4) {
        float abs = f3 * (1.0f - Math.abs(f4));
        boolean z = f4 != 0.0f;
        if (z) {
            canvas.save();
            canvas.translate(0.0f, m21735t() * f4);
        }
        int i4 = i + C1357a0.m37541i(23.0f);
        int measuredWidth = (this.f18966P.getMeasuredWidth() / 2) - (((int) (f2 + f)) / 2);
        if (str != null) {
            TextPaint p0 = C1410y.m37020p0(eVar.f17712b);
            int color = p0.getColor();
            p0.setColor(C5064d.m24131a(abs, i2));
            canvas.drawText(str, measuredWidth, i4, p0);
            p0.setColor(color);
        }
        if (str2 != null) {
            canvas.drawText(str2, measuredWidth + f, i4, C1410y.m37034i0(C5064d.m24131a(abs, i3)));
        }
        if (z) {
            canvas.restore();
        }
    ...
    public final void m21776D(long j, TdApi.MessageLocation messageLocation) {
        ArrayList<TdApi.Message> arrayList;
        if (this.f18994o0 || (arrayList = this.f18968R) == null || arrayList.isEmpty()) {
            return;
        }
    ...
    public final int m21734u(long j, long j2) {
        ArrayList<TdApi.Message> arrayList = this.f18968R;
        if (arrayList != null && !arrayList.isEmpty()) {
            int i = 0;
            Iterator<TdApi.Message> it = this.f18968R.iterator();
    ...
    public boolean m21732w() {
        return this.f18977a.m29583h();
    }
