...
final class K2 extends AbstractC0332i0 {
    public K2(AbstractC0301c cVar) {
    ...
    public final Q0 F0(E0 e02, H h10, o oVar) {
        ...
        int[] iArr = (int[]) ((M0) e02.W(h10, true, oVar)).m();
        Arrays.sort(iArr);
    ...
    public final AbstractC0378r2 I0(int i10, AbstractC0378r2 r2Var) {
        ...
        return EnumC0325g3.SORTED.d(i10) ? r2Var : EnumC0325g3.SIZED.d(i10) ? new P2(r2Var) : new H2(r2Var);
    }
}
