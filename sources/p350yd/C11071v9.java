...
public class C11071v9 {
    public final C10536ab f35539a;
    public final C6227d<AbstractC11083w0> f35540b = new C6227d<>(true);
    public final C6227d<AbstractC11158z0> f35541c = new C6227d<>(true);
    public final C6227d<AbstractC11030u0> f35542d = new C6227d<>(true);
    public final C6227d<AbstractC11051v0> f35543e = new C6227d<>(true);
    public final C6227d<AbstractC11125y0> f35544f = new C6227d<>();
    ...
    public void m1543l(C10930q6 q6Var, int i, CallSettings callSettings) {
        Iterator<AbstractC11051v0> it = this.f35543e.iterator();
        while (it.hasNext()) {
    ...
    public void m1541n(C10930q6 q6Var, int i, boolean z) {
        Iterator<AbstractC11083w0> it = this.f35540b.iterator();
        while (it.hasNext()) {
    ...
    public void m1539p(C10930q6 q6Var, TdApi.ChatList chatList, int i, boolean z) {
        Iterator<AbstractC11125y0> it = this.f35544f.iterator();
        while (it.hasNext()) {
    ...
    public void m1535t(C10930q6 q6Var, TdApi.UpdateMessageSendFailed updateMessageSendFailed) {
        Iterator<AbstractC11158z0> it = this.f35541c.iterator();
        while (it.hasNext()) {
