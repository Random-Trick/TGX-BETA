...
public class C10552b0 implements AbstractC11051v0 {
    public C10930q6 f33843b;
    public TdApi.Call f33844c;
    public boolean f33845d;
    public final C6227d<AbstractC10553a> f33842a = new C6227d<>();
    public final Queue<Runnable> f33846e = new ArrayDeque();
    ...
    public void m4588Y(AbstractC9323v4 v4Var, long j, TdApi.Call call, C10930q6 q6Var, Context context, int i, boolean z) {
        ...
        } else if (call != null && (g0 = q6Var.m2480e2().m1644g0(call.f25364id)) != null && g0.state.getConstructor() == 1073048620) {
            m4615A(context, q6Var, call.f25364id);
        }
    }
    ...
    public static void m4585b0(boolean[] zArr) {
        if (!zArr[0]) {
            zArr[0] = true;
            C1379j0.m37292y0(R.string.VoipFailed, 0);
        }
    }
    ...
    public void m4583c0(C10930q6 q6Var, TdApi.Call call, final AbstractC9323v4 v4Var, final long j, final TdApi.UserFullInfo userFullInfo, DialogInterface dialogInterface, int i) {
        ...
        m4596Q(q6Var, call.f25364id, new Runnable() {
            @Override
    ...
    public void m4579e0(TdApi.Call call, C10930q6 q6Var, DialogInterface dialogInterface, int i) {
        ...
        if (L == call || (L.f25364id == call.f25364id && !C4779t2.m25562Z2(L))) {
            m4543w0(q6Var, call);
        }
    }
    ...
    public static void m4567k0(long j, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            Log.m14727e(2, "Failed to create call: %s", C4779t2.m25378z5(object));
            C1379j0.m37302t0(object);
            ...
            Log.m14716v(2, "#%d: call created, user_id:%d", Integer.valueOf(((TdApi.CallId) object).f25365id), Long.valueOf(j));
        }
    }
    ...
    public void m4614A0(AbstractC10553a aVar) {
        this.f33842a.remove(aVar);
    }

    public void m4613B(C10930q6 q6Var, int i) {
        m4615A(C1379j0.m37315n(), q6Var, i);
    }

    public final void m4612B0(C10930q6 q6Var, TdApi.Call call) {
        TdApi.Call call2 = this.f33844c;
        if (call2 != null || call != null) {
            if (call2 == null || call == null) {
                this.f33843b = q6Var;
                this.f33844c = call;
                boolean z = false;
                boolean z2 = call == null || C1379j0.m37364F() != 0 || C1379j0.m37352P();
                this.f33845d = z2;
                if (z2) {
                    m4541x0();
                }
                if (call != null) {
                    Intent intent = new Intent(C1379j0.m37315n(), TGCallService.class);
                    intent.putExtra("account_id", q6Var.m2188w6());
                    intent.putExtra("call_id", call.f25364id);
                    if (C1379j0.m37364F() != 0) {
                        z = true;
                    }
                    C1379j0.m37367D0(intent, z, true);
                    m4543w0(this.f33843b, this.f33844c);
                }
            } else if (this.f33843b.m2188w6() == q6Var.m2188w6() && this.f33844c.f25364id == call.f25364id) {
                this.f33843b = q6Var;
                this.f33844c = call;
            } else {
                m4605H(q6Var, call.f25364id, call.isVideo);
            }
        }
    }
    ...
    public void m4611C(int i) {
        TdApi.Call call;
        if (!this.f33845d && (call = this.f33844c) != null && call.f25364id == i) {
            this.f33845d = true;
            m4541x0();
        }
    }
    ...
    public final void m4610C0(boolean z) {
        final Context q = C1379j0.m37309q();
        AlertDialog.Builder builder = new AlertDialog.Builder(q, C11524j.m150v());
        builder.setTitle(C4403w.m27869i1(R.string.MicrophonePermission));
        if (z) {
            builder.setMessage(C4403w.m27869i1(R.string.MicrophoneMissing));
        } else {
            builder.setMessage(C4403w.m27869i1(R.string.MicrophonePermissionDesc));
        }
        builder.setPositiveButton(C4403w.m27950P0(), DialogInterface$OnClickListenerC10675g.f34161a);
        builder.setNeutralButton(C4403w.m27869i1(R.string.Settings), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
                C10552b0.m4551s0(q, dialogInterface, i);
            }
        });
        AbstractView$OnTouchListenerC7889a.m14556O1(q, builder.show(), null);
    }
    ...
    public final boolean m4608E(final Context context, C10930q6 q6Var) {
        ...
        if (q6Var.m2704P6()) {
            ...
            builder.setTitle(C4403w.m27869i1(R.string.VoipOfflineAirplaneTitle));
            builder.setMessage(C4403w.m27869i1(R.string.VoipOfflineAirplane));
            if (Build.VERSION.SDK_INT >= 17) {
                ...
                builder.setNeutralButton(C4403w.m27869i1(R.string.AirplaneModeDisable), new DialogInterface.OnClickListener() {
                    @Override
                    public final void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder = new AlertDialog.Builder(context, C11524j.m150v());
            builder.setTitle(C4403w.m27869i1(R.string.VoipOfflineTitle));
            builder.setMessage(C4403w.m27869i1(R.string.VoipOffline));
        }
        if (builder == null) {
            return true;
        }
        try {
            AbstractView$OnTouchListenerC7889a.m14556O1(context, builder.show(), null);
            return false;
    ...
    public boolean m4607F(final Context context, final C10930q6 q6Var, final TdApi.Call call, final long j, final AbstractC9323v4<?> v4Var) {
        if (Build.VERSION.SDK_INT < 23 || C1379j0.m37315n().checkSelfPermission("android.permission.RECORD_AUDIO") == 0) {
            return true;
        }
    ...
    public TdApi.Call m4601L() {
        if (!this.f33845d || C4779t2.m25562Z2(this.f33844c)) {
            return null;
        }
        return this.f33844c;
    }
    ...
    public int m4600M() {
        TdApi.Call call = this.f33844c;
        if (call == null || C4779t2.m25562Z2(call)) {
            return 0;
        }
        return this.f33844c.f25364id;
    }
    ...
    public void m4596Q(C10930q6 q6Var, int i, Runnable runnable) {
        TGCallService w = TGCallService.m14211w();
        m4594S(q6Var, i, false, w != null ? w.m14260B() : 0L, runnable);
    }
    ...
    public void m4594S(C10930q6 q6Var, final int i, boolean z, long j, Runnable runnable) {
        ...
        if (g0 != null) {
            if (runnable != null) {
                if (C4779t2.m25562Z2(g0)) {
                    runnable.run();
                } else {
                    this.f33846e.offer(runnable);
    ...
    public void mo1770b(C10930q6 q6Var, TdApi.Call call) {
        TdApi.Call call2 = this.f33844c;
        if (call2 != null && C4779t2.m25686G2(call2)) {
            if (this.f33843b.m2188w6() == q6Var.m2188w6()) {
                if (this.f33844c.f25364id != call.f25364id) {
                    if (!call.isOutgoing && call.state.getConstructor() == 1073048620) {
                        q6Var.m2270r4().m14783o(new TdApi.DiscardCall(call.f25364id, false, 0, call.isVideo, 0L), q6Var.m2392ja());
                        return;
                    }
                    return;
                }
        ...
        if (Log.isEnabled(2)) {
            Log.m14716v(2, "#%d: updateCall, userId:%s isOutgoing:%b state:%s", Integer.valueOf(call.f25364id), Long.valueOf(call.userId), Boolean.valueOf(call.isOutgoing), call.state);
        }
        if (call.state.getConstructor() == -2000107571) {
            VoIPServerConfig.setConfig(((TdApi.CallStateReady) call.state).config);
        }
        if (C4779t2.m25562Z2(call)) {
            m4612B0(null, null);
            while (true) {
                Runnable poll = this.f33846e.poll();
                if (poll != null) {
                    poll.run();
                } else {
                    return;
    ...
    public void m4549t0(AbstractC9323v4<?> v4Var, long j, TdApi.UserFullInfo userFullInfo) {
        m4559o0(v4Var, j, userFullInfo, C4868i.m24726c2().m24847L2());
    }
    ...
    public void m4559o0(final AbstractC9323v4<?> v4Var, final long j, final TdApi.UserFullInfo userFullInfo, final boolean z) {
        ...
        if (j != 0) {
            ...
            if (!C7389v0.m16667X(C1379j0.m37315n())) {
                m4610C0(true);
                return;
            }
            final TdApi.Call L = m4601L();
            final C10930q6 q6Var = L != null ? this.f33843b : null;
            if (L != null || ((E2 != null && !E2.canBeCalled) || !v4Var.mo4348c().m2704P6())) {
                ...
                builder2.setPositiveButton(C4403w.m27950P0(), DialogInterface$OnClickListenerC10525a0.f33748a);
                if (L != null) {
                    if (L.userId == j) {
                        m4539y0();
                        return;
                    }
                    builder2.setTitle(C4403w.m27869i1(R.string.VoipOngoingAlertTitle));
                    TdApi.User v2 = q6Var.m2480e2().m1583v2(L.userId);
                    TdApi.User v22 = v4Var.mo4348c().m2480e2().m1583v2(j);
                    final C10930q6 q6Var2 = q6Var;
                    builder2.setPositiveButton(C4403w.m27869i1(R.string.HangUp), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                            C10552b0.this.m4583c0(q6Var2, L, v4Var, j, E2, dialogInterface, i);
                        }
                    });
                    builder2.setMessage(C4403w.m27853m1(R.string.CallInProgressDesc, C4779t2.m25437r2(v2), C4779t2.m25417u1(v22)));
                    builder2.setNegativeButton(C4403w.m27869i1(R.string.Cancel), DialogInterface$OnClickListenerC11157z.f35786a);
                    builder2.setNeutralButton(C4403w.m27869i1(R.string.ShowCall), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    if (C7389v0.m16644d1()) {
                        ...
                        builder.setMessage(C4403w.m27869i1(R.string.VoipOfflineAirplane));
                        if (Build.VERSION.SDK_INT >= 17) {
                            builder.setNeutralButton(C4403w.m27869i1(R.string.Settings), DialogInterface$OnClickListenerC10618e.f34022a);
                        } else {
                            builder.setNeutralButton(C4403w.m27869i1(R.string.AirplaneModeDisable), new DialogInterface.OnClickListener() {
                                @Override
                                public final void onClick(DialogInterface dialogInterface, int i) {
                    ...
                    builder2.setTitle(C4403w.m27869i1(R.string.AppName));
                    builder2.setMessage(C4403w.m27853m1(R.string.NoRightToCall, v4Var.mo4348c().m2480e2().m1721K2(j)));
                    builder = builder2;
                    builder.setNeutralButton(C4403w.m27869i1(R.string.OpenChat), new DialogInterface.OnClickListener() {
                        @Override
                        public final void onClick(DialogInterface dialogInterface, int i) {
                ...
                AbstractView$OnTouchListenerC7889a.m14556O1(v4Var.mo4347s(), builder.show(), null);
            } else if (E2 == null) {
                ...
                v4Var.m9261ee(C4403w.m27853m1(R.string.CallX, v4Var.mo4348c().m2480e2().m1721K2(j)), new int[]{R.id.btn_phone_call, R.id.btn_cancel}, new String[]{C4403w.m27869i1(R.string.Call), C4403w.m27869i1(R.string.Cancel)}, null, new int[]{R.drawable.baseline_call_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
    ...
    public final boolean m4543w0(C10930q6 q6Var, TdApi.Call call) {
        ...
        bVar2.m35463bf(new View$OnClickListenerC2162b.C2168e(call));
        x.m9719h0(bVar2);
        return true;
    }

    public final void m4541x0() {
        Iterator<AbstractC10553a> it = this.f33842a.iterator();
        while (it.hasNext()) {
            it.next().mo4536y2(this.f33843b, this.f33844c);
        }
    }
    ...
    public boolean m4537z0() {
        ...
        builder.setMessage(C4403w.m27869i1(R.string.SomeCallInProgressDesc));
        builder.setNeutralButton(C4403w.m27869i1(R.string.HangUp), new DialogInterface.OnClickListener() {
            @Override
            public final void onClick(DialogInterface dialogInterface, int i) {
                C10552b0.this.m4557p0(dialogInterface, i);
            }
        });
        builder.setPositiveButton(C4403w.m27950P0(), DialogInterface$OnClickListenerC10649f.f34096a);
        AbstractView$OnTouchListenerC7889a.m14556O1(E, builder.show(), null);
        return true;
    }
}
