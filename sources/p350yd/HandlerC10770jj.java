...
public class HandlerC10770jj extends Handler {
    public final C10930q6 f34462a;
    public C6924j2 f34463b;
    public List<Runnable> f34464c;

    public class C10771a extends AbstractRunnableC5910b {
        public final TdApi.Chat[] f34465M;
        public final AbstractC9323v4 f34466N;
        public final TdApi.Error[] f34467O;

        public C10771a(TdApi.Chat[] chatArr, AbstractC9323v4 v4Var, TdApi.Error[] errorArr) {
            this.f34465M = chatArr;
            this.f34466N = v4Var;
            this.f34467O = errorArr;
        }

        @Override
        public void mo1364b() {
            TdApi.Chat[] chatArr = this.f34465M;
            if (chatArr[0] != null) {
                HandlerC10770jj.this.m3881C4(this.f34466N, chatArr[0], null);
                return;
            }
            TdApi.Error[] errorArr = this.f34467O;
            if (errorArr[0] != null) {
                C1379j0.m37305t0(errorArr[0]);
            }
        }
    }
    ...
    public class C10772b implements View$OnClickListenerC2805o4.AbstractC2815j {
        ...
        public Object mo3380c() {
            return C3033s4.m32025a(this);
        }

        @Override
        public boolean mo3379d(TdApi.Chat chat, Runnable runnable) {
            if (!HandlerC10770jj.this.f34462a.m2160y2(chat)) {
                C1379j0.m37295y0(R.string.YouCantInviteMembers, 0);
                return false;
            }
            if (chat.type.getConstructor() == 1579049844) {
                HandlerC10770jj.this.f34462a.m2270r4().m14783o(new TdApi.AddChatMember(chat.f25370id, this.f34469a, 0), HandlerC10770jj.this.f34462a.m2392ja());
            } else if (chat.type.getConstructor() != -1472570774) {
                return false;
            } else {
                HandlerC10770jj.this.f34462a.m2270r4().m14783o(new TdApi.AddChatMembers(chat.f25370id, new long[]{this.f34469a}), HandlerC10770jj.this.f34462a.m2392ja());
            }
            return true;
        }
    }
    ...
    public class C10773c implements View$OnClickListenerC2805o4.AbstractC2815j {
        ...
        public void m3386f(Runnable runnable, TdApi.Object object) {
            if (object.getConstructor() != 1829953909 || !C4779t2.m25507h3(((TdApi.ChatMember) object).status)) {
                C1379j0.m37295y0(R.string.YouCantInviteMembers, 0);
            } else {
                HandlerC10770jj.this.f34462a.m2485dd().post(runnable);
            }
        }
        ...
        @Override
        public int mo3381b() {
            return this.f34471a ? R.string.GameInvite : R.string.BotInvite;
        }
        ...
        public boolean mo3379d(TdApi.Chat chat, final Runnable runnable) {
            if (!HandlerC10770jj.this.f34462a.m2220u6(chat)) {
                C1379j0.m37295y0(R.string.YouCantSendMessages, 0);
                return false;
            } else if (this.f34471a || HandlerC10770jj.this.f34462a.m2160y2(chat)) {
                return true;
            } else {
                HandlerC10770jj.this.f34462a.m2270r4().m14783o(new TdApi.GetChatMember(chat.f25370id, new TdApi.MessageSenderUser(this.f34472b.m25157b())), new Client.AbstractC7865g() {
                    @Override
    ...
    public class C10774d extends AbstractRunnableC5910b {
        public final AtomicBoolean f34474M;
        public final Uri f34475N;
        public final AbstractC10664f9 f34476O;
        public final C10788q f34477P;
        public final int f34478Q;
        public final AtomicReference f34479R;
        public final boolean f34480S;
        ...
        public C10774d(AtomicBoolean atomicBoolean, Uri uri, AbstractC10664f9 f9Var, C10788q qVar, int i, AtomicReference atomicReference, boolean z, String str) {
            this.f34474M = atomicBoolean;
            this.f34475N = uri;
            this.f34476O = f9Var;
            this.f34477P = qVar;
            this.f34478Q = i;
            this.f34479R = atomicReference;
            this.f34480S = z;
            this.f34481T = str;
        }
        ...
        public void mo1364b() {
            ...
            if (!this.f34474M.getAndSet(true)) {
                if (HandlerC10770jj.this.f34462a.m2598W6(this.f34475N.getHost(), false) && (pathSegments = this.f34475N.getPathSegments()) != null && pathSegments.size() == 1 && "iv".equals(pathSegments.get(0))) {
                    String queryParameter = this.f34475N.getQueryParameter("url");
                    if (C1363c0.m37460Q(queryParameter)) {
                        HandlerC10770jj.this.m3858E7(this.f34476O, queryParameter, new C10788q(this.f34477P).m3326e());
                        return;
                    }
                }
                if (this.f34478Q == 0) {
                    TdApi.WebPage webPage = (TdApi.WebPage) this.f34479R.get();
                    AbstractC10664f9 f9Var = this.f34476O;
                    if ((f9Var instanceof AbstractC9323v4) && webPage != null && AbstractView$OnClickListenerC0259c.m41990S1((AbstractC9323v4) f9Var, webPage, this.f34480S)) {
                        return;
                    }
                }
                C1379j0.m37339c0(this.f34481T);
            }
        }
    }
    ...
    public class C10775e implements C6957m1.AbstractC6962e {
        ...
        public final C4737p7 f34484N;
        public final Runnable f34486a;
        public final AbstractC9323v4 f34487b;
        public final TdApi.ChatList f34488c;

        public C10775e(Runnable runnable, AbstractC9323v4 v4Var, TdApi.ChatList chatList, long j, C4737p7 p7Var) {
            this.f34486a = runnable;
            this.f34487b = v4Var;
            this.f34488c = chatList;
            this.f34483M = j;
            this.f34484N = p7Var;
        }
        ...
        public void mo3384E3(C6957m1.C6963f fVar, int i, Object obj) {
            if (i == R.id.btn_selectChat) {
                ...
                HandlerC10770jj.this.m3798K7(this.f34487b, this.f34488c, this.f34483M, this.f34484N, i, null);
            }
        }
    }
    ...
    public class C10776f implements AbstractC9323v4.AbstractC9335l {
        ...
        public final Runnable f34490b;

        public C10776f(int i, Runnable runnable) {
            this.f34489a = i;
            this.f34490b = runnable;
        }
        ...
        public void mo3383a(AbstractC9323v4<?> v4Var, boolean z) {
            if (z) {
                v4Var.m9193od(this);
                HandlerC10770jj.this.m3847F8(v4Var, this.f34489a, this.f34490b);
            }
        }
    }
    ...
    public class C10777g implements View$OnClickListenerC2805o4.AbstractC2815j {
        ...
        @Override
        public int mo3381b() {
            return C3033s4.m32024b(this);
        }

        @Override
        public Object mo3380c() {
            return new C4609c7(this.f34492a, this.f34493b);
        }
    ...
    public class C10778h implements C3365yo.AbstractC3367b {
        public final CharSequence f34496a;
        public final TdApi.Function f34497b;
        public final AbstractC5918j f34498c;
        ...
        public void mo3378a(String str, AbstractC5917i iVar) {
            ...
            int constructor = this.f34497b.getConstructor();
            if (constructor == -964543587) {
                ((TdApi.ReportChat) this.f34497b).text = str;
            } else if (constructor == 734652708) {
                ((TdApi.ReportChatPhoto) this.f34497b).text = str;
            }
            iVar.mo1322a(true);
            this.f34498c.mo1330a(this.f34497b);
        }
    ...
    public class C10779i implements AbstractC5117h0 {
        ...
        public Object mo491b2(int i) {
            if (this.f34501b) {
                return this.f34502c.actions[i].url;
            }
            return null;
        }
    }
    ...
    public static class C10780j {
        public int f34503a;
        public AbstractC5920l f34504b;
        public Runnable f34505c;
        public Object f34506d;
        public boolean f34507e;
        public int f34508f;
        public C7319d f34509g;
        public C10788q f34510h;
        public TdApi.ChatList f34511i;
        public String f34512j;
        public TdApi.ChatInviteLinkInfo f34513k;
        public C4737p7 f34514l;
        public TdApi.SearchMessagesFilter f34515m;
        public TdApi.InternalLinkTypeVideoChat f34516n;
        ...
        public static C10780j m3361o(Bundle bundle, String str) {
            ...
            jVar.f34503a = bundle.getInt(str + "cp_options", 0);
            jVar.f34507e = bundle.getBoolean(str + "cp_highlightSet", false);
            jVar.f34508f = bundle.getInt(str + "cp_highlightMode", 0);
            jVar.f34509g = C4779t2.m25579W4(bundle, str + "cp_highlightMessageId");
            jVar.f34511i = C4779t2.m25584W(bundle.getString(str + "cp_chatList", null));
            jVar.f34514l = C4737p7.m26290l(bundle, str + "cp_messageThread");
            jVar.f34515m = C4779t2.m25585V4(bundle, str + "cp_filter");
            return jVar;
        }
        ...
        public C10780j m3370f(TdApi.Message message) {
            return m3371e(new C7319d(message.chatId, message.f25409id));
        }

        public C10780j m3369g(String str, TdApi.ChatInviteLinkInfo chatInviteLinkInfo) {
            this.f34512j = str;
            this.f34513k = chatInviteLinkInfo;
            return this;
        }
        ...
        public C10780j m3366j(Runnable runnable) {
            this.f34505c = runnable;
            return this;
        }

        public final void m3365k() {
            Runnable runnable = this.f34505c;
            if (runnable != null) {
                runnable.run();
                this.f34505c = null;
            }
        ...
        public boolean m3360p(Bundle bundle, String str) {
            if (this.f34504b != null || this.f34505c != null || this.f34506d != null) {
                return false;
            }
            if (this.f34503a != 0) {
                bundle.putInt(str + "cp_options", this.f34503a);
            }
            if (this.f34507e) {
                bundle.putBoolean(str + "cp_highlightSet", this.f34507e);
            }
            if (this.f34508f != 0) {
                bundle.putInt(str + "cp_highlightMode", this.f34508f);
            }
            if (this.f34509g != null) {
                C4779t2.m25547b5(bundle, str + "cp_highlightMessageId", this.f34509g);
            }
            if (this.f34511i != null) {
                bundle.putString(str + "cp_chatList", C4779t2.m25457o4(this.f34511i));
            }
            C4737p7 p7Var = this.f34514l;
            if (p7Var != null) {
                p7Var.m26289m(bundle, str + "cp_messageThread");
            }
            if (this.f34515m == null) {
                return true;
            }
            C4779t2.m25554a5(bundle, str + "cp_filter", this.f34515m);
            return true;
        }
        ...
        public C10780j m3356t(TdApi.InternalLinkTypeVideoChat internalLinkTypeVideoChat) {
            this.f34516n = internalLinkTypeVideoChat;
            return this;
        }
    }
    ...
    public static class C10781k {
        ...
        public final Map<String, TdApi.LanguagePackStringValue> f34518b = new HashMap();
        public int f34519c;
        public final String f34520d;
        public String f34521e;

        public C10781k(TdApi.Document document) {
            this.f34520d = document.fileName;
        }

        public boolean m3355a() {
            return !this.f34518b.isEmpty() && this.f34519c < this.f34518b.size() && m3345k();
        }

        public int m3354b() {
            String[][] strArr = this.f34517a;
        ...
        public String m3351e() {
            ...
            if (C5070i.m24062i(this.f34520d)) {
                return h;
            }
            StringBuilder sb2 = new StringBuilder(h);
            sb2.append(" [");
            if (this.f34520d.endsWith(".xml")) {
        ...
        public int m3350f() {
            ...
            if (b > 0) {
                ...
                for (String str : this.f34517a[0]) {
                    if (this.f34518b.get(str) == null) {
                        arrayList.add(str);
                    }
                }
                for (String str2 : this.f34517a[1]) {
                    if (this.f34518b.get(str2) == null) {
                        arrayList.add(str2);
                    }
                }
                if (!arrayList.isEmpty()) {
                    Log.m14724e("Language pack %s misses following strings: %s", this.f34520d, TextUtils.join(", ", arrayList));
                }
            }
            return b;
        }
        ...
        public TdApi.LanguagePackStringValue m3349g(int i) {
            return this.f34518b.get(C4403w.m27887e1(i));
        }

        public String m3348h(int i) {
            TdApi.LanguagePackStringValue languagePackStringValue = this.f34518b.get(C4403w.m27887e1(i));
        ...
        public TdApi.LanguagePackString[] m3347i() {
            TdApi.LanguagePackString[] languagePackStringArr = new TdApi.LanguagePackString[this.f34518b.size()];
            int i = 0;
            for (Map.Entry<String, TdApi.LanguagePackStringValue> entry : this.f34518b.entrySet()) {
                i++;
        ...
        public int m3346j() {
            return this.f34518b.size() - this.f34519c;
        }
        ...
        public boolean m3345k() {
            ...
            for (int i : C4403w.m27892d1()) {
                ...
                if (!(g instanceof TdApi.LanguagePackStringValueOrdinary)) {
                    Log.m14724e("Language Pack is missing required string: %s", C4403w.m27887e1(i));
                } else {
                    TdApi.LanguagePackStringValueOrdinary languagePackStringValueOrdinary = (TdApi.LanguagePackStringValueOrdinary) g;
                    if (C5070i.m24062i(languagePackStringValueOrdinary.value.trim())) {
                        Log.m14724e("Language Pack required string is empty: %s", C4403w.m27887e1(i));
                    } else {
    ...
    public static void m3901A4(AbstractC10664f9 f9Var, TdApi.Chat chat, C10780j jVar) {
        m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4403w.m27871i1(C4779t2.m25638N2(chat.type) ? R.string.PostNotFound : R.string.MessageNotFound), jVar.f34510h);
        jVar.m3365k();
    }

    public static Object m3900A5(C10783m mVar, CharSequence charSequence, int i, int i2, int i3, boolean z) {
        return i3 == 1 ? new C5132o(null, R.id.theme_color_textLink).m23853j(new TdApi.TextEntityTypeMention()).m23850m(mVar) : C4403w.m27891d2(z);
    }
    ...
    public static Object m3899A6(AbstractC9323v4 v4Var, TdApi.ChatInviteLink chatInviteLink, CharSequence charSequence, int i, int i2, int i3, boolean z) {
        if (i3 == 0) {
            return C4403w.m27874h2(new C10534a9(v4Var.mo4347s(), v4Var.mo4348c()), chatInviteLink.creatorUserId);
        }
        return null;
    }
    ...
    public boolean m3880C5(final C10783m mVar, final AbstractC9323v4 v4Var, Runnable runnable, View view, int i) {
        if (i == R.id.btn_done) {
            this.f34462a.m2712Oe().m2006r(mVar.f34525d, 1000L, new Runnable() {
                @Override
                public final void run() {
    ...
    public void m3870D5(final C10783m mVar, final Runnable runnable, final AbstractC9323v4 v4Var) {
        ...
        if (mVar.f34524c != null) {
            ...
            charSequence = C4403w.m27875h1(R.string.ThemeInstallAuthor, qhVar, mVar.f34522a, "@" + mVar.f34524c);
        } else {
            charSequence = C4403w.m27855m1(R.string.ThemeInstall, mVar.f34522a);
        }
        ...
        cVar.m23285a(R.id.btn_done);
        cVar3.m23285a(R.drawable.baseline_palette_24);
        cVar2.m23285a(3);
        u0Var.m23817a(R.string.ThemeInstallDone);
        if (runnable != null) {
        ...
        if (charSequence2 != null) {
            ...
            spannableStringBuilder.append((CharSequence) C4403w.m27871i1(R.string.ThemeInstallHint));
        }
        v4Var.m9254fe(charSequence2, cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), cVar3.m23281e(), new AbstractC5117h0() {
            @Override
    ...
    public static void m3857E8(final C10930q6 q6Var, final int i, final CharSequence charSequence, final C10788q qVar) {
        ...
        } else if (qVar == null || (hVar = qVar.f34544g) == null || !hVar.m8952p()) {
            C1379j0.m37293z0(charSequence, 0);
        } else if (i == 0) {
            qVar.f34544g.m8971D(q6Var, charSequence).m8918G(3500L, TimeUnit.MILLISECONDS);
        } else {
            new C9357x2.C9365h(qVar.f34544g).m8951q(i).m8971D(q6Var, charSequence).m8918G(3500L, TimeUnit.MILLISECONDS);
        }
    }
    ...
    public static void m3840G5(TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            C1379j0.m37295y0(R.string.ReportChatSent, 0);
        }
    }
    ...
    public boolean m3839G6(final AbstractC9323v4 v4Var, final long j, final TdApi.ChatInviteLink chatInviteLink, final Runnable runnable, final AbstractC5918j jVar, View view, int i) {
        switch (i) {
            ...
            case R.id.btn_deleteLink:
                v4Var.m9261ee(C4403w.m27871i1(R.string.AreYouSureDeleteInviteLink), new int[]{R.id.btn_deleteLink, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.InviteLinkDelete), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
            ...
            case R.id.btn_edit:
                ...
                s6Var.m31978Qf(new View$OnClickListenerC3038s6.C3041c(chatInviteLink, j, (View$OnClickListenerC2855p0) v4Var));
                v4Var.m9291ac(s6Var);
                break;
            case R.id.btn_manageInviteLinks:
                ...
                p0Var.m33195Hh(new View$OnClickListenerC2855p0.C2860d(j, v4Var.mo4348c().m2519ba(), null, null, this.f34462a.m2787K3(j).getConstructor() == -160019714));
                v4Var.m9291ac(p0Var);
                break;
            case R.id.btn_manageJoinRequests:
                ...
                sVar.m32120Cg(new View$OnClickListenerC3021s.C3022a(j, chatInviteLink.inviteLink, v4Var));
                v4Var.m9291ac(sVar);
                break;
            case R.id.btn_revokeLink:
                v4Var.m9261ee(C4403w.m27871i1(v4Var.mo4348c().m2784K6(j) ? R.string.AreYouSureRevokeInviteLinkChannel : R.string.AreYouSureRevokeInviteLinkGroup), new int[]{R.id.btn_revokeLink, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.RevokeLink), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_link_off_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view2, int i2) {
                        boolean F6;
            ...
            case R.id.btn_shareLink:
                ...
                String j1 = C4403w.m27867j1(v4Var.mo4348c().m2784K6(j) ? R.string.ShareTextChannelLink : R.string.ShareTextChatLink, Q3, chatInviteLink.inviteLink);
    ...
    public void m3831H4(AbstractC10664f9 f9Var, C4737p7 p7Var, C10788q qVar, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            m3841G4(f9Var, this.f34462a.m2408ia(object), p7Var, qVar);
        } else if (constructor == -537797015) {
            long j = ((TdApi.User) object).f25442id;
    ...
    public static void m3830H5(Runnable runnable, C10930q6 q6Var, TdApi.ReportChat reportChat) {
        ...
        q6Var.m2270r4().m14783o(reportChat, C10613df.f34016a);
    }
    ...
    public static boolean m3823I2(TdApi.Document document) {
        return ((!C5070i.m24062i(document.fileName) && document.fileName.endsWith(".xml")) || (!C5070i.m24062i(document.mimeType) && document.mimeType.equals("application/xml"))) && ((long) document.document.size) <= EnumC6459p.f20158c.mo20396b(1.0d) && C4779t2.m25587V2(document.document);
    }
    ...
    public static boolean m3813J2(TdApi.Document document) {
        return document != null && !C5070i.m24062i(document.fileName) && document.fileName.endsWith("tgx-theme") && C4779t2.m25587V2(document.document);
    }
    ...
    public static void m3812J3(AbstractC9323v4 v4Var, TdApi.LanguagePackInfo languagePackInfo, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            v4Var.mo4348c().m2757M1(languagePackInfo, C11170zc.f35807a, true);
        }
    }
    ...
    public void m3802K3(AbstractC10664f9 f9Var, String str, C10788q qVar, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            m3857E8(this.f34462a, R.drawable.baseline_error_24, C4779t2.m25379z5(object), qVar);
        } else if (constructor == 546234276) {
            TdApi.ChatInviteLinkInfo chatInviteLinkInfo = (TdApi.ChatInviteLinkInfo) object;
            this.f34462a.m2516bd(chatInviteLinkInfo);
            int X2 = this.f34462a.m2587X2(chatInviteLinkInfo.chatId);
    ...
    public static void m3800K5(Runnable runnable, C10930q6 q6Var, TdApi.ReportChatPhoto reportChatPhoto) {
        ...
        q6Var.m2270r4().m14783o(reportChatPhoto, C10644ef.f34086a);
    }

    public static void m3799K6(boolean z) {
        if (z) {
            C1379j0.m37295y0(R.string.LanguageChangeSuccess, 0);
        }
    }
    ...
    public void m3791L4(List list, final AbstractC10664f9 f9Var, final String str, final C10788q qVar, int i, SparseIntArray sparseIntArray) {
        ...
        if (list.size() > 1 && ((C2964ra) list.get(1)).m32876D()) {
            z = true;
        }
        if (D) {
    ...
    public static void m3789L6(AbstractC10664f9 f9Var, TdApi.LanguagePackInfo languagePackInfo, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            f9Var.mo4348c().m2757M1(languagePackInfo, C11148yc.f35762a, true);
        }
    }
    ...
    public static void m3782M3(final boolean z, final AbstractC5920l lVar) {
        ...
        try {
            ...
            if (n0 == -1) {
                str = C4403w.m27871i1(R.string.TdlibLogClearFail);
            } else {
                str = n0 == 0 ? C4403w.m27871i1(R.string.TdlibLogClearEmpty) : C4403w.m27867j1(R.string.TdlibLogClearOk, C1363c0.m37426m(n0));
            }
    ...
    public static void m3780M5(AtomicInteger atomicInteger, long[] jArr, Runnable runnable, C10930q6 q6Var, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            C1379j0.m37293z0(C4403w.m27846o2(R.string.ReportedXChats, jArr.length), 0);
            if (runnable != null) {
    ...
    public static boolean m3779M6(final AbstractC10664f9 f9Var, final TdApi.LanguagePackInfo languagePackInfo, View view, int i) {
        ...
        f9Var.mo4348c().m2270r4().m14783o(new TdApi.AddCustomServerLanguagePack(languagePackInfo.f25408id), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3761O4(final C10788q qVar, final String str, final AbstractC10664f9 f9Var, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            arrayList.add(new C2964ra(99, (int) R.id.btn_signIn, 0, C4403w.m27875h1(R.string.LogInAsOn, C10571bi.f33908a, f9Var.mo4348c().m2885E1(), loginUrlInfoRequestConfirmation.domain), true));
            if (loginUrlInfoRequestConfirmation.requestWriteAccess) {
                arrayList.add(new C2964ra(99, (int) R.id.btn_allowWriteAccess, 0, C4403w.m27875h1(R.string.AllowWriteAccess, C4403w.m27845p(), f9Var.mo4348c().m2480e2().m1721K2(loginUrlInfoRequestConfirmation.botUserId)), true));
            }
            AbstractC9323v4<?> F = f9Var instanceof AbstractC9323v4 ? (AbstractC9323v4) f9Var : f9Var.mo4347s().m14551P1().m9762F();
            if (F != null && !F.m9347Sa()) {
                F.m9206me(new C9188f2(R.id.btn_open).m10010b(C4403w.m27875h1(R.string.OpenLinkConfirm, C10858mi.f34795a, loginUrlInfoRequestConfirmation.url)).m9997o(arrayList).m10002j(new AbstractC9323v4.AbstractC9343r() {
                    @Override
                ...
                }).m9992t(C10694gf.f34225a).m9998n(loginUrlInfoRequestConfirmation.requestWriteAccess ? new AbstractC9323v4.AbstractC9337n() {
                    @Override
    ...
    public static void m3757O8(Context context, int i, boolean z, boolean z2, int i2, final AbstractC5918j<C10787p> jVar) {
        ...
        int i3 = 0;
        arrayList.add(new C10787p(0, C4403w.m27871i1(R.string.Off)));
        int i4 = z2 ? 20 : 15;
        for (int i5 = 1; i5 <= i4; i5++) {
            arrayList.add(new C10787p(i5, C4403w.m27846o2(R.string.xSeconds, i5)));
        }
        if (z2) {
            while (true) {
                i4 += 5;
                ...
                arrayList.add(new C10787p(i4, C4403w.m27846o2(R.string.xSeconds, i4)));
            }
            arrayList.add(new C10787p(60, C4403w.m27846o2(R.string.xMinutes, 1L)));
        } else {
            arrayList.add(new C10787p(30, C4403w.m27846o2(R.string.xSeconds, 30L)));
            arrayList.add(new C10787p(60, C4403w.m27846o2(R.string.xMinutes, 1L)));
            arrayList.add(new C10787p(3600, C4403w.m27846o2(R.string.xHours, 1L)));
            arrayList.add(new C10787p(86400, C4403w.m27846o2(R.string.xDays, 1L)));
            arrayList.add(new C10787p(604800, C4403w.m27846o2(R.string.xWeeks, 1L)));
        }
        ...
        while (true) {
            if (!it.hasNext()) {
                break;
            } else if (((C10787p) it.next()).f34536a == i) {
                i3 = i6;
                break;
            } else {
                i6++;
        ...
        builder.setTitle(C4403w.m27871i1(R.string.MessageLifetime));
        if (i2 != 0) {
            builder.setMessage(C4403w.m27871i1(i2));
        }
        builder.setPositiveButton(C4403w.m27871i1(R.string.Done), new DialogInterface.OnClickListener() {
            @Override
        ...
        C1379j0.m37310r(context).m14416x3(builder, z ? C11514c0.m348a(2) : null);
    }
    ...
    public void m3752P3(AbstractC9323v4 v4Var, final AbstractC10786o oVar, long j, AbstractC11531p pVar, View view, View view2) {
        switch (view.getId()) {
            ...
            case R.id.btn_sendScheduled:
                if (v4Var != null) {
                    this.f34462a.m2485dd().m3808J7(v4Var, new AbstractC5918j() {
                        @Override
                        public final void mo1330a(Object obj) {
    ...
    public boolean m3742Q3(AbstractC9323v4 v4Var, long j, View view, int i) {
        if (!v4Var.m9347Sa() && i == R.id.btn_delete) {
            this.f34462a.m2270r4().m14783o(new TdApi.RemoveContacts(new long[]{j}), this.f34462a.m2392ja());
        }
        return true;
    }

    public static void m3740Q5(AbstractC9323v4 v4Var, CharSequence charSequence, final AbstractC10785n nVar, final String str) {
        v4Var.m9247ge(new AbstractC9323v4.C9340p.C9341a().m9092c(C1363c0.m37469H(C4403w.m27871i1(R.string.TransferOwnershipAlert), charSequence)).m9091d(new AbstractC9323v4.C9338o(R.id.btn_next, C4403w.m27871i1(R.string.TransferOwnershipConfirm), 2, R.drawable.templarian_baseline_account_switch_24)).m9093b().m9094a(), new AbstractC5117h0() {
            @Override
    ...
    public void m3739Q6(int i, Runnable runnable, int i2, SparseIntArray sparseIntArray) {
        ...
        c2.m24790T4(i3, z);
        if (i == 0 && this.f34463b != null) {
            List<Runnable> list = this.f34464c;
            this.f34463b = null;
            this.f34464c = null;
    ...
    public static boolean m3733R2(final AbstractC9323v4<?> v4Var, final TdApi.Message[] messageArr, final Runnable runnable) {
        ...
        final long Q0 = C4779t2.m25619Q0(messageArr);
        if (Q0 == 0 || !v4Var.mo4348c().m2299p7(Q0) || (c2 = C4779t2.m25543c2(messageArr)) == null || v4Var.mo4348c().m2395j7(c2)) {
            return false;
        }
        final String zb = c.m2135zb(c2, true);
        C9188f2 i = new C9188f2(R.id.btn_deleteSupergroupMessages).m10003i(new C2964ra(28, (int) R.id.text_title, 0, C4403w.m27834r2(R.string.QDeleteXMessagesFromY, messageArr.length, zb), false));
        ...
        raVarArr[2] = new C2964ra(12, (int) R.id.btn_deleteAll, 0, C4403w.m27855m1(R.string.DeleteAllFrom, zb), false);
        final C9180e2 me2 = v4Var.m9206me(i.m9996p(raVarArr).m10002j(new AbstractC9323v4.AbstractC9343r() {
            @Override
    ...
    public static void m3732R3(AbstractC9323v4 v4Var, C10930q6 q6Var, long j, TdApi.MessageSender messageSender, TdApi.ChatMember chatMember) {
        ...
        if (!v4Var.m9347Sa() && (K3 = q6Var.m2787K3(j)) != null) {
            ...
            u7Var.m31378sg(new View$OnClickListenerC3141u7.C3145d(j, messageSender, true, K3, chatMember));
            v4Var.m9291ac(u7Var);
        }
    }
    ...
    public static boolean m3731R4(String str, int i, TdApi.ProxyType proxyType, View view, int i2) {
        if (i2 == R.id.btn_addProxy) {
            C4868i.m24727c2().m24634o(str, i, proxyType, null, true);
            return true;
        } else if (i2 != R.id.btn_save) {
            return true;
        } else {
            C4868i.m24727c2().m24634o(str, i, proxyType, null, false);
            return true;
        }
    }
    ...
    public boolean m3729R6(AbstractC9323v4 v4Var, TdApi.NotificationSettingsScope notificationSettingsScope, long j, Runnable runnable, View view, int i) {
        if (i == R.id.btn_menu_customize) {
            View$OnClickListenerC2359ew ewVar = new View$OnClickListenerC2359ew(v4Var.mo4347s(), this.f34462a);
            if (notificationSettingsScope != null) {
                ewVar.m34953Si(new View$OnClickListenerC2359ew.C2361b(notificationSettingsScope));
            } else {
                ewVar.m34953Si(new View$OnClickListenerC2359ew.C2361b(j));
            }
            v4Var.m9291ac(ewVar);
            C7389v0.m16743D2(runnable);
            return true;
            ...
            int i3 = m3563i3(i);
            if (notificationSettingsScope != null) {
                this.f34462a.m2374kc(notificationSettingsScope, i3);
            } else {
                this.f34462a.m2486dc(j, i3);
            }
            C7389v0.m16743D2(runnable);
            return true;
        } else {
            TdApi.ChatNotificationSettings chatNotificationSettings = this.f34462a.m2771L3(j).notificationSettings;
            chatNotificationSettings.useDefaultMuteFor = true;
            this.f34462a.m2763Lb(j, chatNotificationSettings);
            C7389v0.m16743D2(runnable);
            return true;
        }
    }
    ...
    public static boolean m3723S2(AbstractC9323v4<?> v4Var, final TdApi.Message[] messageArr, final Runnable runnable) {
        ...
        final C10930q6 c = v4Var.mo4348c();
        long Q0 = C4779t2.m25619Q0(messageArr);
        if (c.m2443g7(Q0)) {
            return false;
        }
        ...
        SpannableStringBuilder spannableStringBuilder = new SpannableStringBuilder(C4403w.m27838q2(R.string.QDeleteXMessages, messageArr.length));
        if (i3 > 0) {
            spannableStringBuilder.append((CharSequence) "\n").append(C4403w.m27838q2(R.string.DeleteXForMeWarning, i3));
        }
        if (i2 == length) {
            charSequence = C7316a.m17053h(Q0) ? C4403w.m27871i1(R.string.DeleteForEveryone) : C4403w.m27855m1(R.string.DeleteForUser, c.m2480e2().m1749D2(c.m2494d4(Q0)));
        } else {
            charSequence = C7316a.m17053h(Q0) ? C4403w.m27838q2(R.string.DeleteXForEveryone, i2) : C4403w.m27834r2(R.string.DeleteXForUser, i2, c.m2480e2().m1749D2(c.m2494d4(Q0)));
        }
        v4Var.m9206me(new C9188f2(R.id.btn_deleteMessagesWithRevoke).m10010b(spannableStringBuilder).m9996p(new C2964ra[]{new C2964ra(12, (int) R.id.btn_revokeMessages, 0, charSequence, z2)}).m10002j(new AbstractC9323v4.AbstractC9343r() {
            @Override
        ...
        }).m9994r(R.string.Delete).m9995q(R.id.theme_color_textNegative).m10009c(false));
        return true;
    }
    ...
    public static void m3720S5(final AbstractC9323v4 v4Var, final CharSequence charSequence, final AbstractC10785n nVar, TdApi.Object object) {
        if (object.getConstructor() == -2001619202) {
            ...
            ljVar.m33966bg(new View$OnClickListenerC2665lj.C2666a(10, (TdApi.PasswordState) object).m33923d(new AbstractC5918j() {
                @Override
                public final void mo1330a(Object obj) {
    ...
    public static void m3718S7(AbstractC9323v4<?> v4Var, final C11131y6 y6Var, boolean z) {
        v4Var.m9261ee(C4403w.m27855m1(z ? R.string.SignOutHint2 : R.string.RemoveAccountHint2, y6Var.m1455u()), new int[]{R.id.btn_removeAccount, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.LogOut), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_forever_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean F5;
    ...
    public static void m3712T3(TdApi.Message[] messageArr, final C10930q6 q6Var, final long j, final AbstractC9323v4 v4Var, final TdApi.MessageSender messageSender, Runnable runnable, int i, SparseIntArray sparseIntArray) {
        if (i == R.id.btn_deleteSupergroupMessages) {
            ...
            long[] q = C4779t2.m25646M1(messageArr).m21496q(0);
            if (z) {
    ...
    public void m3711T4(TdApi.Chat[] chatArr, AbstractRunnableC5910b bVar, TdApi.Error[] errorArr, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            this.f34462a.m2485dd().post(bVar);
        } else if (constructor == -1601123095) {
    ...
    public static boolean m3710T5(AbstractC9323v4 v4Var, View view, int i) {
        ...
        qpVar.m32971ih(new View$OnClickListenerC2937qp.C2939b(null));
        v4Var.m9291ac(qpVar);
        return true;
    }
    ...
    public static void m3708T7(final AbstractC9323v4<?> v4Var, final long j, TdApi.Message[] messageArr, final Runnable runnable, AbstractC11531p pVar) {
        ...
        if (messageArr == null || messageArr.length <= 0) {
            jArr = null;
            charSequence = C4403w.m27855m1(R.string.ReportChat, c.m2691Q3(j));
        } else {
            ...
            if (z) {
                ...
                if (P0 != 0) {
                    ...
                    charSequence2 = C4403w.m27855m1(i3, objArr);
                } else {
                    if (messageArr.length != 1) {
                        i3 = R.string.ReportMessages;
                    }
                    charSequence2 = C4403w.m27855m1(i3, c.m2691Q3(messageArr[0].chatId));
                }
            } else {
                charSequence2 = C4403w.m27850n2(R.string.ReportXMessages, messageArr.length, C4403w.m27845p(), new Object[0]);
            }
            charSequence = charSequence2;
            jArr = jArr2;
        }
    ...
    public void m3701U4(final TdApi.Chat[] chatArr, final AbstractRunnableC5910b bVar, final TdApi.Error[] errorArr, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            this.f34462a.m2270r4().m14783o(new TdApi.CreatePrivateChat(((TdApi.User) object).f25442id, false), new Client.AbstractC7865g() {
                @Override
    ...
    public static void m3698U7(final AbstractC9323v4<?> v4Var, final long j, final int i, final Runnable runnable, AbstractC11531p pVar) {
        final C10930q6 c = v4Var.mo4348c();
        final CharSequence m1 = C4403w.m27855m1(R.string.ReportChatPhoto, c.m2691Q3(j));
        C5320c cVar = new C5320c(7);
        C5146u0 u0Var = new C5146u0(7);
        m3643a3(cVar, u0Var);
        v4Var.m9254fe(m1, cVar.m23281e(), u0Var.m23814d(), null, null, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i2) {
                boolean L5;
    ...
    public static void m3692V3(TdApi.ChatMember chatMember, C10930q6 q6Var, TdApi.Message[] messageArr, String str, C9180e2 e2Var) {
        ...
        if (chatMember.status.getConstructor() == -160019714) {
            str2 = C4403w.m27871i1(R.string.RoleOwner);
        } else if (chatMember.status.getConstructor() == -1653518666) {
            str2 = C4403w.m27871i1(R.string.RoleBanned);
        } else if (C4779t2.m25500i3(chatMember.status, false) || chatMember.memberId.getConstructor() == -239660751) {
            int i = chatMember.joinedChatDate;
            if (i != 0) {
                str2 = C4403w.m27920X0(i, TimeUnit.SECONDS, q6Var.m2898D4(), TimeUnit.MILLISECONDS, true, 60, R.string.RoleMember, true);
            } else if (chatMember.memberId.getConstructor() == -239660751) {
                str2 = C4403w.m27871i1(q6Var.m2784K6(C7321e.m16986Q0(chatMember.memberId)) ? R.string.RoleChannel : R.string.RoleGroup);
            } else {
                return;
            }
        } else {
            str2 = C4403w.m27871i1(R.string.RoleLeft);
        }
        CharSequence n2 = C4403w.m27850n2(R.string.QDeleteXMessagesFromYRole, messageArr.length, C10745ij.f34383a, str, str2);
        int N0 = e2Var.f29640a.m34227N0(R.id.text_title);
        if (N0 != -1 && e2Var.f29640a.m34246E0(N0).m32854Z(n2)) {
            e2Var.f29640a.m39315I(N0);
        }
    }
    ...
    public boolean m3691V4(final TdApi.Chat[] chatArr, final AbstractRunnableC5910b bVar, final TdApi.Error[] errorArr, View view, int i) {
        ...
        this.f34462a.m2270r4().m14783o(new TdApi.GetSupportUser(), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public static void m3688V7(final AbstractC9323v4<?> v4Var, final long[] jArr, final Runnable runnable) {
        ...
        C5146u0 u0Var = new C5146u0(7);
        m3643a3(cVar, u0Var);
        final CharSequence q2 = C4403w.m27838q2(R.string.ReportXChats, jArr.length);
        v4Var.m9254fe(q2, cVar.m23281e(), u0Var.m23814d(), null, null, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean O5;
    ...
    public static <T extends TdApi.Function> void m3687V8(AbstractC9323v4<?> v4Var, int i, CharSequence charSequence, T t, boolean z, AbstractC5918j<T> jVar) {
        ...
        if (z) {
            ...
            v4Var.mo4347s().m14551P1().m9718h0(yoVar);
            return;
        }
        jVar.mo1330a(t);
    }
    ...
    public void m3680W5(final AbstractC10785n nVar, TdApi.Object object, final AbstractC9323v4 v4Var, final CharSequence charSequence) {
        ...
        switch (object.getConstructor()) {
            case TdApi.CanTransferOwnershipResultOk.CONSTRUCTOR:
                this.f34462a.m2270r4().m14783o(new TdApi.GetPasswordState(), new Client.AbstractC7865g() {
                    @Override
                    public final void mo255t2(TdApi.Object object2) {
            ...
            case TdApi.CanTransferOwnershipResultPasswordTooFresh.CONSTRUCTOR:
                v4Var.m9247ge(new AbstractC9323v4.C9340p.C9341a().m9092c(C1363c0.m37469H(C4403w.m27871i1(R.string.TransferOwnershipSecurityAlert), C4403w.m27984H0(v4Var, R.string.TransferOwnershipSecurityWaitPassword, C4403w.m27820v0(((TdApi.CanTransferOwnershipResultPasswordTooFresh) object).retryAfter)))).m9091d(new AbstractC9323v4.C9338o(R.id.btn_next, C4403w.m27871i1(R.string.OK), 1, R.drawable.baseline_check_circle_24)).m9093b().m9094a(), C10591ch.f33956a);
                return;
            case TdApi.CanTransferOwnershipResultSessionTooFresh.CONSTRUCTOR:
                v4Var.m9247ge(new AbstractC9323v4.C9340p.C9341a().m9092c(C1363c0.m37469H(C4403w.m27871i1(R.string.TransferOwnershipSecurityAlert), C4403w.m27984H0(v4Var, R.string.TransferOwnershipSecurityWaitSession, C4403w.m27820v0(((TdApi.CanTransferOwnershipResultSessionTooFresh) object).retryAfter)))).m9091d(new AbstractC9323v4.C9338o(R.id.btn_next, C4403w.m27871i1(R.string.OK), 1, R.drawable.baseline_check_circle_24)).m9093b().m9094a(), C10615dh.f34018a);
                return;
            case TdApi.CanTransferOwnershipResultPasswordNeeded.CONSTRUCTOR:
                v4Var.m9247ge(new AbstractC9323v4.C9340p.C9341a().m9092c(C1363c0.m37469H(C4403w.m27871i1(R.string.TransferOwnershipSecurityAlert), C4403w.m27984H0(v4Var, R.string.TransferOwnershipSecurityPasswordNeeded, new Object[0]))).m9091d(new AbstractC9323v4.C9338o(R.id.btn_next, C4403w.m27871i1(R.string.TransferOwnershipSecurityActionSetPassword), 3, R.drawable.mrgrigri_baseline_textbox_password_24)).m9093b().m9094a(), new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i) {
                        boolean T5;
    ...
    public void m3679W6(AbstractC10664f9 f9Var, String str, C10788q qVar, int i, String str2, TdApi.Object object) {
        ...
        boolean z = false;
        if (constructor == -1679978726) {
            m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4403w.m27855m1(R.string.BotNotFound, str), qVar);
        } else if (constructor == -1601123095) {
            TdApi.Chat ia = this.f34462a.m2408ia(object);
            if (!this.f34462a.m2816I6(ia)) {
                m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4403w.m27855m1(R.string.BotNotFound, str), qVar);
                return;
            }
            TdApi.User b4 = this.f34462a.m2525b4(ia);
            if (b4 == null || b4.type.getConstructor() != 1262387765) {
                m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4403w.m27855m1(R.string.BotNotFound, str), qVar);
            } else if (i == 0) {
                m3881C4(f9Var, ia, new C10780j().m3357s(qVar).m3358r(new C4822w2(b4.f25442id, str2, false)).m3368h());
            } else if (i == 1 || i == 2) {
                if (i == 2) {
                    z = true;
                }
                m3832H3(f9Var, new C4822w2(b4.f25442id, str2, z), z);
            }
        }
    }

    public static void m3672X3(C9180e2 e2Var, int i, String str) {
        int N0 = e2Var.f29640a.m34227N0(R.id.btn_deleteAll);
        if (N0 != -1 && e2Var.f29640a.m34246E0(N0).m32854Z(C4403w.m27834r2(R.string.DeleteXMoreFrom, i, str))) {
            e2Var.f29640a.m39315I(N0);
        }
    }
    ...
    public void m3671X4(final AbstractC9323v4 v4Var, final AbstractC10664f9 f9Var, final TdApi.InternalLinkTypePhoneNumberConfirmation internalLinkTypePhoneNumberConfirmation, C10788q qVar, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            m3857E8(this.f34462a, R.drawable.baseline_warning_24, C4779t2.m25379z5(object), qVar);
    ...
    public void m3670X5(final AbstractC10785n nVar, final AbstractC9323v4 v4Var, final CharSequence charSequence, final TdApi.Object object) {
        this.f34462a.m2485dd().post(new Runnable() {
            @Override
            public final void run() {
    ...
    public void m3669X6(AbstractC10664f9 f9Var, C10780j jVar, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            m3881C4(f9Var, this.f34462a.m2408ia(object), jVar);
        }
    }
    ...
    public static void m3660Y5(TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            C1379j0.m37295y0(R.string.GifSaved, 0);
        }
    }
    ...
    public void m3659Y6(long j, TdApi.MessageSender messageSender, TdApi.ChatMemberStatus chatMemberStatus, int i, SparseIntArray sparseIntArray) {
        this.f34462a.m2811Ib(j, messageSender, sparseIntArray.get(R.id.right_readMessages) != 0 ? new TdApi.ChatMemberStatusMember() : new TdApi.ChatMemberStatusLeft(), chatMemberStatus, null);
    }
    ...
    public static void m3653Z2(C5320c cVar, C5320c cVar2, C5146u0 u0Var, C5320c cVar3, boolean z, boolean z2, boolean z3, boolean z4, boolean z5, String str, boolean z6) {
        ...
        if (z) {
            if (z5) {
                u0Var.m23816b(C4403w.m27867j1(R.string.NotificationsDefaultValue, C4403w.m27871i1(R.string.EnableNotifications)));
            } else {
                u0Var.m23817a(R.string.EnableNotifications);
            }
            cVar2.m23285a(R.drawable.baseline_notifications_24);
            cVar.m23285a(R.id.btn_menu_enable);
            if (cVar3 != null) {
                cVar3.m23285a(1);
            }
        }
        if (str != null) {
            u0Var.m23816b(C4403w.m27867j1(R.string.NotificationsDefault, C4403w.m27911Z1(str)));
            cVar2.m23285a(R.drawable.baseline_notifications_off_24);
            cVar.m23285a(R.id.btn_menu_resetToDefault);
            if (cVar3 != null) {
                cVar3.m23285a(1);
            }
        }
        if (z2) {
            u0Var.m23817a(R.string.MuteForever);
            cVar2.m23285a(R.drawable.baseline_notifications_off_24);
            cVar.m23285a(R.id.btn_menu_disable);
            if (cVar3 != null) {
                cVar3.m23285a(1);
            }
        }
        if (z3) {
            u0Var.m23816b(C4403w.m27846o2(R.string.MuteForXHours, 1L));
            u0Var.m23816b(C4403w.m27846o2(R.string.MuteForXHours, 8L));
            u0Var.m23816b(C4403w.m27846o2(R.string.MuteForXDays, 2L));
            cVar2.m23285a(R.drawable.baseline_notifications_paused_24);
            cVar2.m23285a(R.drawable.baseline_notifications_paused_24);
            cVar2.m23285a(R.drawable.baseline_notifications_paused_24);
            cVar.m23285a(R.id.btn_menu_1hour);
            cVar.m23285a(R.id.btn_menu_8hours);
            cVar.m23285a(R.id.btn_menu_2days);
            if (cVar3 != null) {
                cVar3.m23285a(1);
                cVar3.m23285a(1);
                cVar3.m23285a(1);
        ...
        if (z4) {
            cVar.m23285a(R.id.btn_menu_customize);
            u0Var.m23817a(R.string.NotificationsCustomize);
    ...
    public static void m3652Z3(int i, TdApi.Message[] messageArr, C10930q6 q6Var, Runnable runnable, int i2, SparseIntArray sparseIntArray) {
        if (i2 == R.id.btn_deleteMessagesWithRevoke) {
            ...
            if (!z || i <= 0) {
                C6035e<long[]> M1 = C4779t2.m25646M1(messageArr);
                for (int i3 = 0; i3 < M1.m21497p(); i3++) {
                    q6Var.m2770L4(M1.m21502j(i3), M1.m21496q(i3), z);
                }
            } else {
                ...
                C6035e<long[]> M12 = C4779t2.m25646M1(messageArr2);
                for (int i6 = 0; i6 < M12.m21497p(); i6++) {
                    q6Var.m2770L4(M12.m21502j(i6), M12.m21496q(i6), true);
                }
                C6035e<long[]> M13 = C4779t2.m25646M1(messageArr3);
                for (int i7 = 0; i7 < M13.m21497p(); i7++) {
                    q6Var.m2770L4(M13.m21502j(i7), M13.m21496q(i7), false);
                }
            }
            if (runnable != null) {
                runnable.run();
    ...
    public static void m3650Z5(AtomicInteger atomicInteger, AtomicInteger atomicInteger2, List list, TdApi.Object object) {
        ...
        if (atomicInteger.get() == 1) {
            ...
            C1379j0.m37293z0(C4403w.m27838q2(R.string.XGifSaved, list.size()), 0);
        }
    }
    ...
    public static void m3648Z7(AbstractC9323v4<?> v4Var, boolean z, boolean z2) {
        ...
        if (!file.exists()) {
            C1379j0.m37293z0("Log does not exist", 0);
        } else if (file.length() == 0) {
            C1379j0.m37293z0("Log is empty", 0);
        } else {
            x00 x00Var = new x00(v4Var.mo4347s(), z2 ? null : v4Var.mo4348c());
            x00Var.m30996Vi(new x00.C3281m(H0, "text/plain"));
            x00Var.m30962ej();
        }
    }

    public static void m3643a3(C5320c cVar, C5146u0 u0Var) {
        cVar.m23285a(R.id.btn_reportChatSpam);
        u0Var.m23817a(R.string.Spam);
        cVar.m23285a(R.id.btn_reportChatFake);
        u0Var.m23817a(R.string.Fake);
        cVar.m23285a(R.id.btn_reportChatViolence);
        u0Var.m23817a(R.string.Violence);
        cVar.m23285a(R.id.btn_reportChatPornography);
        u0Var.m23817a(R.string.Pornography);
        cVar.m23285a(R.id.btn_reportChatChildAbuse);
        u0Var.m23817a(R.string.ChildAbuse);
        cVar.m23285a(R.id.btn_reportChatCopyright);
        u0Var.m23817a(R.string.Copyright);
        cVar.m23285a(R.id.btn_reportChatOther);
        u0Var.m23817a(R.string.Other);
    }

    public static void m3642a4(AbstractC9323v4 v4Var, AbstractC10782l lVar) {
        if (!v4Var.m9347Sa() && v4Var.m9284bc() != null) {
            v4Var.m9284bc().m9748M().m9514B(false);
            lVar.mo3341a();
        }
    ...
    public static void m3640a6(int i) {
        C1379j0.m37293z0(C4403w.m27846o2(R.string.ReadAllChatsDone, i), 0);
    }

    public static void m3638a8(String str, C9262p0 p0Var) {
        C6250i iVar = new C6250i(str);
        iVar.mo20768t0(C9903a.getDefaultAvatarCacheSize());
        iVar.m20931Z(true);
        p0Var.setPhoto(iVar);
    }
    ...
    public static void m3631b5(AbstractC10664f9 f9Var, TdApi.Background background, AbstractC5917i iVar) {
        ...
        rhVar.m32667Lp(new View$OnClickListenerC2971rh.C2977c0(5, null, null).m32139f(background));
        f9Var.mo4347s().m14551P1().m9718h0(rhVar);
        if (iVar != null) {
            iVar.mo1322a(true);
        }
    }
    ...
    public boolean m3630b6(View view, int i) {
        if (i == R.id.btn_markChatAsRead) {
            this.f34462a.m2732Na(new TdApi.ChatListArchive(), C10808kd.f34609a);
            return true;
        } else if (i != R.id.btn_pinUnpinChat) {
            return true;
        } else {
            this.f34462a.m2294pc().m4092u0(1L);
            return true;
        }
    }
    ...
    public static StringBuilder m3619c7(String str, String str2) {
        ...
        sb2.append(C4403w.m27871i1(R.string.UseProxyServer));
        sb2.append(":</b> ");
        sb2.append(str);
        sb2.append("<br/><b>");
        sb2.append(C4403w.m27871i1(R.string.UseProxyPort));
        sb2.append(":</b> ");
        sb2.append(str2);
        return sb2;
    }
    ...
    public void m3612d4(final AbstractC9323v4 v4Var, final AbstractC10782l lVar, final boolean z) {
        this.f34462a.m2509c5(new AbstractC5917i() {
            @Override
    ...
    public static String m3603e3(long j, TimeUnit timeUnit, int i) {
        ...
        if (seconds < 60) {
            ...
            return C4403w.m27846o2(i5, seconds);
        }
        int i6 = seconds / 60;
        if (i6 < 60) {
            if (i == 0) {
    ...
    public void m3592f4(final AbstractC9323v4 v4Var, final AbstractC10782l lVar, final boolean z, boolean z2) {
        if (z2 && !v4Var.m9347Sa() && v4Var.m9339Ta() && v4Var.m9284bc() != null) {
            ...
            v4Var.m9284bc().m9748M().m9514B(true);
            lVar.mo3340b();
            C1379j0.m37295y0(R.string.EraseDatabaseProgress, 0);
            ...
            if (z) {
                this.f34462a.m2802J4(new AbstractC5917i() {
                    @Override
    ...
    public void m3590f6(long j, Runnable runnable, int i, SparseIntArray sparseIntArray) {
        this.f34462a.m2270r4().m14783o(new TdApi.DeleteChatHistory(j, false, sparseIntArray.get(R.id.btn_clearChatHistory) == R.id.btn_clearChatHistory), this.f34462a.m2392ja());
        C7389v0.m16743D2(runnable);
    }

    public void m3582g4(final AbstractC9323v4 v4Var, final AbstractC10782l lVar, final boolean z, boolean z2) {
        if (z2) {
            v4Var.m9172re(C4403w.m27984H0(v4Var, R.string.EraseDatabaseWarn2, new Object[0]), new AbstractC5917i() {
                @Override
                public final void mo1322a(boolean z3) {
    ...
    public boolean m3580g6(long j, Runnable runnable, View view, int i) {
        ...
        this.f34462a.m2270r4().m14783o(new TdApi.DeleteChatHistory(j, false, false), this.f34462a.m2392ja());
        C7389v0.m16743D2(runnable);
        return true;
    }
    ...
    public void m3571h5(final AbstractC10664f9 f9Var, TdApi.InternalLinkType internalLinkType, final C10788q qVar, String str, final AbstractC5917i iVar) {
        if (!f9Var.mo4347s().m14551P1().m9737W()) {
            boolean z = true;
            switch (internalLinkType.getConstructor()) {
                ...
                case TdApi.InternalLinkTypeQrCodeAuthentication.CONSTRUCTOR:
                    m3857E8(this.f34462a, R.drawable.baseline_warning_24, C4403w.m27871i1(R.string.ScanQRLinkHint), qVar);
                    break;
                case TdApi.InternalLinkTypeThemeSettings.CONSTRUCTOR:
                    ...
                    ezVar.m34834Wh(new View$OnClickListenerC2364ez.C2367c(0));
                    f9Var.mo4347s().m14551P1().m9718h0(ezVar);
                    break;
                ...
                case TdApi.InternalLinkTypeUnsupportedProxy.CONSTRUCTOR:
                    m3857E8(this.f34462a, R.drawable.baseline_warning_24, C4403w.m27871i1(R.string.ProxyLinkUnsupported), qVar);
                    break;
                ...
                case TdApi.InternalLinkTypeChangePhoneNumber.CONSTRUCTOR:
                    f9Var.mo4347s().m14551P1().m9718h0(new View$OnClickListenerC2461gw(f9Var.mo4347s(), f9Var.mo4348c()));
                    break;
                ...
                case TdApi.InternalLinkTypeAuthenticationCode.CONSTRUCTOR:
                    this.f34462a.m2781K9().m1966D0(((TdApi.InternalLinkTypeAuthenticationCode) internalLinkType).code);
                    break;
                case TdApi.InternalLinkTypeTheme.CONSTRUCTOR:
                    ...
                    m3857E8(this.f34462a, R.drawable.baseline_info_24, C4403w.m27984H0(f9Var, R.string.NoCloudThemeSupport, new Object[0]), qVar);
                    break;
                case TdApi.InternalLinkTypeBackground.CONSTRUCTOR:
                    this.f34462a.m2270r4().m14783o(new TdApi.SearchBackground(((TdApi.InternalLinkTypeBackground) internalLinkType).backgroundName), new Client.AbstractC7865g() {
                        @Override
                        public final void mo255t2(TdApi.Object object) {
                ...
                case TdApi.InternalLinkTypeSettings.CONSTRUCTOR:
                    f9Var.mo4347s().m14551P1().m9718h0(new View$OnClickListenerC3217vt(f9Var.mo4347s(), f9Var.mo4348c()));
                    break;
                ...
                case TdApi.InternalLinkTypeUnknownDeepLink.CONSTRUCTOR:
                    this.f34462a.m2270r4().m14783o(new TdApi.GetDeepLinkInfo(str), new Client.AbstractC7865g() {
                        @Override
                        public final void mo255t2(TdApi.Object object) {
                ...
                case TdApi.InternalLinkTypeMessageDraft.CONSTRUCTOR:
                    ...
                    x00Var.m30996Vi(new x00.C3281m(((TdApi.InternalLinkTypeMessageDraft) internalLinkType).text));
                    x00Var.m30962ej();
                    break;
                case TdApi.InternalLinkTypeMessage.CONSTRUCTOR:
                    this.f34462a.m2270r4().m14783o(new TdApi.GetMessageLinkInfo(((TdApi.InternalLinkTypeMessage) internalLinkType).url), new Client.AbstractC7865g() {
                        @Override
                        public final void mo255t2(TdApi.Object object) {
                ...
                case TdApi.InternalLinkTypePhoneNumberConfirmation.CONSTRUCTOR:
                    ...
                    final AbstractC9323v4<?> F = f9Var.mo4347s().m14551P1().m9762F();
                    this.f34462a.m2270r4().m14783o(new TdApi.SendPhoneNumberConfirmationCode(internalLinkTypePhoneNumberConfirmation.hash, internalLinkTypePhoneNumberConfirmation.phoneNumber, C4779t2.m25510h0()), new Client.AbstractC7865g() {
                        @Override
                        public final void mo255t2(TdApi.Object object) {
                ...
                case TdApi.InternalLinkTypeActiveSessions.CONSTRUCTOR:
                    f9Var.mo4347s().m14551P1().m9718h0(new g20(f9Var.mo4347s(), f9Var.mo4348c(), new AbstractC9323v4[]{new View$OnClickListenerC2265cy(f9Var.mo4347s(), f9Var.mo4348c()), new View$OnClickListenerC2899pz(f9Var.mo4347s(), f9Var.mo4348c())}, new String[]{C4403w.m27871i1(R.string.Devices).toUpperCase(), C4403w.m27871i1(R.string.Websites).toUpperCase()}, false));
                    break;
            }
            if (iVar != null) {
                iVar.mo1322a(z);
    ...
    public boolean m3560i6(boolean z, TdApi.SecretChat secretChat, final AbstractC5917i iVar, View view, int i) {
        if (i == R.id.btn_removeChatFromList) {
            if (z) {
                this.f34462a.m2496d2(new TdApi.MessageSenderUser(secretChat.userId), true, new Client.AbstractC7865g() {
                    @Override
                    public final void mo255t2(TdApi.Object object) {
                        AbstractC5917i.this.mo1322a(false);
                    }
    ...
    public boolean m3552j4(final AbstractC5918j jVar, View$OnFocusChangeListenerC7069y1 y1Var, final String str) {
        if (str.startsWith("@")) {
            str = str.substring(1);
        } else if (this.f34462a.m2235t7(str)) {
        ...
        if (C5070i.m24062i(str)) {
            str = null;
        } else if (!C4779t2.m25408v4(str) || str.length() > 32) {
            return false;
        }
        this.f34462a.m2485dd().postDelayed(new Runnable() {
            @Override
            public final void run() {
    ...
    public void m3550j6(final long j, AbstractC9323v4 v4Var, String str, final AbstractC5917i iVar, final boolean z) {
        final TdApi.SecretChat X3 = this.f34462a.m2586X3(j);
        if (X3 != null) {
            if (X3.state.getConstructor() != -1611352087 || !this.f34462a.m2320o2(j) || (!(v4Var instanceof View$OnClickListenerC2971rh) && this.f34462a.m2300p6(j))) {
                v4Var.m9261ee(C4403w.m27855m1(X3.state.getConstructor() == -1637050756 ? R.string.DeleteSecretChatPendingConfirm : R.string.DeleteSecretChatClosedConfirm, str), new int[]{R.id.btn_removeChatFromList, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.DeleteChat), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i) {
                        boolean i6;
                ...
                v4Var.m9206me(new C9188f2(R.id.btn_removeChatFromList).m10009c(false).m10010b(C4403w.m27855m1(R.string.DeleteSecretChatConfirm, str)).m9996p(new C2964ra[]{new C2964ra(12, (int) R.id.btn_clearChatHistory, 0, (CharSequence) C4403w.m27867j1(R.string.DeleteSecretChatHistoryForOtherParty, str), (int) R.id.btn_clearChatHistory, false)}).m9995q(R.id.theme_color_textNegative).m9994r(R.string.Delete).m10002j(new AbstractC9323v4.AbstractC9343r() {
                    @Override
                    public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
    ...
    public static void m3542k4(AbstractC9323v4 v4Var, ViewGroup viewGroup) {
        TextView R = C2139ap.m35487R(v4Var.mo4347s(), 9, R.id.theme_color_textLight, null, v4Var);
        R.setText(C4403w.m27871i1(R.string.ThemeExportInfo));
        R.setPadding(0, C1357a0.m37544i(12.0f), 0, 0);
        viewGroup.addView(R);
    }
    ...
    public void m3530l6(long j, AbstractC9323v4 v4Var, Runnable runnable, final AbstractC5917i iVar) {
        TdApi.ChatMemberStatus K3 = this.f34462a.m2787K3(j);
        if (K3 == null || !C4779t2.m25500i3(K3, false)) {
            v4Var.m9261ee(C4403w.m27871i1(R.string.AreYouSureDeleteThisChat), new int[]{R.id.btn_removeChatFromList, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.DeleteChat), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean k6;
    ...
    public void m3522m4(final AbstractC10664f9 f9Var, C10788q qVar, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4779t2.m25379z5(object), qVar);
    ...
    public void m3521m5(AbstractC10664f9 f9Var, String str, C10788q qVar, DialogInterface dialogInterface, int i) {
        this.f34462a.m2485dd().m3509n7(f9Var, str, qVar.m3325f());
    }
    ...
    public static void m3518m8(AbstractC10664f9 f9Var, C10788q qVar, int i, boolean z) {
        m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4403w.m27871i1(i != -3 ? i != -2 ? R.string.ChatAccessFailed : z ? R.string.ChatAccessRestrictedChannel : R.string.ChatAccessRestrictedGroup : z ? R.string.ChatAccessPrivateChannel : R.string.ChatAccessPrivateGroup), qVar);
    }
    ...
    public void m3512n4(TdApi.ChatMemberStatus chatMemberStatus, long j, TdApi.MessageSender messageSender, int i, SparseIntArray sparseIntArray) {
        ...
        if (chatMemberStatus.getConstructor() != 1661432998 || z) {
            this.f34462a.m2811Ib(j, messageSender, new TdApi.ChatMemberStatusBanned(), chatMemberStatus, null);
            if (!z) {
                this.f34462a.m2811Ib(j, messageSender, new TdApi.ChatMemberStatusLeft(), chatMemberStatus, null);
                return;
            }
            return;
        }
        TdApi.ChatMemberStatusRestricted chatMemberStatusRestricted = (TdApi.ChatMemberStatusRestricted) chatMemberStatus;
        this.f34462a.m2811Ib(j, messageSender, new TdApi.ChatMemberStatusRestricted(false, chatMemberStatusRestricted.restrictedUntilDate, chatMemberStatusRestricted.permissions), chatMemberStatus, null);
    }

    public void m3510n6(long j, AbstractC9323v4 v4Var, Runnable runnable, boolean z) {
        this.f34462a.m2786K4(j, z, null);
        m3703U2(v4Var, j);
        C7389v0.m16743D2(runnable);
    }
    ...
    public void m3502o4(C2964ra raVar, long j, TdApi.MessageSender messageSender, View view, int i, C2964ra raVar2, TextView textView, C2546iq iqVar) {
        raVar.m32856X(m3623c3(j, messageSender, iqVar.m34255A0().get(R.id.right_readMessages) != 0));
    ...
    public static String m3493p3(int i, boolean z) {
        String str;
        if (i <= 0) {
            return C4403w.m27871i1(z ? R.string.NotificationsDefaultEnabled : R.string.NotificationsEnabled);
        } else if (i >= 345600) {
            return C4403w.m27871i1(z ? R.string.NotificationsDefaultDisabled : R.string.NotificationsDisabled);
        } else {
            float f = i;
            ...
            if (round3 > 0) {
                str = C4403w.m27846o2(R.string.xDays, round3);
            } else if (round2 > 0) {
                str = C4403w.m27846o2(R.string.xHours, round2);
            } else {
                str = C4403w.m27846o2(R.string.xMinutes, Math.max(0, round));
            }
            return C4403w.m27867j1(z ? R.string.NotificationsDefaultUnmutesIn : R.string.UnmutesInX, str);
        }
    }
    ...
    public void m3490p6(boolean z, long j, final AbstractC5917i iVar, int i, SparseIntArray sparseIntArray) {
        ...
        if (z) {
            this.f34462a.m2496d2(new TdApi.MessageSenderUser(j), true, new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public void m3482q4(long j, TdApi.ChatMemberStatus chatMemberStatus, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            C1379j0.m37305t0(object);
            Log.m14724e("setChatMemberStatus chatId:%d, status:%s error:%s", Long.valueOf(j), chatMemberStatus, C4779t2.m25379z5(object));
        } else if (constructor == -722616727 && C7316a.m17054g(j)) {
            this.f34462a.m2270r4().m14783o(new TdApi.DeleteChatHistory(j, true, false), this.f34462a.m2392ja());
        }
    }
    ...
    public void m3481q5(AtomicReference atomicReference, int i, final AbstractRunnableC5910b[] bVarArr, final String str, final AtomicBoolean atomicBoolean, final AbstractC10664f9 f9Var, TdApi.Object object) {
        ...
        if (constructor == -1679978726) {
            ...
            if (i == 0 || !C4779t2.m25389y2(webPage.instantViewVersion) || C4779t2.m25477l5(webPage)) {
                post(bVarArr[0]);
            } else {
                this.f34462a.m2270r4().m14783o(new TdApi.GetWebPageInstantView(str, false), new Client.AbstractC7865g() {
                    @Override
                    public final void mo255t2(TdApi.Object object2) {
    ...
    public void m3472r4(boolean z, final long j, final TdApi.ChatMemberStatus chatMemberStatus, AbstractC9323v4 v4Var, boolean z2) {
        long ba2 = this.f34462a.m2519ba();
        if (ba2 == 0) {
            return;
        }
        if (z) {
            this.f34462a.m2270r4().m14783o(new TdApi.AddChatMember(j, ba2, 0), this.f34462a.m2392ja());
            return;
        }
        Client.AbstractC7865g ja = this.f34462a.m2392ja();
        if (z2) {
        ...
        this.f34462a.m2270r4().m14783o(new TdApi.SetChatMemberStatus(j, new TdApi.MessageSenderUser(ba2), chatMemberStatus), ja);
        if (!C4779t2.m25500i3(chatMemberStatus, false)) {
            m3703U2(v4Var, j);
        }
    }
    ...
    public void m3460s6(final long j, AbstractC9323v4 v4Var, boolean z, String str, long j2, final boolean z2, final AbstractC5917i iVar) {
        CharSequence m1;
        if (this.f34462a.m2379k7(j)) {
            m1 = C4403w.m27984H0(v4Var, R.string.DeleteSavedMessagesConfirm, new Object[0]);
        } else if (z) {
            if (this.f34462a.m2475e7(C7316a.m17058c(j))) {
                m1 = C4403w.m27984H0(v4Var, R.string.DeleteAndStopRepliesConfirm, new Object[0]);
            } else {
                m1 = C4403w.m27855m1(R.string.DeleteAndStopBotConfirm, str);
            }
        } else if (this.f34462a.m2475e7(C7316a.m17058c(j))) {
            m1 = C4403w.m27984H0(v4Var, R.string.DeleteRepliesConfirm, new Object[0]);
        } else {
            m1 = C4403w.m27855m1(R.string.DeleteUserChatConfirm, str);
        }
        CharSequence charSequence = m1;
        if (this.f34462a.m2836H2(j2)) {
            v4Var.m9206me(new C9188f2(R.id.btn_removeChatFromList).m10009c(false).m10010b(charSequence).m9996p(new C2964ra[]{new C2964ra(12, (int) R.id.btn_clearChatHistory, 0, (CharSequence) C4403w.m27867j1(R.string.DeleteSecretChatHistoryForOtherParty, str), (int) R.id.btn_clearChatHistory, false)}).m9995q(R.id.theme_color_textNegative).m9994r(R.string.Delete).m10002j(new AbstractC9323v4.AbstractC9343r() {
                @Override
                public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
        ...
        strArr[0] = C4403w.m27871i1(z ? R.string.DeleteAndStop : R.string.DeleteChat);
    ...
    public void m3451t5(final AbstractC10664f9 f9Var, TdApi.Object object) {
        int constructor = object.getConstructor();
        if (constructor == -1679978726) {
            C1379j0.m37295y0(R.string.DeepLinkUnsupported, 0);
    ...
    public static void m3450t6(long j, AbstractC5917i iVar, TdApi.Object object) {
        if (object.getConstructor() == -1679978726) {
            Log.m14724e("Cannot clear secret chat history, secretChatId:%d, error: %s", Integer.valueOf(C7316a.m17047n(j)), C4779t2.m25379z5(object));
        }
        iVar.mo1322a(false);
    }
    ...
    public static void m3442u4(AbstractC9323v4 v4Var, TdApi.Object object, AbstractC10664f9 f9Var, C10788q qVar) {
        if (v4Var != null && !v4Var.m9347Sa()) {
            ...
            if (constructor == -1816236758) {
                View$OnClickListenerC2096i.m35622W1(f9Var, (TdApi.StickerSet) object);
            } else if (constructor == -1679978726) {
                m3857E8(f9Var.mo4348c(), R.drawable.baseline_warning_24, C4779t2.m25379z5(object), qVar);
            } else if (constructor == 1207538697) {
                View$OnClickListenerC2096i.m35621X1(f9Var, (TdApi.StickerSetInfo) object);
            }
        }
    }
    ...
    public void m3440u6(final long j, final AbstractC5917i iVar, int i, SparseIntArray sparseIntArray) {
        if (sparseIntArray.get(R.id.btn_clearChatHistory) == R.id.btn_clearChatHistory) {
            this.f34462a.m2270r4().m14783o(new TdApi.DeleteChatHistory(j, false, false), new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public boolean m3431v5(final AbstractC5918j jVar, boolean z, AbstractC9323v4 v4Var, AbstractC11531p pVar, View view, int i) {
        ...
        switch (i) {
            ...
            case R.id.btn_sendScheduledCustom:
                ...
                v4Var.m9309Xd(C4403w.m27871i1(i2), i5, i4, i3, new AbstractC5920l() {
                    @Override
        ...
        if (j > 0) {
            jVar.mo1330a(new TdApi.MessageSchedulingStateSendAtDate((int) ((this.f34462a.m2898D4() / 1000) + j)));
        }
        return true;
    }
    ...
    public static boolean m3430v6(TdApi.Message[] messageArr, C10930q6 q6Var, Runnable runnable, View view, int i) {
        ...
        C6035e<long[]> M1 = C4779t2.m25646M1(messageArr);
        for (int i2 = 0; i2 < M1.m21497p(); i2++) {
            q6Var.m2770L4(M1.m21502j(i2), M1.m21496q(i2), false);
        }
        if (runnable == null) {
            return true;
        }
    ...
    public void m3422w4(AbstractC10664f9 f9Var, TdApi.BankCardInfo bankCardInfo, String str) {
        ...
        AbstractC9323v4<?> s = f9Var instanceof AbstractC9323v4 ? (AbstractC9323v4) f9Var : C1379j0.m37308s();
        ...
        if (!(s == null || s.m9347Sa())) {
            ...
            if (z) {
                for (TdApi.BankCardActionOpenUrl bankCardActionOpenUrl : bankCardInfo.actions) {
                    ...
                    u0Var.m23816b(bankCardActionOpenUrl.text);
                }
            } else {
                cVar.m23285a(R.id.btn_copyLink);
                u0Var.m23817a(R.string.CopyBankCard);
                iArr = new int[]{R.drawable.baseline_content_copy_24};
            }
            s.m9261ee(bankCardInfo.title, cVar.m23281e(), u0Var.m23814d(), null, iArr, new C10779i(str, z, bankCardInfo));
        }
    }
        ...
        if (v4Var != null && messageArr != null && messageArr.length > 0 && !m3733R2(v4Var, messageArr, runnable) && !m3723S2(v4Var, messageArr, runnable)) {
            ...
            while (true) {
                if (i3 >= length) {
                    z = true;
                    break;
                } else if (!C4779t2.m25728A3(messageArr[i3])) {
                    z = false;
                    break;
                } else {
                    i3++;
            ...
            if (messageArr.length == 1) {
                ...
                str = C4403w.m27846o2(i, messageArr.length);
            }
            if (!z) {
                ...
                while (true) {
                    if (i4 >= length2) {
                        ...
                        str = C7316a.m17049l(Q0) ? C4403w.m27867j1(R.string.DeleteForMeAndX, c.m2480e2().m1749D2(c.m2494d4(Q0))) : C4403w.m27871i1(R.string.DeleteForEveryone);
                    } else {
                        i4++;
                    }
                }
            }
            v4Var.m9261ee(null, new int[]{R.id.menu_btn_delete, R.id.btn_cancel}, new String[]{str, C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
    ...
    public boolean m3410x6(C11533r rVar, Runnable runnable, View view, int i) {
        ...
        C11541z.m7t().m43R(this.f34462a, rVar.m110c(), rVar.m100m(), runnable);
        return true;
    }
    ...
    public void m3401y5(TdApi.Document document, final AbstractC5918j jVar, Runnable runnable) {
        ...
        fileInputStream.close();
        HandlerC10770jj dd = this.f34462a.m2485dd();
        if (runnable == null) {
            runnable = RunnableC10894oc.f34878a;
        }
        dd.post(runnable);
    }

    public void m3400y6(long j, AbstractC9323v4 v4Var, Runnable runnable) {
        this.f34462a.m2786K4(j, false, null);
        m3703U2(v4Var, j);
        C7389v0.m16743D2(runnable);
    }
    ...
    public void m3903A2(AbstractC9323v4<?> v4Var, TdApi.Contact contact) {
        if (contact != null) {
            TdApi.User v2 = contact.userId != 0 ? this.f34462a.m2480e2().m1583v2(contact.userId) : null;
            if (v2 != null) {
            ...
            fkVar.m34657vg(2);
            fkVar.m34665rg(contact.phoneNumber, contact.firstName, contact.lastName);
            v4Var.m9284bc().m9718h0(fkVar);
        }
    }
    ...
    public void m3902A3(AbstractC9323v4<?> v4Var, final long j, final TdApi.MessageSender messageSender, final TdApi.ChatMemberStatus chatMemberStatus) {
        if (messageSender.getConstructor() != -239660751) {
            if (C7316a.m17057d(j) == 973884508) {
                v4Var.m9261ee(C4403w.m27855m1(R.string.MemberCannotJoinRegularGroup, this.f34462a.m2135zb(messageSender, true)), new int[]{R.id.btn_blockSender, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.RemoveFromGroup), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_remove_circle_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i) {
                        boolean p4;
            ...
            v4Var.m9206me(new C9188f2(R.id.btn_blockSender).m10011a(raVar).m10002j(new AbstractC9323v4.AbstractC9343r() {
                @Override
                public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
    ...
    public void m3898A7(AbstractC10664f9 f9Var, TdApi.Message message) {
        m3389z7(f9Var, message.chatId, new C7319d(message.chatId, message.f25409id));
    }
    ...
    public void m3897A8(final AbstractC9323v4<?> v4Var, final TdApi.ChatInviteLink chatInviteLink, final long j, boolean z, boolean z2, final Runnable runnable, final AbstractC5918j<TdApi.ChatInviteLinks> jVar) {
        TdApi.Chat U2 = this.f34462a.m2632U2(j);
        ...
        if (!z2 && chatInviteLink.memberCount > 0) {
            cVar2.m23285a(R.id.btn_viewInviteLinkMembers);
            u0Var.m23817a(R.string.InviteLinkViewMembers);
            cVar.m23285a(R.drawable.baseline_visibility_24);
            cVar3.m23285a(1);
        }
        if (!z2 && chatInviteLink.createsJoinRequest && chatInviteLink.pendingJoinRequestCount > 0) {
            ...
            u0Var.m23817a(R.string.InviteLinkViewRequests);
            cVar.m23285a(R.drawable.baseline_pending_24);
            cVar3.m23285a(1);
        }
        if (z && this.f34462a.m2948A2(U2)) {
        ...
        if (z2 || chatInviteLink.isRevoked) {
            ...
            cVar3.m23285a(1);
            if (!z2) {
                cVar.m23285a(R.drawable.baseline_delete_24);
                cVar2.m23285a(R.id.btn_deleteLink);
                u0Var.m23817a(R.string.InviteLinkDelete);
                cVar3.m23285a(2);
            }
        } else {
            if (!chatInviteLink.isPrimary && (v4Var instanceof View$OnClickListenerC2855p0)) {
                cVar2.m23285a(R.id.btn_edit);
                u0Var.m23817a(R.string.InviteLinkEdit);
                cVar.m23285a(R.drawable.baseline_edit_24);
                cVar3.m23285a(1);
            }
            cVar2.m23285a(R.id.btn_copyLink);
            u0Var.m23817a(R.string.InviteLinkCopy);
        ...
        CharSequence p4 = C4779t2.m25450p4(C4403w.m27875h1(R.string.CreatedByXOnDate, new C4403w.AbstractC4409f() {
            @Override
        ...
        }, v4Var.mo4348c().m2480e2().m1721K2(chatInviteLink.creatorUserId), C4403w.m27912Z0(chatInviteLink.date, TimeUnit.SECONDS)));
        C11122xi xiVar = C11122xi.f35677a;
        String str = chatInviteLink.name;
        v4Var.m9261ee((str == null || str.isEmpty()) ? C4403w.m27875h1(R.string.format_nameAndStatus, xiVar, chatInviteLink.inviteLink, p4) : C4403w.m27875h1(R.string.format_nameAndSubtitleAndStatus, xiVar, chatInviteLink.inviteLink, chatInviteLink.name, p4), cVar2.m23281e(), u0Var.m23814d(), cVar3.m23281e(), cVar.m23281e(), new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean G6;
    ...
    public void m3893B2(AbstractC9323v4<?> v4Var, TdApi.User user) {
        if (user != null) {
            m3883C2(v4Var, user, C5070i.m24062i(user.phoneNumber) ? null : user.phoneNumber);
        }
    }
    ...
    public AbstractRunnableC5910b m3878C7(AbstractC9323v4<?> v4Var) {
        ...
        this.f34462a.m2270r4().m14783o(new TdApi.GetSupportUser(), this.f34462a.m2214uc());
        final C6924j2[] j2VarArr = {v4Var.m9261ee(C1363c0.m37428l(v4Var, C4403w.m27871i1(R.string.AskAQuestionInfo), new C5132o.AbstractC5133a() {
            @Override
        ...
        }), new int[]{R.id.btn_openChat, R.id.btn_cancel}, C5146u0.m23815c(R.string.AskButton, R.string.Cancel), new int[]{3, 1}, new int[]{R.drawable.baseline_help_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean V4;
    ...
    public void m3877C8(final AbstractC9323v4<?> v4Var, final C10781k kVar, TdApi.Message message) {
        ...
        if (message != null) {
            ...
            if (messageForwardInfo == null || messageForwardInfo.origin.getConstructor() != 1490730723) {
                chat = (!message.isOutgoing || message.isChannelPost) ? this.f34462a.m2632U2(message.chatId) : null;
            } else {
                chat = this.f34462a.m2632U2(((TdApi.MessageForwardOriginChannel) message.forwardInfo.origin).chatId);
            }
            if (chat != null) {
                String f4 = this.f34462a.m2462f4(chat.f25370id);
                if (!C5070i.m24062i(f4)) {
                    kVar.m3342n("@" + f4);
                } else {
                    kVar.m3342n(this.f34462a.m2661S3(chat));
                }
            }
        }
        ...
        if (kVar.m3344l()) {
            str = C4403w.m27846o2(R.string.xStrings, kVar.m3346j());
        } else {
            str = C4403w.m27846o2(R.string.xStrings, kVar.m3346j()) + ", " + C4403w.m27846o2(R.string.TranslationsMissing, kVar.m3350f());
        }
        objArr[5] = str;
        v4Var.m9261ee(C4403w.m27855m1(R.string.LanguageInfo, objArr), new int[]{R.id.btn_messageApplyLocalization, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.LanguageInstall), C4403w.m27871i1(R.string.Cancel)}, new int[]{3, 1}, new int[]{R.drawable.baseline_language_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean N6;
        ...
        if (U2 != null) {
            ...
            switch (d) {
                case TdApi.ChatTypeSupergroup.CONSTRUCTOR:
                    if (z && this.f34462a.m2304p2(U2)) {
                        cVar.m23285a(R.id.btn_clearChatHistory);
                        u0Var.m23817a(R.string.ClearHistory);
                    }
                    TdApi.ChatMemberStatus K3 = this.f34462a.m2787K3(j);
                    if (this.f34462a.m2542a3(U2)) {
                        cVar.m23285a(R.id.btn_removeChatFromList);
                        if (this.f34462a.m2784K6(j)) {
                            i2 = R.string.LeaveChannel;
                        }
                        u0Var.m23817a(i2);
                        return;
                    } else if (!C4779t2.m25602T(K3)) {
                        return;
                    } else {
                        if (K3.getConstructor() != -5815259 || (!this.f34462a.m2507c7(j) && !this.f34462a.m2251s7(j))) {
                            cVar.m23285a(R.id.btn_returnToChat);
                            if (this.f34462a.m2784K6(j)) {
                            ...
                            cVar.m23285a(R.id.btn_returnToChat);
                            u0Var.m23817a(this.f34462a.m2784K6(j) ? R.string.JoinChannel : R.string.JoinChat);
                            return;
                        } else {
                            return;
                        }
                ...
                case TdApi.ChatTypePrivate.CONSTRUCTOR:
                    if (z && this.f34462a.m2320o2(j)) {
                        cVar.m23285a(R.id.btn_clearChatHistory);
                        u0Var.m23817a(R.string.ClearHistory);
                    }
                    if (this.f34462a.m2906Cc(U2)) {
                        cVar.m23285a(R.id.btn_removeChatFromListAndStop);
                        u0Var.m23817a(R.string.DeleteAndStop);
                        return;
                    }
                    cVar.m23285a(R.id.btn_removeChatFromList);
                    u0Var.m23817a(R.string.DeleteChat);
                    return;
                case TdApi.ChatTypeBasicGroup.CONSTRUCTOR:
                    ...
                    TdApi.BasicGroup W3 = this.f34462a.m2601W3(j);
                    TdApi.ChatMemberStatus K32 = this.f34462a.m2787K3(j);
                    if (this.f34462a.m2542a3(U2) && K32 != null) {
                        if (C4779t2.m25500i3(K32, false) || (W3 != null && !W3.isActive)) {
                            cVar.m23285a(R.id.btn_removeChatFromList);
                            u0Var.m23817a(R.string.LeaveMegaMenu);
                        } else {
                            cVar.m23285a(R.id.btn_removeChatFromList);
                            u0Var.m23817a(R.string.DeleteChat);
                        }
                        if (!C4779t2.m25602T(K32)) {
                            return;
                        }
                        if (W3 == null || W3.isActive) {
                            cVar.m23285a(R.id.btn_returnToChat);
                            u0Var.m23817a(R.string.returnToGroup);
                            return;
                        }
                        return;
                    }
    ...
    public void m3868D7(final AbstractC10664f9 f9Var, final String str, final C10788q qVar, final AbstractC5917i iVar) {
        if (!C5070i.m24062i(str) && !this.f34462a.m2930B4().m4680k1()) {
            this.f34462a.m2270r4().m14783o(new TdApi.GetInternalLinkType(str), new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public void m3867D8(final AbstractC10664f9 f9Var, final TdApi.LanguagePackInfo languagePackInfo) {
        ...
        if (F != null && !F.m9347Sa()) {
            if (C4403w.m27862k2().equals(languagePackInfo.f25408id)) {
                F.m9261ee(C1363c0.m37428l(f9Var, C4403w.m27867j1(R.string.LanguageSame, languagePackInfo.name), null), new int[]{R.id.btn_done, R.id.btn_settings}, new String[]{C4403w.m27871i1(R.string.OK), C4403w.m27871i1(R.string.Settings)}, null, new int[]{R.drawable.baseline_check_circle_24, R.drawable.baseline_settings_24}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i) {
                        boolean J6;
                ...
                F.m9261ee(C1363c0.m37428l(f9Var, C4403w.m27867j1(languagePackInfo.isOfficial ? R.string.LanguageAlert : R.string.LanguageCustomAlert, languagePackInfo.name, Integer.valueOf((int) Math.floor((languagePackInfo.translatedStringCount / languagePackInfo.totalStringCount) * 100.0f)), languagePackInfo.translationUrl), null), new int[]{R.id.btn_done, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.LanguageChange), C4403w.m27871i1(R.string.Cancel)}, new int[]{3, 1}, new int[]{R.drawable.baseline_language_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i) {
                        boolean M6;
    ...
    public void m3863E2(final AbstractC10664f9 f9Var, boolean z) {
        final AbstractC9323v4<?> F = f9Var.mo4347s().m14551P1().m9762F();
        if (F != null) {
            boolean L1 = this.f34462a.m2773L1();
            int i = 4;
            ...
            C5146u0 u0Var = new C5146u0(i);
            cVar.m23285a(R.id.btn_proxyTelegram);
            cVar.m23285a(R.id.btn_proxySocks5);
            cVar.m23285a(R.id.btn_proxyHttp);
            if (z) {
                u0Var.m23817a(R.string.AddMtprotoProxy);
                u0Var.m23817a(R.string.AddSocks5Proxy);
                u0Var.m23817a(R.string.AddHttpProxy);
            } else {
                u0Var.m23817a(R.string.MtprotoProxy);
                u0Var.m23817a(R.string.Socks5Proxy);
                u0Var.m23817a(R.string.HttpProxy);
            }
            if (L1) {
                cVar.m23285a(R.id.btn_proxyQr);
                u0Var.m23817a(R.string.ScanQR);
            }
            ...
            String str = null;
            if (cVar.m23279g() == 1) {
                vgVar.mo493A3(null, cVar.m23282d(0));
                return;
            }
            if (z) {
                str = C4403w.m27871i1(R.string.ProxyInfo);
            }
            F.m9275ce(str, cVar.m23281e(), u0Var.m23814d(), vgVar);
        }
    }
    ...
    public final void m3842G3(final AbstractC10664f9 f9Var, final long j) {
        if (C10536ab.m4683j1()) {
            this.f34462a.m2549Za(new Runnable() {
                @Override
                public final void run() {
        ...
        o4Var.m33357hk(new View$OnClickListenerC2805o4.C2813h(C10619e0.m4436j(this.f34462a), new C10772b(j)));
        f9Var.mo4347s().m14551P1().m9718h0(o4Var);
    }
    ...
    public void m3847F8(AbstractC9323v4<?> v4Var, final int i, final Runnable runnable) {
        ...
        if (!v4Var.m9339Ta()) {
        ...
        } else if (i != 0 || (j2Var = this.f34463b) == null || j2Var.getContext() != v4Var.mo4347s()) {
            C9188f2 f2Var = new C9188f2(R.id.btn_mapProvider);
            if (i == 0) {
                f2Var.m10010b(C4403w.m27871i1(R.string.MapPreviewProviderHint));
                f2Var.m10005g(new C6924j2.AbstractC6930f() {
                    @Override
            ...
            int g1 = C4868i.m24727c2().m24696g1(i == 2);
            if (i == 2) {
                ...
                f2Var.m9996p(raVarArr2);
            }
            C9180e2 me2 = v4Var.m9206me(f2Var.m9994r(R.string.Save).m10002j(new AbstractC9323v4.AbstractC9343r() {
                @Override
                public final void mo1773l6(int i2, SparseIntArray sparseIntArray) {
    ...
    public void m3832H3(final AbstractC10664f9 f9Var, final C4822w2 w2Var, final boolean z) {
        ...
        View$OnClickListenerC2805o4 o4Var = new View$OnClickListenerC2805o4(f9Var.mo4347s(), f9Var.mo4348c());
        C10930q6 q6Var = this.f34462a;
        o4Var.m33357hk(new View$OnClickListenerC2805o4.C2813h(z ? C10619e0.m4438h(q6Var) : C10619e0.m4436j(q6Var), new C10773c(z, w2Var)));
        f9Var.mo4347s().m14551P1().m9718h0(o4Var);
    }

    public void m3838G7(final AbstractC9323v4<?> v4Var, final String str, final C10788q qVar) {
        v4Var.m9261ee(str, new int[]{R.id.btn_open, R.id.btn_copyLink}, new String[]{C4403w.m27871i1(R.string.Open), C4403w.m27871i1(R.string.CopyLink)}, null, new int[]{R.drawable.baseline_open_in_browser_24, R.drawable.baseline_content_copy_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean r5;
    ...
    public final void m3833H2(final AbstractC9323v4<?> v4Var, C10781k kVar) {
        ...
        final TdApi.LanguagePackInfo languagePackInfo = new TdApi.LanguagePackInfo(d, C4403w.m27908a0(), kVar.m3351e(), kVar.m3348h(R.string.language_name), C4403w.m27817w(d), false, "1".equals(kVar.m3348h(R.string.language_rtl)), false, true, i.length, i.length, i.length, null);
    ...
    public boolean m3808J7(final AbstractC9323v4<?> v4Var, final AbstractC5918j<TdApi.MessageSchedulingState> jVar, long j, boolean z, boolean z2, final AbstractC11531p pVar) {
        ...
        final boolean g7 = this.f34462a.m2443g7(j);
        int i = 4;
        if (z) {
            i = 5;
        }
        ...
        C5320c cVar2 = new C5320c(i);
        if (z2) {
            cVar.m23285a(R.id.btn_sendNoSound);
            u0Var.m23817a(R.string.SendNoSound);
            cVar2.m23285a(R.drawable.baseline_notifications_off_24);
        }
        if (z) {
            cVar.m23285a(R.id.btn_sendOnceOnline);
            u0Var.m23817a(R.string.SendOnceOnline);
            cVar2.m23285a(R.drawable.baseline_visibility_24);
        }
        cVar.m23285a(R.id.btn_sendScheduled30Min);
        u0Var.m23816b(C4403w.m27846o2(g7 ? R.string.RemindInXMinutes : R.string.SendInXMinutes, 30L));
        cVar2.m23285a(R.drawable.baseline_schedule_24);
        cVar.m23285a(R.id.btn_sendScheduled2Hr);
        int i2 = R.string.RemindInXHours;
        u0Var.m23816b(C4403w.m27846o2(g7 ? R.string.RemindInXHours : R.string.SendInXHours, 2L));
        cVar2.m23285a(R.drawable.baseline_schedule_24);
        cVar.m23285a(R.id.btn_sendScheduled8Hr);
        if (!g7) {
            i2 = R.string.SendInXHours;
        }
        u0Var.m23816b(C4403w.m27846o2(i2, 8L));
        cVar2.m23285a(R.drawable.baseline_schedule_24);
        cVar.m23285a(R.id.btn_sendScheduledCustom);
        u0Var.m23816b(C4403w.m27871i1(g7 ? R.string.RemindAtCustomTime : R.string.SendAtCustomTime));
        cVar2.m23285a(R.drawable.baseline_date_range_24);
        v4Var.m9254fe(null, cVar.m23281e(), u0Var.m23814d(), null, cVar2.m23281e(), new AbstractC5117h0() {
            @Override
    ...
    public final void m3807J8(AbstractC9323v4<?> v4Var, long j) {
        TdApi.Chat U2 = this.f34462a.m2632U2(j);
        if (U2 != null && this.f34462a.m2772L2(U2)) {
            View$OnClickListenerC2714mi miVar = new View$OnClickListenerC2714mi(v4Var.mo4347s(), v4Var.mo4348c());
            miVar.m33778df(new View$OnClickListenerC2714mi.C2716b(U2, this.f34462a.m2175x3(U2)));
            v4Var.m9291ac(miVar);
        }
    }

    public final void m3803K2(final AbstractC10664f9 f9Var, final String str, final C10788q qVar) {
        this.f34462a.m2270r4().m14783o(new TdApi.CheckChatInviteLink(str), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public boolean m3798K7(AbstractC9323v4<?> v4Var, TdApi.ChatList chatList, long j, C4737p7 p7Var, int i, Runnable runnable) {
        ...
        switch (i) {
            case R.id.btn_archiveChat:
                this.f34462a.m2270r4().m14783o(new TdApi.AddChatToList(j, C7317b.f23228b), this.f34462a.m2376ka(runnable));
                return true;
            ...
            case R.id.btn_markChatAsRead:
                if (p7Var != null) {
                    this.f34462a.m2733N9(p7Var.m26300b(), p7Var.m26295g(), runnable);
                } else {
                    this.f34462a.m2733N9(U2.f25370id, 0L, runnable);
                }
                return true;
            case R.id.btn_markChatAsUnread:
                this.f34462a.m2717O9(U2, runnable);
                return true;
            case R.id.btn_notifications:
                this.f34462a.m2485dd().m3677W8(v4Var, j, false, runnable);
                return true;
            case R.id.btn_phone_call:
                this.f34462a.m2930B4().m4713c0().m4545v0(v4Var, C4779t2.m25466n2(U2), null, true);
                return true;
            case R.id.btn_pinChat:
                this.f34462a.m2270r4().m14783o(new TdApi.ToggleChatIsPinned(chatList, j, true), this.f34462a.m2376ka(runnable));
                return true;
            case R.id.btn_pinUnpinChat:
                m3797K8(v4Var, chatList, j, runnable);
                return true;
            case R.id.btn_unarchiveChat:
                this.f34462a.m2270r4().m14783o(new TdApi.AddChatToList(j, C7317b.f23227a), this.f34462a.m2376ka(runnable));
                return true;
            case R.id.btn_unpinChat:
                this.f34462a.m2270r4().m14783o(new TdApi.ToggleChatIsPinned(chatList, j, false), this.f34462a.m2376ka(runnable));
                return true;
            default:
    ...
    public final void m3797K8(final AbstractC9323v4<?> v4Var, final TdApi.ChatList chatList, final long j, final Runnable runnable) {
        boolean z3 = this.f34462a.m2143z3(chatList, j);
        String Q3 = this.f34462a.m2691Q3(j);
        int[] iArr = new int[2];
        iArr[0] = z3 ? R.id.btn_unpinChat : R.id.btn_pinChat;
        iArr[1] = R.id.btn_cancel;
        String[] strArr = new String[2];
        strArr[0] = C4403w.m27871i1(z3 ? R.string.UnpinFromTop : R.string.PinToTop);
        strArr[1] = C4403w.m27871i1(R.string.Cancel);
        int[] iArr2 = new int[2];
    ...
    public boolean m3787L8(AbstractC9323v4<?> v4Var, long j, boolean z, final AbstractC10786o oVar, AbstractC11531p pVar) {
        ...
        }, j, this.f34462a.m2480e2().m1729I2(this.f34462a.m2494d4(j)), z, pVar);
    }
    ...
    public void m3783M2(AbstractC10664f9 f9Var, TdApi.AuthenticationCodeInfo authenticationCodeInfo, String str) {
        ...
        ljVar.m33966bg(new View$OnClickListenerC2665lj.C2666a(9, authenticationCodeInfo, C1363c0.m37413w(str)));
        f9Var.mo4347s().m14551P1().m9718h0(ljVar);
    }
    ...
    public void m3777M8(AbstractC10664f9 f9Var, long j) {
        this.f34462a.m2270r4().m14783o(new TdApi.GetStickerSet(j), m3609d7(f9Var, null));
    }
    ...
    public final C6957m1.AbstractC6962e m3773N2(AbstractC9323v4<?> v4Var, TdApi.ChatList chatList, long j, C4737p7 p7Var, C5320c cVar, C5320c cVar2, C5146u0 u0Var, boolean z, boolean z2, boolean z3, Runnable runnable) {
        ...
        if (z) {
            if (this.f34462a.m2542a3(U2)) {
                if (!this.f34462a.m2379k7(C4779t2.m25466n2(U2))) {
                    boolean u3 = this.f34462a.m2223u3(U2.f25370id);
                ...
                if (!z4 && a != null) {
                    ...
                    u0Var.m23817a(a.isPinned ? R.string.Unpin : R.string.Pin);
                    cVar2.m23285a(a.isPinned ? R.drawable.deproko_baseline_pin_undo_24 : R.drawable.deproko_baseline_pin_24);
                }
                boolean B2 = this.f34462a.m2932B2(U2);
                ...
                if (this.f34462a.m2368l2(chatList, U2)) {
                    cVar.m23285a(R.id.btn_archiveUnarchiveChat);
                    boolean z5 = chatList instanceof TdApi.ChatListArchive;
                    u0Var.m23817a(z5 ? R.string.Unarchive : R.string.Archive);
                    cVar2.m23285a(z5 ? R.drawable.baseline_unarchive_24 : R.drawable.baseline_archive_24);
                }
                ...
                cVar.m23285a(R.id.btn_removePsaChatFromList);
                u0Var.m23817a(R.string.PsaHide);
        ...
        if (z4) {
            ...
            if (cVar.m23279g() > 1) {
                u0Var.m23817a(R.string.MoreChatOptions);
                cVar2.m23285a(R.drawable.baseline_more_horiz_24);
            } else {
                u0Var.m23817a(z3 ? R.string.Unselect : R.string.Select);
    ...
    public void m3767N8(AbstractC10664f9 f9Var, String str, C10788q qVar) {
        this.f34462a.m2270r4().m14783o(new TdApi.SearchStickerSet(str), m3609d7(f9Var, qVar));
    }
    ...
    public void m3753P2(final AbstractC9323v4<?> v4Var, final long j) {
        if (this.f34462a.m2480e2().m1761A2(j)) {
            v4Var.m9261ee(C4403w.m27855m1(R.string.DeleteContactConfirm, this.f34462a.m2480e2().m1721K2(j)), new int[]{R.id.btn_delete, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.Delete), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean Q3;
    ...
    public void m3747P8(Context context, final TdApi.Chat chat) {
        m3757O8(context, this.f34462a.m2707P3(chat.f25370id), false, false, 0, new AbstractC5918j() {
            @Override
            public final void mo1330a(Object obj) {
    ...
    public final void m3743Q2(long j) {
        C1379j0.m37295y0(R.string.DeletingPhotoWait, 0);
        this.f34462a.m2270r4().m14783o(new TdApi.DeleteProfilePhoto(j), this.f34462a.m2780Ka());
    }

    public final void m3727R8(final AbstractC10664f9 f9Var, final String str, final String str2, final int i, final C10788q qVar) {
        this.f34462a.m2270r4().m14783o(new TdApi.SearchPublicChat(str), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3717S8(final AbstractC10664f9 f9Var, long j, boolean z, final C10780j jVar) {
        this.f34462a.m2270r4().m14783o(new TdApi.CreateNewSecretChat(j), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3713T2(final AbstractC9323v4<?> v4Var, final boolean z, final AbstractC10782l lVar) {
        CharSequence H0 = C4403w.m27984H0(v4Var, R.string.EraseDatabaseWarn, new Object[0]);
        CharSequence H02 = v4Var.mo4348c().m2930B4().m4661q1() ? C4403w.m27984H0(v4Var, R.string.EraseDatabaseMultiUser, new Object[0]) : null;
        if (H02 != null) {
    ...
    public void m3703U2(AbstractC9323v4<?> v4Var, long j) {
        C9312u1 M = v4Var.mo4347s().m14551P1().m9748M();
    ...
    public void m3697U8(AbstractC9323v4<?> v4Var, String str, String str2, boolean z) {
        ...
        o4Var.m33357hk(new View$OnClickListenerC2805o4.C2813h(new C10777g(str, str2, z)));
        v4Var.m9291ac(o4Var);
    }
    ...
    public void m3693V2(final AbstractC9323v4<?> v4Var, final C11533r rVar, final boolean z, final boolean z2) {
        ...
        String N1 = C4868i.m24727c2().m24835N1(T);
        if (!rVar.m102k() || !C4868i.m24727c2().m24550z(T)) {
        ...
        if (C5070i.m24062i(N1)) {
            N1 = v4Var.mo4348c().m2488da();
        }
        v4Var.m9372Oc(C4403w.m27871i1(R.string.ThemeExportAddAuthorTitle), C4403w.m27871i1(R.string.ThemeExportAddAuthorInfo), R.string.ThemeExportDone, R.string.Cancel, N1, null, new AbstractC9323v4.AbstractC9336m() {
            @Override
    ...
    public final void m3683W2(AbstractC10664f9 f9Var, int i, String str, String str2, boolean z, boolean z2) {
        ...
        if (z2) {
            str3 = C5070i.m24077B(str) + ".java";
        } else {
            str3 = C5070i.m24077B(str) + ".tgx-theme";
        }
    ...
    public void m3678W7(final AbstractC9323v4<?> v4Var, final CharSequence charSequence, final AbstractC10785n nVar) {
        this.f34462a.m2270r4().m14783o(new TdApi.CanTransferOwnership(), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3677W8(AbstractC9323v4<?> v4Var, long j, boolean z, Runnable runnable) {
        TdApi.Chat U2 = this.f34462a.m2632U2(j);
        TdApi.ScopeNotificationSettings hb = this.f34462a.m2423hb(j);
        if (U2 != null && hb != null) {
            if (hb.muteFor == 0) {
                ...
                if (!chatNotificationSettings.useDefaultMuteFor && chatNotificationSettings.muteFor > 0 && !z) {
                    this.f34462a.m2486dc(U2.f25370id, 0);
                    C7389v0.m16743D2(runnable);
                    return;
                }
            }
    ...
    public void m3668X7(int i) {
        if (i != 0) {
            this.f34462a.m2270r4().m14783o(new TdApi.AddSavedAnimation(new TdApi.InputFileId(i)), C10670ff.f34155a);
        }
    }
    ...
    public void m3667X8(AbstractC9323v4<?> v4Var, final long j, final TdApi.MessageSender messageSender, final TdApi.ChatMemberStatus chatMemberStatus) {
        if (messageSender.getConstructor() == -239660751) {
            ...
            this.f34462a.m2811Ib(j, messageSender, new TdApi.ChatMemberStatusMember(), chatMemberStatus, null);
        } else {
            C9188f2 j2 = new C9188f2(R.id.btn_unblockSender).m10011a(new C2964ra(28, 0, 0, (CharSequence) C4403w.m27867j1(R.string.QUnblockX, this.f34462a.m2151yb(messageSender)), false)).m10002j(new AbstractC9323v4.AbstractC9343r() {
                @Override
                public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
            ...
            C2964ra[] raVarArr = new C2964ra[1];
            raVarArr[0] = new C2964ra(12, (int) R.id.right_readMessages, 0, this.f34462a.m2784K6(j) ? R.string.InviteBackToChannel : R.string.InviteBackToGroup, false);
            v4Var.m9206me(j2.m9996p(raVarArr).m9994r(R.string.Unban).m9995q(R.id.theme_color_textNegative));
        }
    }
    ...
    public List<View$OnTouchListenerC5103c0.C5104a> m3663Y2(long j, boolean z, boolean z2, boolean z3, boolean z4) {
        ...
        if (!z && !C7316a.m17051j(j)) {
            if (this.f34462a.m2443g7(j)) {
                arrayList.add(new View$OnTouchListenerC5103c0.C5104a((int) R.id.btn_sendScheduled, C4403w.m27871i1(R.string.SendReminder), (int) R.drawable.baseline_date_range_24).m23941g(1024L));
            } else {
                long d4 = this.f34462a.m2494d4(j);
                if (d4 != 0) {
                    arrayList.add(new View$OnTouchListenerC5103c0.C5104a((int) R.id.btn_sendOnceOnline, C4403w.m27871i1(R.string.SendOnceOnline), (int) R.drawable.baseline_visibility_24).m23942f(this.f34462a, d4));
                }
                arrayList.add(new View$OnTouchListenerC5103c0.C5104a((int) R.id.btn_sendScheduled, C4403w.m27871i1(R.string.SendSchedule), (int) R.drawable.baseline_date_range_24).m23941g(z4 ? 8192L : 512L));
            }
        }
        if (!z && z3) {
        ...
        if (z2) {
            arrayList.add(new View$OnTouchListenerC5103c0.C5104a((int) R.id.btn_sendNoMarkdown, C4403w.m27871i1(z ? R.string.SaveNoMarkdown : R.string.SendNoMarkdown), (int) R.drawable.baseline_code_24).m23941g(2048L));
        }
        return arrayList;
    }
    ...
    public void m3658Y7(final List<C4779t2.C4786e> list) {
        ...
        for (C4779t2.C4786e eVar : list) {
            this.f34462a.m2270r4().m14783o(new TdApi.AddSavedAnimation(new TdApi.InputFileId(eVar.m25366d())), new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public boolean m3657Y8(int i, View$OnClickListenerC9170d1 d1Var, TdApi.Chat chat, boolean z) {
        ...
        String m3 = m3523m3(chat != null ? chat.f25370id : 0L);
        boolean u6 = this.f34462a.m2220u6(chat);
        d1Var.m10056g4(i, R.id.menu_btn_stopwatch, m3, u6, z);
        return u6;
    }
    ...
    public final void m3649Z6(final AbstractC9323v4<?> v4Var, final long j, boolean z, Runnable runnable) {
        ...
        TdApi.ChatMemberStatus K3 = this.f34462a.m2787K3(j);
        if (K3 != null) {
            if (this.f34462a.m2930B4().m4694g3().m28145j()) {
                C1379j0.m37301v0();
                return;
            }
            boolean z3 = !C5070i.m24062i(this.f34462a.m2462f4(j));
            boolean K6 = this.f34462a.m2784K6(j);
            ...
            switch (constructor) {
                ...
                case TdApi.ChatMemberStatusAdministrator.CONSTRUCTOR:
                    if (!z) {
                        str2 = C4403w.m27871i1(z4 ? R.string.LeaveChatAdminHint : K6 ? R.string.LeaveAdminNoReturnHintChannel : R.string.LeaveAdminNoReturnHintGroup);
                        if (!K6) {
                            i3 = R.string.LeaveMegaMenu;
                        }
                ...
                case TdApi.ChatMemberStatusMember.CONSTRUCTOR:
                    if (!z) {
                        ...
                        if (!z4) {
                            ...
                            str2 = C4403w.m27871i1(i);
                        } else if (z3) {
                            if (!K6) {
                                i2 = R.string.LeaveReturnPublicLinkHintGroup;
                            }
                            str2 = C4403w.m27871i1(i2);
                        }
                        chatMemberStatusLeft = new TdApi.ChatMemberStatusLeft();
                        chatMemberStatusMember = chatMemberStatusLeft;
                        str = str2;
            ...
            if (chatMemberStatusMember != null) {
                ...
                if (i3 != 0) {
                    ...
                    if (z || !C7316a.m17054g(j)) {
                        v4Var.m9261ee(str, new int[]{i4, R.id.btn_cancel}, new String[]{C4403w.m27871i1(i3), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                            @Override
                            public final boolean mo493A3(View view, int i5) {
                                boolean t4;
                    ...
                    C9188f2 q = new C9188f2(R.id.btn_removeChatFromList).m9994r(R.string.LeaveDoneGroup).m9995q(R.id.theme_color_textNegative);
                    if (str != null) {
                        q.m10010b(str);
                    }
                    q.m9996p(new C2964ra[]{new C2964ra(12, (int) R.id.btn_removeChatFromList, 0, (int) R.string.LeaveRemoveFromList, (int) R.id.btn_removeChatFromList, true)});
                    q.m10002j(new AbstractC9323v4.AbstractC9343r() {
                        @Override
                ...
                C1379j0.m37295y0(R.string.NoReturnToChat, 0);
            }
        }
    }

    public void m3639a7(AbstractC9323v4<?> v4Var, boolean z) {
        if (this.f34462a.m2519ba() != 0) {
            if (z) {
                v4Var.m9291ac(new View$OnClickListenerC2639kv(v4Var.mo4347s(), this.f34462a));
            } else {
                m3718S7(v4Var, this.f34462a.m2949A1(), true);
            }
        }
    }
    ...
    public boolean m3629b7(String str) {
        ...
        if (this.f34462a.m2598W6(replace, false) && (pathSegments = parse.getPathSegments()) != null && !pathSegments.isEmpty()) {
            String str2 = pathSegments.get(0);
            String str3 = pathSegments.size() > 1 ? pathSegments.get(1) : null;
            str2.hashCode();
            if (str2.equals("s")) {
                return !C5070i.m24062i(str3);
            }
        }
        return false;
    }
    ...
    public final void m3628b8(String str) {
        ...
        this.f34462a.m2270r4().m14783o(new TdApi.SetProfilePhoto(new TdApi.InputChatPhotoStatic(new TdApi.InputFileGenerated(str, C5337d.m23203j(str), 0))), this.f34462a.m2780Ka());
    }

    public final CharSequence m3623c3(long j, TdApi.MessageSender messageSender, boolean z) {
        if (this.f34462a.m2784K6(j)) {
            return C4403w.m27855m1(z ? R.string.MemberCannotJoinChannel : R.string.MemberCanJoinChannel, this.f34462a.m2151yb(messageSender));
        }
        return C4403w.m27855m1(z ? R.string.MemberCannotJoinGroup : R.string.MemberCanJoinGroup, this.f34462a.m2151yb(messageSender));
    }

    public final void m3618c8(TdApi.Chat chat, int i) {
        if (chat != null && this.f34462a.m2707P3(chat.f25370id) != i) {
            this.f34462a.m2779Kb(chat.f25370id, i);
        }
    }
    ...
    public final int m3613d3(long j) {
        ...
        switch (C7316a.m17057d(j)) {
            case TdApi.ChatTypeSupergroup.CONSTRUCTOR:
                if (this.f34462a.m2542a3(U2)) {
                    return this.f34462a.m2784K6(j) ? R.string.LeaveChannel : R.string.LeaveMegaMenu;
                }
                break;
            case TdApi.ChatTypeSecret.CONSTRUCTOR:
            case TdApi.ChatTypePrivate.CONSTRUCTOR:
                return this.f34462a.m2906Cc(U2) ? R.string.DeleteAndStop : R.string.DeleteChat;
            case TdApi.ChatTypeBasicGroup.CONSTRUCTOR:
                TdApi.BasicGroup W3 = this.f34462a.m2601W3(j);
                TdApi.ChatMemberStatus K3 = this.f34462a.m2787K3(j);
                if (this.f34462a.m2542a3(U2) && K3 != null) {
                    return (C4779t2.m25500i3(K3, false) || (W3 != null && !W3.isActive)) ? R.string.LeaveMegaMenu : R.string.DeleteChat;
                }
                break;
        }
        return R.string.DeleteChat;
    ...
    public void m3608d8(C9137c cVar, long j) {
        if (this.f34462a.m2440ga().m3240B(j, true)) {
            cVar.setDataColorId(R.id.theme_color_textNegative);
            cVar.setData(R.string.NotificationsBlocked);
            return;
        }
        TdApi.ChatNotificationSettings I3 = this.f34462a.m2819I3(j);
        cVar.setDataColorId(0);
        if (I3 != null) {
            cVar.setData(m3503o3(this.f34462a.m2287q3(j)));
        } else {
    ...
    public void m3598e8(C9137c cVar, TdApi.NotificationSettingsScope notificationSettingsScope, boolean z) {
        int u0;
        if (this.f34462a.m2440ga().m3236C(notificationSettingsScope)) {
            cVar.setDataColorId(R.id.theme_color_textNegative);
            cVar.setData(R.string.NotificationsBlocked);
            return;
        }
        TdApi.ScopeNotificationSettings M0 = this.f34462a.m2440ga().m3195M0(notificationSettingsScope);
        cVar.setDataColorId(0);
        if (M0 == null) {
            cVar.setData(C4403w.m27871i1(R.string.LoadingInformation));
        } else if (Build.VERSION.SDK_INT < 26 || !z || M0.muteFor != 0 || (u0 = this.f34462a.m2440ga().m3075u0(notificationSettingsScope)) >= 3) {
            cVar.setData(m3503o3(M0.muteFor));
        } else {
            cVar.setData(C4403w.m27867j1(R.string.NotificationsEnabledHint, C4403w.m27911Z1(C4403w.m27871i1(m3533l3(u0, this.f34462a.m2440ga().m3151a1(notificationSettingsScope), this.f34462a.m2440ga().m3148b1(notificationSettingsScope))))));
        }
    }

    public void m3589f7(final AbstractC10664f9 f9Var, final String str) {
        this.f34462a.m2270r4().m14783o(new TdApi.GetBankCardInfo(str), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3588f8(AbstractC10664f9 f9Var, TdApi.LanguagePackInfo languagePackInfo) {
        String j1 = C4403w.m27867j1(R.string.ShareTextLanguageLink, languagePackInfo.name, f9Var.mo4348c().m2730Nc(languagePackInfo.f25408id));
        x00 x00Var = new x00(f9Var.mo4347s(), f9Var.mo4348c());
        x00Var.m30996Vi(new x00.C3281m(j1).m30886E(j1, C4403w.m27871i1(R.string.ShareBtnLanguage)));
        x00Var.m30962ej();
    }

    public int m3583g3(TdApi.Chat chat) {
        int r3 = this.f34462a.m2271r3(chat);
    ...
    public final void m3579g7(final AbstractC10664f9 f9Var, long j, final TdApi.Function function, final C10780j jVar) {
        TdApi.Chat U2;
        if (j == 0 || (U2 = this.f34462a.m2632U2(j)) == null) {
            this.f34462a.m2270r4().m14783o(function, new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public void m3578g8(AbstractC10664f9 f9Var, String str) {
        if (!C5070i.m24062i(str)) {
            x00 x00Var = new x00(f9Var.mo4347s(), f9Var.mo4348c());
            x00Var.m30996Vi(new x00.C3281m(C4403w.m27867j1(R.string.ShareTextProxyLink2, str)).m30886E(C4403w.m27867j1(R.string.ShareTextProxyLink, str), C4403w.m27871i1(R.string.ShareBtnProxy)));
            x00Var.m30962ej();
        }
    }
    ...
    public final CharSequence m3573h3(TdApi.User user) {
        if (user.isMutualContact) {
            return C4403w.m27855m1(C4779t2.m25729A2(user) ? R.string.ContactStateMutual : R.string.ContactStateMutualNoPhone, C4779t2.m25438r2(user));
        } else if (!user.isContact) {
            return null;
        } else {
            return C4403w.m27855m1(C4779t2.m25729A2(user) ? R.string.ContactStateOutgoing : R.string.ContactStateOutgoingNoPhone, C4779t2.m25438r2(user));
        }
    }
    ...
    public void m3568h8(AbstractC10664f9 f9Var, TdApi.StickerSetInfo stickerSetInfo) {
        String Rc = this.f34462a.m2667Rc(stickerSetInfo.name);
        String str = stickerSetInfo.title;
        x00 x00Var = new x00(f9Var.mo4347s(), f9Var.mo4348c());
        x00Var.m30996Vi(new x00.C3281m(C4403w.m27867j1(R.string.ShareTextStickerLink2, str, Rc)).m30886E(C4403w.m27867j1(R.string.ShareTextStickerLink, str, Rc), C4403w.m27871i1(R.string.ShareBtnStickerSet)));
        x00Var.m30962ej();
    }
    ...
    public void m3558i8(AbstractC10664f9 f9Var, String str) {
        x00 x00Var = new x00(f9Var.mo4347s(), f9Var.mo4348c());
        x00Var.m30996Vi(new x00.C3281m(str).m30888C(str));
        x00Var.m30962ej();
    }
    ...
    public final void m3548j8(AbstractC9323v4<?> v4Var, TdApi.User user) {
        String R2 = this.f34462a.m2480e2().m1694R2(user.f25442id);
        String K2 = this.f34462a.m2480e2().m1721K2(user.f25442id);
        String Tc = C5070i.m24062i(R2) ? null : this.f34462a.m2637Tc(R2);
        if (C4779t2.m25659K2(user)) {
            String j1 = C4403w.m27867j1(R.string.ShareTextLink, K2, Tc);
            x00 x00Var = new x00(v4Var.mo4347s(), v4Var.mo4348c());
            x00Var.m30996Vi(new x00.C3281m(j1).m30886E(C4403w.m27867j1(R.string.ShareTextBotLink, Tc), C4403w.m27871i1(R.string.ShareBtnBot)));
            x00Var.m30962ej();
            return;
        }
        x00 x00Var2 = new x00(v4Var.mo4347s(), v4Var.mo4348c());
        x00Var2.m30996Vi(new x00.C3281m(user));
        x00Var2.m30962ej();
    }
    ...
    public final void m3538k8(AbstractC9323v4<?> v4Var, TdApi.User user) {
        ...
        if (!C5070i.m24062i(str3)) {
            String Tc = this.f34462a.m2637Tc(str3);
            if (this.f34462a.m2379k7(user.f25442id)) {
                str = C4403w.m27867j1(R.string.ShareTextMyLink2, Tc);
                str2 = C4403w.m27867j1(R.string.ShareTextMyLink, Tc);
            } else {
                String K2 = this.f34462a.m2480e2().m1721K2(user.f25442id);
                String j1 = C4403w.m27867j1(R.string.ShareTextProfileLink2, K2, Tc);
                str2 = C4403w.m27867j1(R.string.ShareTextProfileLink, K2, Tc);
                str = j1;
            }
            x00 x00Var = new x00(v4Var.mo4347s(), v4Var.mo4348c());
            x00Var.m30996Vi(new x00.C3281m(str).m30886E(str2, C4403w.m27871i1(R.string.ShareLink)));
            x00Var.m30962ej();
        }
    }
    ...
    public boolean m3528l8(TdApi.Chat chat) {
        ...
        return E != null && (N0 = E.m14558N0()) != null && (N0.getBoundController() instanceof View$OnClickListenerC7430j1) && ((View$OnClickListenerC7430j1) N0.getBoundController()).m9131x9().f23724b == 4;
    }

    public String m3523m3(long j) {
        int P3 = this.f34462a.m2707P3(j);
        if (P3 > 0) {
    ...
    public void m3841G4(final AbstractC10664f9 f9Var, final TdApi.Chat chat, final C4737p7 p7Var, final C10788q qVar) {
        ...
        int Y2 = this.f34462a.m2572Y2(chat);
        if (Y2 < 0) {
            m3518m8(f9Var, qVar, Y2, this.f34462a.m2784K6(chat.f25370id));
        } else if (!f9Var.mo4347s().m14423w1()) {
            C9270q1 P1 = f9Var.mo4347s().m14551P1();
            View$OnClickListenerC3062so soVar = new View$OnClickListenerC3062so(f9Var.mo4347s(), f9Var.mo4348c());
            try {
                soVar.m31854Hm(new View$OnClickListenerC3062so.C3075m(chat, p7Var, false));
                if (P1.m9736X()) {
                    P1.m9743Q(soVar);
                    C2760nb nbVar = new C2760nb(f9Var.mo4347s(), f9Var.mo4348c());
                    nbVar.get();
                    P1.m9748M().m9498o(nbVar, 0);
                    return;
                }
                AbstractC9323v4<?> F = P1.m9762F();
                if ((F instanceof View$OnClickListenerC2971rh) && F.mo9464C9() == chat.f25370id && !((View$OnClickListenerC2971rh) F).m32569Tk()) {
                    soVar.m9394Ld(true);
                }
                P1.m9718h0(soVar);
            } catch (Throwable th) {
    ...
    public int m3513n3(String str) {
        ...
        if ("tg".equals(scheme)) {
            ...
            if (C5070i.m24062i(replace)) {
                return 0;
            }
            parse = Uri.parse(replace);
        } else if (C5070i.m24062i(scheme)) {
        ...
        if (this.f34462a.m2598W6(replace, false) && (pathSegments = parse.getPathSegments()) != null && !pathSegments.isEmpty()) {
            ...
            int s = C5070i.m24052s(str2);
            if (!C1363c0.m37460Q(str3) && s != 0) {
                return 1;
            }
        }
        return 0;
    ...
    public final void m3509n7(final AbstractC10664f9 f9Var, final String str, final C10788q qVar) {
        C7319d dVar;
        if (qVar == null || (dVar = qVar.f34541d) == null || !C7316a.m17051j(dVar.m17027c())) {
            this.f34462a.m2270r4().m14783o(new TdApi.GetExternalLinkInfo(str), new Client.AbstractC7865g() {
                @Override
                public final void mo255t2(TdApi.Object object) {
    ...
    public void m3508n8(AbstractC9323v4<?> v4Var, C10684g8 g8Var) {
        boolean s6 = this.f34462a.m2252s6(C7317b.f23228b);
        int i = s6 ? 2 : 1;
        C5320c cVar = new C5320c(i);
        C5146u0 u0Var = new C5146u0(i);
        C5320c cVar2 = new C5320c(i);
        if (s6) {
            cVar.m23285a(R.id.btn_markChatAsRead);
            u0Var.m23817a(R.string.ArchiveRead);
            cVar2.m23285a(R.drawable.baseline_done_all_24);
        }
        boolean V = this.f34462a.m2294pc().m4135V();
        cVar.m23285a(R.id.btn_pinUnpinChat);
        if (V) {
            cVar2.m23285a(R.drawable.deproko_baseline_pin_24);
            u0Var.m23817a(R.string.ArchivePin);
        } else {
            cVar2.m23285a(R.drawable.baseline_arrow_upward_24);
            u0Var.m23817a(R.string.ArchiveHide);
        }
        v4Var.m9261ee(C4403w.m27838q2(R.string.xArchivedChats, g8Var.m4301L()), cVar.m23281e(), u0Var.m23814d(), null, cVar2.m23281e(), new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i2) {
                boolean b6;
    ...
    public final void m3498o8(final AbstractC9323v4<?> v4Var, final TdApi.ChatList chatList, final long j, final Runnable runnable) {
        boolean Z2 = this.f34462a.m2557Z2(j);
        String Q3 = this.f34462a.m2691Q3(j);
        int[] iArr = new int[2];
        iArr[0] = Z2 ? R.id.btn_unarchiveChat : R.id.btn_archiveChat;
        iArr[1] = R.id.btn_cancel;
        String[] strArr = new String[2];
        strArr[0] = C4403w.m27871i1(Z2 ? R.string.UnarchiveChat : R.string.ArchiveChat);
        strArr[1] = C4403w.m27871i1(R.string.Cancel);
        int[] iArr2 = new int[2];
    ...
    public void m3488p8(AbstractC9323v4<?> v4Var, boolean z) {
        if (z) {
            v4Var.m9268de(null, new int[]{R.id.btn_changePhotoCamera, R.id.btn_changePhotoGallery, R.id.btn_changePhotoDelete}, new String[]{C4403w.m27871i1(R.string.takePhoto), C4403w.m27871i1(R.string.pickFromGallery), C4403w.m27871i1(R.string.DeletePhoto)}, new int[]{1, 1, 2}, new int[]{R.drawable.baseline_camera_alt_24, R.drawable.baseline_image_24, R.drawable.baseline_remove_circle_24});
        } else {
            v4Var.m9268de(null, new int[]{R.id.btn_changePhotoCamera, R.id.btn_changePhotoGallery}, new String[]{C4403w.m27871i1(R.string.takePhoto), C4403w.m27871i1(R.string.pickFromGallery)}, null, new int[]{R.drawable.baseline_camera_alt_24, R.drawable.baseline_image_24});
        }
    }
    ...
    public boolean m3479q7(AbstractC10664f9 f9Var, AbstractView$OnClickListenerC3344yb.C3351f fVar) {
        if (!C7389v0.m16612l1(f9Var.mo4347s())) {
            return C1405v.m37145A(fVar.f11151b, fVar.f11152c, fVar.f11153d, fVar.f11154e);
        }
        C2125ac acVar = new C2125ac(f9Var.mo4347s(), f9Var.mo4348c());
        acVar.m9476Ad(fVar);
        f9Var.mo4347s().m14551P1().m9718h0(acVar);
        return true;
    }
    ...
    public final void m3610d6(final TdApi.Function function, final TdApi.Error error, final C10780j jVar) {
        ...
        CharSequence z5 = C4779t2.m25379z5(error);
        if (!C5070i.m24062i(z5)) {
            String str = error.message;
            str.hashCode();
            if (!str.equals("INVITE_REQUEST_SENT")) {
                if (str.equals("USERNAME_NOT_OCCUPIED") && function.getConstructor() == 857135533) {
                    z5 = C4403w.m27855m1(R.string.UsernameNotOccupied, ((TdApi.SearchPublicChat) function).username);
                }
            } else if (!(jVar == null || (chatInviteLinkInfo = jVar.f34513k) == null || !chatInviteLinkInfo.createsJoinRequest)) {
                z5 = C4403w.m27855m1(C4779t2.m25638N2(chatInviteLinkInfo.type) ? R.string.RequestJoinChannelSent : R.string.RequestJoinGroupSent, jVar.f34513k.title);
            }
            m3857E8(this.f34462a, R.drawable.baseline_error_24, z5, jVar != null ? jVar.f34510h : null);
        }
    }
    ...
    public void m3468r8(final AbstractC9323v4<?> v4Var, final TdApi.ChatList chatList, final long j, final C4737p7 p7Var, boolean z, boolean z2, final Runnable runnable) {
        ...
        TdApi.Chat U2 = this.f34462a.m2632U2(j);
        if (U2 != null) {
            boolean a3 = this.f34462a.m2542a3(U2);
            TdApi.ChatPosition a = C7317b.m17043a(U2, chatList);
            if (a3) {
                boolean v3 = this.f34462a.m2207v3(U2);
                ...
                if (z && runnable != null) {
                    cVar.m23285a(R.id.btn_selectChat);
                    u0Var.m23817a(z2 ? R.string.Unselect : R.string.Select);
                    cVar2.m23285a(1);
                    cVar3.m23285a(R.drawable.baseline_playlist_add_check_24);
                }
                if (!this.f34462a.m2443g7(j)) {
                    cVar.m23285a(R.id.btn_notifications);
                    u0Var.m23817a(v3 ? R.string.MuteNotifications : R.string.EnableNotifications);
                    cVar2.m23285a(1);
                    cVar3.m23285a(v3 ? R.drawable.baseline_notifications_off_24 : R.drawable.baseline_notifications_24);
                }
                if (a != null) {
                    cVar.m23285a(a.isPinned ? R.id.btn_unpinChat : R.id.btn_pinChat);
                    u0Var.m23817a(a.isPinned ? R.string.UnpinFromTop : R.string.PinToTop);
                    cVar2.m23285a(1);
                    cVar3.m23285a(a.isPinned ? R.drawable.deproko_baseline_pin_undo_24 : R.drawable.deproko_baseline_pin_24);
                }
                if (this.f34462a.m2368l2(chatList, U2)) {
                    boolean z3 = chatList instanceof TdApi.ChatListArchive;
                    cVar.m23285a(z3 ? R.id.btn_unarchiveChat : R.id.btn_archiveChat);
                    u0Var.m23817a(z3 ? R.string.UnarchiveChat : R.string.ArchiveChat);
                    cVar2.m23285a(1);
                    cVar3.m23285a(z3 ? R.drawable.baseline_unarchive_24 : R.drawable.baseline_archive_24);
                }
                boolean q6 = this.f34462a.m2284q6(U2);
                boolean B2 = this.f34462a.m2932B2(U2);
                if (!B2 || U2.unreadCount == 0 || !q6) {
                    cVar.m23285a(B2 ? R.id.btn_markChatAsRead : R.id.btn_markChatAsUnread);
                    u0Var.m23817a(B2 ? R.string.MarkAsRead : R.string.MarkAsUnread);
                    cVar2.m23285a(1);
                    cVar3.m23285a(B2 ? R.drawable.baseline_done_all_24 : R.drawable.baseline_unsubscribe_24);
                }
                if (!q6 && this.f34462a.m2304p2(U2)) {
                    cVar.m23285a(R.id.btn_clearChatHistory);
                    u0Var.m23817a(R.string.ClearHistory);
                    cVar2.m23285a(1);
                    cVar3.m23285a(R.drawable.templarian_baseline_broom_24);
                }
                cVar2.m23285a(2);
                ...
                switch (U2.type.getConstructor()) {
                    ...
                    case TdApi.ChatTypeBasicGroup.CONSTRUCTOR:
                        ...
                        break;
                    case TdApi.ChatTypeSecret.CONSTRUCTOR:
                        charSequence = C4403w.m27855m1(R.string.SecretChatWithUser, this.f34462a.m2480e2().m1749D2(this.f34462a.m2478e4(U2)));
                        break;
                    case TdApi.ChatTypePrivate.CONSTRUCTOR:
                        String D2 = this.f34462a.m2480e2().m1749D2(this.f34462a.m2478e4(U2));
                        if (!this.f34462a.m2443g7(j)) {
                            charSequence = C4403w.m27855m1(R.string.ChatWithUser, D2);
                            break;
                        } else {
                            charSequence = C4403w.m27871i1(R.string.ChatWithYourself);
                            break;
                        }
                    default:
                        throw new IllegalArgumentException();
                }
                v4Var.m9261ee(charSequence, cVar.m23281e(), u0Var.m23814d(), cVar2.m23281e(), cVar3.m23281e(), new AbstractC5117h0() {
                    @Override
                    public final boolean mo493A3(View view, int i4) {
                        boolean e6;
    ...
    public void m3459s7(AbstractC10664f9 f9Var, TdApi.Message message, C10788q qVar) {
        m3469r7(f9Var, message.chatId, new C7319d(message.chatId, message.f25409id), qVar);
    }

    public final void m3458s8(AbstractC9323v4<?> v4Var, final long j, final Runnable runnable) {
        boolean z = true;
        if (this.f34462a.m2836H2(j)) {
            C9188f2 b = new C9188f2(R.id.btn_removeChatFromList).m10009c(false).m10010b(this.f34462a.m2443g7(j) ? C4403w.m27984H0(v4Var, R.string.ClearSavedMessagesConfirm, new Object[0]) : C4403w.m27871i1(R.string.ClearHistoryConfirm));
            C2964ra[] raVarArr = new C2964ra[1];
            String j1 = C4403w.m27867j1(R.string.DeleteSecretChatHistoryForOtherParty, this.f34462a.m2480e2().m1749D2(C7316a.m17044q(j)));
            if (!this.f34462a.m2187w7(j) || !this.f34462a.m2480e2().m1757B2(this.f34462a.m2494d4(j))) {
                z = false;
            }
            raVarArr[0] = new C2964ra(12, (int) R.id.btn_clearChatHistory, 0, j1, (int) R.id.btn_clearChatHistory, z);
            v4Var.m9206me(b.m9996p(raVarArr).m9995q(R.id.theme_color_textNegative).m9994r(R.string.Delete).m10002j(new AbstractC9323v4.AbstractC9343r() {
                @Override
                public final void mo1773l6(int i, SparseIntArray sparseIntArray) {
        ...
        v4Var.m9261ee(this.f34462a.m2443g7(j) ? C4403w.m27984H0(v4Var, R.string.ClearSavedMessagesConfirm, new Object[0]) : C4403w.m27871i1(R.string.ClearHistoryConfirm), new int[]{R.id.btn_clearChatHistory, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.ClearHistory), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.templarian_baseline_broom_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
            @Override
            public final boolean mo493A3(View view, int i) {
                boolean g6;
    ...
    public boolean m3453t3(AbstractC9323v4<?> v4Var, View view, int i, TdApi.User user, boolean z) {
        ...
        if (i != R.id.btn_addToGroup) {
            int i2 = 4;
            if (i == R.id.btn_phone) {
                if (!C5070i.m24062i(user.phoneNumber)) {
                    if (!z) {
                        i2 = 3;
                    }
                    ...
                    if (!z) {
                        ...
                        if (h32 instanceof SpannableStringBuilder) {
                            ...
                            str = h32;
                            v4Var.m9268de(str, cVar.m23281e(), u0Var.m23814d(), null, cVar2.m23281e());
                        } else if (!C5070i.m24062i(h32)) {
                            w = ((Object) h32) + "\n\n" + w;
                        }
                    }
                    str = w;
                    ...
                    if (view != null) {
                        v4Var.mo4347s().m14584H3().m8985g(view).m8969F(v4Var, this.f34462a, R.drawable.baseline_info_24, h3);
                    } else {
                        C1379j0.m37293z0(h3, 0);
                    }
                }
                return true;
                ...
                if (this.f34462a.m2379k7(user.f25442id)) {
                    if (C5070i.m24062i(user.username)) {
                        v4Var.m9284bc().m9718h0(new View$OnClickListenerC3043s8(v4Var.mo4347s(), v4Var.mo4348c()));
                        return true;
                    }
                    cVar3.m23285a(R.id.btn_username_edit);
                    cVar4.m23285a(R.drawable.baseline_edit_24);
                    u0Var2.m23817a(R.string.EditUsername);
                    z2 = true;
                }
                cVar3.m23285a(R.id.btn_username_copy_link);
                cVar4.m23285a(R.drawable.baseline_link_24);
                u0Var2.m23817a(R.string.CopyLink);
                cVar3.m23285a(R.id.btn_username_share);
                cVar4.m23285a(R.drawable.baseline_forward_24);
                u0Var2.m23817a(R.string.ShareLink);
                if (z2) {
                    str2 = null;
                } else {
                    str2 = "@" + user.username;
                }
                v4Var.m9268de(str2, cVar3.m23281e(), u0Var2.m23814d(), null, cVar4.m23281e());
                return true;
            }
        } else {
            m3842G3(v4Var, user.f25442id);
            return true;
        }
    }
    ...
    public void m3449t7(AbstractC10664f9 f9Var, TdApi.MessageLinkInfo messageLinkInfo, C10788q qVar) {
        if (messageLinkInfo.message != null) {
            ...
            m3469r7(f9Var, j, new C7319d(message.chatId, message.f25409id), qVar);
            return;
        }
        if (this.f34462a.m2632U2(messageLinkInfo.chatId) != null) {
            C1379j0.m37295y0(this.f34462a.m2784K6(messageLinkInfo.chatId) ? R.string.PostNotFound : R.string.MessageNotFound, 0);
        }
        m3569h7(f9Var, messageLinkInfo.chatId, new C10780j().m3368h().m3357s(qVar));
    }

    public void m3448t8(AbstractC9323v4<?> v4Var, long j) {
        m3438u8(v4Var, j, false, this.f34462a.m2922Bc(j), null);
    }
    ...
    public boolean m3443u3(AbstractC9323v4<?> v4Var, int i, TdApi.User user, TdApi.UserFullInfo userFullInfo) {
        switch (i) {
            ...
            case R.id.more_btn_edit:
                if (user != null) {
                    View$OnClickListenerC2118a7 a7Var = new View$OnClickListenerC2118a7(v4Var.mo4347s(), v4Var.mo4348c());
                    if (v4Var.mo4348c().m2379k7(user.f25442id)) {
                        a7Var.m35521uf(1);
                    } else {
                        a7Var.m35521uf(2);
                        a7Var.m35520vf(user);
    ...
    public final void m3438u8(final AbstractC9323v4<?> v4Var, final long j, boolean z, final boolean z2, final Runnable runnable) {
        ...
        switch (C7316a.m17057d(j)) {
            case TdApi.ChatTypeSupergroup.CONSTRUCTOR:
                m3408x8(v4Var, j, this.f34462a.m2691Q3(j), new Runnable() {
                    @Override
                    public final void run() {
                ...
                return;
            case TdApi.ChatTypeSecret.CONSTRUCTOR:
                final String D2 = this.f34462a.m2480e2().m1749D2(this.f34462a.m2494d4(j));
                m3408x8(v4Var, j, C4403w.m27855m1(R.string.SecretChatWithUser, D2), new Runnable() {
                    @Override
                    public final void run() {
            ...
            case TdApi.ChatTypePrivate.CONSTRUCTOR:
                ...
                final String D22 = this.f34462a.m2480e2().m1749D2(q);
                final boolean z3 = z2 && this.f34462a.m2832H6(j);
                if (this.f34462a.m2379k7(q)) {
                    i1 = C4403w.m27871i1(R.string.SavedMessages);
                } else {
                    i1 = this.f34462a.m2475e7(C7316a.m17058c(q)) ? C4403w.m27871i1(R.string.RepliesBot) : C4403w.m27867j1(R.string.ChatWithUser, D22);
                }
    ...
    public boolean m3433v3(AbstractC9323v4<?> v4Var, int i, TdApi.User user) {
        ...
        if (i != R.id.btn_changePhoneNumber) {
            switch (i) {
                case R.id.btn_phone_call:
                    C1405v.m37144B('+' + user.phoneNumber);
                    return true;
                case R.id.btn_phone_copy:
                    C1379j0.m37328i('+' + user.phoneNumber, R.string.copied_phone);
                    return true;
                ...
                default:
                    switch (i) {
                        case R.id.btn_username_copy:
                            C1379j0.m37328i('@' + user.username, R.string.CopiedUsername);
                            return true;
                        case R.id.btn_username_copy_link:
                            C1379j0.m37328i(C4779t2.m25681H1(user), R.string.CopiedLink);
                            return true;
            ...
            v4Var.m9284bc().m9718h0(new View$OnClickListenerC2461gw(v4Var.mo4347s(), v4Var.mo4348c()));
            return true;
        }
    }
    ...
    public void m3419w7(AbstractC10664f9 f9Var, final String str, final int i, final TdApi.ProxyType proxyType, String str2) {
        AbstractC9323v4<?> F = f9Var.mo4347s().m14551P1().m9762F();
        if (F != null) {
            SpannableStringBuilder k = C1363c0.m37430k(str2);
            k.insert(0, (CharSequence) "\n\n");
            String i1 = C4403w.m27871i1(R.string.EnableProxyAlertTitle);
            k.insert(0, (CharSequence) i1);
            k.setSpan(C4779t2.m25727A4(i1), 0, i1.length(), 33);
            k.append((CharSequence) "\n\n");
            k.append((CharSequence) C4403w.m27871i1(R.string.EnableProxyAlertHint));
            if (proxyType.getConstructor() == -1964826627) {
                k.append((CharSequence) "\n\n");
                k.append((CharSequence) C4403w.m27871i1(R.string.EnableProxyAlertHintMtproto));
            }
            C5320c cVar = new C5320c(3);
            C5146u0 u0Var = new C5146u0(3);
            C5320c cVar2 = new C5320c(3);
            C5320c cVar3 = new C5320c(3);
            cVar.m23285a(R.id.btn_addProxy);
            u0Var.m23817a(R.string.ProxyEnable);
            cVar2.m23285a(R.drawable.baseline_security_24);
            cVar3.m23285a(3);
            cVar.m23285a(R.id.btn_save);
            u0Var.m23817a(R.string.ProxySaveForLater);
            cVar2.m23285a(R.drawable.baseline_playlist_add_24);
            cVar3.m23285a(1);
            cVar.m23285a(R.id.btn_cancel);
            u0Var.m23817a(R.string.Cancel);
            cVar2.m23285a(R.drawable.baseline_cancel_24);
            cVar3.m23285a(1);
            F.m9261ee(k, cVar.m23281e(), u0Var.m23814d(), cVar3.m23281e(), cVar2.m23281e(), new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i2) {
                    boolean R4;
    ...
    public final boolean m3413x3(final AbstractC10664f9 f9Var, String str, final C10788q qVar) {
        if (C4779t2.m25514g3(str)) {
            Log.m14724e("Attempt to install custom local languagePackId:%s", str);
            return true;
        }
        this.f34462a.m2270r4().m14783o(new TdApi.GetLanguagePackInfo(str), new Client.AbstractC7865g() {
            @Override
            public final void mo255t2(TdApi.Object object) {
    ...
    public void m3409x7(AbstractC10664f9 f9Var, boolean z) {
        if (C4868i.m24727c2().m24665k0() == 0) {
            m3863E2(f9Var, z);
        } else {
            f9Var.mo4347s().m14551P1().m9718h0(new View$OnLongClickListenerC2502hx(f9Var.mo4347s(), f9Var.mo4348c()));
        }
    }
    ...
    public final void m3408x8(final AbstractC9323v4<?> v4Var, final long j, CharSequence charSequence, final Runnable runnable, boolean z, final Runnable runnable2) {
        if (!z || !this.f34462a.m2320o2(j)) {
            ...
            v4Var.m9261ee(charSequence, new int[]{R.id.btn_removeChatFromList, R.id.btn_clearChatHistory}, new String[]{C4403w.m27871i1(m3613d3(j)), C4403w.m27871i1(R.string.ClearHistory)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_24, R.drawable.templarian_baseline_broom_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean w6;
    ...
    public void m3403y3(AbstractC10664f9 f9Var, C10783m mVar) {
        if (C11541z.m7t().m8s(mVar) != 0) {
            C11541z.m7t().m21h(this.f34462a, mVar.f34531j, false, null);
        }
    }
    ...
    public void m3398y8(AbstractC9323v4<?> v4Var, final C11533r rVar, final Runnable runnable) {
        if (C11541z.m1y(rVar.m110c())) {
            v4Var.m9261ee(C4403w.m27871i1(R.string.ThemeRemoveInfo), new int[]{R.id.btn_done, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.ThemeRemoveConfirm), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_forever_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean x6;
    ...
    public final void m3388z8(final AbstractC9323v4<?> v4Var, TdApi.ChatList chatList, final long j, final Runnable runnable) {
        ...
        TdApi.ChatSource J3 = this.f34462a.m2803J3(chatList, j);
        if (J3 instanceof TdApi.ChatSourcePublicServiceAnnouncement) {
            v4Var.m9261ee(C4403w.m27936T0((TdApi.ChatSourcePublicServiceAnnouncement) J3, this.f34462a.m2691Q3(j)), new int[]{R.id.btn_delete, R.id.btn_cancel}, new String[]{C4403w.m27871i1(R.string.PsaHideDone), C4403w.m27871i1(R.string.Cancel)}, new int[]{2, 1}, new int[]{R.drawable.baseline_delete_sweep_24, R.drawable.baseline_cancel_24}, new AbstractC5117h0() {
                @Override
                public final boolean mo493A3(View view, int i) {
                    boolean z6;
    ...
    public static class C10783m implements AbstractC11531p {
        ...
        public final Map<Integer, Float> f34527f = new HashMap();
        public final Map<Integer, Integer> f34528g = new HashMap();
        public final List<C10784a> f34529h = new ArrayList();
        public final List<C10784a> f34530i = new ArrayList();
        public C11529n f34531j;
        ...
        @Override
        public String mo95b() {
            if (!C5070i.m24062i(this.f34525d)) {
                return this.f34525d;
            }
            return C11514c0.m348a(this.f34526e).mo95b();
        }
        ...
        public float mo93d(int i) {
            Float f = this.f34527f.get(Integer.valueOf(i));
            if (f != null) {
                return f.floatValue();
            }
            return C11514c0.m348a(this.f34526e).mo93d(i);
        }

        @Override
        public int mo92e(int i) {
            Integer num = this.f34528g.get(Integer.valueOf(i));
            if (num != null) {
                return num.intValue();
            }
            return C11514c0.m348a(this.f34526e).mo92e(i);
        }
        ...
        public void m3339g(String str, int i, int i2) {
            if (!this.f34528g.containsKey(Integer.valueOf(i))) {
                this.f34528g.put(Integer.valueOf(i), Integer.valueOf(i2));
                this.f34530i.add(new C10784a(str, i, i2));
                return;
            }
        ...
        public void m3338h(String str, int i, float f) {
            if (this.f34527f.containsKey(Integer.valueOf(i))) {
                throw new IllegalArgumentException("Duplicate property: " + C11524j.m192d0(i));
            } else if (C11541z.m64A(i, f)) {
                this.f34527f.put(Integer.valueOf(i), Float.valueOf(f));
                if (i == R.id.theme_property_parentTheme) {
                    this.f34526e = (int) f;
                }
                this.f34529h.add(new C10784a(str, i, f));
            } else {
        ...
        public void m3337i() {
            ...
            } else if (!C5070i.m24062i(this.f34522a)) {
                AbstractC11531p d = C11514c0.m345d(this.f34526e, false);
                for (int size = this.f34530i.size() - 1; size >= 0; size--) {
                    C10784a aVar = this.f34530i.get(size);
                    if (d.mo92e(aVar.f34534b) == aVar.f34535c) {
                        this.f34530i.remove(size);
                        this.f34528g.remove(Integer.valueOf(aVar.f34534b));
                    }
                }
                for (int size2 = this.f34529h.size() - 1; size2 >= 0; size2--) {
                    C10784a aVar2 = this.f34529h.get(size2);
                    int i = aVar2.f34534b;
                    if (i != R.id.theme_property_parentTheme && d.mo93d(i) == aVar2.f34532M) {
                        this.f34529h.remove(size2);
                        this.f34527f.remove(Integer.valueOf(aVar2.f34534b));
                    }
                }
                C10836lj ljVar = C10836lj.f34730a;
                Collections.sort(this.f34529h, ljVar);
                Collections.sort(this.f34530i, ljVar);
            } else {
        ...
        public static class C10784a implements Comparable<C10784a> {
            ...
            public int compareTo(C10784a aVar) {
                return this.f34533a.compareToIgnoreCase(aVar.f34533a);
            }
    ...
    public static class C10788q implements AbstractC4761s4.AbstractC4770i {
        public int f34538a;
        public int f34539b;
        public TdApi.WebPage f34540c;
        public C7319d f34541d;
        public String f34542e;
        public String f34543f;
        public C9357x2.C9365h f34544g;
        public boolean f34545h;
        public String f34546i;
        public AbstractC9323v4<?> f34547j;
        public AbstractC4761s4 f34548k;
        ...
        public void mo3330a(AbstractC4761s4 s4Var, long j, long j2, boolean z) {
            C7319d dVar = this.f34541d;
            if (dVar != null && dVar.m17029a(s4Var.m26146K2(), j)) {
                this.f34541d = this.f34541d.m17022h(j, j2);
                s4Var.m25940f4().remove(this);
                this.f34548k = null;
            }
        }
        ...
        public C10788q m3316o(long j) {
            AbstractC4761s4 s4Var = this.f34548k;
            if (s4Var == null) {
        ...
        public C10788q m3315p(AbstractC4761s4 s4Var) {
            if (s4Var != null) {
                if (s4Var.m25852o6()) {
                    this.f34548k = s4Var;
                    s4Var.m25940f4().add(this);
                } else {
                    this.f34548k = null;
                }
                m3328c(s4Var.m26097P0());
                return m3314q(new C7319d(s4Var.m26146K2(), s4Var.m26116N3(), s4Var.m25884l4(s4Var.m26116N3())));
            }
            this.f34548k = null;
            return m3314q(null);
        }
        ...
        public C10788q m3313r(TdApi.WebPage webPage) {
            this.f34540c = webPage;
            return this;
        }

        public C10788q m3312s(C9357x2.C9365h hVar) {
            this.f34544g = hVar;
            if (!(hVar == null || this.f34547j == null || hVar.m8953o())) {
                hVar.m8958i(this.f34547j);
            }
            return this;
        }
        ...
        public C10788q(C10788q qVar) {
            ...
            this.f34539b = -1;
            if (qVar != null) {
                this.f34538a = qVar.f34538a;
                this.f34539b = qVar.f34539b;
                this.f34541d = qVar.f34541d;
                this.f34542e = qVar.f34542e;
                this.f34543f = qVar.f34543f;
                this.f34544g = qVar.f34544g;
                this.f34545h = qVar.f34545h;
                this.f34546i = qVar.f34546i;
                this.f34547j = qVar.f34547j;
                AbstractC4761s4 s4Var = qVar.f34548k;
                if (s4Var != null) {
                    m3315p(s4Var);
                }
            }
