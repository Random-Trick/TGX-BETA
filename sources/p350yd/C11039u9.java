...
public class C11039u9 {
    public final C10930q6 f35415a;
    public final Map<String, List<TdApi.Message>> f35414A = new HashMap();
    public final C6227d<AbstractC10748j1> f35416b = new C6227d<>();
    public final C6227d<AbstractC10701h1> f35417c = new C6227d<>();
    public final C6227d<AbstractC10747j0> f35418d = new C6227d<>();
    public final C6233h<String, AbstractC10700h0> f35419e = new C6233h<>(true);
    public final C6227d<AbstractC10817l1> f35420f = new C6227d<>(true);
    public final C6227d<AbstractC10986s1> f35421g = new C6227d<>(true);
    public final C6227d<AbstractC10551b> f35422h = new C6227d<>();
    public final C6227d<AbstractC10861n0> f35423i = new C6227d<>(true);
    public final C6227d<AbstractC10924q0> f35424j = new C6227d<>();
    public final C6227d<AbstractC10573c> f35425k = new C6227d<>(true);
    public final C6227d<AbstractC10816l0> f35426l = new C6227d<>(true);
    public final C6227d<AbstractC11041ub> f35427m = new C6227d<>(true);
    public final C6227d<AbstractC10903p0> f35428n = new C6227d<>(true);
    public final C6227d<AbstractC10790k0> f35429o = new C6227d<>(true);
    public final C6227d<AbstractC10883o1> f35430p = new C6227d<>();
    public final C6227d<AbstractC10574c0> f35431q = new C6227d<>(true);
    public final C6227d<AbstractC10925q1> f35432r = new C6227d<>(true);
    public final C6227d<AbstractC10964r0> f35433s = new C6227d<>(true);
    public final C6227d<AbstractC10524a> f35434t = new C6227d<>(true);
    public final C6231f<AbstractC10748j1> f35435u = new C6231f<>();
    public final C6231f<AbstractC10701h1> f35436v = new C6231f<>();
    public final C6231f<AbstractC10747j0> f35437w = new C6231f<>();
    public final C6231f<AbstractC10817l1> f35438x = new C6231f<>(true);
    public final C6226c<AbstractC10985s0> f35439y = new C6226c<>();
    public final C6231f<AbstractC10839m1> f35440z = new C6231f<>();
            ...
            while (it.hasNext()) {
                ...
                if (list != null) {
                    for (C10930q6.C10938h hVar : list) {
                        C10930q6.C10937g gVar = hVar.f35140c;
                        next.mo4053w6(j, gVar.f35136a, gVar.m2129b(), gVar.m2127d(), gVar.m2128c());
                    }
                }
            }
        }
    ...
    public static void m1807t(C10930q6.C10938h hVar, AbstractC10700h0 h0Var) {
        h0Var.mo3010g1(hVar.f35138a, hVar.f35139b, 3);
    }

    public static void m1803u(C10930q6.C10938h hVar, AbstractC10700h0 h0Var) {
        h0Var.mo3010g1(hVar.f35138a, hVar.f35139b, 2);
    }
    ...
    public void m1978A0(TdApi.UpdateAnimatedEmojiMessageClicked updateAnimatedEmojiMessageClicked) {
        m1974B0(updateAnimatedEmojiMessageClicked, this.f35416b.iterator());
        m1974B0(updateAnimatedEmojiMessageClicked, this.f35435u.m21019d(Long.valueOf(updateAnimatedEmojiMessageClicked.chatId)));
    }

    public void m1977A1(TdApi.UpdateChatTheme updateChatTheme, final TdApi.Chat chat, C10684g8[] g8VarArr) {
        m1781z1(updateChatTheme, this.f35418d.iterator());
        m1781z1(updateChatTheme, this.f35437w.m21019d(Long.valueOf(updateChatTheme.chatId)));
        if (g8VarArr != null) {
    ...
    public void m1975B(TdApi.Session session) {
        Iterator<AbstractC10925q1> it = this.f35432r.iterator();
        while (it.hasNext()) {
            it.next().mo2957E6(this.f35415a, session);
        }
    }

    public void m1972B2(long j) {
        m1967D(this.f35420f.iterator(), j);
        m1967D(this.f35438x.m21019d(Long.valueOf(j)), j);
    }

    public void m1971C(int i) {
        Iterator<AbstractC10524a> it = this.f35434t.iterator();
        while (it.hasNext()) {
            it.next().mo4826g(i);
        }
    }
    ...
    public void m1970C0(boolean z) {
        Iterator<AbstractC11041ub> it = this.f35427m.iterator();
        while (it.hasNext()) {
            it.next().mo1779G0(z);
        }
    }
    ...
    public void m1969C1(TdApi.UpdateChatTitle updateChatTitle, final TdApi.Chat chat, C10684g8[] g8VarArr) {
        m1973B1(updateChatTitle, this.f35418d.iterator());
        m1973B1(updateChatTitle, this.f35437w.m21019d(Long.valueOf(updateChatTitle.chatId)));
        if (g8VarArr != null) {
            for (final C10684g8 g8Var : g8VarArr) {
                m1819q(g8Var, new AbstractC5918j() {
                    @Override
    ...
    public void m1968C2(TdApi.NotificationSettingsScope notificationSettingsScope) {
        m1963E(this.f35420f.iterator(), notificationSettingsScope);
    }

    public void m1966D0(String str) {
        Iterator<AbstractC10573c> it = this.f35425k.iterator();
        while (it.hasNext()) {
    ...
    public void m1964D2() {
        Iterator<AbstractC10817l1> it = this.f35420f.iterator();
        while (it.hasNext()) {
            it.next().mo3245z0();
        }
    }
    ...
    public void m1961E1(TdApi.UpdateChatUnreadMentionCount updateChatUnreadMentionCount, boolean z) {
        m1965D1(updateChatUnreadMentionCount.chatId, updateChatUnreadMentionCount.unreadMentionCount, z, this.f35418d.iterator());
        long j = updateChatUnreadMentionCount.chatId;
        m1965D1(j, updateChatUnreadMentionCount.unreadMentionCount, z, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1960E2(TdApi.UpdateChatNotificationSettings updateChatNotificationSettings) {
        m1935L(this.f35420f.iterator(), updateChatNotificationSettings.chatId, updateChatNotificationSettings.notificationSettings);
        m1935L(this.f35438x.m21019d(Long.valueOf(updateChatNotificationSettings.chatId)), updateChatNotificationSettings.chatId, updateChatNotificationSettings.notificationSettings);
    }

    public void m1959F(TdApi.ChatList chatList, boolean z, int i, int i2, int i3) {
        Iterator<AbstractC10903p0> it = this.f35428n.iterator();
        while (it.hasNext()) {
    ...
    public void m1956F2(TdApi.UpdateScopeNotificationSettings updateScopeNotificationSettings) {
        m1931M(this.f35420f.iterator(), updateScopeNotificationSettings.scope, updateScopeNotificationSettings.notificationSettings);
    }

    public void m1955G(int i) {
        Iterator<AbstractC10925q1> it = this.f35432r.iterator();
        while (it.hasNext()) {
            it.next().mo2954c3(this.f35415a, i);
        }
    }

    public void m1954G0(TdApi.UpdateCall updateCall) {
        m1958F0(updateCall.call, this.f35431q.iterator());
    }

    public void m1953G1(TdApi.UpdateChatUnreadReactionCount updateChatUnreadReactionCount, boolean z) {
        m1957F1(updateChatUnreadReactionCount.chatId, updateChatUnreadReactionCount.unreadReactionCount, z, this.f35418d.iterator());
        long j = updateChatUnreadReactionCount.chatId;
        m1957F1(j, updateChatUnreadReactionCount.unreadReactionCount, z, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1952G2(TdApi.Poll poll) {
        Iterator<AbstractC10839m1> d = this.f35440z.m21019d(Long.valueOf(poll.f25413id));
        if (d != null) {
            while (d.hasNext()) {
    ...
    public void m1950H0(TdApi.UpdateChatActionBar updateChatActionBar) {
        m1946I0(updateChatActionBar, this.f35418d.iterator());
        m1946I0(updateChatActionBar, this.f35437w.m21019d(Long.valueOf(updateChatActionBar.chatId)));
    }

    public void m1948H2(TdApi.UserPrivacySetting userPrivacySetting, TdApi.UserPrivacySettingRules userPrivacySettingRules) {
        Iterator<AbstractC10883o1> it = this.f35430p.iterator();
        while (it.hasNext()) {
    ...
    public void m1947I(TdApi.Session session) {
        Iterator<AbstractC10925q1> it = this.f35432r.iterator();
        while (it.hasNext()) {
            it.next().mo2956O5(this.f35415a, session);
        }
    }

    public void m1945I1(TdApi.UpdateChatVideoChat updateChatVideoChat) {
        m1949H1(updateChatVideoChat.chatId, updateChatVideoChat.videoChat, this.f35418d.iterator());
        long j = updateChatVideoChat.chatId;
        m1949H1(j, updateChatVideoChat.videoChat, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1944I2(TdApi.UpdateRecentStickers updateRecentStickers) {
        Iterator<AbstractC10986s1> it = this.f35421g.iterator();
        while (it.hasNext()) {
    ...
    public void m1943J(boolean z) {
        Iterator<AbstractC10925q1> it = this.f35432r.iterator();
        while (it.hasNext()) {
            it.next().mo2953c7(this.f35415a, z);
        }
    }
    ...
    public void m1941J1(int i, int i2) {
        Iterator<AbstractC10861n0> it = this.f35423i.iterator();
        while (it.hasNext()) {
    ...
    public void m1940J2(TdApi.UpdateSavedAnimations updateSavedAnimations) {
        Iterator<AbstractC10551b> it = this.f35422h.iterator();
        while (it.hasNext()) {
    ...
    public void m1939K(TdApi.Session session) {
        Iterator<AbstractC10925q1> it = this.f35432r.iterator();
        while (it.hasNext()) {
            it.next().mo2955X0(this.f35415a, session);
        }
    }

    public void m1938K0(TdApi.UpdateChatAvailableReactions updateChatAvailableReactions) {
        m1934L0(updateChatAvailableReactions, this.f35418d.iterator());
        m1934L0(updateChatAvailableReactions, this.f35437w.m21019d(Long.valueOf(updateChatAvailableReactions.chatId)));
    }
    ...
    public void m1926N0(long j, String str) {
        m1922O0(j, str, this.f35418d.iterator());
        m1922O0(j, str, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1925N1(TdApi.UpdateFile updateFile) {
        Iterator<AbstractC10985s0> d = this.f35439y.m21019d(Integer.valueOf(updateFile.file.f25373id));
        if (d != null) {
            while (d.hasNext()) {
    ...
    public void m1921O1(TdApi.UpdateFileAddedToDownloads updateFileAddedToDownloads) {
        Iterator<AbstractC10964r0> it = this.f35433s.iterator();
        while (it.hasNext()) {
    ...
    public void m1918P0(TdApi.UpdateChatDefaultDisableNotification updateChatDefaultDisableNotification) {
        Iterator<AbstractC10747j0> it = this.f35418d.iterator();
        while (it.hasNext()) {
        ...
        Iterator<AbstractC10747j0> d = this.f35437w.m21019d(Long.valueOf(updateChatDefaultDisableNotification.chatId));
        if (d != null) {
            while (d.hasNext()) {
    ...
    public void m1916P2(TdApi.UpdateUsersNearby updateUsersNearby) {
        m1912Q2(updateUsersNearby.usersNearby, this.f35429o.iterator());
    }

    public void m1915Q() {
        Iterator<AbstractC10816l0> it = this.f35426l.iterator();
        while (it.hasNext()) {
            it.next().mo1407c();
        }
    }
    ...
    public void m1914Q0(TdApi.UpdateChatMessageSender updateChatMessageSender) {
        ...
        Iterator<AbstractC10747j0> d = this.f35437w.m21019d(Long.valueOf(updateChatMessageSender.chatId));
        if (d != null) {
            while (d.hasNext()) {
    ...
    public void m1906S0(TdApi.UpdateChatDraftMessage updateChatDraftMessage, List<C10930q6.C10938h> list) {
        m1910R0(updateChatDraftMessage.chatId, updateChatDraftMessage.draftMessage, list, this.f35418d.iterator());
        long j = updateChatDraftMessage.chatId;
        m1910R0(j, updateChatDraftMessage.draftMessage, list, this.f35437w.m21019d(Long.valueOf(j)));
        if (list != null) {
            for (final C10930q6.C10938h hVar : list) {
                hVar.f35138a.m4306G(hVar.f35139b, hVar.f35140c);
                m1819q(hVar.f35138a, new AbstractC5918j() {
                    @Override
                    public final void mo1330a(Object obj) {
    ...
    public void m1902T1(TdApi.UpdateGroupCall updateGroupCall) {
        m1905S1(updateGroupCall.groupCall, this.f35431q.iterator());
    }

    public void m1901U(int i, AbstractC10985s0 s0Var) {
        this.f35439y.m21016g(Integer.valueOf(i), s0Var);
    }

    public void m1900U0(TdApi.UpdateChatHasProtectedContent updateChatHasProtectedContent) {
        m1897V0(updateChatHasProtectedContent, this.f35418d.iterator());
        m1897V0(updateChatHasProtectedContent, this.f35437w.m21019d(Long.valueOf(updateChatHasProtectedContent.chatId)));
    }

    public void m1898V(AbstractC11041ub ubVar) {
        this.f35427m.remove(ubVar);
    }

    public void m1896V1(TdApi.UpdateGroupCallParticipant updateGroupCallParticipant) {
        m1899U1(updateGroupCallParticipant.groupCallId, updateGroupCallParticipant.participant, this.f35431q.iterator());
    }

    public void m1895W(long j, AbstractC10839m1 m1Var) {
        this.f35440z.m21016g(Long.valueOf(j), m1Var);
    }

    public void m1894W0(TdApi.UpdateChatHasScheduledMessages updateChatHasScheduledMessages) {
        m1891X0(updateChatHasScheduledMessages, this.f35418d.iterator());
        m1891X0(updateChatHasScheduledMessages, this.f35437w.m21019d(Long.valueOf(updateChatHasScheduledMessages.chatId)));
    }
    ...
    public void m1892X(AbstractC10903p0 p0Var) {
        this.f35428n.remove(p0Var);
    }

    public void m1890X1(TdApi.UpdateMessageContent updateMessageContent) {
        Map<String, List<TdApi.Message>> map = this.f35414A;
        ...
        m1887Y1(updateMessageContent, this.f35416b.iterator());
        m1887Y1(updateMessageContent, this.f35435u.m21019d(Long.valueOf(updateMessageContent.chatId)));
    }
    ...
    public final void m1889Y(long j, TdApi.Message message) {
        ...
        if (!(remove == null || remove.isEmpty())) {
            Map<String, List<TdApi.Message>> map2 = this.f35414A;
            map2.put(message.chatId + "_" + message.f25406id, remove);
    ...
    public void m1886Z(AbstractC10551b bVar) {
        this.f35422h.add(bVar);
    }

    public void m1885Z0(TdApi.UpdateChatIsBlocked updateChatIsBlocked) {
        m1888Y0(updateChatIsBlocked.chatId, updateChatIsBlocked.isBlocked, this.f35418d.iterator());
        long j = updateChatIsBlocked.chatId;
        m1888Y0(j, updateChatIsBlocked.isBlocked, this.f35437w.m21019d(Long.valueOf(j)));
    }
    ...
    public void m1884Z1(TdApi.UpdateMessageContentOpened updateMessageContentOpened) {
        ...
        if (list != null) {
            for (TdApi.Message message : list) {
                C4779t2.m25497i5(message);
            }
        }
        m1880a2(updateMessageContentOpened, this.f35416b.iterator());
        m1880a2(updateMessageContentOpened, this.f35435u.m21019d(Long.valueOf(updateMessageContentOpened.chatId)));
    }

    public void m1882a0(Object obj) {
        synchronized (this) {
            if (obj instanceof AbstractC10748j1) {
                this.f35416b.add((AbstractC10748j1) obj);
            }
            if (obj instanceof AbstractC10701h1) {
                this.f35417c.add((AbstractC10701h1) obj);
            }
            if (obj instanceof AbstractC10747j0) {
                this.f35418d.add((AbstractC10747j0) obj);
            }
            if (obj instanceof AbstractC10817l1) {
                this.f35420f.add((AbstractC10817l1) obj);
            }
            if (obj instanceof AbstractC10986s1) {
                this.f35421g.add((AbstractC10986s1) obj);
            }
            if (obj instanceof AbstractC10551b) {
                this.f35422h.add((AbstractC10551b) obj);
            }
            if (obj instanceof AbstractC10861n0) {
                this.f35423i.add((AbstractC10861n0) obj);
            }
            if (obj instanceof AbstractC10924q0) {
                this.f35424j.add((AbstractC10924q0) obj);
            }
            if (obj instanceof AbstractC11041ub) {
                this.f35427m.add((AbstractC11041ub) obj);
            }
            if (obj instanceof AbstractC10903p0) {
                this.f35428n.add((AbstractC10903p0) obj);
            }
            if (obj instanceof AbstractC10790k0) {
                this.f35429o.add((AbstractC10790k0) obj);
            }
            if (obj instanceof AbstractC10524a) {
                this.f35434t.add((AbstractC10524a) obj);
            }
            if (obj instanceof AbstractC10883o1) {
                this.f35430p.add((AbstractC10883o1) obj);
            }
            if (obj instanceof AbstractC10574c0) {
                this.f35431q.add((AbstractC10574c0) obj);
            }
            if (obj instanceof AbstractC10925q1) {
                this.f35432r.add((AbstractC10925q1) obj);
            }
        }
    }

    public void m1878b0(AbstractC10524a aVar) {
        this.f35434t.add(aVar);
    }

    public void m1877b1(TdApi.UpdateChatIsMarkedAsUnread updateChatIsMarkedAsUnread) {
        m1881a1(updateChatIsMarkedAsUnread.chatId, updateChatIsMarkedAsUnread.isMarkedAsUnread, this.f35418d.iterator());
        long j = updateChatIsMarkedAsUnread.chatId;
        m1881a1(j, updateChatIsMarkedAsUnread.isMarkedAsUnread, this.f35437w.m21019d(Long.valueOf(j)));
    }
    ...
    public void m1876b2(TdApi.UpdateMessageEdited updateMessageEdited) {
        ...
        m1872c2(updateMessageEdited, this.f35416b.iterator());
        m1872c2(updateMessageEdited, this.f35435u.m21019d(Long.valueOf(updateMessageEdited.chatId)));
    }

    public void m1874c0(TdApi.ChatList chatList, AbstractC10700h0 h0Var) {
        this.f35419e.m21021b(C4779t2.m25456o4(chatList), h0Var);
    }

    public void m1870d0(long j, AbstractC10747j0 j0Var) {
        this.f35437w.m21021b(Long.valueOf(j), j0Var);
    }

    public void m1869d1(TdApi.UpdateChatLastMessage updateChatLastMessage, List<C10930q6.C10938h> list) {
        m1873c1(updateChatLastMessage.chatId, updateChatLastMessage.lastMessage, list, this.f35418d.iterator());
        long j = updateChatLastMessage.chatId;
        m1873c1(j, updateChatLastMessage.lastMessage, list, this.f35437w.m21019d(Long.valueOf(j)));
        if (list != null) {
            for (final C10930q6.C10938h hVar : list) {
                hVar.f35138a.m4306G(hVar.f35139b, hVar.f35140c);
                m1819q(hVar.f35138a, new AbstractC5918j() {
    ...
    public void m1868d2(TdApi.UpdateMessageInteractionInfo updateMessageInteractionInfo) {
        ...
        m1864e2(updateMessageInteractionInfo, this.f35416b.iterator());
        m1864e2(updateMessageInteractionInfo, this.f35435u.m21019d(Long.valueOf(updateMessageInteractionInfo.chatId)));
    }

    public void m1866e0(AbstractC10861n0 n0Var) {
        this.f35423i.add(n0Var);
    }
    ...
    public void m1862f0(long j, AbstractC10701h1 h1Var) {
        this.f35436v.m21021b(Long.valueOf(j), h1Var);
    }
    ...
    public void m1860f2(TdApi.UpdateMessageIsPinned updateMessageIsPinned) {
        ...
        m1856g2(updateMessageIsPinned, this.f35416b.iterator());
        m1856g2(updateMessageIsPinned, this.f35435u.m21019d(Long.valueOf(updateMessageIsPinned.chatId)));
    }

    public void m1858g0(long j, AbstractC10748j1 j1Var) {
        this.f35435u.m21021b(Long.valueOf(j), j1Var);
    }

    public void m1857g1(TdApi.UpdateChatMessageTtl updateChatMessageTtl) {
        m1861f1(updateChatMessageTtl.chatId, updateChatMessageTtl.messageTtl, this.f35418d.iterator());
        long j = updateChatMessageTtl.chatId;
        m1861f1(j, updateChatMessageTtl.messageTtl, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1854h0(AbstractC10883o1 o1Var) {
        this.f35430p.add(o1Var);
    }
    ...
    public void m1852h2(TdApi.UpdateMessageLiveLocationViewed updateMessageLiveLocationViewed) {
        m1848i2(updateMessageLiveLocationViewed, this.f35416b.iterator());
        m1848i2(updateMessageLiveLocationViewed, this.f35435u.m21019d(Long.valueOf(updateMessageLiveLocationViewed.chatId)));
    }

    public void m1850i0(AbstractC10925q1 q1Var) {
        this.f35432r.add(q1Var);
    }

    public void m1846j0(long j, AbstractC10817l1 l1Var) {
        this.f35438x.m21021b(Long.valueOf(j), l1Var);
    }

    public void m1845j1(TdApi.UpdateChatOnlineMemberCount updateChatOnlineMemberCount) {
        m1849i1(updateChatOnlineMemberCount.chatId, updateChatOnlineMemberCount.onlineMemberCount, this.f35418d.iterator());
        long j = updateChatOnlineMemberCount.chatId;
        m1849i1(j, updateChatOnlineMemberCount.onlineMemberCount, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1843k(AbstractC10573c cVar) {
        this.f35425k.add(cVar);
    }

    public void m1842k0(AbstractC10817l1 l1Var) {
        this.f35420f.add(l1Var);
    }
    ...
    public void m1840k2(TdApi.UpdateMessageMentionRead updateMessageMentionRead, boolean z, boolean z2) {
        ...
        m1844j2(updateMessageMentionRead, this.f35416b.iterator());
        m1844j2(updateMessageMentionRead, this.f35435u.m21019d(Long.valueOf(updateMessageMentionRead.chatId)));
        if (z) {
            m1965D1(updateMessageMentionRead.chatId, updateMessageMentionRead.unreadMentionCount, z2, this.f35418d.iterator());
            long j = updateMessageMentionRead.chatId;
            m1965D1(j, updateMessageMentionRead.unreadMentionCount, z2, this.f35437w.m21019d(Long.valueOf(j)));
        }
    }

    public void m1839l(AbstractC10816l0 l0Var) {
        this.f35426l.add(l0Var);
        if (!this.f35415a.m2848G6() || !this.f35415a.m2673R6()) {
            if (this.f35415a.m2219u7()) {
                l0Var.mo1407c();
            }
        } else if (this.f35415a.m2331n7()) {
            l0Var.mo1409b(false);
        }
    }

    public void m1838l0(AbstractC10986s1 s1Var) {
        this.f35421g.add(s1Var);
    }

    public void m1837l1(TdApi.UpdateChatPendingJoinRequests updateChatPendingJoinRequests) {
        m1841k1(updateChatPendingJoinRequests.chatId, updateChatPendingJoinRequests.pendingJoinRequests, this.f35418d.iterator());
        long j = updateChatPendingJoinRequests.chatId;
        m1841k1(j, updateChatPendingJoinRequests.pendingJoinRequests, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1836l2(long j, long j2) {
        m1832m2(j, j2, this.f35417c.iterator());
        m1832m2(j, j2, this.f35436v.m21019d(Long.valueOf(j)));
    }

    public void m1835m(int i, AbstractC10985s0 s0Var) {
        this.f35439y.m21021b(Integer.valueOf(i), s0Var);
    }

    public void m1834m0(TdApi.Message message) {
        String str = message.chatId + "_" + message.f25406id;
        List<TdApi.Message> list = this.f35414A.get(str);
        if (list == null) {
            list = new ArrayList<>();
            this.f35414A.put(str, list);
        }
        list.add(message);
    }

    public void m1831n(AbstractC11041ub ubVar) {
        this.f35427m.add(ubVar);
    }

    public void m1830n0(AbstractC10524a aVar) {
        this.f35434t.remove(aVar);
    }

    public void m1829n1(TdApi.UpdateChatPermissions updateChatPermissions) {
        m1833m1(updateChatPermissions.chatId, updateChatPermissions.permissions, this.f35418d.iterator());
        long j = updateChatPermissions.chatId;
        m1833m1(j, updateChatPermissions.permissions, this.f35437w.m21019d(Long.valueOf(j)));
    }

    public void m1828n2(TdApi.UpdateMessageSendAcknowledged updateMessageSendAcknowledged) {
        m1824o2(updateMessageSendAcknowledged, this.f35416b.iterator());
        m1824o2(updateMessageSendAcknowledged, this.f35435u.m21019d(Long.valueOf(updateMessageSendAcknowledged.chatId)));
    }

    public void m1827o(long j, AbstractC10839m1 m1Var) {
        this.f35440z.m21021b(Long.valueOf(j), m1Var);
    }

    public void m1826o0(Object obj) {
        synchronized (this) {
            if (obj instanceof AbstractC10748j1) {
                this.f35416b.remove((AbstractC10748j1) obj);
            }
            if (obj instanceof AbstractC10701h1) {
                this.f35417c.remove((AbstractC10701h1) obj);
            }
            if (obj instanceof AbstractC10747j0) {
                this.f35418d.remove((AbstractC10747j0) obj);
            }
            if (obj instanceof AbstractC10817l1) {
                this.f35420f.remove((AbstractC10817l1) obj);
            }
            if (obj instanceof AbstractC10986s1) {
                this.f35421g.remove((AbstractC10986s1) obj);
            }
            if (obj instanceof AbstractC10986s1) {
                this.f35422h.remove((AbstractC10551b) obj);
            }
            if (obj instanceof AbstractC10861n0) {
                this.f35423i.remove((AbstractC10861n0) obj);
            }
            if (obj instanceof AbstractC10924q0) {
                this.f35424j.remove((AbstractC10924q0) obj);
            }
            if (obj instanceof AbstractC11041ub) {
                this.f35427m.remove((AbstractC11041ub) obj);
            }
            if (obj instanceof AbstractC10903p0) {
                this.f35428n.remove((AbstractC10903p0) obj);
            }
            if (obj instanceof AbstractC10790k0) {
                this.f35429o.remove((AbstractC10790k0) obj);
            }
            if (obj instanceof AbstractC10524a) {
                this.f35434t.remove((AbstractC10524a) obj);
            }
            if (obj instanceof AbstractC10883o1) {
                this.f35430p.remove((AbstractC10883o1) obj);
            }
            if (obj instanceof AbstractC10574c0) {
                this.f35431q.remove((AbstractC10574c0) obj);
            }
            if (obj instanceof AbstractC10925q1) {
                this.f35432r.remove((AbstractC10925q1) obj);
            }
        }
    }

    public void m1825o1(TdApi.UpdateChatPhoto updateChatPhoto) {
        m1821p1(updateChatPhoto, this.f35418d.iterator());
        m1821p1(updateChatPhoto, this.f35437w.m21019d(Long.valueOf(updateChatPhoto.chatId)));
    }

    public void m1823p(AbstractC10903p0 p0Var) {
        this.f35428n.add(p0Var);
    }

    public void m1822p0(TdApi.ChatList chatList, AbstractC10700h0 h0Var) {
        this.f35419e.m21016g(C4779t2.m25456o4(chatList), h0Var);
    }
    ...
    public void m1820p2(TdApi.UpdateMessageSendFailed updateMessageSendFailed) {
        ...
        m1816q2(updateMessageSendFailed, this.f35416b.iterator());
        m1816q2(updateMessageSendFailed, this.f35435u.m21019d(Long.valueOf(updateMessageSendFailed.message.chatId)));
    }

    public final void m1819q(C10684g8 g8Var, AbstractC5918j<AbstractC10700h0> jVar) {
        Iterator<AbstractC10700h0> d = this.f35419e.m21019d(C4779t2.m25456o4(g8Var.m4290j()));
        if (d != null) {
            while (d.hasNext()) {
                jVar.mo1330a(d.next());
            }
    ...
    public void m1818q0(long j, AbstractC10747j0 j0Var) {
        this.f35437w.m21016g(Long.valueOf(j), j0Var);
    }

    public void m1814r0(AbstractC10861n0 n0Var) {
        this.f35423i.remove(n0Var);
    }

    public void m1813r1(TdApi.UpdateChatPosition updateChatPosition, C10930q6.C10938h hVar) {
        boolean b = hVar.f35140c.m2129b();
        boolean d = hVar.f35140c.m2127d();
        boolean c = hVar.f35140c.m2128c();
        m1817q1(updateChatPosition.chatId, updateChatPosition.position, b, d, c, this.f35418d.iterator());
        long j = updateChatPosition.chatId;
        m1817q1(j, updateChatPosition.position, b, d, c, this.f35437w.m21019d(Long.valueOf(j)));
        hVar.f35138a.m4306G(hVar.f35139b, hVar.f35140c);
    }
    ...
    public void m1812r2(TdApi.UpdateMessageSendSucceeded updateMessageSendSucceeded) {
        ...
        m1808s2(updateMessageSendSucceeded, this.f35416b.iterator());
        m1808s2(updateMessageSendSucceeded, this.f35435u.m21019d(Long.valueOf(updateMessageSendSucceeded.message.chatId)));
    }

    public void m1810s0(long j, AbstractC10701h1 h1Var) {
        this.f35436v.m21016g(Long.valueOf(j), h1Var);
    }

    public void m1806t0(long j, AbstractC10748j1 j1Var) {
        this.f35435u.m21016g(Long.valueOf(j), j1Var);
    }
    ...
    public void m1805t1(TdApi.UpdateChatReadInbox updateChatReadInbox, final boolean z, final TdApi.Chat chat, C10684g8[] g8VarArr) {
        m1809s1(updateChatReadInbox, z, this.f35418d.iterator());
        m1809s1(updateChatReadInbox, z, this.f35437w.m21019d(Long.valueOf(updateChatReadInbox.chatId)));
        if (g8VarArr != null) {
            for (final C10684g8 g8Var : g8VarArr) {
                m1819q(g8Var, new AbstractC5918j() {
                    @Override
    ...
    public void m1804t2(TdApi.UpdateMessageUnreadReactions updateMessageUnreadReactions) {
        ...
        m1800u2(updateMessageUnreadReactions, this.f35416b.iterator());
        m1800u2(updateMessageUnreadReactions, this.f35435u.m21019d(Long.valueOf(updateMessageUnreadReactions.chatId)));
    }

    public void m1802u0(AbstractC10883o1 o1Var) {
        this.f35430p.remove(o1Var);
    }

    public void m1801u1(TdApi.UpdateChatReadOutbox updateChatReadOutbox) {
        m1797v1(updateChatReadOutbox, this.f35418d.iterator());
        m1797v1(updateChatReadOutbox, this.f35437w.m21019d(Long.valueOf(updateChatReadOutbox.chatId)));
    }

    public void m1798v0(AbstractC10925q1 q1Var) {
        this.f35432r.remove(q1Var);
    }

    public void m1796v2(TdApi.UpdateDeleteMessages updateDeleteMessages) {
        m1792w2(updateDeleteMessages, this.f35416b.iterator());
        m1792w2(updateDeleteMessages, this.f35435u.m21019d(Long.valueOf(updateDeleteMessages.chatId)));
    }

    public void m1794w0(long j, AbstractC10817l1 l1Var) {
        this.f35438x.m21016g(Long.valueOf(j), l1Var);
    }
    ...
    public void m1790x0(AbstractC10817l1 l1Var) {
        this.f35420f.remove(l1Var);
    }

    public void m1789x1(TdApi.UpdateChatReplyMarkup updateChatReplyMarkup) {
        m1785y1(updateChatReplyMarkup, this.f35418d.iterator());
        m1785y1(updateChatReplyMarkup, this.f35437w.m21019d(Long.valueOf(updateChatReplyMarkup.chatId)));
    }

    public void m1786y0(AbstractC10986s1 s1Var) {
        this.f35421g.remove(s1Var);
    }

    public void m1784y2(TdApi.UpdateNewCallSignalingData updateNewCallSignalingData) {
        m1788x2(updateNewCallSignalingData.callId, updateNewCallSignalingData.data, this.f35431q.iterator());
    }
    ...
    public void m1782z0(TdApi.Message message) {
        ...
        if (list != null && list.remove(message) && list.isEmpty()) {
            this.f35414A.remove(str);
        }
    }

    public void m1780z2(TdApi.UpdateNewMessage updateNewMessage) {
        m1976A2(updateNewMessage, this.f35416b.iterator());
        m1976A2(updateNewMessage, this.f35435u.m21019d(Long.valueOf(updateNewMessage.message.chatId)));
    }
}
