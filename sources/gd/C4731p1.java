...
public class C4731p1 {
    public static TdApi.SponsoredMessage m26309a(C10930q6 q6Var) {
        return m26308b(q6Var);
    }

    public static TdApi.SponsoredMessage m26308b(C10930q6 q6Var) {
    ...
    public static TdApi.Message m26307c(long j, int i, TdApi.SponsoredMessage sponsoredMessage, C10930q6 q6Var) {
        ...
        message.authorSignature = C4403w.m27869i1(R.string.SponsoredSign);
        message.f25406id = sponsoredMessage.messageId;
        message.date = i;
    ...
    public static AbstractC4761s4 m26306d(C9678w2 w2Var, long j, int i, TdApi.SponsoredMessage sponsoredMessage) {
        return new C4656h6(w2Var, m26307c(j, i, sponsoredMessage, w2Var.m7645r0().mo4348c()), sponsoredMessage);
    }
}
