...
public class C4699m1 extends AbstractC4576a1 {
    ...
    public class C4700a implements C4336c.AbstractC4337a {
        ...
        public boolean mo7418n0(View view, float f, float f2) {
            return f2 >= 0.0f && f2 < ((float) C4699m1.this.m27278o());
        }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockTitle pageBlockTitle, boolean z, boolean z2, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26464B0(new TdApi.RichTextBold(pageBlockTitle.title), m26433u0(), C5428t.AbstractC5435c.f17867x, qVar);
        if (z2) {
            f = 10.0f;
        } else if (z) {
            f = 20.0f;
    ...
    public static String m26451d0(C10930q6 q6Var, int i) {
        ...
        if (i2 != 0 || i3 != 0 || i4 != 0) {
            ...
            return C4403w.m27905a1(millis, timeUnit2, q6Var.m2898D4(), timeUnit2, false, 0);
        } else if (C5067f.m24107m(millis, timeUnit)) {
            return C4403w.m27869i1(R.string.Today);
        } else {
            if (C5067f.m24104p(millis, timeUnit)) {
                return C4403w.m27869i1(R.string.Yesterday);
            }
            return C4403w.m27846o0(millis, TimeUnit.MILLISECONDS);
        }
    }

    public static C5457w0 m26450e0() {
        if (f15766r0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15766r0 = w0Var;
            w0Var.m22655m(14.0f);
        }
        return f15766r0;
    ...
    public static C5457w0 m26449f0() {
        if (f15773y0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15773y0 = w0Var;
            w0Var.m22655m(16.0f);
    ...
    public static C5457w0 m26448g0() {
        if (f15762A0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15762A0 = w0Var;
            w0Var.m22655m(14.0f);
    ...
    public static C5457w0 m26447h0() {
        if (f15763B0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15763B0 = w0Var;
            w0Var.m22655m(12.0f);
    ...
    public static C5457w0 m26446i0() {
        if (f15767s0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15767s0 = w0Var;
            w0Var.m22655m(14.0f);
    ...
    public static C5457w0 m26445j0() {
        if (f15769u0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15769u0 = w0Var;
            w0Var.m22655m(21.0f);
    ...
    public static C5457w0 m26444k0() {
        if (f15772x0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15772x0 = w0Var;
            w0Var.m22655m(16.0f);
    ...
    public static C5457w0 m26443l0() {
        if (f15768t0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15768t0 = w0Var;
            w0Var.m22655m(16.0f);
    ...
    public static C5457w0 m26442m0() {
        if (f15771w0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15771w0 = w0Var;
            w0Var.m22655m(14.0f);
    ...
    public static C5457w0 m26440n0() {
        if (f15774z0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15774z0 = w0Var;
            w0Var.m22655m(19.0f);
    ...
    public static C5457w0 m26439o0() {
        if (f15770v0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15770v0 = w0Var;
            w0Var.m22655m(19.0f);
    ...
    public static C5457w0 m26438p0() {
        if (f15765q0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15765q0 = w0Var;
            w0Var.m22655m(21.0f);
    ...
    public static C5457w0 m26433u0() {
        if (f15764p0 == null) {
            C5457w0 w0Var = new C5457w0(C1389o.m37245x());
            f15764p0 = w0Var;
            w0Var.m22655m(24.0f);
    ...
    public void m26432v0(int i, float f, float f2, C3950k kVar) {
        this.f15038c.invalidate();
    }

    public void m26431w0(TdApi.Chat chat, long j, HandlerC10770jj.C10788q qVar, TdApi.SupergroupFullInfo supergroupFullInfo) {
        if (supergroupFullInfo.memberCount > 1) {
            m26463C0(chat, j, qVar);
        }
    }

    public void m26430x0(AbstractC9323v4 v4Var, final long j, final HandlerC10770jj.C10788q qVar, TdApi.Object object) {
        if (object.getConstructor() == -1601123095) {
            final TdApi.Chat chat = (TdApi.Chat) object;
            if (!C7316a.m17049l(chat.f25367id)) {
                if (v4Var.mo4348c().m2303p3(chat.f25367id) > 1 || v4Var.mo4348c().m2816I6(chat)) {
                    m26463C0(chat, j, qVar);
                } else if (chat.type.getConstructor() == -1472570774) {
                    v4Var.mo4348c().m2480e2().m1627k2(C7316a.m17045p(chat.f25367id), new AbstractC5918j() {
                        @Override
                        public final void mo1330a(Object obj) {
                            C4699m1.this.m26431w0(chat, j, qVar, (TdApi.SupergroupFullInfo) obj);
                        }
                    });
                }
            }
    ...
    public void m26429y0(int i, float f, float f2, C3950k kVar) {
        this.f15038c.invalidate();
    }

    public void m26428z0(TdApi.Chat chat, HandlerC10770jj.C10788q qVar, long j) {
        int o = m27278o() - (C1357a0.m37541i(8.0f) * 2);
        this.f15785g0 = this.f15036a.mo4348c().m2526b3(chat.f25367id);
        int i = 0;
        this.f15786h0 = this.f15036a.mo4348c().m2947A3(chat, false, C1357a0.m37529u(o / 2.0f), null);
        mo13519a();
        CharSequence n = this.f15036a.mo4348c().m2166xc().m3295n(chat);
        C5459x0 E = new C5459x0(n.toString(), m26447h0(), this.f15792n0.m22615w(), AbstractC5411l0.m22790E(this.f15036a.mo4348c(), n.toString(), C4779t2.m25392x5(n, false), qVar)).m22639E(1);
        this.f15793o0 = E;
        int w = (m27275w() - m26436r0()) - m26435s0();
        if (this.f15777Y) {
            i = C1357a0.m37541i(12.0f);
        }
        E.m22642B((w - i) - o);
        if (!this.f15038c.mo28225g() || !this.f15036a.m9353Ra() || SystemClock.uptimeMillis() - j <= 50) {
            this.f15038c.invalidate();
            return;
        }
        C3940f fVar = new C3940f(0, new C3950k.AbstractC3952b() {
            ...
            public final void mo45P5(int i2, float f, float f2, C3950k kVar) {
                C4699m1.this.m26429y0(i2, f, f2, kVar);
            }

            @Override
            public void mo35Y0(int i2, float f, C3950k kVar) {
                C3953l.m29526a(this, i2, f, kVar);
            }
        }, C2057b.f7280b, 180L);
        this.f15784f0 = fVar;
        fVar.m29575p(true, true);
    }

    public final void m26465A0(TdApi.RichText richText, C5457w0 w0Var, AbstractC5408k kVar, int i, HandlerC10770jj.C10788q qVar) {
        AbstractC9323v4<?> v4Var = this.f15036a;
        C5459x0 z = C5459x0.m22612z(v4Var, v4Var instanceof RunnableC5390g.AbstractC5393c ? (RunnableC5390g.AbstractC5393c) v4Var : null, richText, w0Var, kVar, qVar);
        this.f15792n0 = z;
        z.m22636H(this.f15038c);
        if (i != 0) {
            this.f15792n0.m22635a(i);
        }
    }

    public final void m26464B0(TdApi.RichText richText, C5457w0 w0Var, AbstractC5408k kVar, HandlerC10770jj.C10788q qVar) {
        m26465A0(richText, w0Var, kVar, 0, qVar);
    }
    ...
    public boolean mo26325C(View view, MotionEvent motionEvent) {
        ...
        return (cVar != null && cVar.m28246e(view, motionEvent)) || ((x0Var = this.f15792n0) != null && x0Var.m22614x(view, motionEvent));
    }

    public final void m26463C0(final TdApi.Chat chat, final long j, final HandlerC10770jj.C10788q qVar) {
        TdApi.ChatMemberStatus K3 = this.f15036a.mo4348c().m2787K3(chat.f25367id);
        if (K3 != null) {
            C4779t2.m25506h3(K3);
        }
        this.f15036a.m9135wd(new Runnable() {
            ...
            public final void run() {
                C4699m1.this.m26428z0(chat, qVar, j);
            }
        });
    }
    ...
    public boolean mo26462D(String str) {
        ...
        if (!(x0Var == null || (m = x0Var.m22625m()) == null)) {
    ...
    public boolean m26461D0() {
        return this.f15782d0.m29573r(true);
    }
    ...
    public void mo26324R(C6238b bVar) {
        ...
        if (this.f15785g0 != null) {
            bVar.m20992k(2147483647L).m20819G(this.f15785g0);
        }
    }

    @Override
    public void mo26458S(C6257p pVar) {
        pVar.m20819G(this.f15789k0);
    }

    @Override
    public void mo26457T(C6240c cVar) {
        C6246h hVar = this.f15789k0;
        if (hVar == null || !C4779t2.m25598T2(hVar.m20910k())) {
            cVar.m20977j(this.f15787i0, this.f15788j0);
        } else {
            cVar.clear();
        }
    }
    ...
    public int mo26323f(View view, int i) {
        ...
        int r0 = (i - m26436r0()) - m26435s0();
        if (this.f15777Y) {
            i2 = C1357a0.m37541i(12.0f);
        }
        int i3 = r0 - i2;
        RunnableC5390g B = this.f15792n0.m22642B(i3);
        C5459x0 x0Var = this.f15793o0;
        if (x0Var != null) {
            x0Var.m22642B(i3);
        }
        this.f15776X = B.m22890z0();
        return this.f15792n0.getHeight() + mo26320q() + m26437q0();
    }
    ...
    public void mo26322i(View view, Canvas canvas, AbstractC6264v vVar, AbstractC6264v vVar2, C6238b bVar) {
        ...
        if (this.f15792n0 != null) {
            ...
            if (this.f15783e0 && this.f15775W != 0) {
                canvas.drawRect(0.0f, 0.0f, measuredWidth, m27278o(), C1410y.m37039g(C11524j.m228N(this.f15775W)));
            }
            if (this.f15790l0) {
                int i5 = C1357a0.m37541i(40.0f);
                int i6 = (r0 - i5) - C1357a0.m37541i(14.0f);
                int i7 = q - C1357a0.m37541i(4.0f);
                if (this.f15788j0 != null) {
                    if (vVar2.mo20246c0()) {
                        if (vVar.mo20246c0()) {
                            canvas.drawCircle(i6 + i4, i7 + i4, i5 / 2, C1410y.m37039g(C11524j.m241G0()));
                        }
                        vVar.mo20256K0(i6, i7, i6 + i5, i7 + i5);
                        vVar.draw(canvas);
                    }
                    vVar2.mo20256K0(i6, i7, i6 + i5, i5 + i7);
                    vVar2.draw(canvas);
                } else {
                    canvas.drawCircle(i6 + i3, i7 + i3, i5 / 2, C1410y.m37039g(C11524j.m228N(this.f15791m0)));
                }
            }
            if (this.f15777Y) {
                int N = C11524j.m228N(R.id.theme_color_iv_blockQuoteLine);
                RectF a0 = C1410y.m37050a0();
                int i8 = C1357a0.m37541i(3.0f);
                int i9 = C1357a0.m37541i(8.0f) / 2;
                a0.top = q - i9;
                ...
                if (this.f15027N) {
                    canvas.drawRect(a0.left, 0.0f, a0.right, i8 + a0.top, C1410y.m37039g(N));
                }
                if (this.f15026M) {
                    canvas.drawRect(a0.left, a0.bottom - i8, a0.right, view.getMeasuredHeight(), C1410y.m37039g(N));
                }
            }
            if (!this.f15777Y) {
                i = measuredWidth - r0;
            } else if (this.f15776X) {
                i = (measuredWidth - r0) - C1357a0.m37541i(12.0f);
            } else {
                i = C1357a0.m37541i(12.0f) + r0 + this.f15792n0.getWidth();
            }
            int i10 = i;
            if (this.f15777Y) {
                r0 += C1357a0.m37541i(12.0f);
            }
            if (this.f15782d0 != null) {
                C1359b.m37512g(canvas, r0 - C1357a0.m37541i(18.0f), this.f15792n0.m22621q() + q, C11524j.m228N(R.id.theme_color_iv_icon), this.f15782d0.m29584g(), 0.0f);
                canvas.drawRect(0.0f, view.getMeasuredHeight() - C1357a0.m37526x(), measuredWidth, view.getMeasuredHeight(), C1410y.m37039g(C11524j.m228N(R.id.theme_color_iv_separator)));
            }
            if (this.f15793o0 != null) {
                C3940f fVar = this.f15784f0;
                float g = fVar != null ? fVar.m29584g() : 1.0f;
                ...
                float f4 = i12;
                float f5 = o2;
                canvas.drawCircle(f4, f5, f3, C1410y.m37039g(C5064d.m24131a(g, C11524j.m241G0())));
                if (this.f15785g0 == null || bVar == null) {
                    C4587b bVar2 = this.f15786h0;
                    if (bVar2 != null) {
                        bVar2.m27214b(canvas, f4, f5, g);
                    }
                } else {
                    C6257p k = bVar.m20992k(2147483647L);
                    int i13 = o / 2;
                    k.mo20256K0(i12 - i13, o2 - i13, i12 + i13, o2 + i13);
                    k.mo20259D0(i13);
                    k.mo20250U(k.mo20252R0() * g);
                    k.draw(canvas);
                    k.mo20253P();
                }
                if (this.f15783e0) {
            ...
            this.f15792n0.m22629i(canvas, r0, i10, 0, q, null, 1.0f, bVar);
            C5459x0 x0Var = this.f15793o0;
            if (x0Var != null) {
                int height = q + this.f15792n0.getHeight();
                C3940f fVar2 = this.f15784f0;
                x0Var.m22630h(canvas, r0, i10, 0, height, null, fVar2 != null ? fVar2.m29584g() * 0.8f : 0.8f);
            }
        }
    }
    ...
    public int mo26441n(String str, int i) {
        int F;
        C5459x0 x0Var = this.f15792n0;
        RunnableC5390g k = x0Var != null ? x0Var.m22627k(i) : null;
        if (k == null || (F = k.m22998F(str)) <= 0) {
            return 0;
        }
        return mo26320q() + (k.m22960Y() * F);
    }
    ...
    public final int m26437q0() {
        return C1357a0.m37541i(this.f15781c0);
    }

    public final int m26436r0() {
        int i = 0;
        int max = Math.max(m27274x(true), (this.f15031R || this.f15032S == null) ? C1357a0.m37541i(this.f15778Z) : 0) + (this.f15790l0 ? C1357a0.m37541i(40.0f) + C1357a0.m37541i(14.0f) : 0);
        if (this.f15782d0 != null) {
    ...
    public final int m26435s0() {
        return Math.max(m27274x(false), C1357a0.m37541i(this.f15778Z));
    }

    public final int m26434t0() {
        return C1357a0.m37541i(this.f15780b0);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockSubtitle pageBlockSubtitle, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15781c0 = 6.0f;
        this.f15780b0 = 0.0f;
        m26464B0(pageBlockSubtitle.subtitle, m26438p0(), C5428t.AbstractC5435c.f17868y, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockHeader pageBlockHeader, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26465A0(new TdApi.RichTextBold(pageBlockHeader.header), m26445j0(), C5428t.AbstractC5435c.f17869z, 32, qVar);
        this.f15780b0 = 14.0f;
        this.f15781c0 = 8.0f;
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockSubheader pageBlockSubheader, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26465A0(new TdApi.RichTextBold(pageBlockSubheader.subheader), m26439o0(), C5428t.AbstractC5435c.f17858A, 32, qVar);
        this.f15780b0 = 8.0f;
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockKicker pageBlockKicker, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 16.0f;
        this.f15781c0 = 3.0f;
        m26465A0(new TdApi.RichTextBold(pageBlockKicker.kicker), m26448g0(), C5428t.AbstractC5435c.f17864u, 32, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockAuthorDate pageBlockAuthorDate, int i, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        String trim = C4779t2.m25507h2(pageBlockAuthorDate.author).trim();
        this.f15781c0 = 8.0f;
        this.f15780b0 = 8.0f;
        if (!trim.isEmpty() || pageBlockAuthorDate.publishDate != 0) {
            ...
            if (pageBlockAuthorDate.publishDate != 0) {
                if (!arrayList.isEmpty()) {
                    arrayList.add(new TdApi.RichTextPlain(C4403w.m27869i1(R.string.format_ivAuthorDateSeparator)));
                }
                arrayList.add(new TdApi.RichTextPlain(m26451d0(v4Var.mo4348c(), pageBlockAuthorDate.publishDate)));
            }
            if (i != 0) {
                if (!arrayList.isEmpty()) {
                    arrayList.add(new TdApi.RichTextPlain(C4403w.m27869i1(R.string.format_ivAuthorDateSeparator)));
                }
                arrayList.add(new TdApi.RichTextPlain(C4403w.m27844o2(R.string.xViews, i)));
            }
            m26464B0(arrayList.size() == 1 ? (TdApi.RichText) arrayList.get(0) : new TdApi.RichTexts((TdApi.RichText[]) arrayList.toArray(new TdApi.RichText[0])), m26450e0(), C5428t.AbstractC5435c.f17859B, qVar);
        }
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockParagraph pageBlockParagraph, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26465A0(pageBlockParagraph.text, m26443l0(), C5428t.AbstractC5435c.f17860q, 32, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockPreformatted pageBlockPreformatted, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26465A0(pageBlockPreformatted.text, m26442m0(), C5428t.AbstractC5435c.f17860q, 32, qVar);
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockRelatedArticles pageBlockRelatedArticles, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26464B0(new TdApi.RichTextBold(pageBlockRelatedArticles.header), m26443l0(), C5428t.AbstractC5435c.f17864u, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockTable pageBlockTable, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 15.0f;
        this.f15781c0 = 2.0f;
        m26465A0(pageBlockTable.caption, m26448g0(), C5428t.AbstractC5435c.f17864u, 34, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockDetails pageBlockDetails, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15782d0 = new C3940f(0, new C3950k.AbstractC3952b() {
            ...
            public final void mo45P5(int i, float f, float f2, C3950k kVar) {
                C4699m1.this.m26432v0(i, f, f2, kVar);
            }
        ...
        this.f15780b0 = 15.0f;
        this.f15781c0 = 12.0f;
        m26465A0(pageBlockDetails.header, m26443l0(), C5428t.AbstractC5435c.f17860q, 32, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockList pageBlockList, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26464B0(new TdApi.RichTextPlain(""), m26443l0(), C5428t.AbstractC5435c.f17860q, qVar);
    }
    ...
    public C4699m1(final AbstractC9323v4<?> v4Var, TdApi.PageBlockChatLink pageBlockChatLink, boolean z, int i, final HandlerC10770jj.C10788q qVar) {
        ...
        this.f15781c0 = 16.0f;
        this.f15780b0 = 16.0f;
        m26464B0(new TdApi.RichTextBold(new TdApi.RichTextPlain(pageBlockChatLink.title)), m26443l0(), z ? C5428t.AbstractC5435c.f17861r : C5428t.AbstractC5435c.f17860q, qVar);
        this.f15783e0 = z;
        ...
        if (this.f15037b.getConstructor() == -202091253) {
            ...
            v4Var.mo4348c().m2270r4().m14783o(new TdApi.SearchPublicChat(((TdApi.PageBlockChatLink) this.f15037b).username), new Client.AbstractC7865g() {
                ...
                public final void mo255t2(TdApi.Object object) {
                    C4699m1.this.m26430x0(v4Var, uptimeMillis, qVar, object);
                }
            });
        }
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockFooter pageBlockFooter, boolean z, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26464B0(pageBlockFooter.footer, m26446i0(), C5428t.AbstractC5435c.f17863t, qVar);
        if (!z) {
            this.f15775W = 0;
        } else {
            this.f15780b0 = 3.0f;
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockBlockQuote pageBlockBlockQuote, boolean z, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15781c0 = 6.0f;
        if (z) {
            m26465A0(pageBlockBlockQuote.credit, m26448g0(), C5428t.AbstractC5435c.f17864u, 32, qVar);
            ...
            m26465A0(pageBlockBlockQuote.text, m26449f0(), C5428t.AbstractC5435c.f17866w, 32, qVar);
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockPullQuote pageBlockPullQuote, boolean z, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15781c0 = 6.0f;
        if (z) {
            m26465A0(pageBlockPullQuote.credit, m26448g0(), C5428t.AbstractC5435c.f17864u, 34, qVar);
            this.f15780b0 = 3.0f;
        } else {
            m26465A0(pageBlockPullQuote.text, m26440n0(), C5428t.AbstractC5435c.f17865v, 34, qVar);
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlock pageBlock, TdApi.PageBlockCaption pageBlockCaption, boolean z, boolean z2, HandlerC10770jj.C10788q qVar) {
        ...
        if (z) {
            ...
            m26465A0(pageBlockCaption.credit, m26447h0(), C5428t.AbstractC5435c.f17864u, 32, qVar);
        ...
        this.f15780b0 = 10.0f;
        m26465A0(pageBlockCaption.text, m26448g0(), C5428t.AbstractC5435c.f17864u, 32, qVar);
    }
    ...
    public C4699m1(AbstractC9323v4<?> v4Var, TdApi.PageBlockEmbeddedPost pageBlockEmbeddedPost, HandlerC10770jj.C10788q qVar) {
        ...
        this.f15780b0 = 6.0f;
        this.f15781c0 = 6.0f;
        m26465A0(new TdApi.RichTexts(new TdApi.RichText[]{new TdApi.RichTextPlain(pageBlockEmbeddedPost.author), new TdApi.RichTextPlain("\n"), new TdApi.RichTextPlain(m26451d0(v4Var.mo4348c(), pageBlockEmbeddedPost.date))}), m26446i0(), C5428t.AbstractC5435c.f17859B, 32, qVar);
        this.f15790l0 = true;
        ...
        if (H0 != null) {
            ...
            TdApi.PhotoSize s0 = C4779t2.m25432s0(pageBlockEmbeddedPost.authorPhoto, H0);
            if (s0 != null) {
                C6246h hVar2 = new C6246h(v4Var.mo4348c(), s0.photo);
                this.f15789k0 = hVar2;
                hVar2.mo20767t0(C9903a.getDefaultAvatarCacheSize());
                this.f15789k0.m20909k0();
                return;
            }
            this.f15788j0.m20909k0();
            return;
        }
        this.f15791m0 = C4779t2.m25681H0(pageBlockEmbeddedPost.author.hashCode(), 0L);
    }
}
