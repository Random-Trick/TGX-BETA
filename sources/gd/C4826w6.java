    ...
    public static class C4827a implements Comparable<C4827a> {
        ...
        public C4827a(C10930q6 q6Var, long j) {
            ...
            if (U2 != null) {
                ...
                if (g7 || (chatPhotoInfo = U2.photo) == null || C4779t2.m25604S2(chatPhotoInfo.small)) {
                    this.f16452O = null;
        ...
        public C6246h m25140c() {
            return this.f16452O;
        }

        public C4587b.C4588a m25139d() {
            return this.f16453P;
        }

        public SparseIntArray m25138e() {
            return this.f16457T;
        }
        ...
        public String m25132k() {
            return this.f16461c;
        }

        public boolean m25131l() {
            return this.f16454Q == 0;
        }

        public boolean m25130m() {
            return this.f16450M;
        }

        public boolean m25129n() {
            return this.f16451N;
        }

        public void m25128o(TdApi.StorageStatisticsByFileType storageStatisticsByFileType, int i) {
            if (this.f16460b == 0 || !C4826w6.m25146h(i)) {
                this.f16454Q += storageStatisticsByFileType.size;
                this.f16455R += storageStatisticsByFileType.count;
                int d = this.f16456S.m23235d(i);
                if (d >= 0) {
                    long i2 = this.f16456S.m23230i(d);
                    int valueAt = this.f16457T.valueAt(d);
                    this.f16456S.m23232g(d, i2 + storageStatisticsByFileType.size);
                    this.f16457T.put(i, valueAt + storageStatisticsByFileType.count);
                    return;
                }
                this.f16456S.m23233f(i, storageStatisticsByFileType.size);
                this.f16457T.put(i, storageStatisticsByFileType.count);
            }
        }

        public void m25127p(long[] jArr) {
            this.f16458U = jArr;
        }
    }
    ...
    public C4826w6(C10930q6 q6Var, TdApi.StorageStatistics storageStatistics) {
        ...
        for (TdApi.StorageStatisticsByChat storageStatisticsByChat : storageStatistics.byChat) {
            for (TdApi.StorageStatisticsByFileType storageStatisticsByFileType : storageStatisticsByChat.byFileType) {
                ...
                m25143k(storageStatisticsByFileType, i, storageStatisticsByChat.chatId);
            }
        }
        int p = this.f16444b.m21496p();
        C5322e eVar = new C5322e(p);
        this.f16449g = new ArrayList<>(p);
        for (int i2 = 0; i2 < p; i2++) {
            C4827a q = this.f16444b.m21495q(i2);
            if (!q.m25131l()) {
                this.f16449g.add(q);
                eVar.m23275a(q.m25136g());
            }
        }
        Collections.sort(this.f16449g);
        this.f16447e.m25127p(eVar.m23269g());
    }

    public static boolean m25146h(int i) {
        return i == 10 || i == 11 || i == 9 || i == 8 || i == 12 || i == 13;
    }

    public static boolean m25144j(int i) {
        return i == 10 || i == 9 || i == 8 || i == 12;
    }

    public ArrayList<C4827a> m25152b() {
        return this.f16449g;
    }

    public long m25151c() {
        return this.f16445c.m25135h();
    }

    public String m25150d() {
        return C1363c0.m37423m(this.f16446d.f16454Q);
    }

    public C4827a m25149e() {
        return this.f16447e;
    }

    public C4827a m25148f() {
        return this.f16448f;
    }

    public C4827a m25147g() {
        return this.f16446d;
    }

    public boolean m25145i() {
        return this.f16446d.m25131l();
    }

    public final void m25143k(TdApi.StorageStatisticsByFileType storageStatisticsByFileType, int i, long j) {
        C4827a aVar;
        this.f16446d.m25128o(storageStatisticsByFileType, i);
        if (j != 0 && !m25146h(i)) {
            aVar = this.f16444b.m21505f(j);
            if (aVar == null) {
                aVar = new C4827a(this.f16443a, j);
                this.f16444b.m21500k(j, aVar);
            }
        } else if (i == 13) {
            aVar = this.f16445c;
        } else if (m25146h(i)) {
        ...
        aVar.m25128o(storageStatisticsByFileType, i);
    }
}
