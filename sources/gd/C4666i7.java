...
public class C4666i7 implements C6883g1.AbstractC6886c, C4630f0.AbstractC4631a, C4602c4.AbstractC4606b, Client.AbstractC7865g {
    ...
    public class C4667a implements C4336c.AbstractC4337a {
        ...
        public void mo7428C(View view, float f, float f2) {
            if (C4666i7.this.f15601R.sticker != null && C4666i7.this.f15601R.sticker.setId != 0) {
                C4666i7.this.f15600Q.mo4348c().m2485dd().m3777M8(C4666i7.this.f15600Q.m26097P0(), C4666i7.this.f15601R.sticker.setId);
            }
        }
        ...
        public boolean mo7418n0(View view, float f, float f2) {
            ...
            AbstractC6264v gifReceiver = C4666i7.this.m26571W() ? h1Var.getGifReceiver() : h1Var.getPreviewReceiver();
            return (gifReceiver == null || !gifReceiver.mo20240k1(f, f2, 0, 0) || (C4666i7.this.f15624l0 == null && C4666i7.this.f15622j0 == null) || C4666i7.this.f15601R.sticker == null || C4666i7.this.f15601R.sticker.setId == 0) ? false : true;
        }
    ...
    public class C4668b implements Client.AbstractC7865g {
        ...
        public static void m26526e(int i, C4602c4.C4603a aVar, View view) {
            if (i == aVar.m26968P()) {
                aVar.m26910x0();
                aVar.m26977K0(view, R.string.InstantViewUnsupported);
            }
        }

        public static void m26525f(int i, C4602c4.C4603a aVar, View view, boolean[] zArr, TdApi.WebPageInstantView webPageInstantView) {
            StringBuilder sb2;
            String str;
            if (i == aVar.m26968P()) {
                aVar.m26910x0();
                ...
                aVar.m26975L0(view, sb3.toString());
            }
        }

        public void m26524g(int i, C4602c4.C4603a aVar, TdApi.WebPage webPage, TdApi.WebPageInstantView webPageInstantView, String str, View view) {
            if (i == aVar.m26968P()) {
                aVar.m26910x0();
                View$OnClickListenerC3147u9 u9Var = new View$OnClickListenerC3147u9(C4666i7.this.f15600Q.m26097P0().mo4347s(), C4666i7.this.f15600Q.mo4348c());
                ...
                try {
                    ...
                    aVar.m26977K0(view, R.string.InstantViewError);
                    u9Var.mo417Z8();
                }
            }
        }

        public static void m26523h(int i, C4602c4.C4603a aVar, View view, TdApi.Object object) {
            if (i == aVar.m26968P()) {
                aVar.m26910x0();
                aVar.m26975L0(view, C4779t2.m25379z5(object));
            }
        }
            ...
            if (constructor == -1679978726) {
                ...
                dd.post(new Runnable() {
                    ...
                    public final void run() {
                        C4666i7.C4668b.m26523h(i, aVar, view, object);
                    }
                });
                ...
                if (!C4779t2.m25389y2(webPageInstantView.version)) {
                    ...
                    dd3.post(new Runnable() {
                        @Override
                        public final void run() {
                            C4666i7.C4668b.m26526e(i2, aVar3, view2);
                        }
                    });
                    return;
                }
                ...
                if (pageBlockArr == null || pageBlockArr.length == 0) {
                    ...
                    dd4.post(new Runnable() {
                        @Override
                        public final void run() {
                            C4666i7.C4668b.m26525f(i3, aVar4, view3, zArr2, webPageInstantView);
                        }
                    });
                    return;
                }
                ...
                dd5.post(new Runnable() {
                    @Override
                    public final void run() {
                        C4666i7.C4668b.this.m26524g(i4, aVar5, webPage, webPageInstantView, str, view4);
                    }
                });
            }
        }
    ...
    public C4666i7(C4656h6 h6Var, TdApi.WebPage webPage, String str) {
        ...
        this.f15602S = str;
        this.f15598O = h6Var.m26146K2();
        this.f15599P = h6Var.m26116N3();
    }

    public static void m26581M() {
        f15591v0 = C1357a0.m37544i(2.0f);
        f15592w0 = C1357a0.m37544i(12.0f);
        f15593x0 = C1357a0.m37544i(60.0f);
        f15594y0 = C1357a0.m37544i(23.0f);
        f15582A0 = C1357a0.m37544i(3.0f);
        f15595z0 = C1357a0.m37544i(10.0f);
        f15583B0 = C1357a0.m37544i(8.0f);
        f15584C0 = C1357a0.m37544i(6.0f);
        f15585D0 = C1357a0.m37544i(5.0f);
        f15586E0 = C1357a0.m37544i(20.0f);
        f15587F0 = C1357a0.m37544i(14.5f);
        f15588G0 = C1357a0.m37544i(1.0f);
    }

    public static boolean m26578P(int i) {
        if (i == 2 || i == 5) {
            return true;
        }
        switch (i) {
    ...
    public static boolean m26577Q(int i) {
        switch (i) {
            case 10:
            case 11:
            case 12:
    ...
    public int m26575S(int i, int i2, int i3, int i4, int i5, int i6) {
        int i7 = i4 + i;
        int i8 = i6 + i7;
    ...
    public int m26574T(int i, int i2, int i3, int i4, int i5, int i6) {
        int i7 = i4 + i;
        int i8 = i6 + i7;
        int i9 = this.f15613b0;
        return (i8 < i9 || i7 >= i9 + f15593x0) ? i5 : i2;
    ...
    public int m26573U(int i, int i2, int i3, int i4, int i5, int i6) {
        int i7 = i4 + i;
        int i8 = i6 + i7;
        int i9 = this.f15613b0;
        return (i8 < i9 || i7 >= i9 + f15593x0) ? i5 : i2;
    ...
    public static boolean m26570X(TdApi.WebPage webPage) {
        if (webPage == null || !C4779t2.m25382z2(webPage)) {
            return false;
        }
        TdApi.Photo photo = webPage.photo;
        if (photo == null || C4779t2.m25423t3(photo)) {
    ...
    public static void m26555h0() {
        f15595z0 = 0;
    }

    public int m26593A(boolean z) {
        AbstractC4597c cVar = this.f15603T;
        if (cVar != null) {
            return cVar.mo25245d(0);
        }
        return 0;
    }

    public ArrayList<C8112b> m26592B() {
        return this.f15607X;
    }
    ...
    public final Client.AbstractC7865g m26590D(View view, C4602c4.C4603a aVar, TdApi.WebPage webPage, String str) {
        return new C4668b(aVar.m26968P(), aVar, view, new boolean[1], webPage, str);
    }
    ...
    public C4630f0 m26587G() {
        return this.f15621i0;
    }

    public TdApi.File m26586H() {
        AbstractC4597c cVar = this.f15603T;
        if (cVar != null) {
            return cVar.mo25244g();
        }
        C4630f0 f0Var = this.f15621i0;
        if (f0Var != null) {
            return f0Var.m26768P();
        }
        return null;
    }
    ...
    public int m26583K() {
        ...
        AbstractC4597c cVar = this.f15603T;
        int j = cVar != null ? f15595z0 + cVar.mo25241j() : 0;
    ...
    public final boolean m26582L() {
        return !C5070i.m24062i(this.f15601R.siteName) || !C5070i.m24062i(this.f15601R.title) || !C7321e.m16965a1(this.f15601R.description) || m26576R();
    }

    public boolean m26580N() {
        return (this.f15610a & 1) != 0;
    }

    public boolean m26579O(String str) {
        ...
        try {
            ...
            if (C5070i.m24068c(host.toLowerCase(locale).replaceAll("^(?:www\\.|m\\.)", ""), parse2.getHost().toLowerCase(locale).replaceAll("^(?:www\\.|m\\.)", ""))) {
                return C5070i.m24068c(parse.getPath(), parse2.getPath());
            }
            return false;
        } catch (Throwable th) {
    ...
    public boolean m26576R() {
        return this.f15614c == 18;
    }

    public boolean m26571W() {
        C4630f0 f0Var = this.f15621i0;
        return (f0Var != null && f0Var.m26763U()) || this.f15624l0 != null;
    }

    public boolean m26569Y() {
        return this.f15614c != 19 && C4779t2.m25382z2(this.f15601R) && !m26568Z();
    }

    public boolean m26568Z() {
        int i = this.f15614c;
        return i != 19 && (i == 16 || C4779t2.m25484k5(this.f15601R.displayUrl));
    }

    @Override
    public void mo26567a(View view, C4602c4 c4Var, C4602c4.C4603a aVar) {
        if (m26569Y()) {
            aVar.m26912w0();
            aVar.m26979J0();
            this.f15600Q.mo4348c().m2270r4().m14783o(new TdApi.GetWebPageInstantView(this.f15602S, false), m26590D(view, aVar, this.f15601R, this.f15600Q.m26625fa(this.f15601R)));
            return;
        }
        m26563c0(view, false);
    }

    public void m26566a0() {
        C4630f0 f0Var = this.f15621i0;
        if (f0Var != null) {
    ...
    public boolean m26565b0(C9552h1 h1Var, MotionEvent motionEvent, int i, int i2, RunnableC5390g.AbstractC5393c cVar) {
        C4602c4 c4Var = this.f15630r0;
        if (c4Var != null && c4Var.m27002w(h1Var, motionEvent)) {
            return true;
        }
        C4630f0 f0Var = this.f15621i0;
        if (f0Var != null && f0Var.m26744i0(h1Var, motionEvent)) {
            return true;
        }
        AbstractC4597c cVar2 = this.f15603T;
        if (cVar2 != null && cVar2.mo25240k(h1Var, motionEvent)) {
            return true;
        }
        if ((this.f15622j0 != null || this.f15624l0 != null) && this.f15631s0.m28248e(h1Var, motionEvent)) {
            return true;
        }
        RunnableC5390g gVar = this.f15617e0;
        if (gVar != null && gVar.m22966V0(h1Var, motionEvent, cVar)) {
            return true;
        }
        RunnableC5390g gVar2 = this.f15618f0;
        if (gVar2 != null && gVar2.m22966V0(h1Var, motionEvent, cVar)) {
            return true;
        }
        RunnableC5390g gVar3 = this.f15619g0;
        return gVar3 != null && gVar3.m22966V0(h1Var, motionEvent, cVar);
    }

    @Override
    public boolean mo26564c(View view, C4602c4 c4Var, C4602c4.C4603a aVar) {
        AbstractC9323v4<?> Z9;
        String str;
        if (this.f15614c != 19 || (Z9 = this.f15600Q.m26097P0().m9300Z9()) == null) {
            return false;
        }
        if (this.f15600Q.mo25842p6()) {
            str = this.f15600Q.m26621ja();
        } else {
            C4656h6 h6Var = this.f15600Q;
            str = this.f15600Q.f16099O0.m2637Tc(h6Var.f16099O0.m2462f4(h6Var.m26622ia()));
        }
        Z9.m9316Wd(str, this.f15600Q.m25917h8(), null);
        return false;
    }

    public boolean m26563c0(View view, boolean z) {
        C4602c4 c4Var;
        if (m26585I() == 18) {
            this.f15600Q.mo4348c().m2485dd().m3858E7(this.f15600Q.m26097P0(), this.f15602S, this.f15630r0.m27011n().m26997A0(view).m3326e());
            return true;
        } else if (this.f15621i0 != null && z && m26577Q(this.f15614c)) {
            View$OnClickListenerC7430j1.m16181lk(this.f15600Q);
            return true;
        } else if (z && (c4Var = this.f15630r0) != null && c4Var.m27016i(view)) {
            return true;
        } else {
            int I = m26585I();
            if (I == 3 || I == 4) {
                ...
                switch (I) {
                    ...
                    default:
                        C4630f0 f0Var = this.f15621i0;
                        if (f0Var == null || !f0Var.m26757a0()) {
                            if (!AbstractView$OnClickListenerC0259c.m41990S1(this.f15600Q.m26097P0(), this.f15601R, this.f15600Q.m25871m6())) {
                                if (this.f15621i0 != null && this.f15601R.photo != null) {
                                    View$OnClickListenerC7430j1.m16181lk(this.f15600Q);
                                    break;
                                } else {
                                    this.f15600Q.mo4348c().m2485dd().m3858E7(this.f15600Q.m26097P0(), this.f15602S, new HandlerC10770jj.C10788q(this.f15630r0.m27011n().m26997A0(view)).m3327d());
                                    break;
                                }
                            }
                        } else {
                ...
                this.f15600Q.m26626ea();
            }
            return true;
        }
    }

    public boolean m26561d0(View view, C4656h6 h6Var) {
        RunnableC5390g gVar;
        RunnableC5390g gVar2;
        C4602c4 c4Var;
        RunnableC5390g gVar3 = this.f15617e0;
        return (gVar3 != null && gVar3.m22964W0(view)) || ((gVar = this.f15618f0) != null && gVar.m22964W0(view)) || (((gVar2 = this.f15619g0) != null && gVar2.m22964W0(view)) || ((c4Var = this.f15630r0) != null && c4Var.m27000y(view)));
    }

    @Override
    public boolean mo15925e(C6883g1 g1Var, View view, TdApi.File file, long j) {
        return m26563c0(view, true);
    }

    public void m26560e0(C6257p pVar, int i, int i2) {
    ...
    public void m26559f0(RunnableC6507m mVar, int i, int i2) {
    ...
    public void m26557g0(C6240c cVar, int i, int i2) {
        if (this.f15622j0 == null && this.f15624l0 == null) {
            ...
            cVar.m20978j(null, this.f15623k0);
        }
    }

    public final void m26553i0(int i, int i2, int i3) {
        TdApi.Sticker sticker;
        this.f15612b = true;
        int F4 = this.f15600Q.m26196F4();
        ...
        if (sticker2 == null || (Math.max(sticker2.width, sticker2.height) > 512 && !C7321e.m16976V0(this.f15601R.sticker.type))) {
            ...
            if (webPage.sticker != null) {
                this.f15621i0 = new C4630f0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), C4779t2.m25552b0(this.f15601R.sticker), this.f15598O, this.f15599P, (AbstractC4761s4) this.f15600Q, false);
                m26551j0(C1363c0.m37426m(this.f15601R.sticker.sticker.size));
                ...
                this.f15621i0 = new C4630f0(s, c, webPage2.photo, this.f15598O, this.f15599P, this.f15600Q, false, false, C4658i.m26604i(webPage2));
            }
            this.f15621i0.m26790B0(this.f15620h0);
            this.f15621i0.m26722t0(this);
            float F = this.f15621i0.m26783F();
            float E = this.f15621i0.m26785E();
            float min = Math.min(i / F, F4 / E);
            int i4 = (int) (F * min);
            int i5 = (int) (min * E);
            this.f15621i0.m26741k(i4, i5);
            this.f15615c0 = i4;
            this.f15616d0 = i5;
        } else {
            float i6 = C1357a0.m37544i(190.0f);
            ...
            if (C7321e.m16976V0(this.f15601R.sticker.type)) {
                ...
                this.f15622j0 = hVar;
                hVar.m20898s0(1);
                this.f15622j0.m20890x0();
                this.f15622j0.mo20768t0(Math.max(i7, i8));
            }
            C6246h D5 = C4779t2.m25705D5(this.f15600Q.mo4348c(), this.f15601R.sticker.thumbnail);
            this.f15623k0 = D5;
            if (D5 != null) {
                D5.m20898s0(1);
                this.f15623k0.m20890x0();
            }
            this.f15625m0 = i7;
            this.f15626n0 = i8;
            this.f15597N += i8;
    ...
    public final void m26551j0(String str) {
        this.f15627o0 = str;
        this.f15628p0 = (int) C7389v0.m16680T1(str, C1410y.m37074G0(13.0f, false, true));
    }

    @Override
    public boolean mo26550k(View view, C4630f0 f0Var) {
        if ((!m26578P(this.f15614c) || this.f15612b || this.f15601R.photo == null) && this.f15607X == null) {
            return m26563c0(view, true);
        }
    ...
    public final void m26572V(ArrayList<C8112b> arrayList, String str, float f, int i) {
        if (!m26580N()) {
    ...
    public final void m26547l0(TdApi.Photo photo) {
        if (C7321e.m17004H0(photo) != null) {
            this.f15612b = false;
            C4630f0 f0Var = new C4630f0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), photo, this.f15598O, this.f15599P, this.f15600Q, false, false, C4658i.m26604i(this.f15601R));
            this.f15621i0 = f0Var;
            f0Var.m26790B0(this.f15620h0);
            this.f15621i0.m26732o0(true);
            this.f15621i0.m26722t0(this);
    ...
    public void m26545m0(AbstractC4345j jVar) {
        this.f15620h0 = jVar;
        RunnableC5390g gVar = this.f15617e0;
        if (gVar != null) {
            gVar.m22915o1(jVar);
    ...
    public void m26543n0(long j, long j2, boolean z) {
        this.f15599P = j2;
        C4630f0 f0Var = this.f15621i0;
        if (f0Var != null) {
        ...
        AbstractC4597c cVar = this.f15603T;
        if (!(cVar == null || cVar.mo25243h() == null)) {
            this.f15603T.mo25243h().m18652Q0(j, j2, z);
        }
        ...
        if (arrayList != null) {
            ...
            while (it.hasNext()) {
                C8112b next = it.next();
                next.m13472x().m18652Q0(j, j2, z);
                next.m13540O0(this.f15600Q.m25994Z3());
            }
        }
    }

    public void m26542o(TdApi.ChatType chatType) {
        C4630f0 f0Var = this.f15621i0;
        if (f0Var != null) {
    ...
    public final void m26541p(TdApi.WebPage webPage, int i) {
        C4630f0 f0Var = new C4630f0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), webPage.animation, this.f15598O, this.f15599P, this.f15600Q, false, false, false, C4658i.m26604i(webPage));
        this.f15621i0 = f0Var;
        f0Var.m26722t0(this);
        this.f15621i0.m26790B0(this.f15620h0);
        int F4 = this.f15600Q.m26196F4();
        ...
        this.f15597N += this.f15616d0 + (m26582L() ? f15583B0 + f15591v0 : -f15582A0);
    }

    public final void m26540q(TdApi.WebPage webPage, int i) {
        final int i2;
        final int i3;
        if (m26570X(webPage) || !m26578P(this.f15614c) || C4779t2.m25423t3(webPage.photo)) {
            i2 = i;
        } else {
            int i4 = f15593x0;
            i2 = (i - f15592w0) - i4;
            ...
            if (this.f15621i0 == null) {
                m26547l0(webPage.photo);
            }
        }
        int i5 = 0;
        boolean z = this.f15621i0 != null && !this.f15612b;
        if (!C5070i.m24062i(webPage.siteName) || m26576R()) {
            final int i6 = C1357a0.m37544i(f15590u0) + 0;
            RunnableC5390g.AbstractC5397g e7Var = z ? new RunnableC5390g.AbstractC5397g() {
                @Override
                public final int mo9970a(int i7, int i8, int i9, int i10) {
                    int S;
                    S = C4666i7.this.m26575S(i6, i2, i7, i8, i9, i10);
                    return S;
                }
            } : null;
            String i1 = m26576R() ? C4403w.m27871i1(R.string.ChatBackground) : webPage.siteName;
            RunnableC5390g f = new RunnableC5390g.C5392b(i1, i, AbstractC4761s4.m26126M4(), this.f15600Q.m26176H2()).m22875p(2).m22876o(e7Var).m22866y((C4403w.m27986G2() ? Log.TAG_CRASH : 0) | 4).m22884g().m22882i(new AbstractC5411l0[]{AbstractC5411l0.m22792D(this.f15600Q.f16099O0, i1, new TdApi.TextEntity(0, i1.length(), new TdApi.TextEntityTypeTextUrl(this.f15602S)), this.f15600Q.m25917h8())}).m22885f();
            this.f15617e0 = f;
            i3 = i6 + f.getHeight();
        } else {
            this.f15617e0 = null;
        ...
        if (C5070i.m24062i(webPage.title) || m26576R()) {
            this.f15618f0 = null;
        } else {
            if (i3 > 0) {
                i3 += C1357a0.m37544i(f15589t0);
            }
            RunnableC5390g f2 = new RunnableC5390g.C5392b(webPage.title, i, AbstractC4761s4.m26126M4(), this.f15600Q.m26135L4()).m22875p(C4779t2.m25382z2(webPage) ? -1 : 4).m22876o(z ? new RunnableC5390g.AbstractC5397g() {
                @Override
                public final int mo9970a(int i7, int i8, int i9, int i10) {
                    int T;
                    T = C4666i7.this.m26574T(i3, i2, i7, i8, i9, i10);
                    return T;
                }
            } : null).m22866y((C4403w.m27986G2() ? Log.TAG_CRASH : 0) | 4).m22884g().m22885f();
            this.f15618f0 = f2;
            i3 += f2.getHeight();
        }
        if (!C7321e.m16965a1(webPage.description)) {
            ...
            RunnableC5390g.C5392b o = new RunnableC5390g.C5392b(webPage.description.text, i, AbstractC4761s4.m26126M4(), this.f15600Q.m26135L4()).m22875p(8).m22876o(z ? new RunnableC5390g.AbstractC5397g() {
                @Override
                public final int mo9970a(int i7, int i8, int i9, int i10) {
                    int U;
                    U = C4666i7.this.m26573U(i3, i2, i7, i8, i9, i10);
                    return U;
                }
            } : null);
            if (C4403w.m27986G2()) {
            ...
            RunnableC5390g.C5392b y = o.m22866y(i5);
            C4656h6 h6Var = this.f15600Q;
            RunnableC5390g f3 = y.m22882i(AbstractC5411l0.m22790F(h6Var.f16099O0, webPage.description, h6Var.m25917h8())).m22885f();
            this.f15619g0 = f3;
            i3 += f3.getHeight();
        } else {
            this.f15619g0 = null;
        ...
        AbstractC4597c cVar = this.f15603T;
        if (cVar != null) {
            this.f15597N = i7 + cVar.mo25242i();
        }
        this.f15609Z = this.f15597N;
    }

    public void m26539r(int i) {
        char c;
        this.f15596M = i;
        int i2 = i - f15595z0;
        this.f15597N = 0;
        ...
        if (!m26577Q(this.f15614c) && this.f15600Q.mo4348c().m2485dd().m3513n3(this.f15602S) == 1) {
            this.f15614c = 15;
        }
        if (m26582L()) {
            m26540q(this.f15601R, i2);
        }
        if (m26570X(this.f15601R)) {
            ...
            int i3 = this.f15614c;
            if (i3 == 1) {
                m26536u(this.f15601R, i2);
            } else if (i3 != 19) {
                if (i3 == 3) {
                    m26541p(this.f15601R, i2);
                } else if (i3 != 4) {
                    if (i3 == 18) {
                    ...
                    AbstractC4597c cVar = this.f15603T;
                    if (cVar != null) {
                        cVar.mo25237n(this.f15620h0);
                        this.f15603T.mo25247a(i2);
                        if (m26582L()) {
                            this.f15597N += f15583B0;
                        }
                        int i4 = this.f15597N;
                        this.f15604U = i4;
                        this.f15597N = i4 + this.f15603T.mo25242i();
                    } else if (m26578P(this.f15614c)) {
                        if (this.f15621i0 != null) {
                            int i5 = this.f15597N;
                    ...
                    m26538s(this.f15601R, i2);
                }
            }
        }
        m26537t();
        if ((this.f15610a & 2) == 0 && m26568Z()) {
            this.f15610a |= 2;
            this.f15600Q.mo4348c().m2270r4().m14783o(new TdApi.GetWebPageInstantView(this.f15602S, false), this);
        }
        m26545m0(this.f15620h0);
        this.f15597N += f15582A0;
    }

    public final void m26538s(TdApi.WebPage webPage, int i) {
        if (m26582L()) {
            int i2 = f15583B0;
            m26553i0(i, i2, f15591v0 + i2);
            return;
        }
        m26553i0(i, 0, -f15582A0);
    }

    public final void m26537t() {
        int i;
        int i2;
        if (m26569Y()) {
            ...
            switch (this.f15614c) {
                ...
                case 18:
                    ...
                    break;
                case 19:
                    i2 = this.f15600Q.m26623ha();
                    break;
            }
            i = 0;
        }
        if (i2 != 0) {
            int i3 = this.f15597N + C1357a0.m37544i(6.0f);
            this.f15629q0 = i3;
            this.f15597N = i3 + C4602c4.m27010o();
            C4602c4 c4Var = new C4602c4(this.f15600Q, false);
            this.f15630r0 = c4Var;
            c4Var.m27027A(i, C4403w.m27871i1(i2), this.f15596M - f15595z0, this.f15614c != 19, this);
        }
    }
    ...
    public void mo255t2(TdApi.Object object) {
        ...
        if (object.getConstructor() == 778202453) {
            ...
            if (pageBlockArr != null && pageBlockArr.length > 1) {
                C4630f0 f0Var = this.f15621i0;
                TdApi.File P = f0Var != null ? f0Var.m26768P() : null;
                int i2 = P != null ? P.f25376id : 0;
                ...
                while (true) {
                    ...
                    if (constructor2 == 417601156) {
                        ...
                        String h2 = C4779t2.m25508h2(pageBlockPhoto.caption.text);
                        bVar = C8112b.m13524W0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), pageBlockPhoto.photo, new TdApi.FormattedText(h2, RunnableC5390g.m22997G(h2, 1)));
                    } else if (constructor2 == 510041394) {
                        TdApi.PageBlockVideo pageBlockVideo = (TdApi.PageBlockVideo) pageBlock2;
                        String h22 = C4779t2.m25508h2(pageBlockVideo.caption.text);
                        bVar = C8112b.m13522X0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), pageBlockVideo.video, new TdApi.FormattedText(h22, RunnableC5390g.m22997G(h22, 1)));
                    } else if (constructor2 != 1355669513) {
                        bVar = null;
                    } else {
                        TdApi.PageBlockAnimation pageBlockAnimation = (TdApi.PageBlockAnimation) pageBlock2;
                        String h23 = C4779t2.m25508h2(pageBlockAnimation.caption.text);
                        bVar = C8112b.m13528U0(this.f15600Q.mo4347s(), this.f15600Q.mo4348c(), pageBlockAnimation.animation, new TdApi.FormattedText(h23, RunnableC5390g.m22997G(h23, 1)));
                    }
                    if (bVar == null) {
                        arrayList.clear();
                        break;
                    }
                    if (i4 == -1 && bVar.m13474w() == i2) {
                        bVar.m13540O0(this.f15600Q.m25994Z3());
                        i4 = i5;
                    }
                    arrayList.add(bVar);
                    i5++;
                ...
                if (arrayList.size() > 1) {
                    ...
                    if (!m26580N()) {
                        final String j1 = C4403w.m27867j1(R.string.XofY, Integer.valueOf(i4 + 1), Integer.valueOf(arrayList.size()));
                        final float T1 = C7389v0.m16680T1(j1, C1410y.m37074G0(13.0f, false, true));
                        final int i6 = i4;
                        this.f15600Q.mo4348c().m2485dd().post(new Runnable() {
                            @Override
                            public final void run() {
                                C4666i7.this.m26572V(arrayList, j1, T1, i6);
                            }
                        });
                    }
                }
    ...
    public final void m26536u(TdApi.WebPage webPage, int i) {
        if (webPage.video != null || webPage.photo != null) {
            int i2 = webPage.duration;
            if (i2 != 0) {
                m26551j0(C1363c0.m37436h(i2));
            }
            if (m26582L()) {
                int i3 = f15583B0;
                m26553i0(i, i3, f15591v0 + i3);
                return;
            }
            m26553i0(i, 0, -f15582A0);
        }
    ...
    public void m26534w(C9552h1 h1Var, Canvas canvas, int i, int i2, AbstractC6264v vVar, AbstractC6264v vVar2, float f) {
        Canvas canvas2;
        int i3;
        C9552h1 h1Var2;
        int i4;
        ...
        if (cVar != null) {
            ...
            C4656h6 h6Var = this.f15600Q;
            int W2 = h6Var != null ? h6Var.m26024W2() : 0;
            ...
            int i8 = W2;
            h1Var2 = h1Var;
            cVar.mo25246c(h1Var, canvas, i6, i7, vVar, vVar2, i8, i5, f, 0.0f);
        } else {
            i3 = i;
            canvas2 = canvas;
            h1Var2 = h1Var;
            ...
            if (f0Var != null) {
                ...
                f0Var.m26725s(h1Var, canvas, i9, i10, vVar, vVar2, 1.0f);
                String str = null;
                float f2 = 0.0f;
                if (!C5070i.m24062i(this.f15627o0)) {
                    str = this.f15627o0;
                    f2 = this.f15628p0;
                } else if (!C5070i.m24062i(this.f15606W)) {
                    str = this.f15606W;
                    f2 = this.f15605V;
                }
                if (!C5070i.m24062i(str)) {
                    ...
                    canvas2.drawRoundRect(a0, C1357a0.m37544i(4.0f), C1357a0.m37544i(4.0f), C1410y.m37042g(1275068416));
                    int i15 = f15584C0;
                    canvas2.drawText(str, ((i11 - i15) - f15585D0) - f2, ((i12 - i15) - f15586E0) + f15587F0, C1410y.m37074G0(13.0f, false, false));
                }
                ...
                C1359b.m37501u(canvas, vVar, vVar2, false, true, i16, i17, i16 + this.f15625m0, i17 + this.f15626n0);
            }
        }
        C4602c4 c4Var = this.f15630r0;
        if (c4Var == null) {
        ...
        if (this.f15614c == i4) {
            c4Var.m27015j(h1Var2, canvas2, i3, i2 + this.f15629q0);
        } else {
            c4Var.m27015j(h1Var2, canvas2, G2 ? i3 : f15595z0 + i3, i2 + this.f15629q0);
        }
    }

    public final void m26533x(Canvas canvas, int i, int i2, int i3, boolean z) {
        RectF a0 = C1410y.m37053a0();
        if (z) {
            int i4 = i + i3;
        ...
        int i5 = f15582A0;
        canvas.drawRoundRect(a0, i5 / 2, i5 / 2, C1410y.m37042g(this.f15600Q.m26032V4()));
        int i6 = 0;
        if (this.f15617e0 != null) {
            int i7 = C1357a0.m37544i(f15590u0) + 0;
            RunnableC5390g gVar = this.f15617e0;
            ...
            gVar.m22902u(canvas, i8, i9, 0, i2 + i7);
            i6 = this.f15617e0.getHeight() + i7;
        }
        if (this.f15618f0 != null) {
            if (i6 > 0) {
                i6 += C1357a0.m37544i(f15589t0);
            }
            RunnableC5390g gVar2 = this.f15618f0;
            ...
            gVar2.m22902u(canvas, i10, i11, 0, i2 + i6);
        ...
        if (this.f15619g0 != null) {
            ...
            gVar3.m22902u(canvas, i12, i13, 0, i2 + i6);
            this.f15619g0.getHeight();
        }
    }

    public C4707n m26532y() {
        AbstractC4597c cVar = this.f15603T;
