...
public class C4847z extends AbstractC4718o<TdApi.InlineQueryResultPhoto> {
    ...
    public C4847z(AbstractView$OnTouchListenerC7889a aVar, C10930q6 q6Var, TdApi.InlineQueryResultPhoto inlineQueryResultPhoto) {
        super(aVar, q6Var, 10, inlineQueryResultPhoto.f25389id, inlineQueryResultPhoto);
        if (inlineQueryResultPhoto.photo.minithumbnail != null) {
            C6250i iVar = new C6250i(inlineQueryResultPhoto.photo.minithumbnail);
            this.f16523a0 = iVar;
            iVar.m20898s0(2);
        }
        TdApi.PhotoSize l = C4630f0.m26739l(inlineQueryResultPhoto.photo);
        TdApi.PhotoSize o = C4630f0.m26733o(inlineQueryResultPhoto.photo, l);
        this.f16526d0 = C4630f0.m26764T(inlineQueryResultPhoto.photo, o);
        this.f16527e0 = C4630f0.m26779H(inlineQueryResultPhoto.photo, o);
        if (l != null) {
            C6246h hVar = new C6246h(q6Var, l.photo);
            this.f16524b0 = hVar;
            hVar.m20898s0(2);
            this.f16524b0.m20918g0(false);
        }
        if (o != null) {
            C6246h hVar2 = new C6246h(q6Var, o.photo);
            this.f16525c0 = hVar2;
            hVar2.m20898s0(2);
            this.f16525c0.m20918g0(false);
            this.f16525c0.mo20768t0(C1357a0.m37544i(128.0f));
        }
    }

    public C6246h m25052Z() {
        return this.f16525c0;
    }

    public C6246h m25051a0() {
        return this.f16523a0;
    }

    public C6246h m25050b0() {
