...
public class C4649h implements AbstractC5113f0, C4341g.AbstractC4342a, AbstractC5098a1, C9357x2.AbstractC9363f {
    ...
    public final int f15514c0 = C1357a0.m37544i(72.0f) + C1357a0.m37544i(11.0f);
    public boolean f15515d0;
    public int f15516e0;

    public C4649h(C10930q6 q6Var, TdApi.Chat chat) {
        C4341g r = new C4341g().m28235r(this);
        this.f15510a0 = r;
        this.f15512b0 = new C3941g(r);
        this.f15509a = q6Var;
        this.f15511b = chat.f25370id;
        this.f15513c = C4779t2.m25466n2(chat);
        this.f15495M = C7316a.m17048m(chat.f25370id);
        this.f15496N = C7316a.m17045p(chat.f25370id);
        m26631x(chat.title);
        this.f15507Y = q6Var.m2947A3(chat, false, 25.0f, null);
        TdApi.ChatPhotoInfo chatPhotoInfo = chat.photo;
        if (chatPhotoInfo != null) {
            m26633v(chatPhotoInfo.small);
        }
        m26630y();
    }

    public static C4649h m26648A(C10930q6 q6Var, TdApi.ChatMember chatMember, boolean z, boolean z2) {
        C4649h hVar;
        ...
        hVar.m26635t(chatMember, z, z2);
        return hVar;
    }

    @Override
    public void mo13518a() {
        List<Reference<View>> n = this.f15510a0.m28239n();
        if (n != null) {
    ...
    public final void m26647e() {
        ...
        if (gVar != null) {
            i -= gVar.getWidth() + C1357a0.m37544i(4.0f);
        }
        int i2 = i;
        if (i2 <= 0) {
            this.f15506X = null;
        } else if (!C5070i.m24062i(this.f15505W)) {
            this.f15506X = new RunnableC5390g.C5392b(this.f15509a, this.f15505W, (HandlerC10770jj.C10788q) null, i2, C1410y.m37086A0(15.0f), C5428t.AbstractC5441d.f17873D).m22869v().m22885f();
        } else {
            this.f15506X = null;
        }
    }
    ...
    public final void m26646h() {
        ...
        if (chatMember != null) {
            ...
            if (C5070i.m24062i(str) && this.f15500R) {
        ...
        if (!C5070i.m24062i(str)) {
            RunnableC5390g f = new RunnableC5390g.C5392b(str, i, C1410y.m37086A0(13.0f), C5428t.AbstractC5441d.f17873D).m22869v().m22885f();
            this.f15501S = f;
            i -= f.getWidth() + C1357a0.m37544i(4.0f);
        } else {
            this.f15501S = null;
        }
        if (i <= 0) {
        ...
        if (!C5070i.m24062i(this.f15503U)) {
            gVar = new RunnableC5390g.C5392b(this.f15503U, i, C1410y.m37086A0(15.0f), C5428t.AbstractC5441d.f17872C).m22889b().m22869v().m22885f();
        }
        this.f15504V = gVar;
    }

    public <T extends View & AbstractC5143t> void m26645i(T t, AbstractC6264v vVar, Canvas canvas) {
        int i = C1357a0.m37544i(72.0f);
        C4403w.m27986G2();
        int measuredWidth = t.getMeasuredWidth();
        float a = this.f15512b0.m29574a();
        if (a > 0.0f) {
            ...
            Drawable X = t.mo14041X(R.drawable.baseline_incognito_circle_18, R.id.theme_color_iconLight);
            canvas.drawCircle(I0, y0, (X.getMinimumWidth() / 2.0f) * a, C1410y.m37042g(C11524j.m148w()));
            int i2 = (a > 1.0f ? 1 : (a == 1.0f ? 0 : -1));
            if (i2 != 0) {
                canvas.save();
                canvas.scale(a, a, I0, y0);
            }
            C1362c.m37490b(canvas, X, I0 - (X.getMinimumWidth() / 2.0f), y0 - (X.getMinimumHeight() / 2.0f), C1410y.m37070K());
            if (i2 != 0) {
                canvas.restore();
            }
        }
        RunnableC5390g gVar = this.f15504V;
        if (gVar != null) {
            gVar.m22904t(canvas, i, C1357a0.m37544i(13.0f));
        }
        RunnableC5390g gVar2 = this.f15501S;
        C5428t.AbstractC5441d dVar = null;
        if (gVar2 != null) {
            int i3 = (measuredWidth - C1357a0.m37544i(14.0f)) - this.f15501S.getWidth();
            int measuredHeight = (t.getMeasuredHeight() / 2) - (this.f15501S.getHeight() / 2);
            TdApi.ChatMember chatMember = this.f15499Q;
            gVar2.m22894y(canvas, i3, measuredHeight, (chatMember == null || !C4779t2.m25624P2(chatMember.status)) ? null : C5428t.AbstractC5441d.f17877H);
        }
        RunnableC5390g gVar3 = this.f15506X;
        if (gVar3 != null) {
            int i4 = C1357a0.m37544i(33.0f);
            if (this.f15497O) {
                dVar = C5428t.AbstractC5441d.f17877H;
            }
            gVar3.m22894y(canvas, i, i4, dVar);
        }
    }

    public C6246h m26644j() {
        return this.f15508Z;
    }

    public C4587b m26643k() {
        return this.f15507Y;
    }
    ...
    public TdApi.ChatMember m26641n() {
        return this.f15499Q;
    }

    public TdApi.MessageSender m26640o() {
        long j = this.f15513c;
        if (j != 0) {
    ...
    public C4341g m26638q() {
        return this.f15510a0;
    }

    public void m26637r(int i) {
    ...
    public void m26635t(TdApi.ChatMember chatMember, boolean z, boolean z2) {
    ...
    public final void m26634u(boolean z) {
        if (this.f15497O == z) {
            return;
        }
        if (!this.f15498P || !z) {
    ...
    public final void m26633v(TdApi.File file) {
    ...
    public void m26632w(CharSequence charSequence) {
        if (!C5070i.m24068c(this.f15505W, charSequence)) {
    ...
    public final void m26631x(String str) {
        if (!C5070i.m24068c(this.f15503U, str)) {
            if (f15494f0 == null) {
    ...
    public void m26630y() {
        ...
        if (this.f15515d0) {
            charSequence = C4779t2.m25667J1(new C10534a9(null, this.f15509a), this.f15499Q, false);
        }
        if (!C5070i.m24062i(charSequence)) {
            m26632w(charSequence);
        } else if (this.f15513c != 0) {
            TdApi.User v2 = this.f15509a.m2480e2().m1583v2(this.f15513c);
            boolean q3 = C4779t2.m25444q3(v2);
            if (q3) {
                str = C4403w.m27871i1(R.string.status_Online);
            } else if (v2 == null || v2.type.getConstructor() != 1262387765) {
                str = this.f15509a.m2166xc().m3291r(this.f15513c, v2, false);
            } else {
                str = C4403w.m27871i1(((TdApi.UserTypeBot) v2.type).canReadAllGroupMessages ? R.string.BotStatusRead : R.string.BotStatusCantRead);
            }
            m26632w(str);
            m26634u(q3);
        } else {
            m26632w(this.f15509a.m2166xc().m3296m(this.f15511b));
            m26634u(false);
        }
    }
    ...
    public void m26629z() {
        ...
        if (j != 0) {
            ...
            m26631x(C4779t2.m25452p2(v2.f25442id, v2));
