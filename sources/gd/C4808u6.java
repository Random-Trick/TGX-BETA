...
public class C4808u6 extends AbstractC4705m6 implements C11059v7.AbstractC11068i {
    ...
    public String mo25216b() {
        ...
        return user == null ? C4403w.m27871i1(R.string.LoadingUser) : C4779t2.m25438r2(user);
    }
    ...
    public boolean mo25212g(View view, RunnableC5390g gVar, C5455v0 v0Var, HandlerC10770jj.C10788q qVar, AbstractC6264v vVar) {
        ...
        this.f15807a.mo4348c().m2485dd().m3429v7(this.f15807a.m26097P0(), this.f16389M.f25442id, qVar);
        return true;
    }
