...
public class C4599c1 extends AbstractC4576a1 {
    ...
    public C4599c1(AbstractC9323v4<?> v4Var, TdApi.PageBlock pageBlock, String str, C9773p0.AbstractC9776c cVar) {
        ...
        C4756s sVar = (C4756s) AbstractC4718o.m26342Y(v4Var.mo4347s(), v4Var.mo4348c(), pageBlock, cVar);
        this.f15200W = sVar;
        this.f15201X = cVar;
        if (sVar == null) {
    ...
    public boolean mo26659L(View view, boolean z) {
        ...
        this.f15036a.mo4348c().m2930B4().m4636w2().m7105H0(this.f15036a.mo4348c(), this.f15200W.m26266a0(), this.f15201X);
        return true;
    }

    public C4756s m27065Y() {
        return this.f15200W;
    }
